...
namespace SmartThingsNet.Api
{
    ...
    public interface IScenesApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Execute a Scene based on a sceneId.
        /// </remarks>
        ...
        StandardSuccessResponse ExecuteScene(string authorization, string sceneId, string locationId = default(string));
        ...
        ApiResponse<StandardSuccessResponse> ExecuteSceneWithHttpInfo(string authorization, string sceneId, string locationId = default(string));
        /// <summary>
        /// List Scenes
        /// </summary>
        /// <remarks>
        /// Get a list of Scenes for a specified user. If no locationId is sent, all scenes for all available locations will be returned.
        /// </remarks>
        /// <exception cref="SmartThingsNet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">OAuth token</param>
        /// <param name="locationId">The location of a scene. (optional)</param>
        /// <returns>ScenePagedResult</returns>
        ScenePagedResult ListScenes(string authorization, string locationId = default(string));
        ...
        ApiResponse<ScenePagedResult> ListScenesWithHttpInfo(string authorization, string locationId = default(string));
    ...
    public interface IScenesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<StandardSuccessResponse> ExecuteSceneAsync(string authorization, string sceneId, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<StandardSuccessResponse>> ExecuteSceneWithHttpInfoAsync(string authorization, string sceneId, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Scenes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ScenePagedResult> ListScenesAsync(string authorization, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ScenePagedResult>> ListScenesWithHttpInfoAsync(string authorization, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ScenesApi : IScenesApi
    {
        ...
        /// <summary>
        /// Execute a Scene Execute a Scene based on a sceneId.
        /// </summary>
        /// <exception cref="SmartThingsNet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">OAuth token</param>
        /// <param name="sceneId">The ID of the Scene.</param>
        /// <param name="locationId">The location of a scene. (optional)</param>
        /// <returns>StandardSuccessResponse</returns>
        public StandardSuccessResponse ExecuteScene(string authorization, string sceneId, string locationId = default(string))
        {
            SmartThingsNet.Client.ApiResponse<StandardSuccessResponse> localVarResponse = ExecuteSceneWithHttpInfo(authorization, sceneId, locationId);
        ...
        /// <param name="locationId">The location of a scene. (optional)</param>
        /// <returns>ApiResponse of StandardSuccessResponse</returns>
        public SmartThingsNet.Client.ApiResponse<StandardSuccessResponse> ExecuteSceneWithHttpInfo(string authorization, string sceneId, string locationId = default(string))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new SmartThingsNet.Client.ApiException(400, "Missing required parameter 'authorization' when calling ScenesApi->ExecuteScene");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StandardSuccessResponse</returns>
        public async System.Threading.Tasks.Task<StandardSuccessResponse> ExecuteSceneAsync(string authorization, string sceneId, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SmartThingsNet.Client.ApiResponse<StandardSuccessResponse> localVarResponse = await ExecuteSceneWithHttpInfoAsync(authorization, sceneId, locationId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StandardSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<SmartThingsNet.Client.ApiResponse<StandardSuccessResponse>> ExecuteSceneWithHttpInfoAsync(string authorization, string sceneId, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<StandardSuccessResponse>("/scenes/{sceneId}/execute", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List Scenes Get a list of Scenes for a specified user. If no locationId is sent, all scenes for all available locations will be returned.
        /// </summary>
        /// <exception cref="SmartThingsNet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">OAuth token</param>
        /// <param name="locationId">The location of a scene. (optional)</param>
        /// <returns>ScenePagedResult</returns>
        public ScenePagedResult ListScenes(string authorization, string locationId = default(string))
        {
            SmartThingsNet.Client.ApiResponse<ScenePagedResult> localVarResponse = ListScenesWithHttpInfo(authorization, locationId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="locationId">The location of a scene. (optional)</param>
        /// <returns>ApiResponse of ScenePagedResult</returns>
        public SmartThingsNet.Client.ApiResponse<ScenePagedResult> ListScenesWithHttpInfo(string authorization, string locationId = default(string))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new SmartThingsNet.Client.ApiException(400, "Missing required parameter 'authorization' when calling ScenesApi->ListScenes");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ScenePagedResult>("/scenes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ScenePagedResult</returns>
        public async System.Threading.Tasks.Task<ScenePagedResult> ListScenesAsync(string authorization, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SmartThingsNet.Client.ApiResponse<ScenePagedResult> localVarResponse = await ListScenesWithHttpInfoAsync(authorization, locationId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ScenePagedResult)</returns>
        public async System.Threading.Tasks.Task<SmartThingsNet.Client.ApiResponse<ScenePagedResult>> ListScenesWithHttpInfoAsync(string authorization, string locationId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ScenePagedResult>("/scenes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
