...
namespace SmartThingsNet.Api
{
    ...
    public interface IOAuthApiSync : IApiAccessor
    {
        ...
        /// <summary>
        /// Generate stClientId and stClientSecret
        /// </summary>
        /// <remarks>
        /// Generate new &#x60;stClientId&#x60; and &#x60;stClientSecret&#x60; for a SmartThings Schema App. 
        /// </remarks>
        ...
        /// <param name="generateStOauthBody">JSON with the endpointAppId requiring new credentials</param>
        /// <returns>PostReceipt</returns>
        PostReceipt GenerateStOauthCredentials(string authorization, GenerateStOauthBody generateStOauthBody);
        ...
        ApiResponse<PostReceipt> GenerateStOauthCredentialsWithHttpInfo(string authorization, GenerateStOauthBody generateStOauthBody);
    ...
    public interface IOAuthApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PostReceipt> GenerateStOauthCredentialsAsync(string authorization, GenerateStOauthBody generateStOauthBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PostReceipt>> GenerateStOauthCredentialsWithHttpInfoAsync(string authorization, GenerateStOauthBody generateStOauthBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class OAuthApi : IOAuthApi
    {
        ...
        /// <returns></returns>
        public OAuthApi(SmartThingsNet.Client.Configuration configuration)
        {
        ...
        public OAuthApi(SmartThingsNet.Client.ISynchronousClient client, SmartThingsNet.Client.IAsynchronousClient asyncClient, SmartThingsNet.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Generate stClientId and stClientSecret Generate new &#x60;stClientId&#x60; and &#x60;stClientSecret&#x60; for a SmartThings Schema App. 
        /// </summary>
        /// <exception cref="SmartThingsNet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">Personal Access Token &#x60;[w:apps:*]&#x60;</param>
        /// <param name="generateStOauthBody">JSON with the endpointAppId requiring new credentials</param>
        /// <returns>PostReceipt</returns>
        public PostReceipt GenerateStOauthCredentials(string authorization, GenerateStOauthBody generateStOauthBody)
        {
            SmartThingsNet.Client.ApiResponse<PostReceipt> localVarResponse = GenerateStOauthCredentialsWithHttpInfo(authorization, generateStOauthBody);
        ...
        /// <param name="generateStOauthBody">JSON with the endpointAppId requiring new credentials</param>
        /// <returns>ApiResponse of PostReceipt</returns>
        public SmartThingsNet.Client.ApiResponse<PostReceipt> GenerateStOauthCredentialsWithHttpInfo(string authorization, GenerateStOauthBody generateStOauthBody)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new SmartThingsNet.Client.ApiException(400, "Missing required parameter 'authorization' when calling OAuthApi->GenerateStOauthCredentials");
            }

            // verify the required parameter 'generateStOauthBody' is set
            if (generateStOauthBody == null)
            {
                throw new SmartThingsNet.Client.ApiException(400, "Missing required parameter 'generateStOauthBody' when calling OAuthApi->GenerateStOauthCredentials");
            }
            ...
            localVarRequestOptions.Data = generateStOauthBody;


            // make the HTTP request
            var localVarResponse = this.Client.Post<PostReceipt>("/schema/oauth/stclient/credentials", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GenerateStOauthCredentials", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PostReceipt</returns>
        public async System.Threading.Tasks.Task<PostReceipt> GenerateStOauthCredentialsAsync(string authorization, GenerateStOauthBody generateStOauthBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SmartThingsNet.Client.ApiResponse<PostReceipt> localVarResponse = await GenerateStOauthCredentialsWithHttpInfoAsync(authorization, generateStOauthBody, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PostReceipt)</returns>
        public async System.Threading.Tasks.Task<SmartThingsNet.Client.ApiResponse<PostReceipt>> GenerateStOauthCredentialsWithHttpInfoAsync(string authorization, GenerateStOauthBody generateStOauthBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<PostReceipt>("/schema/oauth/stclient/credentials", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
