...
namespace SmartThingsNet.Api
{
    ...
    /// </summary>
    public interface ITTSApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Get details about options supported by the tts and playtext API
        /// </remarks>
        ...
        /// <returns>TTSInfo</returns>
        TTSInfo Info(string authorization);
        ...
        /// <exception cref="SmartThingsNet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">OAuth token</param>
        /// <returns>ApiResponse of TTSInfo</returns>
        ApiResponse<TTSInfo> InfoWithHttpInfo(string authorization);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        PlayedText Playtext(string authorization, PlaytextBody playtextBody);
        ...
        /// <param name="authorization">OAuth token</param>
        /// <param name="playtextBody"></param>
        /// <returns>ApiResponse of PlayedText</returns>
        ApiResponse<PlayedText> PlaytextWithHttpInfo(string authorization, PlaytextBody playtextBody);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ConvertedTTS Tts(string authorization, TTSBody tTSBody);
        ...
        /// <param name="authorization">OAuth token</param>
        /// <param name="tTSBody"></param>
        /// <returns>ApiResponse of ConvertedTTS</returns>
        ApiResponse<ConvertedTTS> TtsWithHttpInfo(string authorization, TTSBody tTSBody);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITTSApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of TTSInfo</returns>
        System.Threading.Tasks.Task<TTSInfo> InfoAsync(string authorization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="authorization">OAuth token</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TTSInfo)</returns>
        System.Threading.Tasks.Task<ApiResponse<TTSInfo>> InfoWithHttpInfoAsync(string authorization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PlayedText> PlaytextAsync(string authorization, PlaytextBody playtextBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PlayedText>> PlaytextWithHttpInfoAsync(string authorization, PlaytextBody playtextBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ConvertedTTS> TtsAsync(string authorization, TTSBody tTSBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ConvertedTTS>> TtsWithHttpInfoAsync(string authorization, TTSBody tTSBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITTSApi : ITTSApiSync, ITTSApiAsync
    {
    ...
    public partial class TTSApi : ITTSApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public TTSApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public TTSApi(SmartThingsNet.Client.Configuration configuration)
        {
        ...
        public TTSApi(SmartThingsNet.Client.ISynchronousClient client, SmartThingsNet.Client.IAsynchronousClient asyncClient, SmartThingsNet.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="authorization">OAuth token</param>
        /// <returns>TTSInfo</returns>
        public TTSInfo Info(string authorization)
        {
            SmartThingsNet.Client.ApiResponse<TTSInfo> localVarResponse = InfoWithHttpInfo(authorization);
        ...
        /// <param name="authorization">OAuth token</param>
        /// <returns>ApiResponse of TTSInfo</returns>
        public SmartThingsNet.Client.ApiResponse<TTSInfo> InfoWithHttpInfo(string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new SmartThingsNet.Client.ApiException(400, "Missing required parameter 'authorization' when calling TTSApi->Info");
            }
            ...
            var localVarResponse = this.Client.Get<TTSInfo>("/services/tts/info", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("Info", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TTSInfo</returns>
        public async System.Threading.Tasks.Task<TTSInfo> InfoAsync(string authorization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SmartThingsNet.Client.ApiResponse<TTSInfo> localVarResponse = await InfoWithHttpInfoAsync(authorization, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TTSInfo)</returns>
        public async System.Threading.Tasks.Task<SmartThingsNet.Client.ApiResponse<TTSInfo>> InfoWithHttpInfoAsync(string authorization, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TTSInfo>("/services/tts/info", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="playtextBody"></param>
        /// <returns>ApiResponse of PlayedText</returns>
        public SmartThingsNet.Client.ApiResponse<PlayedText> PlaytextWithHttpInfo(string authorization, PlaytextBody playtextBody)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<PlayedText>("/services/tts/playtext", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="tTSBody"></param>
        /// <returns>ApiResponse of ConvertedTTS</returns>
        public SmartThingsNet.Client.ApiResponse<ConvertedTTS> TtsWithHttpInfo(string authorization, TTSBody tTSBody)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ConvertedTTS>("/services/tts", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
