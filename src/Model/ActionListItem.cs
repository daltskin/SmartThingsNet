...
namespace SmartThingsNet.Model
{
    ...
    /// ActionListItem
    /// </summary>
    [DataContract(Name = "actionListItem")]
    public partial class ActionListItem : IEquatable<ActionListItem>, IValidatableObject
    {
        /// <summary>
        ...
        public List<ExcludedActionItem> Exclusion { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionListItem {\n");
        ...
        {
            return this.Equals(input as ActionListItem);
        }

        /// <summary>
        /// Returns true if ActionListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionListItem input)
        {
            if (input == null)
            {
                return false;
