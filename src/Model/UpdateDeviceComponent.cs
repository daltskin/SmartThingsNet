...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateDeviceComponent")]
    public partial class UpdateDeviceComponent : IEquatable<UpdateDeviceComponent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDeviceComponent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDeviceComponent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDeviceComponent" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="icon">Identifier allowing the user to pick a custom icon for the device component. The icon of the main component represents the device itself .</param>
        /// <param name="categories">A case-sensitive string from the pre-defined list of valid categories [/devicecategories](#/operation/listCategories). Allows the user to redefine the category of the device from what the manufacturer set by default. (required).</param>
        public UpdateDeviceComponent(string id = default(string), string icon = default(string), List<string> categories = default(List<string>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for UpdateDeviceComponent and cannot be null");
            }
            this.Id = id;
            // to ensure "categories" is required (not null)
            if (categories == null) {
                throw new ArgumentNullException("categories is a required property for UpdateDeviceComponent and cannot be null");
            }
        ...
        /// <summary>
        /// Identifier allowing the user to pick a custom icon for the device component. The icon of the main component represents the device itself 
        /// </summary>
        /// <value>Identifier allowing the user to pick a custom icon for the device component. The icon of the main component represents the device itself </value>
        [DataMember(Name = "icon", EmitDefaultValue = false)]
        public string Icon { get; set; }

        /// <summary>
        /// A case-sensitive string from the pre-defined list of valid categories [/devicecategories](#/operation/listCategories). Allows the user to redefine the category of the device from what the manufacturer set by default.
        /// </summary>
        /// <value>A case-sensitive string from the pre-defined list of valid categories [/devicecategories](#/operation/listCategories). Allows the user to redefine the category of the device from what the manufacturer set by default.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDeviceComponent {\n");
        ...
        {
            return this.Equals(input as UpdateDeviceComponent);
        }

        /// <summary>
        /// Returns true if UpdateDeviceComponent instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDeviceComponent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDeviceComponent input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Icon, length must be less than 255.", new [] { "Icon" });
            }

            // Icon (string) minLength
            if (this.Icon != null && this.Icon.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Icon, length must be greater than 1.", new [] { "Icon" });
            }
