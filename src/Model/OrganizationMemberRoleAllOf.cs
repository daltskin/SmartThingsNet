...
{
    /// <summary>
    /// OrganizationMemberRoleAllOf
    /// </summary>
    [DataContract(Name = "OrganizationMemberRole_allOf")]
    public partial class OrganizationMemberRoleAllOf : IEquatable<OrganizationMemberRoleAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationMemberRoleAllOf" /> class.
        /// </summary>
        /// <param name="role">role.</param>
        public OrganizationMemberRoleAllOf(Role role = default(Role))
        {
            this.Role = role;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationMemberRoleAllOf {\n");
        ...
        {
            return this.Equals(input as OrganizationMemberRoleAllOf);
        }

        /// <summary>
        /// Returns true if OrganizationMemberRoleAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationMemberRoleAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationMemberRoleAllOf input)
        {
            if (input == null)
            {
                return false;
