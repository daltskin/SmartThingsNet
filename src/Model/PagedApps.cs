...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedApps")]
    public partial class PagedApps : IEquatable<PagedApps>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedApps" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedApps(List<PagedApp> items = default(List<PagedApp>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<PagedApp> Items { get; set; }
        ...
        {
            return this.Equals(input as PagedApps);
        }

        /// <summary>
        /// Returns true if PagedApps instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedApps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedApps input)
        {
            if (input == null)
            {
                return false;
