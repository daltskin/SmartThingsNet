...
{
    /// <summary>
    /// DetailViewListItemAllOf
    /// </summary>
    [DataContract(Name = "detailViewListItem_allOf")]
    public partial class DetailViewListItemAllOf : IEquatable<DetailViewListItemAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailViewListItemAllOf {\n");
        ...
        {
            return this.Equals(input as DetailViewListItemAllOf);
        }

        /// <summary>
        /// Returns true if DetailViewListItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailViewListItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailViewListItemAllOf input)
        {
            if (input == null)
            {
                return false;
