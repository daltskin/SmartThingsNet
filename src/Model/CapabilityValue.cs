...
namespace SmartThingsNet.Model
{
    ...
    public partial class CapabilityValue :  IEquatable<CapabilityValue>, IValidatableObject
    {
        ...
        public CapabilityValue(string key = default(string), List<string> enabledValues = default(List<string>), List<double> range = default(List<double>), double step = 1D)
        {
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for CapabilityValue and cannot be null");
