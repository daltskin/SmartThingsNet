...
namespace SmartThingsNet.Model
{
    ...
    /// CapabilityValue
    /// </summary>
    [DataContract(Name = "capabilityValue")]
    public partial class CapabilityValue : IEquatable<CapabilityValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityValue" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="CapabilityValue" /> class.
        /// </summary>
        /// <param name="key">This can be either command name or attribute name. (required).</param>
        /// <param name="enabledValues">A list of values supported among those defined in the capability alternatives. For instance, a device may not support &#x60;auto&#x60; for supported thermostat fan modes, so this field might be an array containing &#x60;on&#x60; and &#x60;off&#x60;..</param>
        ...
        /// <param name="range">The inclusive range of a numeric value or bounds of a string depending on the data type it is applied to..</param>
        /// <param name="step">The incremental step that increases or decreases for numeric values. (default to 1D).</param>
        public CapabilityValue(string key = default(string), List<string> enabledValues = default(List<string>), string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), List<double> range = default(List<double>), double step = 1D)
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for CapabilityValue and cannot be null");
            }
            this.Key = key;
        ...
        /// </summary>
        /// <value>This can be either command name or attribute name.</value>
        ...
        /// </summary>
        /// <value>A list of values supported among those defined in the capability alternatives. For instance, a device may not support &#x60;auto&#x60; for supported thermostat fan modes, so this field might be an array containing &#x60;on&#x60; and &#x60;off&#x60;.</value>
        [DataMember(Name = "enabledValues", EmitDefaultValue = false)]
        ...
        /// <summary>
        /// The inclusive range of a numeric value or bounds of a string depending on the data type it is applied to.
        /// </summary>
        /// <value>The inclusive range of a numeric value or bounds of a string depending on the data type it is applied to.</value>
        [DataMember(Name = "range", EmitDefaultValue = false)]
        public List<double> Range { get; set; }

        /// <summary>
        /// The incremental step that increases or decreases for numeric values.
        /// </summary>
        /// <value>The incremental step that increases or decreases for numeric values.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityValue {\n");
            sb.Append("  Key: ").Append(Key).Append("\n");
            sb.Append("  EnabledValues: ").Append(EnabledValues).Append("\n");
        ...
        {
            return this.Equals(input as CapabilityValue);
        }

        /// <summary>
        /// Returns true if CapabilityValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityValue input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EnabledValues == input.EnabledValues ||
                    this.EnabledValues != null &&
                    input.EnabledValues != null &&
                    this.EnabledValues.SequenceEqual(input.EnabledValues)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.EnabledValues.GetHashCode();
                }
                if (this.Label != null)
                {
