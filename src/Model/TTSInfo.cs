...
namespace SmartThingsNet.Model
{
    ...
    /// TTSInfo
    /// </summary>
    [DataContract(Name = "TTSInfo")]
    public partial class TTSInfo : IEquatable<TTSInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TTSInfo" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="TTSInfo" /> class.
        /// </summary>
        /// <param name="voices">Voices supported by the TTS service (required).</param>
        public TTSInfo(List<TTSInfoVoices> voices = default(List<TTSInfoVoices>))
        {
            // to ensure "voices" is required (not null)
            if (voices == null) {
                throw new ArgumentNullException("voices is a required property for TTSInfo and cannot be null");
            }
            this.Voices = voices;
        }

        /// <summary>
        /// Voices supported by the TTS service
        /// </summary>
        /// <value>Voices supported by the TTS service</value>
        [DataMember(Name = "voices", IsRequired = true, EmitDefaultValue = false)]
        public List<TTSInfoVoices> Voices { get; set; }
        ...
        {
            return this.Equals(input as TTSInfo);
        }

        /// <summary>
        /// Returns true if TTSInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of TTSInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TTSInfo input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Voices == input.Voices ||
                    this.Voices != null &&
                    input.Voices != null &&
                    this.Voices.SequenceEqual(input.Voices)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Voices != null)
                {
                    hashCode = (hashCode * 59) + this.Voices.GetHashCode();
                }
                return hashCode;
            }
        }
