...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceLifecycleDetail")]
    public partial class DeviceLifecycleDetail : IEquatable<DeviceLifecycleDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleDetail" /> class.
        /// </summary>
        /// <param name="deviceIds">An array of GUIDs of devices being subscribed to. A max of 20 GUIDs are allowed..</param>
        /// <param name="subscriptionName">A name for the subscription that will be passed to the installed app..</param>
        /// <param name="locationId">The id of the location that both the app and source device are in..</param>
        public DeviceLifecycleDetail(List<string> deviceIds = default(List<string>), string subscriptionName = default(string), string locationId = default(string))
        {
        ...
        /// </summary>
        /// <value>An array of GUIDs of devices being subscribed to. A max of 20 GUIDs are allowed.</value>
        ...
        /// </summary>
        /// <value>A name for the subscription that will be passed to the installed app.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleDetail {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleDetail);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleDetail input)
        {
            if (input == null)
            {
                return false;
