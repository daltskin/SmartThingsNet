...
namespace SmartThingsNet.Model
{
    ...
    /// CapabilityReference
    /// </summary>
    [DataContract(Name = "CapabilityReference")]
    public partial class CapabilityReference : IEquatable<CapabilityReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CapabilityReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityReference" /> class.
        /// </summary>
        ...
        public CapabilityReference(string id = default(string), int version = default(int), Restriction restrictions = default(Restriction), bool ephemeral = default(bool))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for CapabilityReference and cannot be null");
            }
            this.Id = id;
        ...
        {
            return this.Equals(input as CapabilityReference);
        }

        /// <summary>
        /// Returns true if CapabilityReference instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityReference input)
        {
            if (input == null)
            {
                return false;
