...
namespace SmartThingsNet.Model
{
    ...
    public partial class CapabilityReference :  IEquatable<CapabilityReference>, IValidatableObject
    {
        ...
        public CapabilityReference(string id = default(string), int version = default(int))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for CapabilityReference and cannot be null");
