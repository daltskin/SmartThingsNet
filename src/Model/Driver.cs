...
namespace SmartThingsNet.Model
{
    ...
    public partial class Driver : IEquatable<Driver>, IValidatableObject
    {
        ...
        public Driver(string driverId = default(string), string name = default(string), string packageKey = default(string), List<DeviceIntegrationProfileKey> deviceIntegrationProfiles = default(List<DeviceIntegrationProfileKey>), List<DriverPermission> permissions = default(List<DriverPermission>), string version = default(string), List<DriverFingerprint> fingerprints = default(List<DriverFingerprint>))
        {
            // to ensure "driverId" is required (not null)
            if (driverId == null) {
                throw new ArgumentNullException("driverId is a required property for Driver and cannot be null");
            }
            this.DriverId = driverId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Driver and cannot be null");
            }
            this.Name = name;
            // to ensure "packageKey" is required (not null)
            if (packageKey == null) {
                throw new ArgumentNullException("packageKey is a required property for Driver and cannot be null");
            }
        ...
        public List<DriverFingerprint> Fingerprints { get; set; }
