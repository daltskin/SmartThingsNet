...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip10Hour")]
    public partial class ServiceCapabilityDataForecastPrecip10Hour : IEquatable<ServiceCapabilityDataForecastPrecip10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 10 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip10Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 10 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 10 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip10Hour input)
        {
            if (input == null)
            {
                return false;
