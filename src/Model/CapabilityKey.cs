...
namespace SmartThingsNet.Model
{
    ...
    /// CapabilityKey
    /// </summary>
    [DataContract(Name = "capabilityKey")]
    public partial class CapabilityKey : IEquatable<CapabilityKey>, IValidatableObject
    {
        ...
        public CapabilityKey(string capability = default(string), int version = 1)
        {
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for CapabilityKey and cannot be null");
            }
