...
{
    /// <summary>
    /// An internal platform representation of a developer organization.
    /// </summary>
    [DataContract(Name = "OrganizationResponse_allOf")]
    public partial class OrganizationResponseAllOf : IEquatable<OrganizationResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationResponseAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationResponseAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationResponseAllOf" /> class.
        /// </summary>
        ...
        public OrganizationResponseAllOf(string developerGroupId = default(string), string adminGroupId = default(string), Guid organizationId = default(Guid), bool isDefaultUserOrg = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationResponseAllOf {\n");
        ...
        {
            return this.Equals(input as OrganizationResponseAllOf);
        }

        /// <summary>
        /// Returns true if OrganizationResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationResponseAllOf input)
        {
            if (input == null)
            {
                return false;
