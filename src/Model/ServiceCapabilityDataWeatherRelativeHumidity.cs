...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_relativeHumidity")]
    public partial class ServiceCapabilityDataWeatherRelativeHumidity : IEquatable<ServiceCapabilityDataWeatherRelativeHumidity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherRelativeHumidity" /> class.
        /// </summary>
        /// <param name="value">The relative humidity of the air, which is defined as the ratio of the amount of water vapor in the air to the amount of vapor required to bring the air to saturation at a constant temperature. Relative humidity is always expressed as a percentage.  Range - 0 to 10 .</param>
        /// <param name="unit">%.</param>
        public ServiceCapabilityDataWeatherRelativeHumidity(int value = default(int), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// The relative humidity of the air, which is defined as the ratio of the amount of water vapor in the air to the amount of vapor required to bring the air to saturation at a constant temperature. Relative humidity is always expressed as a percentage.  Range - 0 to 10 
        /// </summary>
        /// <value>The relative humidity of the air, which is defined as the ratio of the amount of water vapor in the air to the amount of vapor required to bring the air to saturation at a constant temperature. Relative humidity is always expressed as a percentage.  Range - 0 to 10 </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherRelativeHumidity {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherRelativeHumidity);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherRelativeHumidity instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherRelativeHumidity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherRelativeHumidity input)
        {
            if (input == null)
            {
                return false;
