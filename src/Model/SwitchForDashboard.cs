...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SwitchForDashboard :  IEquatable<SwitchForDashboard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchForDashboard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwitchForDashboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchForDashboard" /> class.
        /// </summary>
        ...
        public SwitchForDashboard(SwitchCommandCommand command = default(SwitchCommandCommand), SwitchStateForDashboardState state = default(SwitchStateForDashboardState))
        {
            ...
            this.Command = command ?? throw new ArgumentNullException("command is a required property for SwitchForDashboard and cannot be null");
            this.State = state;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwitchForDashboard {\n");
        ...
        {
            return this.Equals(input as SwitchForDashboard);
        }

        /// <summary>
        /// Returns true if SwitchForDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchForDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchForDashboard input)
        {
            if (input == null)
                return false;
