...
namespace SmartThingsNet.Model
{
    ...
    /// SliderForArgument
    /// </summary>
    [DataContract(Name = "sliderForArgument")]
    public partial class SliderForArgument : IEquatable<SliderForArgument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForArgument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SliderForArgument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForArgument" /> class.
        /// </summary>
        ...
        public SliderForArgument(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string name = default(string), string argumentType = default(string))
        {
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for SliderForArgument and cannot be null");
            }
            this.Range = range;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for SliderForArgument and cannot be null");
            }
            this.Name = name;
            this.Step = step;
            this.Unit = unit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderForArgument {\n");
        ...
        {
            return this.Equals(input as SliderForArgument);
        }

        /// <summary>
        /// Returns true if SliderForArgument instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderForArgument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderForArgument input)
        {
            if (input == null)
            {
                return false;
