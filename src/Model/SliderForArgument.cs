...
namespace SmartThingsNet.Model
{
    ...
    public partial class SliderForArgument :  IEquatable<SliderForArgument>, IValidatableObject
    {
        ...
        public SliderForArgument(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string name = default(string))
        {
            // to ensure "range" is required (not null)
            this.Range = range ?? throw new ArgumentNullException("range is a required property for SliderForArgument and cannot be null");
            this.Step = step;
            this.Unit = unit;
            this.Name = name;
        }
