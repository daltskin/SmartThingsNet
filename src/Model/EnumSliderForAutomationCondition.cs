...
{
    /// <summary>
    /// This display type creates slider composed with enumeration that the user can set an automation to compare between enumeration and device&#39;s status. An alternatives array should be &#x60;ascending&#x60; order.
    /// </summary>
    [DataContract(Name = "enumSliderForAutomationCondition")]
    public partial class EnumSliderForAutomationCondition : IEquatable<EnumSliderForAutomationCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnumSliderForAutomationCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnumSliderForAutomationCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnumSliderForAutomationCondition" /> class.
        /// </summary>
        ...
        /// <param name="supportedOperators">supportedOperators.</param>
        public EnumSliderForAutomationCondition(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string value = default(string), List<EnumSliderForAutomationConditionSupportedOperators> supportedOperators = default(List<EnumSliderForAutomationConditionSupportedOperators>))
        {
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for EnumSliderForAutomationCondition and cannot be null");
            }
            this.Alternatives = alternatives;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for EnumSliderForAutomationCondition and cannot be null");
            }
            this.Value = value;
        ...
        /// </summary>
        [DataMember(Name = "supportedOperators", EmitDefaultValue = false)]
        public List<EnumSliderForAutomationConditionSupportedOperators> SupportedOperators { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnumSliderForAutomationCondition {\n");
        ...
        {
            return this.Equals(input as EnumSliderForAutomationCondition);
        }

        /// <summary>
        /// Returns true if EnumSliderForAutomationCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of EnumSliderForAutomationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnumSliderForAutomationCondition input)
        {
            if (input == null)
            {
                return false;
