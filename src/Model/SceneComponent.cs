...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneComponent")]
    public partial class SceneComponent : IEquatable<SceneComponent>, IValidatableObject
    {
        /// <summary>
        ...
        public SceneComponent(string componentId = default(string), List<SceneCapability> capabilities = default(List<SceneCapability>))
        {
        ...
        public List<SceneCapability> Capabilities { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneComponent {\n");
        ...
        {
            return this.Equals(input as SceneComponent);
        }

        /// <summary>
        /// Returns true if SceneComponent instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneComponent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneComponent input)
        {
            if (input == null)
            {
                return false;
