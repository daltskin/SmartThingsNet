...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin3Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin3Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin3Hour : IEquatable<ServiceCapabilityDataForecastSnowMin3Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin3Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 3 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin3Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 3 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 3 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin3Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin3Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin3Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin3Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin3Hour input)
        {
            if (input == null)
            {
                return false;
