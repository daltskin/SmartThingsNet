...
{
    /// <summary>
    /// The status for an individual organization member invitation.
    /// </summary>
    [DataContract(Name = "InviteResponseItem")]
    public partial class InviteResponseItem : IEquatable<InviteResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InviteResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteResponseItem" /> class.
        /// </summary>
        /// <param name="email">The E-mail address of the invited party. (required).</param>
        /// <param name="role">role (required).</param>
        /// <param name="status">Status code for this invite entry. (required).</param>
        /// <param name="info">Information on the individual invitation. (required).</param>
        /// <param name="inviteId">Invite ID for sucessfully created invitations..</param>
        /// <param name="acceptUrl">The URL the invitee can follow to accept a successful invitation (they must be logged in)..</param>
        public InviteResponseItem(string email = default(string), Role role = default(Role), int status = default(int), string info = default(string), string inviteId = default(string), string acceptUrl = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null) {
                throw new ArgumentNullException("email is a required property for InviteResponseItem and cannot be null");
            }
            this.Email = email;
            // to ensure "role" is required (not null)
            if (role == null) {
                throw new ArgumentNullException("role is a required property for InviteResponseItem and cannot be null");
            }
            this.Role = role;
            this.Status = status;
            // to ensure "info" is required (not null)
            if (info == null) {
                throw new ArgumentNullException("info is a required property for InviteResponseItem and cannot be null");
            }
            this.Info = info;
        ...
        /// <summary>
        /// The E-mail address of the invited party.
        /// </summary>
        /// <value>The E-mail address of the invited party.</value>
        ...
        /// <summary>
        /// Status code for this invite entry.
        /// </summary>
        /// <value>Status code for this invite entry.</value>
        [DataMember(Name = "status", IsRequired = true, EmitDefaultValue = false)]
        public int Status { get; set; }

        /// <summary>
        /// Information on the individual invitation.
        /// </summary>
        /// <value>Information on the individual invitation.</value>
        [DataMember(Name = "info", IsRequired = true, EmitDefaultValue = false)]
        public string Info { get; set; }

        /// <summary>
        /// Invite ID for sucessfully created invitations.
        /// </summary>
        /// <value>Invite ID for sucessfully created invitations.</value>
        [DataMember(Name = "inviteId", EmitDefaultValue = false)]
        public string InviteId { get; set; }

        /// <summary>
        /// The URL the invitee can follow to accept a successful invitation (they must be logged in).
        /// </summary>
        /// <value>The URL the invitee can follow to accept a successful invitation (they must be logged in).</value>
        [DataMember(Name = "acceptUrl", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InviteResponseItem {\n");
        ...
        {
            return this.Equals(input as InviteResponseItem);
        }

        /// <summary>
        /// Returns true if InviteResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of InviteResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InviteResponseItem input)
        {
            if (input == null)
            {
                return false;
