...
{
    /// <summary>
    /// ZWaveGenericFingerprint
    /// </summary>
    [DataContract(Name = "ZWaveGenericFingerprint")]
    public partial class ZWaveGenericFingerprint : IEquatable<ZWaveGenericFingerprint>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>8-bit indicator for the generic type of the device</value>
        ...
        /// </summary>
        /// <value>List of reported command classes</value>
        [DataMember(Name = "specificType", EmitDefaultValue = false)]
        public List<int> SpecificType { get; set; }

        /// <summary>
        /// Gets or Sets CommandClasses
        /// </summary>
        [DataMember(Name = "commandClasses", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZWaveGenericFingerprint {\n");
            sb.Append("  GenericType: ").Append(GenericType).Append("\n");
            sb.Append("  SpecificType: ").Append(SpecificType).Append("\n");
            sb.Append("  CommandClasses: ").Append(CommandClasses).Append("\n");
        ...
        {
            return this.Equals(input as ZWaveGenericFingerprint);
        }

        /// <summary>
        /// Returns true if ZWaveGenericFingerprint instances are equal
        /// </summary>
        /// <param name="input">Instance of ZWaveGenericFingerprint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZWaveGenericFingerprint input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.GenericType == input.GenericType ||
                    this.GenericType.Equals(input.GenericType)
                ) && 
                (
                    this.SpecificType == input.SpecificType ||
                    this.SpecificType != null &&
                    input.SpecificType != null &&
                    this.SpecificType.SequenceEqual(input.SpecificType)
                ) && 
                (
                    this.CommandClasses == input.CommandClasses ||
                    (this.CommandClasses != null &&
                    this.CommandClasses.Equals(input.CommandClasses))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.GenericType.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.CommandClasses.GetHashCode();
                }
        ...
        {
            // GenericType (int) maximum
            if (this.GenericType > (int)255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GenericType, must be a value less than or equal to 255.", new [] { "GenericType" });
            }

            // GenericType (int) minimum
            if (this.GenericType < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GenericType, must be a value greater than or equal to 0.", new [] { "GenericType" });
            }
