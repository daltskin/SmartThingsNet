...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceProfile :  IEquatable<DeviceProfile>, IValidatableObject
    {
        ...
        public DeviceProfile(string id = default(string), string name = default(string), Owner owner = default(Owner), List<DeviceComponent> components = default(List<DeviceComponent>), Dictionary<string, string> metadata = default(Dictionary<string, string>), DeviceProfileStatus? status = default(DeviceProfileStatus?))
        {
            this.Id = id;
            this.Name = name;
            this.Owner = owner;
