...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin7Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin7Hour : IEquatable<ServiceCapabilityDataForecastSnowMin7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 7 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin7Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 7 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 7 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin7Hour input)
        {
            if (input == null)
            {
                return false;
