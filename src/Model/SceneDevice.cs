...
namespace SmartThingsNet.Model
{
    ...
    /// SceneDevice
    /// </summary>
    [DataContract(Name = "SceneDevice")]
    public partial class SceneDevice : IEquatable<SceneDevice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneDevice" /> class.
        /// </summary>
        /// <param name="deviceId">the id of the device.</param>
        /// <param name="deviceLabel">the label of the device.</param>
        /// <param name="deviceName">the name of the device.</param>
        /// <param name="deviceTypeId">The identifier for the device&#39;s DeviceType..</param>
        /// <param name="components">components.</param>
        /// <param name="locationId">Location of the device.</param>
        public SceneDevice(string deviceId = default(string), string deviceLabel = default(string), string deviceName = default(string), string deviceTypeId = default(string), List<SceneComponent> components = default(List<SceneComponent>), string locationId = default(string))
        {
        ...
        /// </summary>
        /// <value>Location of the device</value>
        ...
        {
            return this.Equals(input as SceneDevice);
        }

        /// <summary>
        /// Returns true if SceneDevice instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneDevice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneDevice input)
        {
            if (input == null)
            {
                return false;
