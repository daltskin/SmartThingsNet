...
namespace SmartThingsNet.Model
{
    ...
    public partial class PushButton :  IEquatable<PushButton>, IValidatableObject
    {
        ...
        public PushButton(string command = default(string), string argument = default(string))
        {
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for PushButton and cannot be null");
