...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin6Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin6Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin6Hour : IEquatable<ServiceCapabilityDataForecastSnowMin6Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin6Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 6 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin6Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 6 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 6 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin6Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin6Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin6Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin6Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin6Hour input)
        {
            if (input == null)
            {
                return false;
