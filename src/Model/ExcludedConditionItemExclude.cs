...
{
    /// <summary>
    /// ExcludedConditionItemExclude
    /// </summary>
    [DataContract(Name = "excludedConditionItem_exclude")]
    public partial class ExcludedConditionItemExclude : IEquatable<ExcludedConditionItemExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItemExclude" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedConditionItemExclude() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItemExclude" /> class.
        /// </summary>
        ...
        public ExcludedConditionItemExclude(string component = default(string), string capability = default(string), int version = default(int), List<Object> attributes = default(List<Object>))
        {
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for ExcludedConditionItemExclude and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedConditionItemExclude {\n");
        ...
        {
            return this.Equals(input as ExcludedConditionItemExclude);
        }

        /// <summary>
        /// Returns true if ExcludedConditionItemExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedConditionItemExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedConditionItemExclude input)
        {
            if (input == null)
            {
                return false;
