...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    /// <value>The type of the event that is being subscribed to.</value>
    ...
    public enum SubscriptionSource
    {
        ...
        /// <summary>
        /// Enum DEVICELIFECYCLE for value: DEVICE_LIFECYCLE
        /// </summary>
        [EnumMember(Value = "DEVICE_LIFECYCLE")]
        DEVICELIFECYCLE = 4,

        /// <summary>
        /// Enum DEVICEHEALTH for value: DEVICE_HEALTH
        /// </summary>
        [EnumMember(Value = "DEVICE_HEALTH")]
        DEVICEHEALTH = 5,

        /// <summary>
        /// Enum SECURITYARMSTATE for value: SECURITY_ARM_STATE
        /// </summary>
        [EnumMember(Value = "SECURITY_ARM_STATE")]
        SECURITYARMSTATE = 6,

        /// <summary>
        /// Enum HUBHEALTH for value: HUB_HEALTH
        /// </summary>
        [EnumMember(Value = "HUB_HEALTH")]
        HUBHEALTH = 7,

        /// <summary>
        /// Enum SCENELIFECYCLE for value: SCENE_LIFECYCLE
        /// </summary>
        [EnumMember(Value = "SCENE_LIFECYCLE")]
        SCENELIFECYCLE = 8
