...
namespace SmartThingsNet.Model
{
    ...
    /// ModeEvent
    /// </summary>
    [DataContract(Name = "ModeEvent")]
    public partial class ModeEvent : IEquatable<ModeEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModeEvent" /> class.
        /// </summary>
        /// <param name="eventId">The id of the event..</param>
        /// <param name="locationId">The id of the location in which the event was triggered..</param>
        /// <param name="modeId">The ID of the mode associated with a MODE_EVENT..</param>
        public ModeEvent(string eventId = default(string), string locationId = default(string), string modeId = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the mode associated with a MODE_EVENT.</value>
        ...
        {
            return this.Equals(input as ModeEvent);
        }

        /// <summary>
        /// Returns true if ModeEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ModeEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModeEvent input)
        {
            if (input == null)
            {
                return false;
