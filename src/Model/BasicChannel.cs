...
namespace SmartThingsNet.Model
{
    ...
    /// BasicChannel
    /// </summary>
    [DataContract(Name = "BasicChannel")]
    public partial class BasicChannel : IEquatable<BasicChannel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicChannel" /> class.
        /// </summary>
        ...
        public BasicChannel(string name = default(string), string description = default(string), ChannelType? type = default(ChannelType?), string termsOfServiceUrl = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as BasicChannel);
        }

        /// <summary>
        /// Returns true if BasicChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicChannel input)
        {
            if (input == null)
            {
                return false;
