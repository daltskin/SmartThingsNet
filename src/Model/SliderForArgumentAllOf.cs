...
{
    /// <summary>
    /// SliderForArgumentAllOf
    /// </summary>
    [DataContract(Name = "sliderForArgument_allOf")]
    public partial class SliderForArgumentAllOf : IEquatable<SliderForArgumentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForArgumentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SliderForArgumentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForArgumentAllOf" /> class.
        /// </summary>
        ...
        public SliderForArgumentAllOf(string name = default(string), string argumentType = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for SliderForArgumentAllOf and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderForArgumentAllOf {\n");
        ...
        {
            return this.Equals(input as SliderForArgumentAllOf);
        }

        /// <summary>
        /// Returns true if SliderForArgumentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderForArgumentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderForArgumentAllOf input)
        {
            if (input == null)
            {
                return false;
