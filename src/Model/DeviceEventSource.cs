...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    /// <value>Entity that created the event.</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum DeviceEventSource
    {
        /// <summary>
        /// Enum OCFDEVICE for value: OCFDEVICE
        /// </summary>
        [EnumMember(Value = "OCFDEVICE")]
        OCFDEVICE = 1,

        /// <summary>
        /// Enum HUBDEVICE for value: HUBDEVICE
        /// </summary>
        [EnumMember(Value = "HUBDEVICE")]
        HUBDEVICE = 2,
