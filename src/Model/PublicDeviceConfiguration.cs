...
{
    /// <summary>
    /// PublicDeviceConfiguration
    /// </summary>
    [DataContract(Name = "PublicDeviceConfiguration")]
    public partial class PublicDeviceConfiguration : IEquatable<PublicDeviceConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDeviceConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicDeviceConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDeviceConfiguration" /> class.
        /// </summary>
        ...
        /// <param name="version">The version of the device configuration. (default to &quot;0.0.1&quot;).</param>
        ...
        /// <param name="manufacturerName">Secondary namespacing key for grouping presentations (formerly &#x60;mnmn&#x60;).</param>
        public PublicDeviceConfiguration(string mnmn = default(string), string vid = default(string), string version = "0.0.1", TypeEnum? type = TypeEnum.Profile, List<Object> dpInfo = default(List<Object>), string iconUrl = default(string), List<Object> icons = default(List<Object>), CreateProfileDeviceConfigRequestDashboard dashboard = default(CreateProfileDeviceConfigRequestDashboard), List<DeviceConfigEntry> detailView = default(List<DeviceConfigEntry>), CreateProfileDeviceConfigRequestAutomation automation = default(CreateProfileDeviceConfigRequestAutomation), string presentationId = default(string), string manufacturerName = default(string))
        {
            // to ensure "mnmn" is required (not null)
            if (mnmn == null) {
                throw new ArgumentNullException("mnmn is a required property for PublicDeviceConfiguration and cannot be null");
            }
            this.Mnmn = mnmn;
            // to ensure "vid" is required (not null)
            if (vid == null) {
                throw new ArgumentNullException("vid is a required property for PublicDeviceConfiguration and cannot be null");
            }
            this.Vid = vid;
        ...
        [DataMember(Name = "mnmn", IsRequired = true, EmitDefaultValue = false)]
        public string Mnmn { get; set; }

        /// <summary>
        /// A unique identifier for the presentation of a device. This can be a model number on legacy device integrations, but also may be a system generated UUID based on a device&#39;s structure and display configuration.
        /// </summary>
        /// <value>A unique identifier for the presentation of a device. This can be a model number on legacy device integrations, but also may be a system generated UUID based on a device&#39;s structure and display configuration.</value>
        [DataMember(Name = "vid", IsRequired = true, EmitDefaultValue = false)]
        public string Vid { get; set; }

        /// <summary>
        /// The version of the device configuration.
        /// </summary>
        /// <value>The version of the device configuration.</value>
        [DataMember(Name = "version", EmitDefaultValue = false)]
        public string _Version { get; set; }

        /// <summary>
        /// Information used for obtaining details page plugins on different platforms. Array of Details page link objects.
        /// </summary>
        /// <value>Information used for obtaining details page plugins on different platforms. Array of Details page link objects.</value>
        [DataMember(Name = "dpInfo", EmitDefaultValue = false)]
        public List<Object> DpInfo { get; set; }

        /// <summary>
        /// DEPRECATED: Please use iconUrl under icons property.
        /// </summary>
        /// <value>DEPRECATED: Please use iconUrl under icons property.</value>
        ...
        public CreateProfileDeviceConfigRequestDashboard Dashboard { get; set; }

        /// <summary>
        /// Gets or Sets DetailView
        /// </summary>
        [DataMember(Name = "detailView", EmitDefaultValue = false)]
        public List<DeviceConfigEntry> DetailView { get; set; }

        /// <summary>
        /// Gets or Sets Automation
        /// </summary>
        [DataMember(Name = "automation", EmitDefaultValue = false)]
        public CreateProfileDeviceConfigRequestAutomation Automation { get; set; }

        /// <summary>
        /// System generated identifier that corresponds to a device presentation (formerly &#x60;vid&#x60;)
        /// </summary>
        /// <value>System generated identifier that corresponds to a device presentation (formerly &#x60;vid&#x60;)</value>
        ...
        /// </summary>
        /// <value>Secondary namespacing key for grouping presentations (formerly &#x60;mnmn&#x60;)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublicDeviceConfiguration {\n");
            sb.Append("  Mnmn: ").Append(Mnmn).Append("\n");
            sb.Append("  Vid: ").Append(Vid).Append("\n");
            sb.Append("  _Version: ").Append(_Version).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  DpInfo: ").Append(DpInfo).Append("\n");
            sb.Append("  IconUrl: ").Append(IconUrl).Append("\n");
            sb.Append("  Icons: ").Append(Icons).Append("\n");
            sb.Append("  Dashboard: ").Append(Dashboard).Append("\n");
            sb.Append("  DetailView: ").Append(DetailView).Append("\n");
        ...
        {
            return this.Equals(input as PublicDeviceConfiguration);
        }

        /// <summary>
        /// Returns true if PublicDeviceConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicDeviceConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicDeviceConfiguration input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Mnmn == input.Mnmn ||
                    (this.Mnmn != null &&
                    this.Mnmn.Equals(input.Mnmn))
                ) && 
                (
                    this.Vid == input.Vid ||
                    (this.Vid != null &&
                ...
                (
                    this.DpInfo == input.DpInfo ||
                    this.DpInfo != null &&
                    input.DpInfo != null &&
                    this.DpInfo.SequenceEqual(input.DpInfo)
                ) && 
                (
                ...
                (
                    this.DetailView == input.DetailView ||
                    this.DetailView != null &&
                    input.DetailView != null &&
                    this.DetailView.SequenceEqual(input.DetailView)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Mnmn != null)
                {
                    hashCode = (hashCode * 59) + this.Mnmn.GetHashCode();
                }
                if (this.Vid != null)
                {
                ...
                if (this.DpInfo != null)
                {
                    hashCode = (hashCode * 59) + this.DpInfo.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.DetailView.GetHashCode();
                }
