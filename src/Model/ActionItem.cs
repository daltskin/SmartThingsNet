...
namespace SmartThingsNet.Model
{
    ...
    /// ActionItem
    /// </summary>
    [DataContract(Name = "actionItem")]
    public partial class ActionItem : IEquatable<ActionItem>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ActionItem);
        }

        /// <summary>
        /// Returns true if ActionItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionItem input)
        {
            if (input == null)
            {
                return false;
