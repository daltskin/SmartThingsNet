...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip11Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip11Hour")]
    public partial class ServiceCapabilityDataForecastPrecip11Hour : IEquatable<ServiceCapabilityDataForecastPrecip11Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip11Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 11 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip11Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 11 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 11 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip11Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip11Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip11Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip11Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip11Hour input)
        {
            if (input == null)
            {
                return false;
