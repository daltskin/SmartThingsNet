...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrUpdateLambdaSmartAppRequest")]
    public partial class CreateOrUpdateLambdaSmartAppRequest : IEquatable<CreateOrUpdateLambdaSmartAppRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateLambdaSmartAppRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOrUpdateLambdaSmartAppRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateLambdaSmartAppRequest" /> class.
        /// </summary>
        /// <param name="functions">A list of AWS arns referencing a Lambda function. (required).</param>
        public CreateOrUpdateLambdaSmartAppRequest(List<string> functions = default(List<string>))
        {
            // to ensure "functions" is required (not null)
            if (functions == null) {
                throw new ArgumentNullException("functions is a required property for CreateOrUpdateLambdaSmartAppRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A list of AWS arns referencing a Lambda function.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateOrUpdateLambdaSmartAppRequest {\n");
        ...
        {
            return this.Equals(input as CreateOrUpdateLambdaSmartAppRequest);
        }

        /// <summary>
        /// Returns true if CreateOrUpdateLambdaSmartAppRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrUpdateLambdaSmartAppRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrUpdateLambdaSmartAppRequest input)
        {
            if (input == null)
            {
                return false;
