...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax12Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax12Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax12Hour : IEquatable<ServiceCapabilityDataForecastSnowMax12Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax12Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 12 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax12Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 12 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 12 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax12Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax12Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax12Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax12Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax12Hour input)
        {
            if (input == null)
            {
                return false;
