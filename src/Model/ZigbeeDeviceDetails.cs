...
{
    /// <summary>
    /// Device Profile information for Zigbee devices. This field will be empty if device type is not ZIGBEE.
    /// </summary>
    [DataContract(Name = "ZigbeeDeviceDetails")]
    public partial class ZigbeeDeviceDetails : IEquatable<ZigbeeDeviceDetails>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZigbeeDeviceDetails" /> class.
        /// </summary>
        /// <param name="eui">The EUID of the Zigbee device.</param>
        ...
        public ZigbeeDeviceDetails(string eui = default(string), string networkId = default(string), string driverId = default(string), bool executingLocally = default(bool), string hubId = default(string), ProvisioningState? provisioningState = default(ProvisioningState?))
        {
            this.Eui = eui;
        ...
        /// <summary>
        /// The EUID of the Zigbee device
        /// </summary>
        /// <value>The EUID of the Zigbee device</value>
        [DataMember(Name = "eui", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZigbeeDeviceDetails {\n");
        ...
        {
            return this.Equals(input as ZigbeeDeviceDetails);
        }

        /// <summary>
        /// Returns true if ZigbeeDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ZigbeeDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZigbeeDeviceDetails input)
        {
            if (input == null)
            {
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Eui != null)
                {
                    hashCode = (hashCode * 59) + this.Eui.GetHashCode();
                }
