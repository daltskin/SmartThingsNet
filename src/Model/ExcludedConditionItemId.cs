...
{
    /// <summary>
    /// ExcludedConditionItemId
    /// </summary>
    [DataContract(Name = "excludedConditionItemId")]
    public partial class ExcludedConditionItemId : IEquatable<ExcludedConditionItemId>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItemId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedConditionItemId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItemId" /> class.
        /// </summary>
        /// <param name="id">The index of the array in the given capability to which this exclusion object will be inserted.</param>
        /// <param name="value">To express that a specific value is selected.</param>
        /// <param name="exclude">exclude (required).</param>
        public ExcludedConditionItemId(int id = default(int), Object value = default(Object), List<ExcludedConditionItemExclude> exclude = default(List<ExcludedConditionItemExclude>))
        {
            // to ensure "exclude" is required (not null)
            if (exclude == null) {
                throw new ArgumentNullException("exclude is a required property for ExcludedConditionItemId and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The index of the array in the given capability to which this exclusion object will be inserted</value>
        ...
        /// </summary>
        /// <value>To express that a specific value is selected</value>
        ...
        public List<ExcludedConditionItemExclude> Exclude { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedConditionItemId {\n");
        ...
        {
            return this.Equals(input as ExcludedConditionItemId);
        }

        /// <summary>
        /// Returns true if ExcludedConditionItemId instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedConditionItemId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedConditionItemId input)
        {
            if (input == null)
            {
                return false;
