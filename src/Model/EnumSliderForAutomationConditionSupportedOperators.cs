...
{
    /// <summary>
    /// EnumSliderForAutomationConditionSupportedOperators
    /// </summary>
    [DataContract(Name = "enumSliderForAutomationCondition_supportedOperators")]
    public partial class EnumSliderForAutomationConditionSupportedOperators : IEquatable<EnumSliderForAutomationConditionSupportedOperators>, IValidatableObject
    {
        /// <summary>
        /// The operator to be supported by this display type.
        /// </summary>
        /// <value>The operator to be supported by this display type.</value>
        ...
        protected EnumSliderForAutomationConditionSupportedOperators() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnumSliderForAutomationConditionSupportedOperators" /> class.
        /// </summary>
        ...
        /// <summary>
        /// The alternative string of given operator.
        /// </summary>
        /// <value>The alternative string of given operator.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnumSliderForAutomationConditionSupportedOperators {\n");
        ...
        {
            return this.Equals(input as EnumSliderForAutomationConditionSupportedOperators);
        }

        /// <summary>
        /// Returns true if EnumSliderForAutomationConditionSupportedOperators instances are equal
        /// </summary>
        /// <param name="input">Instance of EnumSliderForAutomationConditionSupportedOperators to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnumSliderForAutomationConditionSupportedOperators input)
        {
            if (input == null)
            {
                return false;
