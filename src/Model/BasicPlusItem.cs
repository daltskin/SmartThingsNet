...
{
    /// <summary>
    /// To specify the function of the device using the extended area of the dashboard card.
    /// </summary>
    [DataContract(Name = "basicPlusItem")]
    public partial class BasicPlusItem : IEquatable<BasicPlusItem>, IValidatableObject
    {
        /// <summary>
        /// To specify the type of UI component to display this basicPlus item. The corresponding field must also be included. For example, if you specify \&quot;camera\&quot; here, you must also include the \&quot;camera\&quot; key and its object definition for this basicPlus item.
        /// </summary>
        /// <value>To specify the type of UI component to display this basicPlus item. The corresponding field must also be included. For example, if you specify \&quot;camera\&quot; here, you must also include the \&quot;camera\&quot; key and its object definition for this basicPlus item.</value>
        ...
        {
            return this.Equals(input as BasicPlusItem);
        }

        /// <summary>
        /// Returns true if BasicPlusItem instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicPlusItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicPlusItem input)
        {
            if (input == null)
            {
                return false;
