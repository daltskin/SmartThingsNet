...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCapabilityRequest")]
    public partial class CreateCapabilityRequest : IEquatable<CreateCapabilityRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCapabilityRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCapabilityRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCapabilityRequest" /> class.
        /// </summary>
        ...
        /// <param name="attributes">A mapping of attribute names to their definitions. All attribute names are lower camelcase. Required if no commands are specified..</param>
        /// <param name="commands">A mapping of command names to their definitions. All command names are lower camelcase. Required if no attributes are specified..</param>
        public CreateCapabilityRequest(string name = default(string), bool ephemeral = false, Dictionary<string, CapabilityAttribute> attributes = default(Dictionary<string, CapabilityAttribute>), Dictionary<string, CapabilityCommand> commands = default(Dictionary<string, CapabilityCommand>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CreateCapabilityRequest and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>A mapping of attribute names to their definitions. All attribute names are lower camelcase. Required if no commands are specified.</value>
        ...
        /// </summary>
        /// <value>A mapping of command names to their definitions. All command names are lower camelcase. Required if no attributes are specified.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCapabilityRequest {\n");
        ...
        {
            return this.Equals(input as CreateCapabilityRequest);
        }

        /// <summary>
        /// Returns true if CreateCapabilityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCapabilityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCapabilityRequest input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // Name (string) pattern
            Regex regexName = new Regex(@"^[a-zA-Z0-9][a-zA-Z0-9 ]{1,35}$", RegexOptions.CultureInvariant);
