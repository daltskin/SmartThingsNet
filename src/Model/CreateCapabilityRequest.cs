...
namespace SmartThingsNet.Model
{
    ...
    public partial class CreateCapabilityRequest :  IEquatable<CreateCapabilityRequest>, IValidatableObject
    {
        ...
        public CreateCapabilityRequest(string name = default(string), Dictionary<string, CapabilityAttribute> attributes = default(Dictionary<string, CapabilityAttribute>), Dictionary<string, CapabilityCommand> commands = default(Dictionary<string, CapabilityCommand>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateCapabilityRequest and cannot be null");
