...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax11Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax11Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax11Hour : IEquatable<ServiceCapabilityDataForecastSnowMax11Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax11Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 11 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax11Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 11 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 11 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax11Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax11Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax11Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax11Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax11Hour input)
        {
            if (input == null)
            {
                return false;
