...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    /// <value>Denotes the current state of a configuration instance.  &#39;STAGED&#39; configuration is used during active modification to config.  A configuration is marked &#39;DONE&#39; once it is deemed finished.  At this point it is immutable, meaning it can&#39;t be changed.  A status of &#39;AUTHORIZED&#39; means the apps permissions have been authorized by the consumer.  Installed Apps in &#39;AUTHORIZED&#39; state are fully installed and used by the SmartThings platform.  A status of &#39;REVOKED&#39; means the apps permissions have been revoked. </value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum InstallConfigurationStatus
    {
        /// <summary>
