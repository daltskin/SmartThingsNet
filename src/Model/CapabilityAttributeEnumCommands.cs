...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CapabilityAttribute_enumCommands")]
    public partial class CapabilityAttributeEnumCommands : IEquatable<CapabilityAttributeEnumCommands>, IValidatableObject
    {
        /// <summary>
        ...
        public CapabilityAttributeEnumCommands(string command = default(string), string value = default(string))
        {
            ...
            if (command == null) {
                throw new ArgumentNullException("command is a required property for CapabilityAttributeEnumCommands and cannot be null");
            }
            this.Command = command;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CapabilityAttributeEnumCommands and cannot be null");
            }
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>the command that sets this attribute to the associated value</value>
        ...
        /// </summary>
        /// <value>the value that this command will set the attribute to</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityAttributeEnumCommands {\n");
        ...
        {
            return this.Equals(input as CapabilityAttributeEnumCommands);
        }

        /// <summary>
        /// Returns true if CapabilityAttributeEnumCommands instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityAttributeEnumCommands to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityAttributeEnumCommands input)
        {
            if (input == null)
            {
                return false;
