...
{
    /// <summary>
    /// CapabilityValueForDashboardState
    /// </summary>
    [DataContract(Name = "capabilityValueForDashboardState")]
    public partial class CapabilityValueForDashboardState : IEquatable<CapabilityValueForDashboardState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityValueForDashboardState" /> class.
        /// </summary>
        ...
        public CapabilityValueForDashboardState(string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            this.Label = label;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityValueForDashboardState {\n");
        ...
        {
            return this.Equals(input as CapabilityValueForDashboardState);
        }

        /// <summary>
        /// Returns true if CapabilityValueForDashboardState instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityValueForDashboardState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityValueForDashboardState input)
        {
            if (input == null)
            {
                return false;
