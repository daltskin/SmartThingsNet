...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CapabilitySubscriptionDetail")]
    public partial class CapabilitySubscriptionDetail : IEquatable<CapabilitySubscriptionDetail>, IValidatableObject
    {
        ...
        public CapabilitySubscriptionDetail(string locationId = default(string), string capability = default(string), string attribute = "*", Object value = default(Object), bool stateChangeOnly = true, string subscriptionName = default(string), List<string> modes = default(List<string>))
        {
            ...
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for CapabilitySubscriptionDetail and cannot be null");
            }
            this.LocationId = locationId;
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for CapabilitySubscriptionDetail and cannot be null");
            }
