...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CapabilitySubscriptionDetail :  IEquatable<CapabilitySubscriptionDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilitySubscriptionDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CapabilitySubscriptionDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilitySubscriptionDetail" /> class.
        /// </summary>
        /// <param name="locationId">The id of the location that both the app and source device are in. (required).</param>
        /// <param name="capability">Name of the capability that is subscribed to. (required).</param>
        ...
        /// <param name="stateChangeOnly">Only execute the subscription if the subscribed event is a state change from previous events. (default to true).</param>
        ...
        /// <param name="modes">List of modes that the subscription will execute for. If not provided then all modes will be supported..</param>
        public CapabilitySubscriptionDetail(string locationId = default(string), string capability = default(string), string attribute = "*", Object value = default(Object), bool stateChangeOnly = true, string subscriptionName = default(string), List<string> modes = default(List<string>))
        {
            // to ensure "locationId" is required (not null)
            this.LocationId = locationId ?? throw new ArgumentNullException("locationId is a required property for CapabilitySubscriptionDetail and cannot be null");
            // to ensure "capability" is required (not null)
            this.Capability = capability ?? throw new ArgumentNullException("capability is a required property for CapabilitySubscriptionDetail and cannot be null");
        ...
        /// </summary>
        /// <value>The id of the location that both the app and source device are in.</value>
        ...
        /// </summary>
        /// <value>Name of the capability that is subscribed to.</value>
        ...
        /// </summary>
        /// <value>List of modes that the subscription will execute for. If not provided then all modes will be supported.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilitySubscriptionDetail {\n");
        ...
        {
            return this.Equals(input as CapabilitySubscriptionDetail);
        }

        /// <summary>
        /// Returns true if CapabilitySubscriptionDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilitySubscriptionDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilitySubscriptionDetail input)
        {
            if (input == null)
                return false;
