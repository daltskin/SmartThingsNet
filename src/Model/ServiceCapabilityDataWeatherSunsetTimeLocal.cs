...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherSunsetTimeLocal
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_sunsetTimeLocal")]
    public partial class ServiceCapabilityDataWeatherSunsetTimeLocal : IEquatable<ServiceCapabilityDataWeatherSunsetTimeLocal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherSunsetTimeLocal" /> class.
        /// </summary>
        /// <param name="value">This field contains the local time of sunset. It reflects any local daylight savings conventions.  ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ .</param>
        public ServiceCapabilityDataWeatherSunsetTimeLocal(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// This field contains the local time of sunset. It reflects any local daylight savings conventions.  ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ 
        /// </summary>
        /// <value>This field contains the local time of sunset. It reflects any local daylight savings conventions.  ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherSunsetTimeLocal {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherSunsetTimeLocal);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherSunsetTimeLocal instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherSunsetTimeLocal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherSunsetTimeLocal input)
        {
            if (input == null)
            {
                return false;
