...
namespace SmartThingsNet.Model
{
    ...
    public partial class Slider : IEquatable<Slider>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Slider" /> class.
        /// </summary>
        /// <param name="range">The inclusive range of a numeric value or bounds of a string depending on the data type it is applied to. (required).</param>
        /// <param name="step">step.</param>
        /// <param name="unit">unit.</param>
        /// <param name="command">The command which will send the value of the slider as an argument.</param>
        ...
        public Slider(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string command = default(string), string argumentType = default(string), string value = default(string), string valueType = default(string))
        {
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for Slider and cannot be null");
            }
            this.Range = range;
            this.Step = step;
            this.Unit = unit;
        ...
        /// </summary>
        /// <value>The command which will send the value of the slider as an argument</value>
        ...
        {
            return this.Equals(input as Slider);
        }

        /// <summary>
        /// Returns true if Slider instances are equal
        /// </summary>
        /// <param name="input">Instance of Slider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Slider input)
        {
            if (input == null)
            {
                return false;
