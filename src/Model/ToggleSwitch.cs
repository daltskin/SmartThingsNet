...
namespace SmartThingsNet.Model
{
    ...
    /// ToggleSwitch
    /// </summary>
    [DataContract(Name = "toggleSwitch")]
    public partial class ToggleSwitch : IEquatable<ToggleSwitch>, IValidatableObject
    {
        /// <summary>
        ...
        public ToggleSwitch(SwitchCommandCommand command = default(SwitchCommandCommand), SwitchStateState state = default(SwitchStateState))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for ToggleSwitch and cannot be null");
            }
        ...
        public SwitchStateState State { get; set; }
        ...
        {
            return this.Equals(input as ToggleSwitch);
        }

        /// <summary>
        /// Returns true if ToggleSwitch instances are equal
        /// </summary>
        /// <param name="input">Instance of ToggleSwitch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToggleSwitch input)
        {
            if (input == null)
            {
                return false;
