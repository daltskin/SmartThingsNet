...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow3Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow3Hour")]
    public partial class ServiceCapabilityDataForecastSnow3Hour : IEquatable<ServiceCapabilityDataForecastSnow3Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow3Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 3 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow3Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 3 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 3 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow3Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow3Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow3Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow3Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow3Hour input)
        {
            if (input == null)
            {
                return false;
