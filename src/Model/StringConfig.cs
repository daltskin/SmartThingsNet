...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringConfig")]
    public partial class StringConfig : IEquatable<StringConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringConfig" /> class.
        /// </summary>
        /// <param name="value">A config value.</param>
        public StringConfig(string value = default(string))
        {
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as StringConfig);
        }

        /// <summary>
        /// Returns true if StringConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of StringConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringConfig input)
        {
            if (input == null)
            {
                return false;
