...
namespace SmartThingsNet.Model
{
    ...
    public partial class App : IEquatable<App>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>A user defined unique identifier for an app.  It is alpha-numeric, may contain dashes, underscores, periods, and be less then 250 characters long.  It must be unique within your account. </value>
        ...
        [DataMember(Name = "singleInstance", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>System generated metadata that impacts eligibility requirements around installing an App.</value>
        [DataMember(Name = "installMetadata", EmitDefaultValue = false)]
        public Dictionary<string, string> InstallMetadata { get; set; }
        ...
        public LambdaSmartApp LambdaSmartApp { get; set; }

        /// <summary>
        /// Gets or Sets WebhookSmartApp
        /// </summary>
        [DataMember(Name = "webhookSmartApp", EmitDefaultValue = false)]
        public WebhookSmartApp WebhookSmartApp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InstallMetadata: ").Append(InstallMetadata).Append("\n");
        ...
        public bool Equals(App input)
        {
            ...
            return 
                ...
                (
                    this.InstallMetadata == input.InstallMetadata ||
                    this.InstallMetadata != null &&
                    input.InstallMetadata != null &&
                    this.InstallMetadata.SequenceEqual(input.InstallMetadata)
                ) && 
                (
