...
namespace SmartThingsNet.Model
{
    ...
    public partial class Schedule :  IEquatable<Schedule>, IValidatableObject
    {
        ...
        public Schedule(Guid installedAppId = default(Guid), Guid locationId = default(Guid), List<long> scheduledExecutions = default(List<long>), string name = default(string), CronSchedule cron = default(CronSchedule))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Schedule and cannot be null");
        ...
        /// </summary>
        /// <value>The ID of the location the installed app is in.</value>
        ...
        /// </summary>
        /// <value>list of scheduled execution times in millis from jan 1 1970 UTC</value>
        [DataMember(Name="scheduledExecutions", EmitDefaultValue=false)]
        public List<long> ScheduledExecutions { get; set; }

        /// <summary>
        /// The unique per installed app name of the schedule.
        /// </summary>
        /// <value>The unique per installed app name of the schedule.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ScheduledExecutions: ").Append(ScheduledExecutions).Append("\n");
        ...
        public bool Equals(Schedule input)
        {
            ...
            return 
                ...
                (
                    this.ScheduledExecutions == input.ScheduledExecutions ||
                    this.ScheduledExecutions != null &&
                    input.ScheduledExecutions != null &&
                    this.ScheduledExecutions.SequenceEqual(input.ScheduledExecutions)
                ) && 
                (
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.Name != null && this.Name.Length > 36)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Name, length must be less than 36.", new [] { "Name" });
            }
