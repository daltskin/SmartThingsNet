...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SceneDeviceGroupRequest :  IEquatable<SceneDeviceGroupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneDeviceGroupRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SceneDeviceGroupRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneDeviceGroupRequest" /> class.
        /// </summary>
        ...
        public SceneDeviceGroupRequest(string deviceGroupId = default(string), string actionId = default(string), SceneCapability capability = default(SceneCapability))
        {
            ...
            this.DeviceGroupId = deviceGroupId ?? throw new ArgumentNullException("deviceGroupId is a required property for SceneDeviceGroupRequest and cannot be null");
        ...
        /// </summary>
        /// <value>the id of the device group</value>
        ...
        public SceneCapability Capability { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneDeviceGroupRequest {\n");
        ...
        {
            return this.Equals(input as SceneDeviceGroupRequest);
        }

        /// <summary>
        /// Returns true if SceneDeviceGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneDeviceGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneDeviceGroupRequest input)
        {
            if (input == null)
                return false;
