...
namespace SmartThingsNet.Model
{
    ...
    public partial class ListForAutomationAction :  IEquatable<ListForAutomationAction>, IValidatableObject
    {
        ...
        public ListForAutomationAction(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string), string command = default(string))
        {
            // to ensure "alternatives" is required (not null)
            this.Alternatives = alternatives ?? throw new ArgumentNullException("alternatives is a required property for ListForAutomationAction and cannot be null");
