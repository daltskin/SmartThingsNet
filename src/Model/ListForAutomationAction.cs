...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listForAutomationAction")]
    public partial class ListForAutomationAction : IEquatable<ListForAutomationAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForAutomationAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationAction" /> class.
        /// </summary>
        ...
        /// <param name="command">The name of the command that is called when an item is chosen from the list.</param>
        /// <param name="argumentType">The data type of the &#x60;argument&#x60;. It&#39;s automatically filled from the given capability..</param>
        public ListForAutomationAction(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string), string command = default(string), string argumentType = default(string))
        {
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for ListForAutomationAction and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The name of the command that is called when an item is chosen from the list</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForAutomationAction {\n");
        ...
        {
            return this.Equals(input as ListForAutomationAction);
        }

        /// <summary>
        /// Returns true if ListForAutomationAction instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForAutomationAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForAutomationAction input)
        {
            if (input == null)
            {
                return false;
