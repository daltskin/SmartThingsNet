...
namespace SmartThingsNet.Model
{
    ...
    public partial class Dashboard : IEquatable<Dashboard>, IValidatableObject
    {
        ...
        public Dashboard(List<StatesArrayItem> states = default(List<StatesArrayItem>), List<ActionsArrayItem> actions = default(List<ActionsArrayItem>), List<BasicPlusArrayItem> basicPlus = default(List<BasicPlusArrayItem>), GroupVisibleConditions groupVisibleConditions = default(GroupVisibleConditions))
        {
            this.States = states;
        ...
        public List<StatesArrayItem> States { get; set; }

        /// <summary>
        /// Gets or Sets Actions
        /// </summary>
        [DataMember(Name = "actions", EmitDefaultValue = false)]
        public List<ActionsArrayItem> Actions { get; set; }

        /// <summary>
        /// Gets or Sets BasicPlus
        /// </summary>
        [DataMember(Name = "basicPlus", EmitDefaultValue = false)]
        public List<BasicPlusArrayItem> BasicPlus { get; set; }
