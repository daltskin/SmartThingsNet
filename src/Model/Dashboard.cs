...
namespace SmartThingsNet.Model
{
    ...
    public partial class Dashboard : IEquatable<Dashboard>, IValidatableObject
    {
        ...
        public Dashboard(List<StatesArrayItem> states = default(List<StatesArrayItem>), List<ActionsArrayItem> actions = default(List<ActionsArrayItem>), List<BasicPlusItem> basicPlus = default(List<BasicPlusItem>), GroupVisibleConditions groupVisibleConditions = default(GroupVisibleConditions))
        {
            this.States = states;
