...
namespace SmartThingsNet.Model
{
    ...
    public partial class Dashboard :  IEquatable<Dashboard>, IValidatableObject
    {
        ...
        public Dashboard(List<StatesArrayItem> states = default(List<StatesArrayItem>), List<ActionsArrayItem> actions = default(List<ActionsArrayItem>), List<BasicPlusArrayItem> basicPlus = default(List<BasicPlusArrayItem>))
        {
            this.States = states;
