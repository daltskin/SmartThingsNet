...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax3Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax3Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax3Hour : IEquatable<ServiceCapabilityDataForecastSnowMax3Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax3Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 3 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax3Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 3 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 3 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax3Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax3Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax3Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax3Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax3Hour input)
        {
            if (input == null)
            {
                return false;
