...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceGroupCommand
    /// </summary>
    [DataContract(Name = "DeviceGroupCommand")]
    public partial class DeviceGroupCommand : IEquatable<DeviceGroupCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGroupCommand" /> class.
        /// </summary>
        /// <param name="capability">capability.</param>
        /// <param name="command">command.</param>
        /// <param name="arguments">arguments.</param>
        public DeviceGroupCommand(string capability = default(string), string command = default(string), List<Object> arguments = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceGroupCommand {\n");
        ...
        {
            return this.Equals(input as DeviceGroupCommand);
        }

        /// <summary>
        /// Returns true if DeviceGroupCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceGroupCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceGroupCommand input)
        {
            if (input == null)
            {
                return false;
