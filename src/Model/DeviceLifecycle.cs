...
{
    /// <summary>
    /// The device lifecycle. The lifecycle will be one of: * CREATE - Invoked when a device is created. * DELETE - Invoked when a device is deleted. * UPDATE - Invoked when a device is updated. * MOVE_FROM - Invoked when a device is moved from a location. * MOVE_TO - Invoked when a device is moved to a location. * ROOM_MOVE - Invoked when a device is moved into or out of a room within a location 
    /// </summary>
    /// <value>The device lifecycle. The lifecycle will be one of: * CREATE - Invoked when a device is created. * DELETE - Invoked when a device is deleted. * UPDATE - Invoked when a device is updated. * MOVE_FROM - Invoked when a device is moved from a location. * MOVE_TO - Invoked when a device is moved to a location. * ROOM_MOVE - Invoked when a device is moved into or out of a room within a location </value>
    ...
    public enum DeviceLifecycle
    {
        ...
        /// <summary>
        /// Enum MOVEFROM for value: MOVE_FROM
        /// </summary>
        [EnumMember(Value = "MOVE_FROM")]
        MOVEFROM = 4,

        /// <summary>
        /// Enum MOVETO for value: MOVE_TO
        /// </summary>
        [EnumMember(Value = "MOVE_TO")]
        MOVETO = 5,

        /// <summary>
        /// Enum ROOMMOVE for value: ROOM_MOVE
        /// </summary>
        [EnumMember(Value = "ROOM_MOVE")]
        ROOMMOVE = 6
