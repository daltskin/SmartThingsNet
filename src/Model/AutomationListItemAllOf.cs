...
{
    /// <summary>
    /// AutomationListItemAllOf
    /// </summary>
    [DataContract(Name = "automationListItem_allOf")]
    public partial class AutomationListItemAllOf : IEquatable<AutomationListItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationListItemAllOf" /> class.
        /// </summary>
        ...
        public AutomationListItemAllOf(List<ExcludedConditionItem> exclusion = default(List<ExcludedConditionItem>), string component = default(string), VisibleCondition visibleCondition = default(VisibleCondition))
        {
        ...
        public List<ExcludedConditionItem> Exclusion { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationListItemAllOf {\n");
        ...
        {
            return this.Equals(input as AutomationListItemAllOf);
        }

        /// <summary>
        /// Returns true if AutomationListItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationListItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationListItemAllOf input)
        {
            if (input == null)
            {
                return false;
