...
namespace SmartThingsNet.Model
{
    ...
    public partial class AutomationListItemAllOf : IEquatable<AutomationListItemAllOf>, IValidatableObject
    {
        ...
        public AutomationListItemAllOf(List<ExcludedConditionItem> exclusion = default(List<ExcludedConditionItem>), string component = "main", VisibleCondition visibleCondition = default(VisibleCondition))
        {
