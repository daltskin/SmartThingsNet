...
namespace SmartThingsNet.Model
{
    ...
    public partial class CronSchedule : IEquatable<CronSchedule>, IValidatableObject
    {
        ...
        public CronSchedule(string expression = default(string), string timezone = default(string))
        {
            ...
            if (expression == null) {
                throw new ArgumentNullException("expression is a required property for CronSchedule and cannot be null");
            }
            this.Expression = expression;
            // to ensure "timezone" is required (not null)
            if (timezone == null) {
                throw new ArgumentNullException("timezone is a required property for CronSchedule and cannot be null");
            }
