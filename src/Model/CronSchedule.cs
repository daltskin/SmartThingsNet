...
namespace SmartThingsNet.Model
{
    ...
    public partial class CronSchedule :  IEquatable<CronSchedule>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CronSchedule" /> class.
        /// </summary>
        /// <param name="expression">The cron expression for the schedule for CRON schedules. The format matches that specified by the [Quartz scheduler](http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html) but should not include the seconds (1st) field. The exact second will be chosen at random but will remain consistent. The years part must be les than 2 years from now.  (required).</param>
        /// <param name="timezone">The timezone id for CRON schedules. (required).</param>
        public CronSchedule(string expression = default(string), string timezone = default(string))
        {
            // to ensure "expression" is required (not null)
            this.Expression = expression ?? throw new ArgumentNullException("expression is a required property for CronSchedule and cannot be null");
            // to ensure "timezone" is required (not null)
            this.Timezone = timezone ?? throw new ArgumentNullException("timezone is a required property for CronSchedule and cannot be null");
        }
        ...
        /// </summary>
        /// <value>The cron expression for the schedule for CRON schedules. The format matches that specified by the [Quartz scheduler](http://www.quartz-scheduler.org/documentation/quartz-2.x/tutorials/crontrigger.html) but should not include the seconds (1st) field. The exact second will be chosen at random but will remain consistent. The years part must be les than 2 years from now. </value>
        ...
        /// </summary>
        /// <value>The timezone id for CRON schedules.</value>
