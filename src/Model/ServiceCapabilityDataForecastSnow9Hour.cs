...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow9Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow9Hour")]
    public partial class ServiceCapabilityDataForecastSnow9Hour : IEquatable<ServiceCapabilityDataForecastSnow9Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow9Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 9 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow9Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 9 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 9 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow9Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow9Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow9Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow9Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow9Hour input)
        {
            if (input == null)
            {
                return false;
