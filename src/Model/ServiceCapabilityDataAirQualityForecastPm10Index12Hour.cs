...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm10Index12Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm10Index12Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm10Index12Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm10Index12Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm10Index12Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 12 hours index forecast of particulate matter less than 10 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm10Index12Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) 12 hours index forecast of particulate matter less than 10 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 12 hours index forecast of particulate matter less than 10 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm10Index12Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm10Index12Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm10Index12Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm10Index12Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm10Index12Hour input)
        {
            if (input == null)
            {
                return false;
