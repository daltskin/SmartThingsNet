...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "automationForCapability")]
    public partial class AutomationForCapability : IEquatable<AutomationForCapability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationForCapability" /> class.
        /// </summary>
        /// <param name="conditions">To specify the conditions of device state to trigger actions in the automation view of SmartThings app..</param>
        /// <param name="actions">To specify the actions of device control based on the device state in the automation view of SmartThings app..</param>
        public AutomationForCapability(List<AutomationForCapabilityConditions> conditions = default(List<AutomationForCapabilityConditions>), List<AutomationForCapabilityActions> actions = default(List<AutomationForCapabilityActions>))
        {
        ...
        /// </summary>
        /// <value>To specify the conditions of device state to trigger actions in the automation view of SmartThings app.</value>
        [DataMember(Name = "conditions", EmitDefaultValue = false)]
        public List<AutomationForCapabilityConditions> Conditions { get; set; }

        /// <summary>
        /// To specify the actions of device control based on the device state in the automation view of SmartThings app.
        /// </summary>
        /// <value>To specify the actions of device control based on the device state in the automation view of SmartThings app.</value>
        [DataMember(Name = "actions", EmitDefaultValue = false)]
        public List<AutomationForCapabilityActions> Actions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationForCapability {\n");
        ...
        {
            return this.Equals(input as AutomationForCapability);
        }

        /// <summary>
        /// Returns true if AutomationForCapability instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationForCapability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationForCapability input)
        {
            if (input == null)
            {
                return false;
