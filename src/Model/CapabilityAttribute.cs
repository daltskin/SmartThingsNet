...
namespace SmartThingsNet.Model
{
    ...
    /// CapabilityAttribute
    /// </summary>
    [DataContract(Name = "CapabilityAttribute")]
    public partial class CapabilityAttribute : IEquatable<CapabilityAttribute>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityAttribute" /> class.
        /// </summary>
        /// <param name="schema">schema.</param>
        /// <param name="setter">The name of the command that sets this attribute.</param>
        /// <param name="enumCommands">a list of objects that specify which commands set this attribute.</param>
        public CapabilityAttribute(AttributeSchema schema = default(AttributeSchema), string setter = default(string), List<CapabilityAttributeEnumCommands> enumCommands = default(List<CapabilityAttributeEnumCommands>))
        {
            this.Schema = schema;
            this.Setter = setter;
            this.EnumCommands = enumCommands;
        }
        ...
        /// </summary>
        /// <value>The name of the command that sets this attribute</value>
        [DataMember(Name = "setter", EmitDefaultValue = false)]
        public string Setter { get; set; }

        /// <summary>
        /// a list of objects that specify which commands set this attribute
        /// </summary>
        /// <value>a list of objects that specify which commands set this attribute</value>
        [DataMember(Name = "enumCommands", EmitDefaultValue = false)]
        public List<CapabilityAttributeEnumCommands> EnumCommands { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityAttribute {\n");
            sb.Append("  Schema: ").Append(Schema).Append("\n");
            sb.Append("  Setter: ").Append(Setter).Append("\n");
            sb.Append("  EnumCommands: ").Append(EnumCommands).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CapabilityAttribute);
        }

        /// <summary>
        /// Returns true if CapabilityAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityAttribute input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Setter == input.Setter ||
                    (this.Setter != null &&
                    this.Setter.Equals(input.Setter))
                ) && 
                (
                    this.EnumCommands == input.EnumCommands ||
                    this.EnumCommands != null &&
                    input.EnumCommands != null &&
                    this.EnumCommands.SequenceEqual(input.EnumCommands)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Setter != null)
                {
                    hashCode = (hashCode * 59) + this.Setter.GetHashCode();
                }
                if (this.EnumCommands != null)
                {
                    hashCode = (hashCode * 59) + this.EnumCommands.GetHashCode();
                }
                return hashCode;
            }
        }
