...
namespace SmartThingsNet.Model
{
    ...
    /// WasConditionAllOf
    /// </summary>
    [DataContract(Name = "WasCondition_allOf")]
    public partial class WasConditionAllOf : IEquatable<WasConditionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasConditionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WasConditionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WasConditionAllOf" /> class.
        /// </summary>
        ...
        public WasConditionAllOf(string id = default(string), Interval duration = default(Interval), Operand operand = default(Operand))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for WasConditionAllOf and cannot be null");
            }
            this.Id = id;
            // to ensure "duration" is required (not null)
            if (duration == null) {
                throw new ArgumentNullException("duration is a required property for WasConditionAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasConditionAllOf {\n");
        ...
        {
            return this.Equals(input as WasConditionAllOf);
        }

        /// <summary>
        /// Returns true if WasConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of WasConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasConditionAllOf input)
        {
            if (input == null)
            {
                return false;
