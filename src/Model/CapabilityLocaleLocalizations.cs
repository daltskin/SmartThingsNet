...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CapabilityLocaleLocalizations")]
    public partial class CapabilityLocaleLocalizations : IEquatable<CapabilityLocaleLocalizations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocaleLocalizations" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public CapabilityLocaleLocalizations(List<LocaleReference> items = default(List<LocaleReference>))
        {
            this.Items = items;
        }
        ...
        public List<LocaleReference> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityLocaleLocalizations {\n");
        ...
        {
            return this.Equals(input as CapabilityLocaleLocalizations);
        }

        /// <summary>
        /// Returns true if CapabilityLocaleLocalizations instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityLocaleLocalizations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityLocaleLocalizations input)
        {
            if (input == null)
            {
                return false;
