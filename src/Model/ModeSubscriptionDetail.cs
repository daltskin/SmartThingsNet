...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModeSubscriptionDetail")]
    public partial class ModeSubscriptionDetail : IEquatable<ModeSubscriptionDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModeSubscriptionDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModeSubscriptionDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModeSubscriptionDetail" /> class.
        /// </summary>
        /// <param name="locationId">The GUID for the location to subscribe to mode changes. (required).</param>
        public ModeSubscriptionDetail(string locationId = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for ModeSubscriptionDetail and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The GUID for the location to subscribe to mode changes.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModeSubscriptionDetail {\n");
        ...
        {
            return this.Equals(input as ModeSubscriptionDetail);
        }

        /// <summary>
        /// Returns true if ModeSubscriptionDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ModeSubscriptionDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModeSubscriptionDetail input)
        {
            if (input == null)
            {
                return false;
