...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceIntegrationProfileKey")]
    public partial class DeviceIntegrationProfileKey : IEquatable<DeviceIntegrationProfileKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceIntegrationProfileKey" /> class.
        /// </summary>
        /// <param name="id">Unique identifier for integration profile..</param>
        /// <param name="majorVersion">Major Version of the integration profile.</param>
        public DeviceIntegrationProfileKey(Guid id = default(Guid), long majorVersion = default(long))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Unique identifier for integration profile.
        /// </summary>
        /// <value>Unique identifier for integration profile.</value>
        ...
        /// </summary>
        /// <value>Major Version of the integration profile</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceIntegrationProfileKey {\n");
        ...
        {
            return this.Equals(input as DeviceIntegrationProfileKey);
        }

        /// <summary>
        /// Returns true if DeviceIntegrationProfileKey instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceIntegrationProfileKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceIntegrationProfileKey input)
        {
            if (input == null)
            {
                return false;
