...
namespace SmartThingsNet.Model
{
    ...
    public partial class Error : IEquatable<Error>, IValidatableObject
    {
        ...
        /// <param name="target">Optional field used to point to a problamatic part of the request..</param>
        /// <param name="details">details.</param>
        public Error(string code = default(string), string message = default(string), string target = default(string), List<Error> details = default(List<Error>))
        {
            this.Code = code;
        ...
        /// </summary>
        /// <value>Optional field used to point to a problamatic part of the request.</value>
