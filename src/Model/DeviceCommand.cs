...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceCommand : IEquatable<DeviceCommand>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="DeviceCommand" /> class.
        /// </summary>
        /// <param name="component">The name of the component on this device, default is &#39;main&#39;. The component must be valid for the device. (default to &quot;main&quot;).</param>
        ...
        /// <param name="arguments">Arguments of the command. All the required arguments defined in the capability&#39;s command argument definition must be provided. The type of the arguments are dependent on the type of the capability&#39;s command argument. Please refer to the capabilities definition at https://developer-preview.smartthings.com/docs/devices/capabilities/capabilities-reference .</param>
        public DeviceCommand(string component = "main", string capability = default(string), string command = default(string), List<Object> arguments = default(List<Object>))
        {
            ...
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for DeviceCommand and cannot be null");
            }
            this.Capability = capability;
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for DeviceCommand and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The name of the component on this device, default is &#39;main&#39;. The component must be valid for the device.</value>
        ...
        /// </summary>
        /// <value>Capability that this command relates to. This must be a capability of the component.</value>
        ...
        /// <summary>
        /// Arguments of the command. All the required arguments defined in the capability&#39;s command argument definition must be provided. The type of the arguments are dependent on the type of the capability&#39;s command argument. Please refer to the capabilities definition at https://developer-preview.smartthings.com/docs/devices/capabilities/capabilities-reference 
        /// </summary>
        /// <value>Arguments of the command. All the required arguments defined in the capability&#39;s command argument definition must be provided. The type of the arguments are dependent on the type of the capability&#39;s command argument. Please refer to the capabilities definition at https://developer-preview.smartthings.com/docs/devices/capabilities/capabilities-reference </value>
