...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceCommand :  IEquatable<DeviceCommand>, IValidatableObject
    {
        ...
        public DeviceCommand(string component = "main", string capability = default(string), string command = default(string), List<Object> arguments = default(List<Object>))
        {
            ...
            this.Command = command ?? throw new ArgumentNullException("command is a required property for DeviceCommand and cannot be null");
        ...
        /// </summary>
        /// <value>Arguments of the command. All the required arguments defined in the capability&#39;s command argument definition must be provided. The type of the arguments are dependent on the type of the capability&#39;s command argument. Please refer to the capabilities definition at https://smartthings.developer.samsung.com/develop/api-ref/capabilities.html </value>
