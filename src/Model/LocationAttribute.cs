...
{
    /// <summary>
    /// Defines LocationAttribute
    /// </summary>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum LocationAttribute
    {
        /// <summary>
        /// Enum FineDust for value: FineDust
        /// </summary>
        [EnumMember(Value = "FineDust")]
        FineDust = 1,

        /// <summary>
        /// Enum FineDustIndex for value: FineDustIndex
        /// </summary>
        [EnumMember(Value = "FineDustIndex")]
        FineDustIndex = 2,

        /// <summary>
        /// Enum Humidity for value: Humidity
        /// </summary>
        ...
        /// <summary>
        /// Enum TemperatureC for value: TemperatureC
        /// </summary>
        [EnumMember(Value = "TemperatureC")]
        TemperatureC = 7,

        /// <summary>
        /// Enum TemperatureF for value: TemperatureF
        /// </summary>
        [EnumMember(Value = "TemperatureF")]
        TemperatureF = 8,

        /// <summary>
        /// Enum UltraFineDust for value: UltraFineDust
        /// </summary>
        [EnumMember(Value = "UltraFineDust")]
        UltraFineDust = 9,

        /// <summary>
        /// Enum UltraFineDustIndex for value: UltraFineDustIndex
        /// </summary>
        [EnumMember(Value = "UltraFineDustIndex")]
        UltraFineDustIndex = 10,
        ...
        /// <summary>
        /// Enum WeatherAlertSeverity for value: WeatherAlertSeverity
        /// </summary>
        [EnumMember(Value = "WeatherAlertSeverity")]
        WeatherAlertSeverity = 12
