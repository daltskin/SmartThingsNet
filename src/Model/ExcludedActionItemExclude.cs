...
{
    /// <summary>
    /// ExcludedActionItemExclude
    /// </summary>
    [DataContract(Name = "excludedActionItem_exclude")]
    public partial class ExcludedActionItemExclude : IEquatable<ExcludedActionItemExclude>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedActionItemExclude" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedActionItemExclude() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedActionItemExclude" /> class.
        /// </summary>
        /// <param name="component">To specify target component to exclude, if it&#39;s omitted then all components with this capability will be excluded.</param>
        /// <param name="capability">capability (required).</param>
        /// <param name="version">version.</param>
        /// <param name="commands">commands.</param>
        public ExcludedActionItemExclude(string component = default(string), string capability = default(string), int version = default(int), List<Object> commands = default(List<Object>))
        {
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for ExcludedActionItemExclude and cannot be null");
            }
        ...
        /// </summary>
        /// <value>To specify target component to exclude, if it&#39;s omitted then all components with this capability will be excluded</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedActionItemExclude {\n");
        ...
        {
            return this.Equals(input as ExcludedActionItemExclude);
        }

        /// <summary>
        /// Returns true if ExcludedActionItemExclude instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedActionItemExclude to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedActionItemExclude input)
        {
            if (input == null)
            {
                return false;
