...
namespace SmartThingsNet.Model
{
    ...
    /// LocationIsa
    /// </summary>
    [DataContract(Name = "LocationIsa")]
    public partial class LocationIsa : IEquatable<LocationIsa>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationIsa" /> class.
        /// </summary>
        /// <param name="installedSmartApps">installedSmartApps.</param>
        public LocationIsa(List<IsaResults> installedSmartApps = default(List<IsaResults>))
        {
            this.InstalledSmartApps = installedSmartApps;
        }

        /// <summary>
        /// Gets or Sets InstalledSmartApps
        /// </summary>
        [DataMember(Name = "installedSmartApps", EmitDefaultValue = false)]
        public List<IsaResults> InstalledSmartApps { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocationIsa {\n");
            sb.Append("  InstalledSmartApps: ").Append(InstalledSmartApps).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LocationIsa);
        }

        /// <summary>
        /// Returns true if LocationIsa instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationIsa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationIsa input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.InstalledSmartApps == input.InstalledSmartApps ||
                    this.InstalledSmartApps != null &&
                    input.InstalledSmartApps != null &&
                    this.InstalledSmartApps.SequenceEqual(input.InstalledSmartApps)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.InstalledSmartApps != null)
                {
                    hashCode = (hashCode * 59) + this.InstalledSmartApps.GetHashCode();
                }
                return hashCode;
            }
        }
