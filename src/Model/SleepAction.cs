...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SleepAction :  IEquatable<SleepAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SleepAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SleepAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SleepAction" /> class.
        /// </summary>
        /// <param name="id">Unique id for the action.</param>
        /// <param name="duration">duration (required).</param>
        public SleepAction(string id = default(string), Interval duration = default(Interval))
        {
            // to ensure "duration" is required (not null)
            this.Duration = duration ?? throw new ArgumentNullException("duration is a required property for SleepAction and cannot be null");
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as SleepAction);
        }

        /// <summary>
        /// Returns true if SleepAction instances are equal
        /// </summary>
        /// <param name="input">Instance of SleepAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SleepAction input)
        {
            if (input == null)
                return false;
