...
namespace SmartThingsNet.Model
{
    ...
    public partial class SleepAction : IEquatable<SleepAction>, IValidatableObject
    {
        ...
        public SleepAction(Interval duration = default(Interval))
        {
            // to ensure "duration" is required (not null)
            if (duration == null) {
                throw new ArgumentNullException("duration is a required property for SleepAction and cannot be null");
            }
