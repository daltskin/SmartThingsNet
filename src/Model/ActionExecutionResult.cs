...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActionExecutionResult")]
    public partial class ActionExecutionResult : IEquatable<ActionExecutionResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionExecutionResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ActionExecutionResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionExecutionResult" /> class.
        /// </summary>
        ...
        public ActionExecutionResult(string actionId = default(string), IfActionExecutionResult _if = default(IfActionExecutionResult), LocationActionExecutionResult location = default(LocationActionExecutionResult), List<CommandActionExecutionResult> command = default(List<CommandActionExecutionResult>), SleepActionExecutionResult sleep = default(SleepActionExecutionResult))
        {
            // to ensure "actionId" is required (not null)
            if (actionId == null) {
                throw new ArgumentNullException("actionId is a required property for ActionExecutionResult and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "actionId", IsRequired = true, EmitDefaultValue = false)]
        ...
        public IfActionExecutionResult If { get; set; }

        /// <summary>
        /// Gets or Sets Location
        /// </summary>
        [DataMember(Name = "location", EmitDefaultValue = false)]
        public LocationActionExecutionResult Location { get; set; }

        /// <summary>
        /// Gets or Sets Command
        /// </summary>
        [DataMember(Name = "command", EmitDefaultValue = false)]
        public List<CommandActionExecutionResult> Command { get; set; }

        /// <summary>
        /// Gets or Sets Sleep
        /// </summary>
        [DataMember(Name = "sleep", EmitDefaultValue = false)]
        public SleepActionExecutionResult Sleep { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionExecutionResult {\n");
        ...
        {
            return this.Equals(input as ActionExecutionResult);
        }

        /// <summary>
        /// Returns true if ActionExecutionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionExecutionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionExecutionResult input)
        {
            if (input == null)
            {
                return false;
