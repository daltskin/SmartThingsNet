...
namespace SmartThingsNet.Model
{
    ...
    public partial class ActionExecutionResult :  IEquatable<ActionExecutionResult>, IValidatableObject
    {
        ...
        /// <param name="deviceId">Optional device ID for device actions.</param>
        /// <param name="result">result (required).</param>
        public ActionExecutionResult(string actionId = default(string), string deviceId = default(string), ExecutionResult result = default(ExecutionResult))
        {
            // to ensure "actionId" is required (not null)
            this.ActionId = actionId ?? throw new ArgumentNullException("actionId is a required property for ActionExecutionResult and cannot be null");
            this.Result = result;
        ...
        /// <summary>
        /// Optional device ID for device actions
        /// </summary>
        /// <value>Optional device ID for device actions</value>
