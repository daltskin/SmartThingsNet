...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin11Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin11Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin11Hour : IEquatable<ServiceCapabilityDataForecastSnowMin11Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin11Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 11 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin11Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 11 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 11 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin11Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin11Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin11Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin11Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin11Hour input)
        {
            if (input == null)
            {
                return false;
