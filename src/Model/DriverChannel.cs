...
namespace SmartThingsNet.Model
{
    ...
    /// DriverChannel
    /// </summary>
    [DataContract(Name = "DriverChannel")]
    public partial class DriverChannel : IEquatable<DriverChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverChannel" /> class.
        /// </summary>
        ...
        public DriverChannel(Guid channelId = default(Guid), string driverId = default(string), string version = default(string), string createdDate = default(string), string lastModifiedDate = default(string))
        {
        ...
        {
            return this.Equals(input as DriverChannel);
        }

        /// <summary>
        /// Returns true if DriverChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverChannel input)
        {
            if (input == null)
            {
                return false;
