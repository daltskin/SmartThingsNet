...
namespace SmartThingsNet.Model
{
    ...
    /// CameraOverlayIcons
    /// </summary>
    [DataContract(Name = "camera_overlayIcons")]
    public partial class CameraOverlayIcons : IEquatable<CameraOverlayIcons>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CameraOverlayIcons" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CameraOverlayIcons() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CameraOverlayIcons" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Icon Id used to retrieve a overlay icon to be drawn on the camera card.
        /// </summary>
        /// <value>Icon Id used to retrieve a overlay icon to be drawn on the camera card.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CameraOverlayIcons {\n");
        ...
        {
            return this.Equals(input as CameraOverlayIcons);
        }

        /// <summary>
        /// Returns true if CameraOverlayIcons instances are equal
        /// </summary>
        /// <param name="input">Instance of CameraOverlayIcons to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CameraOverlayIcons input)
        {
            if (input == null)
            {
                return false;
