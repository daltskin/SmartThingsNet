...
namespace SmartThingsNet.Model
{
    ...
    public partial class UpdateLocationResponse : IEquatable<UpdateLocationResponse>, IValidatableObject
    {
        ...
        public UpdateLocationResponse(Guid locationId = default(Guid), string name = default(string), string countryCode = default(string), decimal latitude = default(decimal), decimal longitude = default(decimal), int regionRadius = default(int), string temperatureScale = default(string), string timeZoneId = default(string), string locale = default(string), string backgroundImage = default(string), Dictionary<string, string> additionalProperties = default(Dictionary<string, string>), LocationParent parent = default(LocationParent), DateTime created = default(DateTime), DateTime lastModified = default(DateTime))
        {
            this.LocationId = locationId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for UpdateLocationResponse and cannot be null");
            }
            this.Name = name;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null) {
                throw new ArgumentNullException("countryCode is a required property for UpdateLocationResponse and cannot be null");
            }
