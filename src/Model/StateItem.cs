...
namespace SmartThingsNet.Model
{
    ...
    /// StateItem
    /// </summary>
    [DataContract(Name = "stateItem")]
    public partial class StateItem : IEquatable<StateItem>, IValidatableObject
    {
        /// <summary>
        ...
        public StateItem(string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for StateItem and cannot be null");
            }
            this.Label = label;
        ...
        {
            return this.Equals(input as StateItem);
        }

        /// <summary>
        /// Returns true if StateItem instances are equal
        /// </summary>
        /// <param name="input">Instance of StateItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateItem input)
        {
            if (input == null)
            {
                return false;
