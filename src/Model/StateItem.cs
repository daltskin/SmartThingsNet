...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StateItem : StateItemAllOf,  IEquatable<StateItem>, IValidatableObject
    {
        /// <summary>
        ...
        public StateItem(string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), string group = default(string)) : base()
        {
        }
