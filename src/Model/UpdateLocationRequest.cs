...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateLocationRequest")]
    public partial class UpdateLocationRequest : IEquatable<UpdateLocationRequest>, IValidatableObject
    {
        ...
        protected UpdateLocationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLocationRequest" /> class.
        /// </summary>
        /// <param name="name">A name for the Location. (required).</param>
        /// <param name="latitude">A geographical latitude..</param>
        /// <param name="longitude">A geographical longitude..</param>
        /// <param name="regionRadius">The radius in meters around latitude and longitude which defines this :ocation..</param>
        ...
        public UpdateLocationRequest(string name = default(string), decimal latitude = default(decimal), decimal longitude = default(decimal), int regionRadius = default(int), string temperatureScale = default(string), string locale = default(string), Dictionary<string, string> additionalProperties = default(Dictionary<string, string>))
        {
            ...
            if (name == null) {
                throw new ArgumentNullException("name is a required property for UpdateLocationRequest and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>A name for the Location.</value>
        ...
        /// <summary>
        /// The radius in meters around latitude and longitude which defines this :ocation.
        /// </summary>
        /// <value>The radius in meters around latitude and longitude which defines this :ocation.</value>
        ...
        {
            return this.Equals(input as UpdateLocationRequest);
        }

        /// <summary>
        /// Returns true if UpdateLocationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateLocationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateLocationRequest input)
        {
            if (input == null)
            {
                return false;
