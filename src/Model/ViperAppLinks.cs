...
namespace SmartThingsNet.Model
{
    ...
    /// ViperAppLinks
    /// </summary>
    [DataContract(Name = "ViperAppLinks")]
    public partial class ViperAppLinks : IEquatable<ViperAppLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViperAppLinks" /> class.
        /// </summary>
        /// <param name="android">app deep linking to partners in android.</param>
        /// <param name="ios">app deep linking to partners in ios.</param>
        /// <param name="isLinkingEnabled">whether deep app linking is enabled.</param>
        public ViperAppLinks(string android = default(string), string ios = default(string), bool isLinkingEnabled = default(bool))
        {
        ...
        /// <summary>
        /// app deep linking to partners in android
        /// </summary>
        /// <value>app deep linking to partners in android</value>
        [DataMember(Name = "android", EmitDefaultValue = false)]
        public string Android { get; set; }

        /// <summary>
        /// app deep linking to partners in ios
        /// </summary>
        /// <value>app deep linking to partners in ios</value>
        [DataMember(Name = "ios", EmitDefaultValue = false)]
        public string Ios { get; set; }

        /// <summary>
        /// whether deep app linking is enabled
        /// </summary>
        /// <value>whether deep app linking is enabled</value>
        [DataMember(Name = "isLinkingEnabled", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ViperAppLinks {\n");
            sb.Append("  Android: ").Append(Android).Append("\n");
            sb.Append("  Ios: ").Append(Ios).Append("\n");
            sb.Append("  IsLinkingEnabled: ").Append(IsLinkingEnabled).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ViperAppLinks);
        }

        /// <summary>
        /// Returns true if ViperAppLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of ViperAppLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViperAppLinks input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IsLinkingEnabled == input.IsLinkingEnabled ||
                    this.IsLinkingEnabled.Equals(input.IsLinkingEnabled)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IsLinkingEnabled.GetHashCode();
                return hashCode;
            }
        }
