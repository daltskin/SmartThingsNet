...
{
    /// <summary>
    /// AutomationForCapabilityActions
    /// </summary>
    [DataContract(Name = "automationForCapability_actions")]
    public partial class AutomationForCapabilityActions : IEquatable<AutomationForCapabilityActions>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationForCapabilityActions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutomationForCapabilityActions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationForCapabilityActions" /> class.
        /// </summary>
        ...
        public SliderForAutomationAction Slider { get; set; }

        /// <summary>
        /// Gets or Sets List
        /// </summary>
        [DataMember(Name = "list", EmitDefaultValue = false)]
        public ListForAutomationAction List { get; set; }

        /// <summary>
        /// Gets or Sets TextField
        /// </summary>
        [DataMember(Name = "textField", EmitDefaultValue = false)]
        public TextFieldForAutomationAction TextField { get; set; }

        /// <summary>
        /// Gets or Sets NumberField
        /// </summary>
        [DataMember(Name = "numberField", EmitDefaultValue = false)]
        public NumberFieldForAutomationAction NumberField { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationForCapabilityActions {\n");
        ...
        {
            return this.Equals(input as AutomationForCapabilityActions);
        }

        /// <summary>
        /// Returns true if AutomationForCapabilityActions instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationForCapabilityActions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationForCapabilityActions input)
        {
            if (input == null)
            {
                return false;
