...
namespace SmartThingsNet.Model
{
    ...
    /// InstalledDriver
    /// </summary>
    [DataContract(Name = "InstalledDriver")]
    public partial class InstalledDriver : IEquatable<InstalledDriver>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledDriver" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstalledDriver() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledDriver" /> class.
        /// </summary>
        /// <param name="driverId">Unique Identifier of the driver (required).</param>
        /// <param name="name">User friendly Identifier for Driver (required).</param>
        /// <param name="description">Description of Driver.</param>
        /// <param name="version">version of the driver currently in use (required).</param>
        /// <param name="channelId">identifier for channel this driver is installed from.</param>
        /// <param name="developer">developer of the driver.</param>
        /// <param name="vendorSupportInformation">information on how to reach vendor.</param>
        /// <param name="permissions">map of permissions and attributes used by the driver. In format of {\&quot;permissions\&quot;:{\&quot;perm1\&quot;:{...}, \&quot;perm2\&quot;{...}}} .</param>
        public InstalledDriver(string driverId = default(string), string name = default(string), string description = default(string), string version = default(string), string channelId = default(string), string developer = default(string), string vendorSupportInformation = default(string), Dictionary<string, Object> permissions = default(Dictionary<string, Object>))
        {
            // to ensure "driverId" is required (not null)
            if (driverId == null) {
                throw new ArgumentNullException("driverId is a required property for InstalledDriver and cannot be null");
            }
            this.DriverId = driverId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for InstalledDriver and cannot be null");
            }
            this.Name = name;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for InstalledDriver and cannot be null");
            }
            this._Version = version;
            this.Description = description;
            this.ChannelId = channelId;
            this.Developer = developer;
            this.VendorSupportInformation = vendorSupportInformation;
        ...
        /// </summary>
        /// <value>Unique Identifier of the driver</value>
        [DataMember(Name = "driverId", IsRequired = true, EmitDefaultValue = false)]
        public string DriverId { get; set; }

        /// <summary>
        /// User friendly Identifier for Driver
        /// </summary>
        /// <value>User friendly Identifier for Driver</value>
        ...
        /// </summary>
        /// <value>Description of Driver</value>
        [DataMember(Name = "description", EmitDefaultValue = false)]
        public string Description { get; set; }

        /// <summary>
        /// version of the driver currently in use
        /// </summary>
        /// <value>version of the driver currently in use</value>
        [DataMember(Name = "version", IsRequired = true, EmitDefaultValue = false)]
        public string _Version { get; set; }

        /// <summary>
        /// identifier for channel this driver is installed from
        /// </summary>
        /// <value>identifier for channel this driver is installed from</value>
        ...
        /// </summary>
        /// <value>developer of the driver</value>
        [DataMember(Name = "developer", EmitDefaultValue = false)]
        public string Developer { get; set; }

        /// <summary>
        /// information on how to reach vendor
        /// </summary>
        /// <value>information on how to reach vendor</value>
        [DataMember(Name = "vendorSupportInformation", EmitDefaultValue = false)]
        public string VendorSupportInformation { get; set; }

        /// <summary>
        /// map of permissions and attributes used by the driver. In format of {\&quot;permissions\&quot;:{\&quot;perm1\&quot;:{...}, \&quot;perm2\&quot;{...}}} 
        /// </summary>
        /// <value>map of permissions and attributes used by the driver. In format of {\&quot;permissions\&quot;:{\&quot;perm1\&quot;:{...}, \&quot;perm2\&quot;{...}}} </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstalledDriver {\n");
            ...
            sb.Append("  VendorSupportInformation: ").Append(VendorSupportInformation).Append("\n");
        ...
        {
            return this.Equals(input as InstalledDriver);
        }

        /// <summary>
        /// Returns true if InstalledDriver instances are equal
        /// </summary>
        /// <param name="input">Instance of InstalledDriver to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstalledDriver input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.VendorSupportInformation == input.VendorSupportInformation ||
                    (this.VendorSupportInformation != null &&
                    this.VendorSupportInformation.Equals(input.VendorSupportInformation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VendorSupportInformation != null)
                {
                    hashCode = (hashCode * 59) + this.VendorSupportInformation.GetHashCode();
                }
