...
namespace SmartThingsNet.Model
{
    ...
    /// DriverAllOf
    /// </summary>
    [DataContract(Name = "Driver_allOf")]
    public partial class DriverAllOf : IEquatable<DriverAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverAllOf" /> class.
        /// </summary>
        /// <param name="fingerprints">fingerprints.</param>
        /// <param name="permissions">permissions.</param>
        public DriverAllOf(List<DriverFingerprint> fingerprints = default(List<DriverFingerprint>), List<DriverPermission> permissions = default(List<DriverPermission>))
        {
        ...
        {
            return this.Equals(input as DriverAllOf);
        }

        /// <summary>
        /// Returns true if DriverAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverAllOf input)
        {
            if (input == null)
            {
                return false;
