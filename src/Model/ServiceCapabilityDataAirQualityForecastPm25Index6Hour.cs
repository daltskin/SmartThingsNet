...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm25Index6Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm25Index6Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm25Index6Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm25Index6Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm25Index6Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) six hours index forecast of particulate matter less than 2.5 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm25Index6Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) six hours index forecast of particulate matter less than 2.5 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) six hours index forecast of particulate matter less than 2.5 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm25Index6Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm25Index6Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm25Index6Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm25Index6Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm25Index6Hour input)
        {
            if (input == null)
            {
                return false;
