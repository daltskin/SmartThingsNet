...
namespace SmartThingsNet.Model
{
    ...
    /// ActionListItemAllOf
    /// </summary>
    [DataContract(Name = "actionListItem_allOf")]
    public partial class ActionListItemAllOf : IEquatable<ActionListItemAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public ActionListItemAllOf(string component = default(string), VisibleCondition visibleCondition = default(VisibleCondition), List<ExcludedActionItem> exclusion = default(List<ExcludedActionItem>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionListItemAllOf {\n");
        ...
        {
            return this.Equals(input as ActionListItemAllOf);
        }

        /// <summary>
        /// Returns true if ActionListItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionListItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionListItemAllOf input)
        {
            if (input == null)
            {
                return false;
