...
namespace SmartThingsNet.Model
{
    ...
    /// DateTimeOperand
    /// </summary>
    [DataContract(Name = "DateTimeOperand")]
    public partial class DateTimeOperand : IEquatable<DateTimeOperand>, IValidatableObject
    {
        ...
        public DateTimeOperand(string timeZoneId = default(string), string locationId = default(string), List<DayOfWeek> daysOfWeek = default(List<DayOfWeek>), int year = default(int), int month = default(int), int day = default(int), TimeReference reference = default(TimeReference), Interval offset = default(Interval))
        {
        ...
        public Interval Offset { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DateTimeOperand {\n");
        ...
        {
            return this.Equals(input as DateTimeOperand);
        }

        /// <summary>
        /// Returns true if DateTimeOperand instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTimeOperand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTimeOperand input)
        {
            if (input == null)
            {
                return false;
