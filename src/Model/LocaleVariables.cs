...
namespace SmartThingsNet.Model
{
    ...
    public partial class LocaleVariables :  IEquatable<LocaleVariables>, IValidatableObject
    {
        ...
        public LocaleVariables(string localeTag = default(string), Dictionary<string, string> variables = default(Dictionary<string, string>))
        {
            ...
            this.LocaleTag = localeTag ?? throw new ArgumentNullException("localeTag is a required property for LocaleVariables and cannot be null");
        ...
        [DataMember(Name="localeTag", EmitDefaultValue=false)]
