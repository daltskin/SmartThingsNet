...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LocaleVariables")]
    public partial class LocaleVariables : IEquatable<LocaleVariables>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocaleVariables" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LocaleVariables() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LocaleVariables" /> class.
        /// </summary>
        ...
        public LocaleVariables(string localeTag = default(string), Dictionary<string, string> variables = default(Dictionary<string, string>))
        {
            // to ensure "localeTag" is required (not null)
            if (localeTag == null) {
                throw new ArgumentNullException("localeTag is a required property for LocaleVariables and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocaleVariables {\n");
        ...
        {
            return this.Equals(input as LocaleVariables);
        }

        /// <summary>
        /// Returns true if LocaleVariables instances are equal
        /// </summary>
        /// <param name="input">Instance of LocaleVariables to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocaleVariables input)
        {
            if (input == null)
            {
                return false;
