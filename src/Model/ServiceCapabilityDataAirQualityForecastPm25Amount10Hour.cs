...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm25Amount10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm25Amount10Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm25Amount10Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm25Amount10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm25Amount10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 10 hours dust amount forecast of particulate matter less than 2.5 microns .</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityForecastPm25Amount10Hour(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea) 10 hours dust amount forecast of particulate matter less than 2.5 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 10 hours dust amount forecast of particulate matter less than 2.5 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm25Amount10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm25Amount10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm25Amount10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm25Amount10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm25Amount10Hour input)
        {
            if (input == null)
            {
                return false;
