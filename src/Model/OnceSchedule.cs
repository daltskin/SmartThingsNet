...
namespace SmartThingsNet.Model
{
    ...
    /// OnceSchedule
    /// </summary>
    [DataContract(Name = "OnceSchedule")]
    public partial class OnceSchedule : IEquatable<OnceSchedule>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OnceSchedule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OnceSchedule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OnceSchedule" /> class.
        /// </summary>
        /// <param name="time">The time in millis from jan 1 1970 UTC for ONCE schedules. Must be less than 2 years from now. (required).</param>
        /// <param name="overwrite">overwrite.</param>
        public OnceSchedule(long time = default(long), bool overwrite = default(bool))
        {
            this.Time = time;
        ...
        /// </summary>
        /// <value>The time in millis from jan 1 1970 UTC for ONCE schedules. Must be less than 2 years from now.</value>
        ...
        {
            return this.Equals(input as OnceSchedule);
        }

        /// <summary>
        /// Returns true if OnceSchedule instances are equal
        /// </summary>
        /// <param name="input">Instance of OnceSchedule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OnceSchedule input)
        {
            if (input == null)
            {
                return false;
