...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IconImage")]
    public partial class IconImage : IEquatable<IconImage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IconImage" /> class.
        /// </summary>
        /// <param name="url">A default icon image url for an app. https url required. .</param>
        public IconImage(string url = default(string))
        {
            this.Url = url;
        }
        ...
        {
            return this.Equals(input as IconImage);
        }

        /// <summary>
        /// Returns true if IconImage instances are equal
        /// </summary>
        /// <param name="input">Instance of IconImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IconImage input)
        {
            if (input == null)
            {
                return false;
