...
namespace SmartThingsNet.Model
{
    ...
    /// DriverPermission
    /// </summary>
    [DataContract(Name = "DriverPermission")]
    public partial class DriverPermission : IEquatable<DriverPermission>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverPermission" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DriverPermission() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverPermission" /> class.
        /// </summary>
        /// <param name="name">Name of the permission (required).</param>
        /// <param name="attributes">Additional properties on a driver permission (required).</param>
        public DriverPermission(string name = default(string), Dictionary<string, Object> attributes = default(Dictionary<string, Object>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for DriverPermission and cannot be null");
            }
            this.Name = name;
            // to ensure "attributes" is required (not null)
            if (attributes == null) {
                throw new ArgumentNullException("attributes is a required property for DriverPermission and cannot be null");
            }
        ...
        /// <summary>
        /// Additional properties on a driver permission
        /// </summary>
        /// <value>Additional properties on a driver permission</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverPermission {\n");
        ...
        {
            return this.Equals(input as DriverPermission);
        }

        /// <summary>
        /// Returns true if DriverPermission instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverPermission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverPermission input)
        {
            if (input == null)
            {
                return false;
