...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateSignatureTypeRequest")]
    public partial class UpdateSignatureTypeRequest : IEquatable<UpdateSignatureTypeRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSignatureTypeRequest" /> class.
        /// </summary>
        /// <param name="signatureType">signatureType.</param>
        public UpdateSignatureTypeRequest(SignatureType? signatureType = default(SignatureType?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateSignatureTypeRequest {\n");
        ...
        {
            return this.Equals(input as UpdateSignatureTypeRequest);
        }

        /// <summary>
        /// Returns true if UpdateSignatureTypeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSignatureTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateSignatureTypeRequest input)
        {
            if (input == null)
            {
                return false;
