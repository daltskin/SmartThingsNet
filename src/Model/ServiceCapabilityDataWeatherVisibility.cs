...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherVisibility
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_visibility")]
    public partial class ServiceCapabilityDataWeatherVisibility : IEquatable<ServiceCapabilityDataWeatherVisibility>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherVisibility" /> class.
        /// </summary>
        /// <param name="value">The horizontal visibility at the observation point in kilometers .</param>
        /// <param name="unit">Km.</param>
        public ServiceCapabilityDataWeatherVisibility(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// The horizontal visibility at the observation point in kilometers 
        /// </summary>
        /// <value>The horizontal visibility at the observation point in kilometers </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherVisibility {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherVisibility);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherVisibility instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherVisibility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherVisibility input)
        {
            if (input == null)
            {
                return false;
