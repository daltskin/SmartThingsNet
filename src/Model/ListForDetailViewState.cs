...
{
    /// <summary>
    /// ListForDetailViewState
    /// </summary>
    [DataContract(Name = "listForDetailView_state")]
    public partial class ListForDetailViewState : IEquatable<ListForDetailViewState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForDetailViewState" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForDetailViewState() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForDetailViewState" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="valueType">The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability..</param>
        /// <param name="alternatives">alternatives (required).</param>
        public ListForDetailViewState(string value = default(string), string valueType = default(string), List<string> alternatives = default(List<string>))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ListForDetailViewState and cannot be null");
            }
            this.Value = value;
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for ListForDetailViewState and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForDetailViewState {\n");
        ...
        {
            return this.Equals(input as ListForDetailViewState);
        }

        /// <summary>
        /// Returns true if ListForDetailViewState instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForDetailViewState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForDetailViewState input)
        {
            if (input == null)
            {
                return false;
