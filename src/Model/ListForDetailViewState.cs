...
namespace SmartThingsNet.Model
{
    ...
    public partial class ListForDetailViewState :  IEquatable<ListForDetailViewState>, IValidatableObject
    {
        ...
        public ListForDetailViewState(string value = default(string), List<string> alternatives = default(List<string>))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ListForDetailViewState and cannot be null");
            // to ensure "alternatives" is required (not null)
            this.Alternatives = alternatives ?? throw new ArgumentNullException("alternatives is a required property for ListForDetailViewState and cannot be null");
        }
