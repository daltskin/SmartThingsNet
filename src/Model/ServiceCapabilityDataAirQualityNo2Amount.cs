...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityNo2Amount
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_no2Amount")]
    public partial class ServiceCapabilityDataAirQualityNo2Amount : IEquatable<ServiceCapabilityDataAirQualityNo2Amount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityNo2Amount" /> class.
        /// </summary>
        /// <param name="value">(Available for Korea Only) Nitrogen Dioxide pollutant in ug/m3.</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityNo2Amount(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for Korea Only) Nitrogen Dioxide pollutant in ug/m3
        /// </summary>
        /// <value>(Available for Korea Only) Nitrogen Dioxide pollutant in ug/m3</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityNo2Amount {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityNo2Amount);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityNo2Amount instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityNo2Amount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityNo2Amount input)
        {
            if (input == null)
            {
                return false;
