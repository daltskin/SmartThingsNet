...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow10Hour")]
    public partial class ServiceCapabilityDataForecastSnow10Hour : IEquatable<ServiceCapabilityDataForecastSnow10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 10 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow10Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 10 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 10 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow10Hour input)
        {
            if (input == null)
            {
                return false;
