...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualitySo2Amount
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_so2Amount")]
    public partial class ServiceCapabilityDataAirQualitySo2Amount : IEquatable<ServiceCapabilityDataAirQualitySo2Amount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualitySo2Amount" /> class.
        /// </summary>
        /// <param name="value">(Available for Korea Only) Sulfur Dioxide pollutant in ug/m3.</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualitySo2Amount(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for Korea Only) Sulfur Dioxide pollutant in ug/m3
        /// </summary>
        /// <value>(Available for Korea Only) Sulfur Dioxide pollutant in ug/m3</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualitySo2Amount {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualitySo2Amount);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualitySo2Amount instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualitySo2Amount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualitySo2Amount input)
        {
            if (input == null)
            {
                return false;
