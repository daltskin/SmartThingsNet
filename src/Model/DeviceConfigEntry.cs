...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceConfigEntry
    /// </summary>
    [DataContract(Name = "deviceConfigEntry")]
    public partial class DeviceConfigEntry : IEquatable<DeviceConfigEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceConfigEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntry" /> class.
        /// </summary>
        ...
        public DeviceConfigEntry(string component = default(string), string capability = default(string), int version = 1, VisibleCondition visibleCondition = default(VisibleCondition), List<CapabilityValue> values = default(List<CapabilityValue>), List<PatchItem> patch = default(List<PatchItem>))
        {
            // to ensure "component" is required (not null)
            if (component == null) {
                throw new ArgumentNullException("component is a required property for DeviceConfigEntry and cannot be null");
            }
            this.Component = component;
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for DeviceConfigEntry and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntry {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntry);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntry input)
        {
            if (input == null)
            {
                return false;
