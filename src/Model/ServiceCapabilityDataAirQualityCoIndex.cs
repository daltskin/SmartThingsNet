...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityCoIndex
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_coIndex")]
    public partial class ServiceCapabilityDataAirQualityCoIndex : IEquatable<ServiceCapabilityDataAirQualityCoIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityCoIndex" /> class.
        /// </summary>
        /// <param name="value">(Available for non-Korea Only) index of Carbon Monoxide pollutant.</param>
        /// <param name="unit">EPA.</param>
        public ServiceCapabilityDataAirQualityCoIndex(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for non-Korea Only) index of Carbon Monoxide pollutant
        /// </summary>
        /// <value>(Available for non-Korea Only) index of Carbon Monoxide pollutant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityCoIndex {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityCoIndex);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityCoIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityCoIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityCoIndex input)
        {
            if (input == null)
            {
                return false;
