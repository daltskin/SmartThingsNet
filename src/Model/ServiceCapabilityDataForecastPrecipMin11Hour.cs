...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precipMin11Hour")]
    public partial class ServiceCapabilityDataForecastPrecipMin11Hour : IEquatable<ServiceCapabilityDataForecastPrecipMin11Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecipMin11Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) minimium 11 hour forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecipMin11Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) minimium 11 hour forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) minimium 11 hour forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecipMin11Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecipMin11Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecipMin11Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecipMin11Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecipMin11Hour input)
        {
            if (input == null)
            {
                return false;
