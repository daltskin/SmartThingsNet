...
namespace SmartThingsNet.Model
{
    ...
    /// ArrayOperand
    /// </summary>
    [DataContract(Name = "ArrayOperand")]
    public partial class ArrayOperand : IEquatable<ArrayOperand>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayOperand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ArrayOperand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayOperand" /> class.
        /// </summary>
        /// <param name="operands">operands (required).</param>
        /// <param name="aggregation">aggregation.</param>
        public ArrayOperand(List<Operand> operands = default(List<Operand>), OperandAggregationMode? aggregation = default(OperandAggregationMode?))
        {
            // to ensure "operands" is required (not null)
            if (operands == null) {
                throw new ArgumentNullException("operands is a required property for ArrayOperand and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "operands", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as ArrayOperand);
        }

        /// <summary>
        /// Returns true if ArrayOperand instances are equal
        /// </summary>
        /// <param name="input">Instance of ArrayOperand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArrayOperand input)
        {
            if (input == null)
            {
                return false;
