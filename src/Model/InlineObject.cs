...
namespace SmartThingsNet.Model
{
    ...
    public partial class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        ...
        public InlineObject(DashboardForCapability dashboard = default(DashboardForCapability), List<Object> detailView = default(List<Object>), AutomationForCapability automation = default(AutomationForCapability))
        {
