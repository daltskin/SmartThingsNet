...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip5Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip5Hour")]
    public partial class ServiceCapabilityDataForecastPrecip5Hour : IEquatable<ServiceCapabilityDataForecastPrecip5Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip5Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 5 hours forecast liquid precipitation amount in millimeters.</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip5Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 5 hours forecast liquid precipitation amount in millimeters
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 5 hours forecast liquid precipitation amount in millimeters</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip5Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip5Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip5Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip5Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip5Hour input)
        {
            if (input == null)
            {
                return false;
