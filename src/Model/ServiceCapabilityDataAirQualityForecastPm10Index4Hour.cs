...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm10Index4Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm10Index4Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm10Index4Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm10Index4Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm10Index4Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 4 hours index forecast of particulate matter less than 10 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm10Index4Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) 4 hours index forecast of particulate matter less than 10 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 4 hours index forecast of particulate matter less than 10 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm10Index4Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm10Index4Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm10Index4Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm10Index4Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm10Index4Hour input)
        {
            if (input == null)
            {
                return false;
