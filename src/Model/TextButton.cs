...
{
    /// <summary>
    /// To specify available values shown in buttons with text label.
    /// </summary>
    [DataContract(Name = "textButton")]
    public partial class TextButton : IEquatable<TextButton>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="TextButton" /> class.
        /// </summary>
        /// <param name="command">To specify command name with argument(s) and key of the buttons is the argument of the command. If this is omitted then keys at &#x60;buttons&#x60; array are the enumCommands without arguments..</param>
        /// <param name="value">value.</param>
        /// <param name="buttons">buttons (required).</param>
        /// <param name="supportedValues">supportedValues.</param>
        public TextButton(string command = default(string), string value = default(string), List<TextButtonButtons> buttons = default(List<TextButtonButtons>), string supportedValues = default(string))
        {
            // to ensure "buttons" is required (not null)
            if (buttons == null) {
                throw new ArgumentNullException("buttons is a required property for TextButton and cannot be null");
            }
        ...
        /// <summary>
        /// To specify command name with argument(s) and key of the buttons is the argument of the command. If this is omitted then keys at &#x60;buttons&#x60; array are the enumCommands without arguments.
        /// </summary>
        /// <value>To specify command name with argument(s) and key of the buttons is the argument of the command. If this is omitted then keys at &#x60;buttons&#x60; array are the enumCommands without arguments.</value>
        ...
        /// </summary>
        [DataMember(Name = "buttons", IsRequired = true, EmitDefaultValue = false)]
        public List<TextButtonButtons> Buttons { get; set; }
        ...
        {
            return this.Equals(input as TextButton);
        }

        /// <summary>
        /// Returns true if TextButton instances are equal
        /// </summary>
        /// <param name="input">Instance of TextButton to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextButton input)
        {
            if (input == null)
            {
                return false;
