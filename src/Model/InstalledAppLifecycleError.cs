...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstalledAppLifecycleError")]
    public partial class InstalledAppLifecycleError : IEquatable<InstalledAppLifecycleError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledAppLifecycleError" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        /// <param name="message">message.</param>
        /// <param name="target">target.</param>
        /// <param name="details">details.</param>
        public InstalledAppLifecycleError(string code = default(string), string message = default(string), string target = default(string), List<InstalledAppLifecycleError> details = default(List<InstalledAppLifecycleError>))
        {
            this.Code = code;
        ...
        public List<InstalledAppLifecycleError> Details { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstalledAppLifecycleError {\n");
        ...
        {
            return this.Equals(input as InstalledAppLifecycleError);
        }

        /// <summary>
        /// Returns true if InstalledAppLifecycleError instances are equal
        /// </summary>
        /// <param name="input">Instance of InstalledAppLifecycleError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstalledAppLifecycleError input)
        {
            if (input == null)
            {
                return false;
