...
namespace SmartThingsNet.Model
{
    ...
    /// PagedDeviceProfiles
    /// </summary>
    [DataContract(Name = "PagedDeviceProfiles")]
    public partial class PagedDeviceProfiles : IEquatable<PagedDeviceProfiles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDeviceProfiles" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedDeviceProfiles {\n");
        ...
        {
            return this.Equals(input as PagedDeviceProfiles);
        }

        /// <summary>
        /// Returns true if PagedDeviceProfiles instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedDeviceProfiles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedDeviceProfiles input)
        {
            if (input == null)
            {
                return false;
