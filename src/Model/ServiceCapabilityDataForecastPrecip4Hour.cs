...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip4Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip4Hour")]
    public partial class ServiceCapabilityDataForecastPrecip4Hour : IEquatable<ServiceCapabilityDataForecastPrecip4Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip4Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 4 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip4Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 4 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 4 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip4Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip4Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip4Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip4Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip4Hour input)
        {
            if (input == null)
            {
                return false;
