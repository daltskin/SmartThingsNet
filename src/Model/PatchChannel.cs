...
namespace SmartThingsNet.Model
{
    ...
    /// PatchChannel
    /// </summary>
    [DataContract(Name = "PatchChannel")]
    public partial class PatchChannel : IEquatable<PatchChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchChannel" /> class.
        /// </summary>
        ...
        public PatchChannel(string name = default(string), string description = default(string), string termsOfServiceUrl = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as PatchChannel);
        }

        /// <summary>
        /// Returns true if PatchChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchChannel input)
        {
            if (input == null)
            {
                return false;
