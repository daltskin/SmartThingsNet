...
{
    /// <summary>
    /// ExcludedDeviceConditionConfigEntryAllOf
    /// </summary>
    [DataContract(Name = "excludedDeviceConditionConfigEntry_allOf")]
    public partial class ExcludedDeviceConditionConfigEntryAllOf : IEquatable<ExcludedDeviceConditionConfigEntryAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedDeviceConditionConfigEntryAllOf" /> class.
        /// </summary>
        /// <param name="exclusion">To exclude specified automation in &#x60;exclude&#x60; when this item is selected by the user..</param>
        public ExcludedDeviceConditionConfigEntryAllOf(List<ExcludedConditionItemId> exclusion = default(List<ExcludedConditionItemId>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedDeviceConditionConfigEntryAllOf {\n");
        ...
        {
            return this.Equals(input as ExcludedDeviceConditionConfigEntryAllOf);
        }

        /// <summary>
        /// Returns true if ExcludedDeviceConditionConfigEntryAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedDeviceConditionConfigEntryAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedDeviceConditionConfigEntryAllOf input)
        {
            if (input == null)
            {
                return false;
