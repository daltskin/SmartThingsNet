...
namespace SmartThingsNet.Model
{
    ...
    /// PagedCapabilities
    /// </summary>
    [DataContract(Name = "PagedCapabilities")]
    public partial class PagedCapabilities : IEquatable<PagedCapabilities>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedCapabilities" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedCapabilities(List<CapabilitySummary> items = default(List<CapabilitySummary>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<CapabilitySummary> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedCapabilities {\n");
        ...
        {
            return this.Equals(input as PagedCapabilities);
        }

        /// <summary>
        /// Returns true if PagedCapabilities instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedCapabilities input)
        {
            if (input == null)
            {
                return false;
