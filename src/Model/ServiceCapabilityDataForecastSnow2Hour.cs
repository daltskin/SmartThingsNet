...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow2Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow2Hour")]
    public partial class ServiceCapabilityDataForecastSnow2Hour : IEquatable<ServiceCapabilityDataForecastSnow2Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow2Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 2 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow2Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 2 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 2 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow2Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow2Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow2Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow2Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow2Hour input)
        {
            if (input == null)
            {
                return false;
