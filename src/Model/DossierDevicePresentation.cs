...
{
    /// <summary>
    /// DossierDevicePresentation
    /// </summary>
    [DataContract(Name = "DossierDevicePresentation")]
    public partial class DossierDevicePresentation : IEquatable<DossierDevicePresentation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierDevicePresentation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DossierDevicePresentation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierDevicePresentation" /> class.
        /// </summary>
        ...
        public DossierDevicePresentation(string manufacturerName = default(string), string presentationId = default(string), string mnmn = default(string), string vid = default(string), string version = "0.0.1", string iconUrl = default(string), List<Object> icons = default(List<Object>), Dashboard dashboard = default(Dashboard), List<DetailViewListItem> detailView = default(List<DetailViewListItem>), Automation automation = default(Automation), List<Object> dpInfo = default(List<Object>), List<LanguageItem> language = default(List<LanguageItem>))
        {
            // to ensure "mnmn" is required (not null)
            if (mnmn == null) {
                throw new ArgumentNullException("mnmn is a required property for DossierDevicePresentation and cannot be null");
            }
            this.Mnmn = mnmn;
            // to ensure "vid" is required (not null)
            if (vid == null) {
                throw new ArgumentNullException("vid is a required property for DossierDevicePresentation and cannot be null");
            }
            this.Vid = vid;
            // to ensure "dpInfo" is required (not null)
            if (dpInfo == null) {
                throw new ArgumentNullException("dpInfo is a required property for DossierDevicePresentation and cannot be null");
            }
            this.DpInfo = dpInfo;
        ...
        /// <summary>
        /// The version of the device presentation.
        /// </summary>
        /// <value>The version of the device presentation.</value>
        ...
        public List<DetailViewListItem> DetailView { get; set; }
        ...
        [DataMember(Name = "dpInfo", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierDevicePresentation {\n");
        ...
        {
            return this.Equals(input as DossierDevicePresentation);
        }

        /// <summary>
        /// Returns true if DossierDevicePresentation instances are equal
        /// </summary>
        /// <param name="input">Instance of DossierDevicePresentation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DossierDevicePresentation input)
        {
            if (input == null)
            {
                return false;
