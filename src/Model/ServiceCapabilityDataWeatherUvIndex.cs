...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherUvIndex
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_uvIndex")]
    public partial class ServiceCapabilityDataWeatherUvIndex : IEquatable<ServiceCapabilityDataWeatherUvIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherUvIndex" /> class.
        /// </summary>
        /// <param name="value">The UV index provides indices of the intensity of the solar radiation level and risk of skin damage due to exposure.  Range - -2&#x3D;Not Available, -1&#x3D;No Report, 0-2&#x3D;Low, 3-5&#x3D;Moderate, 6-7&#x3D;High, 8-10&#x3D; Very High, 11-16&#x3D;Extreme .</param>
        public ServiceCapabilityDataWeatherUvIndex(int value = default(int))
        {
            this.Value = value;
        }

        /// <summary>
        /// The UV index provides indices of the intensity of the solar radiation level and risk of skin damage due to exposure.  Range - -2&#x3D;Not Available, -1&#x3D;No Report, 0-2&#x3D;Low, 3-5&#x3D;Moderate, 6-7&#x3D;High, 8-10&#x3D; Very High, 11-16&#x3D;Extreme 
        /// </summary>
        /// <value>The UV index provides indices of the intensity of the solar radiation level and risk of skin damage due to exposure.  Range - -2&#x3D;Not Available, -1&#x3D;No Report, 0-2&#x3D;Low, 3-5&#x3D;Moderate, 6-7&#x3D;High, 8-10&#x3D; Very High, 11-16&#x3D;Extreme </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherUvIndex {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherUvIndex);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherUvIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherUvIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherUvIndex input)
        {
            if (input == null)
            {
                return false;
