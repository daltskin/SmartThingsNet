...
namespace SmartThingsNet.Model
{
    ...
    /// LocationAction
    /// </summary>
    [DataContract(Name = "LocationAction")]
    public partial class LocationAction : IEquatable<LocationAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationAction" /> class.
        /// </summary>
        /// <param name="locationId">locationId is required for \&quot;User level rule\&quot;. (It&#39;s optional for \&quot;Location level rule\&quot;).</param>
        /// <param name="mode">mode.</param>
        public LocationAction(string locationId = default(string), string mode = default(string))
        {
        ...
        /// </summary>
        /// <value>locationId is required for \&quot;User level rule\&quot;. (It&#39;s optional for \&quot;Location level rule\&quot;)</value>
        ...
        {
            return this.Equals(input as LocationAction);
        }

        /// <summary>
        /// Returns true if LocationAction instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationAction input)
        {
            if (input == null)
            {
                return false;
