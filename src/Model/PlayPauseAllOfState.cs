...
namespace SmartThingsNet.Model
{
    ...
    public partial class PlayPauseAllOfState :  IEquatable<PlayPauseAllOfState>, IValidatableObject
    {
        ...
        public PlayPauseAllOfState(string value = default(string), string play = default(string), string pause = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for PlayPauseAllOfState and cannot be null");
            // to ensure "play" is required (not null)
            this.Play = play ?? throw new ArgumentNullException("play is a required property for PlayPauseAllOfState and cannot be null");
            // to ensure "pause" is required (not null)
            this.Pause = pause ?? throw new ArgumentNullException("pause is a required property for PlayPauseAllOfState and cannot be null");
