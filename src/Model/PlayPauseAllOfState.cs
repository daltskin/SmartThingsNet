...
namespace SmartThingsNet.Model
{
    ...
    /// PlayPauseAllOfState
    /// </summary>
    [DataContract(Name = "playPause_allOf_state")]
    public partial class PlayPauseAllOfState : IEquatable<PlayPauseAllOfState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayPauseAllOfState" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayPauseAllOfState() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayPauseAllOfState" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="valueType">The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability..</param>
        /// <param name="play">The value of \&quot;attribute\&quot; which indicates playing state. When the attribute value equals to this then UI will show playing state. (required).</param>
        /// <param name="pause">The value of \&quot;attribute\&quot; which indicates paused state. When the attribute value equals to this then UI will show paused state. (required).</param>
        ...
        public PlayPauseAllOfState(string value = default(string), string valueType = default(string), string play = default(string), string pause = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for PlayPauseAllOfState and cannot be null");
            }
            this.Value = value;
            // to ensure "play" is required (not null)
            if (play == null) {
                throw new ArgumentNullException("play is a required property for PlayPauseAllOfState and cannot be null");
            }
            this.Play = play;
            // to ensure "pause" is required (not null)
            if (pause == null) {
                throw new ArgumentNullException("pause is a required property for PlayPauseAllOfState and cannot be null");
            }
            this.Pause = pause;
        ...
        /// </summary>
        /// <value>The value of \&quot;attribute\&quot; which indicates playing state. When the attribute value equals to this then UI will show playing state.</value>
        [DataMember(Name = "play", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The value of \&quot;attribute\&quot; which indicates paused state. When the attribute value equals to this then UI will show paused state.</value>
        [DataMember(Name = "pause", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayPauseAllOfState {\n");
        ...
        {
            return this.Equals(input as PlayPauseAllOfState);
        }

        /// <summary>
        /// Returns true if PlayPauseAllOfState instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayPauseAllOfState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayPauseAllOfState input)
        {
            if (input == null)
            {
                return false;
