...
{
    /// <summary>
    /// ListForAutomationConditionAllOf
    /// </summary>
    [DataContract(Name = "listForAutomationCondition_allOf")]
    public partial class ListForAutomationConditionAllOf : IEquatable<ListForAutomationConditionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationConditionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForAutomationConditionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationConditionAllOf" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="valueType">The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability..</param>
        public ListForAutomationConditionAllOf(string value = default(string), string valueType = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ListForAutomationConditionAllOf and cannot be null");
            }
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForAutomationConditionAllOf {\n");
        ...
        {
            return this.Equals(input as ListForAutomationConditionAllOf);
        }

        /// <summary>
        /// Returns true if ListForAutomationConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForAutomationConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForAutomationConditionAllOf input)
        {
            if (input == null)
            {
                return false;
