...
namespace SmartThingsNet.Model
{
    ...
    /// DthDeviceDetails
    /// </summary>
    [DataContract(Name = "DthDeviceDetails")]
    public partial class DthDeviceDetails : IEquatable<DthDeviceDetails>, IValidatableObject
    {

        /// <summary>
        /// Gets or Sets NetworkSecurityLevel
        /// </summary>
        [DataMember(Name = "networkSecurityLevel", EmitDefaultValue = false)]
        public DeviceNetworkSecurityLevel? NetworkSecurityLevel { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="DthDeviceDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DthDeviceDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DthDeviceDetails" /> class.
        /// </summary>
        /// <param name="completedSetup">True if the device setup has been completed so the device is ready to use. (required).</param>
        /// <param name="deviceNetworkType">The device network type..</param>
        /// <param name="deviceTypeId">The identifier for the device&#39;s DeviceType. (required).</param>
        /// <param name="deviceTypeName">The name for the device&#39;s DeviceType. (required).</param>
        /// <param name="executingLocally">True if the device is executing locally on the hub.</param>
        /// <param name="hubId">The hub that the device is connected to..</param>
        /// <param name="installedGroovyAppId">The ID of the installed groovy application.</param>
        /// <param name="networkSecurityLevel">networkSecurityLevel.</param>
        public DthDeviceDetails(bool completedSetup = default(bool), string deviceNetworkType = default(string), string deviceTypeId = default(string), string deviceTypeName = default(string), bool executingLocally = default(bool), string hubId = default(string), string installedGroovyAppId = default(string), DeviceNetworkSecurityLevel? networkSecurityLevel = default(DeviceNetworkSecurityLevel?))
        {
            this.CompletedSetup = completedSetup;
            // to ensure "deviceTypeId" is required (not null)
            if (deviceTypeId == null) {
                throw new ArgumentNullException("deviceTypeId is a required property for DthDeviceDetails and cannot be null");
            }
            this.DeviceTypeId = deviceTypeId;
            // to ensure "deviceTypeName" is required (not null)
            if (deviceTypeName == null) {
                throw new ArgumentNullException("deviceTypeName is a required property for DthDeviceDetails and cannot be null");
            }
            this.DeviceTypeName = deviceTypeName;
            this.DeviceNetworkType = deviceNetworkType;
            this.ExecutingLocally = executingLocally;
            this.HubId = hubId;
            this.InstalledGroovyAppId = installedGroovyAppId;
        ...
        /// </summary>
        /// <value>True if the device setup has been completed so the device is ready to use.</value>
        [DataMember(Name = "completedSetup", IsRequired = true, EmitDefaultValue = true)]
        public bool CompletedSetup { get; set; }

        /// <summary>
        /// The device network type.
        /// </summary>
        /// <value>The device network type.</value>
        ...
        /// </summary>
        /// <value>The identifier for the device&#39;s DeviceType.</value>
        [DataMember(Name = "deviceTypeId", IsRequired = true, EmitDefaultValue = false)]
        public string DeviceTypeId { get; set; }

        /// <summary>
        /// The name for the device&#39;s DeviceType.
        /// </summary>
        /// <value>The name for the device&#39;s DeviceType.</value>
        [DataMember(Name = "deviceTypeName", IsRequired = true, EmitDefaultValue = false)]
        public string DeviceTypeName { get; set; }

        /// <summary>
        /// True if the device is executing locally on the hub
        /// </summary>
        /// <value>True if the device is executing locally on the hub</value>
        [DataMember(Name = "executingLocally", EmitDefaultValue = true)]
        public bool ExecutingLocally { get; set; }

        /// <summary>
        /// The hub that the device is connected to.
        /// </summary>
        /// <value>The hub that the device is connected to.</value>
        ...
        /// </summary>
        /// <value>The ID of the installed groovy application</value>
        [DataMember(Name = "installedGroovyAppId", EmitDefaultValue = false)]
        public string InstalledGroovyAppId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DthDeviceDetails {\n");
            sb.Append("  CompletedSetup: ").Append(CompletedSetup).Append("\n");
            ...
            sb.Append("  InstalledGroovyAppId: ").Append(InstalledGroovyAppId).Append("\n");
            sb.Append("  NetworkSecurityLevel: ").Append(NetworkSecurityLevel).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DthDeviceDetails);
        }

        /// <summary>
        /// Returns true if DthDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of DthDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DthDeviceDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.CompletedSetup == input.CompletedSetup ||
                    this.CompletedSetup.Equals(input.CompletedSetup)
                ) && 
                (
                ...
                (
                    this.InstalledGroovyAppId == input.InstalledGroovyAppId ||
                    (this.InstalledGroovyAppId != null &&
                    this.InstalledGroovyAppId.Equals(input.InstalledGroovyAppId))
                ) && 
                (
                    this.NetworkSecurityLevel == input.NetworkSecurityLevel ||
                    this.NetworkSecurityLevel.Equals(input.NetworkSecurityLevel)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.CompletedSetup.GetHashCode();
                ...
                if (this.InstalledGroovyAppId != null)
                {
                    hashCode = (hashCode * 59) + this.InstalledGroovyAppId.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.NetworkSecurityLevel.GetHashCode();
                return hashCode;
            }
        }
