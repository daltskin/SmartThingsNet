...
namespace SmartThingsNet.Model
{
    ...
    public partial class DthDeviceDetails :  IEquatable<DthDeviceDetails>, IValidatableObject
    {
        ...
        public DthDeviceDetails(string deviceTypeId = default(string), string deviceTypeName = default(string), string deviceNetworkType = default(string), bool completedSetup = default(bool), DeviceNetworkSecurityLevel? networkSecurityLevel = default(DeviceNetworkSecurityLevel?), string hubId = default(string))
        {
            // to ensure "deviceTypeId" is required (not null)
            this.DeviceTypeId = deviceTypeId ?? throw new ArgumentNullException("deviceTypeId is a required property for DthDeviceDetails and cannot be null");
            // to ensure "deviceTypeName" is required (not null)
            this.DeviceTypeName = deviceTypeName ?? throw new ArgumentNullException("deviceTypeName is a required property for DthDeviceDetails and cannot be null");
        ...
        [DataMember(Name="completedSetup", EmitDefaultValue=false)]
