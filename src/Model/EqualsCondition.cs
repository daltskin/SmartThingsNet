...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EqualsCondition : SimpleCondition,  IEquatable<EqualsCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public EqualsCondition(string id = default(string), Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?)) : base(id, left, right, aggregation)
        {
        }
