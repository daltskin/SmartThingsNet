...
namespace SmartThingsNet.Model
{
    ...
    /// EqualsCondition
    /// </summary>
    [DataContract(Name = "EqualsCondition")]
    public partial class EqualsCondition : IEquatable<EqualsCondition>, IValidatableObject
    {
        ...
        public EqualsCondition(Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            if (left == null) {
                throw new ArgumentNullException("left is a required property for EqualsCondition and cannot be null");
            }
            this.Left = left;
            // to ensure "right" is required (not null)
            if (right == null) {
                throw new ArgumentNullException("right is a required property for EqualsCondition and cannot be null");
            }
            this.Right = right;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EqualsCondition {\n");
        ...
        {
            return this.Equals(input as EqualsCondition);
        }

        /// <summary>
        /// Returns true if EqualsCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of EqualsCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EqualsCondition input)
        {
            if (input == null)
            {
                return false;
