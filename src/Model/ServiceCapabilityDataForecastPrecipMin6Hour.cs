...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precipMin6Hour")]
    public partial class ServiceCapabilityDataForecastPrecipMin6Hour : IEquatable<ServiceCapabilityDataForecastPrecipMin6Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecipMin6Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) minimium 6 hour forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecipMin6Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) minimium 6 hour forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) minimium 6 hour forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecipMin6Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecipMin6Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecipMin6Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecipMin6Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecipMin6Hour input)
        {
            if (input == null)
            {
                return false;
