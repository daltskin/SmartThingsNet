...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow4Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow4Hour")]
    public partial class ServiceCapabilityDataForecastSnow4Hour : IEquatable<ServiceCapabilityDataForecastSnow4Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow4Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 4 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow4Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 4 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 4 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow4Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow4Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow4Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow4Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow4Hour input)
        {
            if (input == null)
            {
                return false;
