...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceCategory :  IEquatable<DeviceCategory>, IValidatableObject
    {
        ...
        public DeviceCategory(string name = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DeviceCategory and cannot be null");
        }
        ...
        {
            return this.Equals(input as DeviceCategory);
        }

        /// <summary>
        /// Returns true if DeviceCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCategory input)
        {
            if (input == null)
                return false;
