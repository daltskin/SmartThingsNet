...
{
    /// <summary>
    /// ZigbeeGenericFingerprint
    /// </summary>
    [DataContract(Name = "ZigbeeGenericFingerprint")]
    public partial class ZigbeeGenericFingerprint : IEquatable<ZigbeeGenericFingerprint>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Device Identifiers associated with a generic zigbee fingerprint</value>
        [DataMember(Name = "deviceIdentifiers", EmitDefaultValue = false)]
        public List<int> DeviceIdentifiers { get; set; }

        /// <summary>
        /// Device profiles associated with a generic zigbee fingerprint
        /// </summary>
        /// <value>Device profiles associated with a generic zigbee fingerprint</value>
        [DataMember(Name = "zigbeeProfiles", EmitDefaultValue = false)]
        public List<int> ZigbeeProfiles { get; set; }
        ...
        {
            return this.Equals(input as ZigbeeGenericFingerprint);
        }

        /// <summary>
        /// Returns true if ZigbeeGenericFingerprint instances are equal
        /// </summary>
        /// <param name="input">Instance of ZigbeeGenericFingerprint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZigbeeGenericFingerprint input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.DeviceIdentifiers != null &&
                    this.DeviceIdentifiers.SequenceEqual(input.DeviceIdentifiers)
                ) && 
                (
                    this.ZigbeeProfiles == input.ZigbeeProfiles ||
                    this.ZigbeeProfiles != null &&
                    input.ZigbeeProfiles != null &&
                    this.ZigbeeProfiles.SequenceEqual(input.ZigbeeProfiles)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ZigbeeProfiles != null)
                {
                    hashCode = (hashCode * 59) + this.ZigbeeProfiles.GetHashCode();
                }
