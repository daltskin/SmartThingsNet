...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin10Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin10Hour : IEquatable<ServiceCapabilityDataForecastSnowMin10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 10 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin10Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 10 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 10 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin10Hour input)
        {
            if (input == null)
            {
                return false;
