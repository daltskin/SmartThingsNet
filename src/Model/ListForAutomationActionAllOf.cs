...
{
    /// <summary>
    /// ListForAutomationActionAllOf
    /// </summary>
    [DataContract(Name = "listForAutomationAction_allOf")]
    public partial class ListForAutomationActionAllOf : IEquatable<ListForAutomationActionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationActionAllOf" /> class.
        /// </summary>
        ...
        public ListForAutomationActionAllOf(string command = default(string), string argumentType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForAutomationActionAllOf {\n");
        ...
        {
            return this.Equals(input as ListForAutomationActionAllOf);
        }

        /// <summary>
        /// Returns true if ListForAutomationActionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForAutomationActionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForAutomationActionAllOf input)
        {
            if (input == null)
            {
                return false;
