...
{
    /// <summary>
    /// The definition of this preference.
    /// </summary>
    [DataContract(Name = "PreferenceRequest_definition")]
    public partial class PreferenceRequestDefinition : IEquatable<PreferenceRequestDefinition>, IValidatableObject
    {
        /// <summary>
        /// The type of a string preference. &#x60;text&#x60; is a normal preference, &#x60;password&#x60; encrypts the values, and &#x60;paragraph&#x60; is for documentation purposes.
        /// </summary>
        /// <value>The type of a string preference. &#x60;text&#x60; is a normal preference, &#x60;password&#x60; encrypts the values, and &#x60;paragraph&#x60; is for documentation purposes.</value>
        ...
        /// </summary>
        /// <value>The type of a string preference. &#x60;text&#x60; is a normal preference, &#x60;password&#x60; encrypts the values, and &#x60;paragraph&#x60; is for documentation purposes.</value>
        [DataMember(Name = "stringType", EmitDefaultValue = false)]
        public StringTypeEnum? StringType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreferenceRequestDefinition" /> class.
        /// </summary>
        /// <param name="minimum">Minimum value a preference may be set to. Only valid for &#x60;integer&#x60; and &#x60;number&#x60; preference types..</param>
        /// <param name="maximum">Maximum value a preference may be set to. Only valid for &#x60;integer&#x60; and &#x60;number&#x60; preference types..</param>
        /// <param name="minLength">Minimum length a string may be set to. Only valid for &#x60;string&#x60; preference type..</param>
        /// <param name="maxLength">Maximum length a string may be set to. Only valid for &#x60;string&#x60; preference type..</param>
        /// <param name="_default">Default value for a preference..</param>
        /// <param name="stringType">The type of a string preference. &#x60;text&#x60; is a normal preference, &#x60;password&#x60; encrypts the values, and &#x60;paragraph&#x60; is for documentation purposes..</param>
        /// <param name="options">The available selections for an &#x60;enumeration&#x60; preference..</param>
        public PreferenceRequestDefinition(double minimum = default(double), double maximum = default(double), int minLength = default(int), int maxLength = default(int), Object _default = default(Object), StringTypeEnum? stringType = default(StringTypeEnum?), Dictionary<string, string> options = default(Dictionary<string, string>))
        {
        ...
        /// <summary>
        /// Minimum value a preference may be set to. Only valid for &#x60;integer&#x60; and &#x60;number&#x60; preference types.
        /// </summary>
        /// <value>Minimum value a preference may be set to. Only valid for &#x60;integer&#x60; and &#x60;number&#x60; preference types.</value>
        [DataMember(Name = "minimum", EmitDefaultValue = false)]
        public double Minimum { get; set; }

        /// <summary>
        /// Maximum value a preference may be set to. Only valid for &#x60;integer&#x60; and &#x60;number&#x60; preference types.
        /// </summary>
        /// <value>Maximum value a preference may be set to. Only valid for &#x60;integer&#x60; and &#x60;number&#x60; preference types.</value>
        [DataMember(Name = "maximum", EmitDefaultValue = false)]
        public double Maximum { get; set; }

        /// <summary>
        /// Minimum length a string may be set to. Only valid for &#x60;string&#x60; preference type.
        /// </summary>
        /// <value>Minimum length a string may be set to. Only valid for &#x60;string&#x60; preference type.</value>
        [DataMember(Name = "minLength", EmitDefaultValue = false)]
        public int MinLength { get; set; }

        /// <summary>
        /// Maximum length a string may be set to. Only valid for &#x60;string&#x60; preference type.
        /// </summary>
        /// <value>Maximum length a string may be set to. Only valid for &#x60;string&#x60; preference type.</value>
        ...
        /// </summary>
        /// <value>Default value for a preference.</value>
        ...
        /// </summary>
        /// <value>The available selections for an &#x60;enumeration&#x60; preference.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreferenceRequestDefinition {\n");
            sb.Append("  Minimum: ").Append(Minimum).Append("\n");
            sb.Append("  Maximum: ").Append(Maximum).Append("\n");
            sb.Append("  MinLength: ").Append(MinLength).Append("\n");
            sb.Append("  MaxLength: ").Append(MaxLength).Append("\n");
            sb.Append("  Default: ").Append(Default).Append("\n");
            sb.Append("  StringType: ").Append(StringType).Append("\n");
        ...
        {
            return this.Equals(input as PreferenceRequestDefinition);
        }

        /// <summary>
        /// Returns true if PreferenceRequestDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of PreferenceRequestDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreferenceRequestDefinition input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StringType == input.StringType ||
                    this.StringType.Equals(input.StringType)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StringType.GetHashCode();
