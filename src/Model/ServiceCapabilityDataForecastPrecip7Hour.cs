...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip7Hour")]
    public partial class ServiceCapabilityDataForecastPrecip7Hour : IEquatable<ServiceCapabilityDataForecastPrecip7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 7 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip7Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 7 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 7 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip7Hour input)
        {
            if (input == null)
            {
                return false;
