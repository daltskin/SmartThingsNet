...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow11Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow11Hour")]
    public partial class ServiceCapabilityDataForecastSnow11Hour : IEquatable<ServiceCapabilityDataForecastSnow11Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow11Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 11 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow11Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 11 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 11 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow11Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow11Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow11Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow11Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow11Hour input)
        {
            if (input == null)
            {
                return false;
