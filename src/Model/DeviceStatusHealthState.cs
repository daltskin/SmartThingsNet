...
{
    /// <summary>
    /// DeviceStatusHealthState
    /// </summary>
    [DataContract(Name = "DeviceStatus_healthState")]
    public partial class DeviceStatusHealthState : IEquatable<DeviceStatusHealthState>, IValidatableObject
    {
        /// <summary>
        /// Current state of the device
        /// </summary>
        /// <value>Current state of the device</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceStatusHealthState" /> class.
        /// </summary>
        /// <param name="state">Current state of the device.</param>
        /// <param name="lastUpdatedDate">Last reported date/time in UTC.</param>
        public DeviceStatusHealthState(StateEnum? state = default(StateEnum?), DateTime lastUpdatedDate = default(DateTime))
        {
            this.State = state;
        ...
        /// </summary>
        /// <value>Last reported date/time in UTC</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceStatusHealthState {\n");
        ...
        {
            return this.Equals(input as DeviceStatusHealthState);
        }

        /// <summary>
        /// Returns true if DeviceStatusHealthState instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceStatusHealthState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceStatusHealthState input)
        {
            if (input == null)
            {
                return false;
