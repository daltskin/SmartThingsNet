...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceStatus : IEquatable<DeviceStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public DeviceStatus(Dictionary<string, string> components = default(Dictionary<string, string>), DeviceStatusHealthState healthState = default(DeviceStatusHealthState))
        {
        ...
        /// </summary>
        /// <value>A map of componentId to Component status.</value>
        ...
        {
            return this.Equals(input as DeviceStatus);
        }

        /// <summary>
        /// Returns true if DeviceStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceStatus input)
        {
            if (input == null)
            {
                return false;
