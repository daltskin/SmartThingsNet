...
namespace SmartThingsNet.Model
{
    ...
    /// SubscriptionFilter
    /// </summary>
    [DataContract(Name = "SubscriptionFilter")]
    public partial class SubscriptionFilter : IEquatable<SubscriptionFilter>, IValidatableObject
    {
        ...
        public SubscriptionFilterTypes? Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionFilter" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="value">An array of subscription filter values..</param>
        /// <param name="eventType">eventType.</param>
        /// <param name="attribute">attribute.</param>
        /// <param name="capability">capability.</param>
        /// <param name="component">component.</param>
        public SubscriptionFilter(SubscriptionFilterTypes? type = default(SubscriptionFilterTypes?), List<string> value = default(List<string>), List<string> eventType = default(List<string>), List<string> attribute = default(List<string>), List<string> capability = default(List<string>), List<string> component = default(List<string>))
        {
            this.Type = type;
            this.Value = value;
        ...
        /// </summary>
        /// <value>An array of subscription filter values.</value>
        ...
        {
            return this.Equals(input as SubscriptionFilter);
        }

        /// <summary>
        /// Returns true if SubscriptionFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionFilter input)
        {
            if (input == null)
            {
                return false;
