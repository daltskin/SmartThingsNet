...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateAppOAuthResponse")]
    public partial class GenerateAppOAuthResponse : IEquatable<GenerateAppOAuthResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateAppOAuthResponse" /> class.
        /// </summary>
        /// <param name="oauthClientDetails">oauthClientDetails.</param>
        /// <param name="oauthClientId">The OAuth Client ID..</param>
        /// <param name="oauthClientSecret">The OAuth Client Secret..</param>
        public GenerateAppOAuthResponse(AppOAuth oauthClientDetails = default(AppOAuth), Guid oauthClientId = default(Guid), Guid oauthClientSecret = default(Guid))
        {
        ...
        /// <summary>
        /// Gets or Sets OauthClientDetails
        /// </summary>
        [DataMember(Name = "oauthClientDetails", EmitDefaultValue = false)]
        public AppOAuth OauthClientDetails { get; set; }
        ...
        public Guid OauthClientSecret { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateAppOAuthResponse {\n");
            sb.Append("  OauthClientDetails: ").Append(OauthClientDetails).Append("\n");
        ...
        {
            return this.Equals(input as GenerateAppOAuthResponse);
        }

        /// <summary>
        /// Returns true if GenerateAppOAuthResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateAppOAuthResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateAppOAuthResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.OauthClientDetails == input.OauthClientDetails ||
                    (this.OauthClientDetails != null &&
                    this.OauthClientDetails.Equals(input.OauthClientDetails))
                ) && 
                (
