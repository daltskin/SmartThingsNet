...
namespace SmartThingsNet.Model
{
    ...
    /// components
    /// </summary>
    [DataContract(Name = "DeviceGroupResponse_components")]
    public partial class DeviceGroupResponseComponents : IEquatable<DeviceGroupResponseComponents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGroupResponseComponents" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        public DeviceGroupResponseComponents(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceGroupResponseComponents {\n");
        ...
        {
            return this.Equals(input as DeviceGroupResponseComponents);
        }

        /// <summary>
        /// Returns true if DeviceGroupResponseComponents instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceGroupResponseComponents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceGroupResponseComponents input)
        {
            if (input == null)
            {
                return false;
