...
namespace SmartThingsNet.Model
{
    ...
    public partial class RuleRequest :  IEquatable<RuleRequest>, IValidatableObject
    {
        ...
        public RuleRequest(string name = default(string), List<Action> actions = default(List<Action>), string timeZoneId = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for RuleRequest and cannot be null");
            // to ensure "actions" is required (not null)
            this.Actions = actions ?? throw new ArgumentNullException("actions is a required property for RuleRequest and cannot be null");
