...
namespace SmartThingsNet.Model
{
    ...
    public partial class Operand : IEquatable<Operand>, IValidatableObject
    {
        ...
        public ArrayOperand Array { get; set; }

        /// <summary>
        /// Gets or Sets Map
        /// </summary>
        [DataMember(Name = "map", EmitDefaultValue = false)]
        public Dictionary<string, Operand> Map { get; set; }

        /// <summary>
        /// Gets or Sets Device
        /// </summary>
        [DataMember(Name = "device", EmitDefaultValue = false)]
        public DeviceOperand Device { get; set; }

        /// <summary>
        /// Gets or Sets Location
        /// </summary>
        [DataMember(Name = "location", EmitDefaultValue = false)]
        public LocationOperand Location { get; set; }

        /// <summary>
        /// Gets or Sets Date
        /// </summary>
        [DataMember(Name = "date", EmitDefaultValue = false)]
        public DateOperand Date { get; set; }

        /// <summary>
        /// Gets or Sets Time
        /// </summary>
        [DataMember(Name = "time", EmitDefaultValue = false)]
        public TimeOperand Time { get; set; }

        /// <summary>
        /// Gets or Sets Datetime
        /// </summary>
        [DataMember(Name = "datetime", EmitDefaultValue = false)]
        public DateTimeOperand Datetime { get; set; }
        ...
        {
            return this.Equals(input as Operand);
        }

        /// <summary>
        /// Returns true if Operand instances are equal
        /// </summary>
        /// <param name="input">Instance of Operand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Operand input)
        {
            if (input == null)
            {
                return false;
