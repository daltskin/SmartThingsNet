...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherSunriseTimeLocal
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_sunriseTimeLocal")]
    public partial class ServiceCapabilityDataWeatherSunriseTimeLocal : IEquatable<ServiceCapabilityDataWeatherSunriseTimeLocal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherSunriseTimeLocal" /> class.
        /// </summary>
        /// <param name="value">This field contains the local time of sunrise. It reflects any local daylight savings conventions in UTC.  ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ .</param>
        public ServiceCapabilityDataWeatherSunriseTimeLocal(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// This field contains the local time of sunrise. It reflects any local daylight savings conventions in UTC.  ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ 
        /// </summary>
        /// <value>This field contains the local time of sunrise. It reflects any local daylight savings conventions in UTC.  ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherSunriseTimeLocal {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherSunriseTimeLocal);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherSunriseTimeLocal instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherSunriseTimeLocal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherSunriseTimeLocal input)
        {
            if (input == null)
            {
                return false;
