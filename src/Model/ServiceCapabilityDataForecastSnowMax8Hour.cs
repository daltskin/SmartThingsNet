...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax8Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax8Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax8Hour : IEquatable<ServiceCapabilityDataForecastSnowMax8Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax8Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 8 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax8Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 8 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 8 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax8Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax8Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax8Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax8Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax8Hour input)
        {
            if (input == null)
            {
                return false;
