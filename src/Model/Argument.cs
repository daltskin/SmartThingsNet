...
namespace SmartThingsNet.Model
{
    ...
    public partial class Argument :  IEquatable<Argument>, IValidatableObject
    {
        ...
        public Argument(string name = default(string), bool optional = false, Object schema = default(Object))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Argument and cannot be null");
            // to ensure "schema" is required (not null)
            this.Schema = schema ?? throw new ArgumentNullException("schema is a required property for Argument and cannot be null");
        ...
        /// </summary>
        /// <value>A name that is unique within the command. Used for i18n and named argument command execution.</value>
        ...
        /// </summary>
        /// <value>Whether or not the argument must be supplied. If the argument is at the end of the arguments array then it can be completely ignored. If the argument is followed by another argument &#x60;null&#x60; must be supplied. </value>
