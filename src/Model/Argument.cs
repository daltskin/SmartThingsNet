...
namespace SmartThingsNet.Model
{
    ...
    public partial class Argument : IEquatable<Argument>, IValidatableObject
    {
        ...
        public Argument(string name = default(string), bool optional = false, Object schema = default(Object))
        {
            ...
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Argument and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for Argument and cannot be null");
            }
            this.Schema = schema;
