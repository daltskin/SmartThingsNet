...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScheduleRequest :  IEquatable<ScheduleRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public ScheduleRequest(OnceSchedule once = default(OnceSchedule), string name = default(string), CronSchedule cron = default(CronSchedule))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ScheduleRequest and cannot be null");
            this.Once = once;
            this.Cron = cron;
        }
        ...
        {
            return this.Equals(input as ScheduleRequest);
        }

        /// <summary>
        /// Returns true if ScheduleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleRequest input)
        {
            if (input == null)
                return false;
