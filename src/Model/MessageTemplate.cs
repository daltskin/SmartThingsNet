...
namespace SmartThingsNet.Model
{
    ...
    public partial class MessageTemplate :  IEquatable<MessageTemplate>, IValidatableObject
    {
        ...
        public MessageTemplate(string localeTag = default(string), string template = default(string))
        {
            // to ensure "localeTag" is required (not null)
            this.LocaleTag = localeTag ?? throw new ArgumentNullException("localeTag is a required property for MessageTemplate and cannot be null");
            // to ensure "template" is required (not null)
            this.Template = template ?? throw new ArgumentNullException("template is a required property for MessageTemplate and cannot be null");
        }
