...
namespace SmartThingsNet.Model
{
    ...
    public partial class MessageTemplate : IEquatable<MessageTemplate>, IValidatableObject
    {
        ...
        public MessageTemplate(string localeTag = default(string), string template = default(string))
        {
            ...
            if (localeTag == null) {
                throw new ArgumentNullException("localeTag is a required property for MessageTemplate and cannot be null");
            }
            this.LocaleTag = localeTag;
            // to ensure "template" is required (not null)
            if (template == null) {
                throw new ArgumentNullException("template is a required property for MessageTemplate and cannot be null");
            }
