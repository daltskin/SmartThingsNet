...
{
    /// <summary>
    /// CapabilityReferenceRequestAllOf
    /// </summary>
    [DataContract(Name = "CapabilityReferenceRequest_allOf")]
    public partial class CapabilityReferenceRequestAllOf : IEquatable<CapabilityReferenceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityReferenceRequestAllOf" /> class.
        /// </summary>
        /// <param name="restrictions">restrictions.</param>
        public CapabilityReferenceRequestAllOf(Restriction restrictions = default(Restriction))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityReferenceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as CapabilityReferenceRequestAllOf);
        }

        /// <summary>
        /// Returns true if CapabilityReferenceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityReferenceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityReferenceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
