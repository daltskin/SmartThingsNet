...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneCapability")]
    public partial class SceneCapability : IEquatable<SceneCapability>, IValidatableObject
    {
        /// <summary>
        /// The status of the capability
        /// </summary>
        /// <value>The status of the capability</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneCapability" /> class.
        /// </summary>
        /// <param name="capabilityId">The id of the capability.</param>
        /// <param name="status">The status of the capability.</param>
        /// <param name="commands">Capability commands.</param>
        public SceneCapability(string capabilityId = default(string), StatusEnum? status = default(StatusEnum?), Dictionary<string, SceneCommand> commands = default(Dictionary<string, SceneCommand>))
        {
        ...
        /// </summary>
        /// <value>The id of the capability</value>
        [DataMember(Name = "capabilityId", EmitDefaultValue = false)]
        public string CapabilityId { get; set; }

        /// <summary>
        /// Capability commands
        /// </summary>
        /// <value>Capability commands</value>
        [DataMember(Name = "commands", EmitDefaultValue = false)]
        public Dictionary<string, SceneCommand> Commands { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneCapability {\n");
        ...
        {
            return this.Equals(input as SceneCapability);
        }

        /// <summary>
        /// Returns true if SceneCapability instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneCapability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneCapability input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    this.CapabilityId.Equals(input.CapabilityId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.CapabilityId.GetHashCode();
                }
