...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdhocMessageTemplate")]
    public partial class AdhocMessageTemplate : IEquatable<AdhocMessageTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocMessageTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdhocMessageTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdhocMessageTemplate" /> class.
        /// </summary>
        /// <param name="localeTag">The tag of the locale as defined in [RFC bcp47](http://www.rfc-editor.org/rfc/bcp/bcp47.txt). (required).</param>
        /// <param name="variables">A map&lt;string,string&gt; with the key representing the variable name, and the value representing the verbiage to be replaced in template string. .</param>
        /// <param name="template">A message template string.  Specify variables using the double curly braces convention. i.e. \&quot;Hello, {{ firstName }}!\&quot;  (required).</param>
        public AdhocMessageTemplate(string localeTag = default(string), Dictionary<string, string> variables = default(Dictionary<string, string>), string template = default(string))
        {
            // to ensure "localeTag" is required (not null)
            if (localeTag == null) {
                throw new ArgumentNullException("localeTag is a required property for AdhocMessageTemplate and cannot be null");
            }
            this.LocaleTag = localeTag;
            // to ensure "template" is required (not null)
            if (template == null) {
                throw new ArgumentNullException("template is a required property for AdhocMessageTemplate and cannot be null");
            }
        ...
        [DataMember(Name = "localeTag", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A map&lt;string,string&gt; with the key representing the variable name, and the value representing the verbiage to be replaced in template string. </value>
        ...
        /// </summary>
        /// <value>A message template string.  Specify variables using the double curly braces convention. i.e. \&quot;Hello, {{ firstName }}!\&quot; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocMessageTemplate {\n");
            sb.Append("  LocaleTag: ").Append(LocaleTag).Append("\n");
        ...
        {
            return this.Equals(input as AdhocMessageTemplate);
        }

        /// <summary>
        /// Returns true if AdhocMessageTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocMessageTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocMessageTemplate input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.LocaleTag == input.LocaleTag ||
                    (this.LocaleTag != null &&
                    this.LocaleTag.Equals(input.LocaleTag))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.LocaleTag != null)
                {
                    hashCode = (hashCode * 59) + this.LocaleTag.GetHashCode();
                }
