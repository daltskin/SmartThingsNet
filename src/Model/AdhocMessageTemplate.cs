...
namespace SmartThingsNet.Model
{
    ...
    public partial class AdhocMessageTemplate :  IEquatable<AdhocMessageTemplate>, IValidatableObject
    {
        ...
        public AdhocMessageTemplate(string localeTag = default(string), Dictionary<string, string> variables = default(Dictionary<string, string>), string template = default(string))
        {
            ...
            this.LocaleTag = localeTag ?? throw new ArgumentNullException("localeTag is a required property for AdhocMessageTemplate and cannot be null");
            // to ensure "template" is required (not null)
            this.Template = template ?? throw new ArgumentNullException("template is a required property for AdhocMessageTemplate and cannot be null");
