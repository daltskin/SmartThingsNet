...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceHealthEvent :  IEquatable<DeviceHealthEvent>, IValidatableObject
    {
        ...
        public DeviceHealthEvent(string eventId = default(string), string locationId = default(string), string deviceId = default(string), string hubId = default(string), StatusEnum? status = default(StatusEnum?), ReasonEnum? reason = default(ReasonEnum?))
        {
