...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceHealthEvent")]
    public partial class DeviceHealthEvent : IEquatable<DeviceHealthEvent>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The reason the device is offline. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ReasonEnum
        {
            ...
            /// <summary>
            /// Enum HUBOFFLINE for value: HUB_OFFLINE
            /// </summary>
            [EnumMember(Value = "HUB_OFFLINE")]
            HUBOFFLINE = 3,
            ...
            /// <summary>
            /// Enum HUBDISCONNECTED for value: HUB_DISCONNECTED
            /// </summary>
        ...
        public DeviceEventSource? EventSource { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// ID for what owns the device health event. Works in tandem with &#x60;ownerType&#x60; as a composite identifier.
        /// </summary>
        /// <value>ID for what owns the device health event. Works in tandem with &#x60;ownerType&#x60; as a composite identifier.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceHealthEvent {\n");
        ...
        {
            return this.Equals(input as DeviceHealthEvent);
        }

        /// <summary>
        /// Returns true if DeviceHealthEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceHealthEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceHealthEvent input)
        {
            if (input == null)
            {
                return false;
