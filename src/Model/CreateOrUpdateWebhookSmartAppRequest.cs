...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrUpdateWebhookSmartAppRequest")]
    public partial class CreateOrUpdateWebhookSmartAppRequest : IEquatable<CreateOrUpdateWebhookSmartAppRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateWebhookSmartAppRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOrUpdateWebhookSmartAppRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateWebhookSmartAppRequest" /> class.
        /// </summary>
        /// <param name="targetUrl">A URL that should be invoked during execution. (required).</param>
        public CreateOrUpdateWebhookSmartAppRequest(string targetUrl = default(string))
        {
            // to ensure "targetUrl" is required (not null)
            if (targetUrl == null) {
                throw new ArgumentNullException("targetUrl is a required property for CreateOrUpdateWebhookSmartAppRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateOrUpdateWebhookSmartAppRequest {\n");
        ...
        {
            return this.Equals(input as CreateOrUpdateWebhookSmartAppRequest);
        }

        /// <summary>
        /// Returns true if CreateOrUpdateWebhookSmartAppRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrUpdateWebhookSmartAppRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrUpdateWebhookSmartAppRequest input)
        {
            if (input == null)
            {
                return false;
