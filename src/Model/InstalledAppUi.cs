...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstalledApp_ui")]
    public partial class InstalledAppUi : IEquatable<InstalledAppUi>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledAppUi" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstalledAppUi() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledAppUi" /> class.
        /// </summary>
        /// <param name="pluginId">pluginId.</param>
        /// <param name="pluginUri">pluginUri.</param>
        /// <param name="dashboardCardsEnabled">dashboardCardsEnabled (required).</param>
        /// <param name="preInstallDashboardCardsEnabled">preInstallDashboardCardsEnabled (required).</param>
        public InstalledAppUi(string pluginId = default(string), string pluginUri = default(string), bool dashboardCardsEnabled = default(bool), bool preInstallDashboardCardsEnabled = default(bool))
        {
        ...
        /// <summary>
        /// Gets or Sets PluginUri
        /// </summary>
        [DataMember(Name = "pluginUri", EmitDefaultValue = false)]
        public string PluginUri { get; set; }

        /// <summary>
        /// Gets or Sets DashboardCardsEnabled
        /// </summary>
        [DataMember(Name = "dashboardCardsEnabled", IsRequired = true, EmitDefaultValue = true)]
        public bool DashboardCardsEnabled { get; set; }

        /// <summary>
        /// Gets or Sets PreInstallDashboardCardsEnabled
        /// </summary>
        [DataMember(Name = "preInstallDashboardCardsEnabled", IsRequired = true, EmitDefaultValue = true)]
        public bool PreInstallDashboardCardsEnabled { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstalledAppUi {\n");
            sb.Append("  PluginId: ").Append(PluginId).Append("\n");
            sb.Append("  PluginUri: ").Append(PluginUri).Append("\n");
            sb.Append("  DashboardCardsEnabled: ").Append(DashboardCardsEnabled).Append("\n");
            sb.Append("  PreInstallDashboardCardsEnabled: ").Append(PreInstallDashboardCardsEnabled).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InstalledAppUi);
        }

        /// <summary>
        /// Returns true if InstalledAppUi instances are equal
        /// </summary>
        /// <param name="input">Instance of InstalledAppUi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstalledAppUi input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.PluginUri != null &&
                    this.PluginUri.Equals(input.PluginUri))
                ) && 
                (
                    this.DashboardCardsEnabled == input.DashboardCardsEnabled ||
                    this.DashboardCardsEnabled.Equals(input.DashboardCardsEnabled)
                ) && 
                (
                    this.PreInstallDashboardCardsEnabled == input.PreInstallDashboardCardsEnabled ||
                    this.PreInstallDashboardCardsEnabled.Equals(input.PreInstallDashboardCardsEnabled)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PluginUri.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.DashboardCardsEnabled.GetHashCode();
                hashCode = (hashCode * 59) + this.PreInstallDashboardCardsEnabled.GetHashCode();
                return hashCode;
            }
        }
