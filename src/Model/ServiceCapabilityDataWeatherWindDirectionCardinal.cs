...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherWindDirectionCardinal
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_windDirectionCardinal")]
    public partial class ServiceCapabilityDataWeatherWindDirectionCardinal : IEquatable<ServiceCapabilityDataWeatherWindDirectionCardinal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherWindDirectionCardinal" /> class.
        /// </summary>
        /// <param name="value">(This attribute is not available in Korea and Japan) This field contains the cardinal direction from which the wind blows in an abbreviated form.  Range - N, NNE, NE, ENE, E, ESE, SE, SSE, S, SSW, SW, WSW, W, WNW, NW, NNW, CALM .</param>
        public ServiceCapabilityDataWeatherWindDirectionCardinal(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is not available in Korea and Japan) This field contains the cardinal direction from which the wind blows in an abbreviated form.  Range - N, NNE, NE, ENE, E, ESE, SE, SSE, S, SSW, SW, WSW, W, WNW, NW, NNW, CALM 
        /// </summary>
        /// <value>(This attribute is not available in Korea and Japan) This field contains the cardinal direction from which the wind blows in an abbreviated form.  Range - N, NNE, NE, ENE, E, ESE, SE, SSE, S, SSW, SW, WSW, W, WNW, NW, NNW, CALM </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherWindDirectionCardinal {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherWindDirectionCardinal);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherWindDirectionCardinal instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherWindDirectionCardinal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherWindDirectionCardinal input)
        {
            if (input == null)
            {
                return false;
