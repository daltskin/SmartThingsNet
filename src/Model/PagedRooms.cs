...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedRooms")]
    public partial class PagedRooms : IEquatable<PagedRooms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRooms" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedRooms() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRooms" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="links">links.</param>
        public PagedRooms(List<Room> items = default(List<Room>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        {
            return this.Equals(input as PagedRooms);
        }

        /// <summary>
        /// Returns true if PagedRooms instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedRooms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedRooms input)
        {
            if (input == null)
            {
                return false;
