...
namespace SmartThingsNet.Model
{
    ...
    public partial class SwitchStateState :  IEquatable<SwitchStateState>, IValidatableObject
    {
        ...
        public SwitchStateState(string value = default(string), string on = default(string), string off = default(string), string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for SwitchStateState and cannot be null");
            // to ensure "on" is required (not null)
            this.On = on ?? throw new ArgumentNullException("on is a required property for SwitchStateState and cannot be null");
            // to ensure "off" is required (not null)
            this.Off = off ?? throw new ArgumentNullException("off is a required property for SwitchStateState and cannot be null");
            this.Label = label;
