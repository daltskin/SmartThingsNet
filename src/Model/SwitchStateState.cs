...
{
    /// <summary>
    /// To describe \&quot;on\&quot; and \&quot;off\&quot; state of a switch
    /// </summary>
    [DataContract(Name = "switchState_state")]
    public partial class SwitchStateState : IEquatable<SwitchStateState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchStateState" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwitchStateState() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchStateState" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="valueType">The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability..</param>
        /// <param name="on">The attribute value that corresponds to the &#x60;on&#x60; state. (required).</param>
        /// <param name="off">The attribute value that corresponds to the &#x60;off&#x60; state. (required).</param>
        /// <param name="label">This displays a string. This can be a formatted string with variables. Example: &#x60;{{attribute.value}} {{attribute.unit}}&#x60; (where &#x60;attribute&#x60; is the name of an attribute in your capability) .</param>
        ...
        public SwitchStateState(string value = default(string), string valueType = default(string), string on = default(string), string off = default(string), string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for SwitchStateState and cannot be null");
            }
            this.Value = value;
            // to ensure "on" is required (not null)
            if (on == null) {
                throw new ArgumentNullException("on is a required property for SwitchStateState and cannot be null");
            }
            this.On = on;
            // to ensure "off" is required (not null)
            if (off == null) {
                throw new ArgumentNullException("off is a required property for SwitchStateState and cannot be null");
            }
            this.Off = off;
        ...
        /// </summary>
        /// <value>The attribute value that corresponds to the &#x60;on&#x60; state.</value>
        [DataMember(Name = "on", IsRequired = true, EmitDefaultValue = false)]
        public string On { get; set; }

        /// <summary>
        /// The attribute value that corresponds to the &#x60;off&#x60; state.
        /// </summary>
        /// <value>The attribute value that corresponds to the &#x60;off&#x60; state.</value>
        [DataMember(Name = "off", IsRequired = true, EmitDefaultValue = false)]
        public string Off { get; set; }

        /// <summary>
        /// This displays a string. This can be a formatted string with variables. Example: &#x60;{{attribute.value}} {{attribute.unit}}&#x60; (where &#x60;attribute&#x60; is the name of an attribute in your capability) 
        /// </summary>
        /// <value>This displays a string. This can be a formatted string with variables. Example: &#x60;{{attribute.value}} {{attribute.unit}}&#x60; (where &#x60;attribute&#x60; is the name of an attribute in your capability) </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwitchStateState {\n");
        ...
        {
            return this.Equals(input as SwitchStateState);
        }

        /// <summary>
        /// Returns true if SwitchStateState instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchStateState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchStateState input)
        {
            if (input == null)
            {
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Off != null)
                {
                    hashCode = (hashCode * 59) + this.Off.GetHashCode();
                }
                if (this.Label != null)
                {
