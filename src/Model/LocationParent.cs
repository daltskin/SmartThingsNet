...
{
    /// <summary>
    /// The parent of a Location
    /// </summary>
    [DataContract(Name = "LocationParent")]
    public partial class LocationParent : IEquatable<LocationParent>, IValidatableObject
    {
        ...
        public LocationParentTypes? Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationParent" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="id">The ID of the parent.</param>
        public LocationParent(LocationParentTypes? type = default(LocationParentTypes?), string id = default(string))
        {
            this.Type = type;
            this.Id = id;
        }
        ...
        /// </summary>
        /// <value>The ID of the parent</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocationParent {\n");
        ...
        {
            return this.Equals(input as LocationParent);
        }

        /// <summary>
        /// Returns true if LocationParent instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationParent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationParent input)
        {
            if (input == null)
            {
                return false;
