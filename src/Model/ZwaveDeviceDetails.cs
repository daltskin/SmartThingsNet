...
{
    /// <summary>
    /// Device Profile information for Z-Wave devices. This field will be empty if device type is not ZWAVE.
    /// </summary>
    [DataContract(Name = "ZwaveDeviceDetails")]
    public partial class ZwaveDeviceDetails : IEquatable<ZwaveDeviceDetails>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZwaveDeviceDetails" /> class.
        /// </summary>
        /// <param name="networkId">The network-specific identifier of the device on the network.</param>
        /// <param name="driverId">The ID of the Sprocket driver.</param>
        ...
        public ZwaveDeviceDetails(string networkId = default(string), string driverId = default(string), bool executingLocally = default(bool), string hubId = default(string), DeviceNetworkSecurityLevel? networkSecurityLevel = default(DeviceNetworkSecurityLevel?), ProvisioningState? provisioningState = default(ProvisioningState?))
        {
        ...
        /// </summary>
        /// <value>The network-specific identifier of the device on the network</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZwaveDeviceDetails {\n");
        ...
        {
            return this.Equals(input as ZwaveDeviceDetails);
        }

        /// <summary>
        /// Returns true if ZwaveDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ZwaveDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZwaveDeviceDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProvisioningState == input.ProvisioningState ||
                    this.ProvisioningState.Equals(input.ProvisioningState)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ProvisioningState.GetHashCode();
                return hashCode;
            }
        }
