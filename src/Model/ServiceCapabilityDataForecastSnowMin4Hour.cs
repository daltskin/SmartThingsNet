...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin4Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin4Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin4Hour : IEquatable<ServiceCapabilityDataForecastSnowMin4Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin4Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 4 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin4Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 4 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 4 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin4Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin4Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin4Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin4Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin4Hour input)
        {
            if (input == null)
            {
                return false;
