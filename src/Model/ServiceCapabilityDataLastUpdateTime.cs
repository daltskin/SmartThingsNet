...
{
    /// <summary>
    /// ServiceCapabilityDataLastUpdateTime
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_lastUpdateTime")]
    public partial class ServiceCapabilityDataLastUpdateTime : IEquatable<ServiceCapabilityDataLastUpdateTime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataLastUpdateTime" /> class.
        /// </summary>
        /// <param name="value">Time the data was pull from content provider. ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ .</param>
        public ServiceCapabilityDataLastUpdateTime(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// Time the data was pull from content provider. ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ 
        /// </summary>
        /// <value>Time the data was pull from content provider. ISO 8601 in UTC - YYYY-MM-DDTHH:MM:SS.SSSZ </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataLastUpdateTime {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataLastUpdateTime);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataLastUpdateTime instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataLastUpdateTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataLastUpdateTime input)
        {
            if (input == null)
            {
                return false;
