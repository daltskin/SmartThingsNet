...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceEventsRequest
    /// </summary>
    [DataContract(Name = "DeviceEventsRequest")]
    public partial class DeviceEventsRequest : IEquatable<DeviceEventsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceEventsRequest" /> class.
        /// </summary>
        /// <param name="deviceEvents">An array of attribute state updates..</param>
        public DeviceEventsRequest(List<DeviceStateEvent> deviceEvents = default(List<DeviceStateEvent>))
        {
        ...
        /// </summary>
        /// <value>An array of attribute state updates.</value>
        [DataMember(Name = "deviceEvents", EmitDefaultValue = false)]
        public List<DeviceStateEvent> DeviceEvents { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceEventsRequest {\n");
        ...
        {
            return this.Equals(input as DeviceEventsRequest);
        }

        /// <summary>
        /// Returns true if DeviceEventsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceEventsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceEventsRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.DeviceEvents == input.DeviceEvents ||
                    this.DeviceEvents != null &&
                    input.DeviceEvents != null &&
                    this.DeviceEvents.SequenceEqual(input.DeviceEvents)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DeviceEvents.GetHashCode();
                }
                return hashCode;
            }
        }
