...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precipMax1Hour")]
    public partial class ServiceCapabilityDataForecastPrecipMax1Hour : IEquatable<ServiceCapabilityDataForecastPrecipMax1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecipMax1Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) maximium 1 hour forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecipMax1Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) maximium 1 hour forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) maximium 1 hour forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecipMax1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecipMax1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecipMax1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecipMax1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecipMax1Hour input)
        {
            if (input == null)
            {
                return false;
