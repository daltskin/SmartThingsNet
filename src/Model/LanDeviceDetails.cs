...
{
    /// <summary>
    /// Device Profile information for Lan devices. This field will be empty if device type is not LAN.
    /// </summary>
    [DataContract(Name = "LanDeviceDetails")]
    public partial class LanDeviceDetails : IEquatable<LanDeviceDetails>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LanDeviceDetails" /> class.
        /// </summary>
        ...
        public LanDeviceDetails(string networkId = default(string), string driverId = default(string), bool executingLocally = default(bool), string hubId = default(string), ProvisioningState? provisioningState = default(ProvisioningState?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanDeviceDetails {\n");
        ...
        {
            return this.Equals(input as LanDeviceDetails);
        }

        /// <summary>
        /// Returns true if LanDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of LanDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanDeviceDetails input)
        {
            if (input == null)
            {
                return false;
