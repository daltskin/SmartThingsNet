...
{
    /// <summary>
    /// The capability presentation describes how the capability will look in the app, what actions and states are shown, as well as how conditions and actions are expressed in an automation.
    /// </summary>
    [DataContract(Name = "capabilityPresentationForPUT")]
    public partial class CapabilityPresentationForPUT : IEquatable<CapabilityPresentationForPUT>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityPresentationForPUT" /> class.
        /// </summary>
        /// <param name="dashboard">dashboard.</param>
        /// <param name="detailView">detailView.</param>
        /// <param name="automation">automation.</param>
        public CapabilityPresentationForPUT(DashboardForCapability dashboard = default(DashboardForCapability), List<Object> detailView = default(List<Object>), AutomationForCapability automation = default(AutomationForCapability))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityPresentationForPUT {\n");
        ...
        {
            return this.Equals(input as CapabilityPresentationForPUT);
        }

        /// <summary>
        /// Returns true if CapabilityPresentationForPUT instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityPresentationForPUT to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityPresentationForPUT input)
        {
            if (input == null)
            {
                return false;
