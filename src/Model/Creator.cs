...
{
    /// <summary>
    /// The creator name who create the behavior
    /// </summary>
    /// <value>The creator name who create the behavior</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum Creator
    {
        /// <summary>
        /// Enum SMARTTHINGS for value: SMARTTHINGS
        /// </summary>
        [EnumMember(Value = "SMARTTHINGS")]
        SMARTTHINGS = 1,

        /// <summary>
        /// Enum ARB for value: ARB
        /// </summary>
