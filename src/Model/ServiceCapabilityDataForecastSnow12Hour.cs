...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow12Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow12Hour")]
    public partial class ServiceCapabilityDataForecastSnow12Hour : IEquatable<ServiceCapabilityDataForecastSnow12Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow12Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 12 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow12Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 12 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 12 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow12Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow12Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow12Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow12Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow12Hour input)
        {
            if (input == null)
            {
                return false;
