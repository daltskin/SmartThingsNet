...
namespace SmartThingsNet.Model
{
    ...
    public partial class SliderForAutomationCondition :  IEquatable<SliderForAutomationCondition>, IValidatableObject
    {
        ...
        public SliderForAutomationCondition(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string value = default(string))
        {
            // to ensure "range" is required (not null)
            this.Range = range ?? throw new ArgumentNullException("range is a required property for SliderForAutomationCondition and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for SliderForAutomationCondition and cannot be null");
            this.Step = step;
            this.Unit = unit;
        }
