...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sliderForAutomationCondition")]
    public partial class SliderForAutomationCondition : IEquatable<SliderForAutomationCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SliderForAutomationCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationCondition" /> class.
        /// </summary>
        ...
        public SliderForAutomationCondition(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string value = default(string), string valueType = default(string))
        {
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for SliderForAutomationCondition and cannot be null");
            }
            this.Range = range;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for SliderForAutomationCondition and cannot be null");
            }
            this.Value = value;
            this.Step = step;
            this.Unit = unit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderForAutomationCondition {\n");
        ...
        {
            return this.Equals(input as SliderForAutomationCondition);
        }

        /// <summary>
        /// Returns true if SliderForAutomationCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderForAutomationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderForAutomationCondition input)
        {
            if (input == null)
            {
                return false;
