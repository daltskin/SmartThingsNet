...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityVersion
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_version")]
    public partial class ServiceCapabilityDataAirQualityVersion : IEquatable<ServiceCapabilityDataAirQualityVersion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityVersion" /> class.
        /// </summary>
        /// <param name="value">API version number used with the given vendor.</param>
        public ServiceCapabilityDataAirQualityVersion(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// API version number used with the given vendor
        /// </summary>
        /// <value>API version number used with the given vendor</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityVersion {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityVersion);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityVersion instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityVersion input)
        {
            if (input == null)
            {
                return false;
