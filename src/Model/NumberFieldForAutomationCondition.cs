...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "numberFieldForAutomationCondition")]
    public partial class NumberFieldForAutomationCondition : IEquatable<NumberFieldForAutomationCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberFieldForAutomationCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumberFieldForAutomationCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberFieldForAutomationCondition" /> class.
        /// </summary>
        ...
        public NumberFieldForAutomationCondition(string value = default(string), string valueType = default(string), string unit = default(string), List<double> range = default(List<double>))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for NumberFieldForAutomationCondition and cannot be null");
            }
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberFieldForAutomationCondition {\n");
        ...
        {
            return this.Equals(input as NumberFieldForAutomationCondition);
        }

        /// <summary>
        /// Returns true if NumberFieldForAutomationCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberFieldForAutomationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberFieldForAutomationCondition input)
        {
            if (input == null)
            {
                return false;
