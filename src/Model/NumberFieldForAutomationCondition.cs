...
namespace SmartThingsNet.Model
{
    ...
    public partial class NumberFieldForAutomationCondition :  IEquatable<NumberFieldForAutomationCondition>, IValidatableObject
    {
        ...
        public NumberFieldForAutomationCondition(string value = default(string), string unit = default(string), List<double> range = default(List<double>))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for NumberFieldForAutomationCondition and cannot be null");
            this.Unit = unit;
            this.Range = range;
        }
