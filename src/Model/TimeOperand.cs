...
{
    /// <summary>
    /// TimeOperand is restricted to returning a value between 0 and 86399 seconds. This means that adding an offset that potentially drives the integer value outside the range of [0..86399] will cause an adjustment to bring the value back in that range
    /// </summary>
    [DataContract(Name = "TimeOperand")]
    public partial class TimeOperand : IEquatable<TimeOperand>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TimeOperand);
        }

        /// <summary>
        /// Returns true if TimeOperand instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeOperand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeOperand input)
        {
            if (input == null)
            {
                return false;
