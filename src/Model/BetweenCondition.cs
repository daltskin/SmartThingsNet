...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BetweenCondition :  IEquatable<BetweenCondition>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetweenCondition" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="BetweenCondition" /> class.
        /// </summary>
        /// <param name="id">Unique id for the condition.</param>
        /// <param name="value">value (required).</param>
        /// <param name="start">start (required).</param>
        /// <param name="end">end (required).</param>
        /// <param name="aggregation">aggregation.</param>
        public BetweenCondition(string id = default(string), Operand value = default(Operand), Operand start = default(Operand), Operand end = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for BetweenCondition and cannot be null");
            // to ensure "start" is required (not null)
            this.Start = start ?? throw new ArgumentNullException("start is a required property for BetweenCondition and cannot be null");
            // to ensure "end" is required (not null)
            this.End = end ?? throw new ArgumentNullException("end is a required property for BetweenCondition and cannot be null");
            this.Id = id;
        ...
        public Operand Start { get; set; }

        /// <summary>
        /// Gets or Sets End
        /// </summary>
        [DataMember(Name="end", EmitDefaultValue=false)]
        public Operand End { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BetweenCondition {\n");
        ...
        {
            return this.Equals(input as BetweenCondition);
        }

        /// <summary>
        /// Returns true if BetweenCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of BetweenCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BetweenCondition input)
        {
            if (input == null)
                return false;
