...
namespace SmartThingsNet.Model
{
    ...
    /// BetweenCondition
    /// </summary>
    [DataContract(Name = "BetweenCondition")]
    public partial class BetweenCondition : IEquatable<BetweenCondition>, IValidatableObject
    {
        ...
        public BetweenCondition(Operand value = default(Operand), Operand start = default(Operand), Operand end = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for BetweenCondition and cannot be null");
            }
            this.Value = value;
            // to ensure "start" is required (not null)
            if (start == null) {
                throw new ArgumentNullException("start is a required property for BetweenCondition and cannot be null");
            }
            this.Start = start;
            // to ensure "end" is required (not null)
            if (end == null) {
                throw new ArgumentNullException("end is a required property for BetweenCondition and cannot be null");
            }
            this.End = end;
