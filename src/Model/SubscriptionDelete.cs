...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscriptionDelete")]
    public partial class SubscriptionDelete : IEquatable<SubscriptionDelete>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionDelete" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        public SubscriptionDelete(int count = default(int))
        {
            this.Count = count;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscriptionDelete {\n");
        ...
        {
            return this.Equals(input as SubscriptionDelete);
        }

        /// <summary>
        /// Returns true if SubscriptionDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionDelete input)
        {
            if (input == null)
            {
                return false;
