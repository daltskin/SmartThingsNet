...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateAppSettingsRequest")]
    public partial class UpdateAppSettingsRequest : IEquatable<UpdateAppSettingsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAppSettingsRequest" /> class.
        /// </summary>
        /// <param name="settings">settings.</param>
        public UpdateAppSettingsRequest(Dictionary<string, string> settings = default(Dictionary<string, string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAppSettingsRequest {\n");
        ...
        {
            return this.Equals(input as UpdateAppSettingsRequest);
        }

        /// <summary>
        /// Returns true if UpdateAppSettingsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAppSettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAppSettingsRequest input)
        {
            if (input == null)
            {
                return false;
