...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstalledAppLifecycleEvent")]
    public partial class InstalledAppLifecycleEvent : IEquatable<InstalledAppLifecycleEvent>, IValidatableObject
    {
        ...
        public InstalledAppLifecycle? Lifecycle { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledAppLifecycleEvent" /> class.
        /// </summary>
        ...
        /// <param name="create">Create installed app lifecycle. .</param>
        /// <param name="install">Install installed app lifecycle. .</param>
        /// <param name="update">Update installed app lifecycle. .</param>
        /// <param name="delete">Delete installed app lifecycle. .</param>
        /// <param name="other">Other installed app lifecycle. .</param>
        /// <param name="error">error.</param>
        public InstalledAppLifecycleEvent(string eventId = default(string), string locationId = default(string), string installedAppId = default(string), string appId = default(string), InstalledAppLifecycle? lifecycle = default(InstalledAppLifecycle?), Object create = default(Object), Object install = default(Object), Object update = default(Object), Object delete = default(Object), Object other = default(Object), InstalledAppLifecycleError error = default(InstalledAppLifecycleError))
        {
        ...
        /// </summary>
        /// <value>Create installed app lifecycle. </value>
        ...
        /// </summary>
        /// <value>Install installed app lifecycle. </value>
        ...
        /// </summary>
        /// <value>Update installed app lifecycle. </value>
        ...
        /// </summary>
        /// <value>Delete installed app lifecycle. </value>
        ...
        /// </summary>
        /// <value>Other installed app lifecycle. </value>
        ...
        public InstalledAppLifecycleError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstalledAppLifecycleEvent {\n");
        ...
        {
            return this.Equals(input as InstalledAppLifecycleEvent);
        }

        /// <summary>
        /// Returns true if InstalledAppLifecycleEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of InstalledAppLifecycleEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstalledAppLifecycleEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Install == input.Install ||
                    (this.Install != null &&
                    this.Install.Equals(input.Install))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Install.GetHashCode();
                }
                if (this.Update != null)
                {
