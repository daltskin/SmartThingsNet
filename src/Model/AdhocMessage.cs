...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdhocMessage :  IEquatable<AdhocMessage>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="AdhocMessage" /> class.
        /// </summary>
        /// <param name="fallbackLocale">The tag of the locale as defined in [RFC bcp47](http://www.rfc-editor.org/rfc/bcp/bcp47.txt). (required).</param>
        /// <param name="defaultVariables">A map&lt;string,string&gt; with the key representing the variable name, and the value representing the verbiage to be replaced in template string. &#x60;defaultVariables&#x60; will only be used if there are no matching locale-level (template) variables for that key. .</param>
        /// <param name="templates">A list of templates representing the same message in different languages. (required).</param>
        public AdhocMessage(string fallbackLocale = default(string), Dictionary<string, string> defaultVariables = default(Dictionary<string, string>), List<AdhocMessageTemplate> templates = default(List<AdhocMessageTemplate>))
        {
            // to ensure "fallbackLocale" is required (not null)
            this.FallbackLocale = fallbackLocale ?? throw new ArgumentNullException("fallbackLocale is a required property for AdhocMessage and cannot be null");
            // to ensure "templates" is required (not null)
            this.Templates = templates ?? throw new ArgumentNullException("templates is a required property for AdhocMessage and cannot be null");
        ...
        /// </summary>
        /// <value>The tag of the locale as defined in [RFC bcp47](http://www.rfc-editor.org/rfc/bcp/bcp47.txt).</value>
        [DataMember(Name="fallbackLocale", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>A map&lt;string,string&gt; with the key representing the variable name, and the value representing the verbiage to be replaced in template string. &#x60;defaultVariables&#x60; will only be used if there are no matching locale-level (template) variables for that key. </value>
        ...
        /// </summary>
        /// <value>A list of templates representing the same message in different languages.</value>
        [DataMember(Name="templates", EmitDefaultValue=false)]
        public List<AdhocMessageTemplate> Templates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdhocMessage {\n");
            sb.Append("  FallbackLocale: ").Append(FallbackLocale).Append("\n");
        ...
        {
            return this.Equals(input as AdhocMessage);
        }

        /// <summary>
        /// Returns true if AdhocMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of AdhocMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdhocMessage input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.FallbackLocale.Equals(input.FallbackLocale))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FallbackLocale != null)
                    hashCode = hashCode * 59 + this.FallbackLocale.GetHashCode();
