...
namespace SmartThingsNet.Model
{
    ...
    /// An array of Rules
    /// </summary>
    [DataContract(Name = "PagedRules")]
    public partial class PagedRules : IEquatable<PagedRules>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRules" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedRules(List<Rule> items = default(List<Rule>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        {
            return this.Equals(input as PagedRules);
        }

        /// <summary>
        /// Returns true if PagedRules instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedRules input)
        {
            if (input == null)
            {
                return false;
