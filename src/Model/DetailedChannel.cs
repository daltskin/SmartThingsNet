...
namespace SmartThingsNet.Model
{
    ...
    /// DetailedChannel
    /// </summary>
    [DataContract(Name = "DetailedChannel")]
    public partial class DetailedChannel : IEquatable<DetailedChannel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailedChannel" /> class.
        /// </summary>
        /// <param name="channelId">The identifier of the Sprocket channel.</param>
        /// <param name="name">Name of the channel.</param>
        /// <param name="description">Description of the channel.</param>
        /// <param name="type">type.</param>
        /// <param name="termsOfServiceUrl">URL for a developer-provided Terms of Service agreement for the channel.</param>
        /// <param name="createdDate">The ISO-8601 formatted timestamp when the channel was created.</param>
        /// <param name="lastModifiedDate">The ISO-8601 formatted timestamp when the channel was last modified.</param>
        public DetailedChannel(Guid channelId = default(Guid), string name = default(string), string description = default(string), ChannelType? type = default(ChannelType?), string termsOfServiceUrl = default(string), string createdDate = default(string), string lastModifiedDate = default(string))
        {
        ...
        /// <summary>
        /// The identifier of the Sprocket channel
        /// </summary>
        /// <value>The identifier of the Sprocket channel</value>
        ...
        /// </summary>
        /// <value>Description of the channel</value>
        [DataMember(Name = "description", EmitDefaultValue = false)]
        public string Description { get; set; }

        /// <summary>
        /// URL for a developer-provided Terms of Service agreement for the channel
        /// </summary>
        /// <value>URL for a developer-provided Terms of Service agreement for the channel</value>
        [DataMember(Name = "termsOfServiceUrl", EmitDefaultValue = false)]
        public string TermsOfServiceUrl { get; set; }

        /// <summary>
        /// The ISO-8601 formatted timestamp when the channel was created
        /// </summary>
        /// <value>The ISO-8601 formatted timestamp when the channel was created</value>
        [DataMember(Name = "createdDate", EmitDefaultValue = false)]
        public string CreatedDate { get; set; }

        /// <summary>
        /// The ISO-8601 formatted timestamp when the channel was last modified
        /// </summary>
        /// <value>The ISO-8601 formatted timestamp when the channel was last modified</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailedChannel {\n");
        ...
        {
            return this.Equals(input as DetailedChannel);
        }

        /// <summary>
        /// Returns true if DetailedChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedChannel input)
        {
            if (input == null)
            {
                return false;
