...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip24Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip24Hour")]
    public partial class ServiceCapabilityDataForecastPrecip24Hour : IEquatable<ServiceCapabilityDataForecastPrecip24Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip24Hour" /> class.
        /// </summary>
        /// <param name="value">Rolling twenty-four hour liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip24Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// Rolling twenty-four hour liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>Rolling twenty-four hour liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip24Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip24Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip24Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip24Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip24Hour input)
        {
            if (input == null)
            {
                return false;
