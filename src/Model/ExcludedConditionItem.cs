...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "excludedConditionItem")]
    public partial class ExcludedConditionItem : IEquatable<ExcludedConditionItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedConditionItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItem" /> class.
        /// </summary>
        /// <param name="value">To express that a specific value is selected.</param>
        /// <param name="exclude">exclude (required).</param>
        public ExcludedConditionItem(Object value = default(Object), List<ExcludedConditionItemExclude> exclude = default(List<ExcludedConditionItemExclude>))
        {
            // to ensure "exclude" is required (not null)
            if (exclude == null) {
                throw new ArgumentNullException("exclude is a required property for ExcludedConditionItem and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedConditionItem {\n");
        ...
        {
            return this.Equals(input as ExcludedConditionItem);
        }

        /// <summary>
        /// Returns true if ExcludedConditionItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedConditionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedConditionItem input)
        {
            if (input == null)
            {
                return false;
