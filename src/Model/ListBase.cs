...
namespace SmartThingsNet.Model
{
    ...
    /// ListBase
    /// </summary>
    [DataContract(Name = "listBase")]
    public partial class ListBase : IEquatable<ListBase>, IValidatableObject
    {
        /// <summary>
        ...
        public ListBase(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string))
        {
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for ListBase and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListBase);
        }

        /// <summary>
        /// Returns true if ListBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ListBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListBase input)
        {
            if (input == null)
            {
                return false;
