...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GreaterThanCondition : SimpleCondition,  IEquatable<GreaterThanCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public GreaterThanCondition(string id = default(string), Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?)) : base(id, left, right, aggregation)
        {
        }
