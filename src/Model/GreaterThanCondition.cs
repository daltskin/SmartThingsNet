...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GreaterThanCondition")]
    public partial class GreaterThanCondition : IEquatable<GreaterThanCondition>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GreaterThanCondition" /> class.
        /// </summary>
        ...
        public GreaterThanCondition(Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            if (left == null) {
                throw new ArgumentNullException("left is a required property for GreaterThanCondition and cannot be null");
            }
            this.Left = left;
            // to ensure "right" is required (not null)
            if (right == null) {
                throw new ArgumentNullException("right is a required property for GreaterThanCondition and cannot be null");
            }
            this.Right = right;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GreaterThanCondition {\n");
        ...
        {
            return this.Equals(input as GreaterThanCondition);
        }

        /// <summary>
        /// Returns true if GreaterThanCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of GreaterThanCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GreaterThanCondition input)
        {
            if (input == null)
            {
                return false;
