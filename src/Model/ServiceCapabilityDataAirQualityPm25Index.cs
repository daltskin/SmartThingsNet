...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityPm25Index
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_pm25Index")]
    public partial class ServiceCapabilityDataAirQualityPm25Index : IEquatable<ServiceCapabilityDataAirQualityPm25Index>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityPm25Index" /> class.
        /// </summary>
        /// <param name="value">index of particulate matter less than 2.5 microns.</param>
        /// <param name="unit">EPA.</param>
        public ServiceCapabilityDataAirQualityPm25Index(int value = default(int), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// index of particulate matter less than 2.5 microns
        /// </summary>
        /// <value>index of particulate matter less than 2.5 microns</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityPm25Index {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityPm25Index);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityPm25Index instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityPm25Index to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityPm25Index input)
        {
            if (input == null)
            {
                return false;
