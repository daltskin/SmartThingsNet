...
{
    /// <summary>
    /// ExcludedDeviceActionConfigEntry
    /// </summary>
    [DataContract(Name = "excludedDeviceActionConfigEntry")]
    public partial class ExcludedDeviceActionConfigEntry : IEquatable<ExcludedDeviceActionConfigEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedDeviceActionConfigEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedDeviceActionConfigEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedDeviceActionConfigEntry" /> class.
        /// </summary>
        ...
        public List<ExcludedActionItemId> Exclusion { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedDeviceActionConfigEntry {\n");
        ...
        {
            return this.Equals(input as ExcludedDeviceActionConfigEntry);
        }

        /// <summary>
        /// Returns true if ExcludedDeviceActionConfigEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedDeviceActionConfigEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedDeviceActionConfigEntry input)
        {
            if (input == null)
            {
                return false;
