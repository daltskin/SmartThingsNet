...
namespace SmartThingsNet.Model
{
    ...
    /// ConvertedTTS
    /// </summary>
    [DataContract(Name = "ConvertedTTS")]
    public partial class ConvertedTTS : IEquatable<ConvertedTTS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertedTTS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConvertedTTS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertedTTS" /> class.
        /// </summary>
        /// <param name="message">message to indicate success (required).</param>
        /// <param name="audioURL">Audio URL (required).</param>
        public ConvertedTTS(string message = default(string), string audioURL = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for ConvertedTTS and cannot be null");
            }
            this.Message = message;
            // to ensure "audioURL" is required (not null)
            if (audioURL == null) {
                throw new ArgumentNullException("audioURL is a required property for ConvertedTTS and cannot be null");
            }
        ...
        /// </summary>
        /// <value>message to indicate success</value>
        ...
        [DataMember(Name = "audioURL", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as ConvertedTTS);
        }

        /// <summary>
        /// Returns true if ConvertedTTS instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertedTTS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertedTTS input)
        {
            if (input == null)
            {
                return false;
