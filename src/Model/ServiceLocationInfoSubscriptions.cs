...
{
    /// <summary>
    /// Array of Nimbus subscription for this location ID
    /// </summary>
    [DataContract(Name = "ServiceLocationInfo_subscriptions")]
    public partial class ServiceLocationInfoSubscriptions : IEquatable<ServiceLocationInfoSubscriptions>, IValidatableObject
    {
        /// <summary>
        /// Defines SubscribedCapabilities
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SubscribedCapabilitiesEnum
        {
            /// <summary>
            ...
            /// <summary>
            /// Enum AirQuality for value: airQuality
            /// </summary>
            ...
            /// <summary>
            /// Enum AirQualityForecast for value: airQualityForecast
            /// </summary>
            [EnumMember(Value = "airQualityForecast")]
            AirQualityForecast = 5
        ...
        /// capability name(s)
        /// </summary>
        /// <value>capability name(s)</value>
        [DataMember(Name = "subscribedCapabilities", IsRequired = true, EmitDefaultValue = false)]
        public List<SubscribedCapabilitiesEnum> SubscribedCapabilities { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceLocationInfoSubscriptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceLocationInfoSubscriptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceLocationInfoSubscriptions" /> class.
        /// </summary>
        /// <param name="subscriptionId">subscription ID (required).</param>
        /// <param name="geoplaceId">Geo Place ID (This ID is only supported in \&quot;alert\&quot; capability) .</param>
        /// <param name="type">DIRECT or EXECUTION delivery, default to DIRECT (required).</param>
        /// <param name="predicate">JEXL expression string.</param>
        /// <param name="subscribedCapabilities">capability name(s) (required).</param>
        public ServiceLocationInfoSubscriptions(string subscriptionId = default(string), string geoplaceId = default(string), string type = default(string), string predicate = default(string), List<SubscribedCapabilitiesEnum> subscribedCapabilities = default(List<SubscribedCapabilitiesEnum>))
        {
            // to ensure "subscriptionId" is required (not null)
            if (subscriptionId == null) {
                throw new ArgumentNullException("subscriptionId is a required property for ServiceLocationInfoSubscriptions and cannot be null");
            }
            this.SubscriptionId = subscriptionId;
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for ServiceLocationInfoSubscriptions and cannot be null");
            }
            this.Type = type;
            // to ensure "subscribedCapabilities" is required (not null)
            if (subscribedCapabilities == null) {
                throw new ArgumentNullException("subscribedCapabilities is a required property for ServiceLocationInfoSubscriptions and cannot be null");
            }
            this.SubscribedCapabilities = subscribedCapabilities;
        ...
        /// <summary>
        /// Geo Place ID (This ID is only supported in \&quot;alert\&quot; capability) 
        /// </summary>
        /// <value>Geo Place ID (This ID is only supported in \&quot;alert\&quot; capability) </value>
        [DataMember(Name = "geoplaceId", EmitDefaultValue = false)]
        public string GeoplaceId { get; set; }

        /// <summary>
        /// DIRECT or EXECUTION delivery, default to DIRECT
        /// </summary>
        /// <value>DIRECT or EXECUTION delivery, default to DIRECT</value>
        ...
        /// </summary>
        /// <value>JEXL expression string</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceLocationInfoSubscriptions {\n");
            sb.Append("  SubscriptionId: ").Append(SubscriptionId).Append("\n");
            sb.Append("  GeoplaceId: ").Append(GeoplaceId).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  Predicate: ").Append(Predicate).Append("\n");
            sb.Append("  SubscribedCapabilities: ").Append(SubscribedCapabilities).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ServiceLocationInfoSubscriptions);
        }

        /// <summary>
        /// Returns true if ServiceLocationInfoSubscriptions instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceLocationInfoSubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceLocationInfoSubscriptions input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GeoplaceId == input.GeoplaceId ||
                    (this.GeoplaceId != null &&
                    this.GeoplaceId.Equals(input.GeoplaceId))
                ) && 
                (
                ...
                (
                    this.SubscribedCapabilities == input.SubscribedCapabilities ||
                    this.SubscribedCapabilities.SequenceEqual(input.SubscribedCapabilities)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GeoplaceId != null)
                {
                    hashCode = (hashCode * 59) + this.GeoplaceId.GetHashCode();
                }
                if (this.Type != null)
                {
                ...
                hashCode = (hashCode * 59) + this.SubscribedCapabilities.GetHashCode();
                return hashCode;
            }
        }
