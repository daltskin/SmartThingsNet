...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityVendor
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_vendor")]
    public partial class ServiceCapabilityDataAirQualityVendor : IEquatable<ServiceCapabilityDataAirQualityVendor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityVendor" /> class.
        /// </summary>
        /// <param name="value">Name of the content provider.</param>
        public ServiceCapabilityDataAirQualityVendor(string value = default(string))
        {
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>Name of the content provider</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityVendor {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityVendor);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityVendor instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityVendor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityVendor input)
        {
            if (input == null)
            {
                return false;
