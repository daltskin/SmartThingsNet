...
{
    /// <summary>
    /// The capability that is common to all devices in the group
    /// </summary>
    [DataContract(Name = "DeviceGroupCapability")]
    public partial class DeviceGroupCapability : IEquatable<DeviceGroupCapability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGroupCapability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceGroupCapability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGroupCapability" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="version">version.</param>
        public DeviceGroupCapability(string id = default(string), int version = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DeviceGroupCapability and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceGroupCapability {\n");
        ...
        {
            return this.Equals(input as DeviceGroupCapability);
        }

        /// <summary>
        /// Returns true if DeviceGroupCapability instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceGroupCapability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceGroupCapability input)
        {
            if (input == null)
            {
                return false;
