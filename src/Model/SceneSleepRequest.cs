...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneSleepRequest")]
    public partial class SceneSleepRequest : IEquatable<SceneSleepRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneSleepRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SceneSleepRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneSleepRequest" /> class.
        /// </summary>
        /// <param name="seconds">Number of seconds to sleep the sequence (required).</param>
        public SceneSleepRequest(int seconds = default(int))
        {
        ...
        /// </summary>
        /// <value>Number of seconds to sleep the sequence</value>
        [DataMember(Name = "seconds", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneSleepRequest {\n");
        ...
        {
            return this.Equals(input as SceneSleepRequest);
        }

        /// <summary>
        /// Returns true if SceneSleepRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneSleepRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneSleepRequest input)
        {
            if (input == null)
            {
                return false;
