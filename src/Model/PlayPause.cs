...
{
    /// <summary>
    /// To specify separate commands for play and pause, use the \&quot;play\&quot; and \&quot;pause\&quot; fields respectively. To specify a single command, use \&quot;name\&quot; for the command and the \&quot;play\&quot; and \&quot;pause\&quot; fields for the arguments.
    /// </summary>
    [DataContract]
    public partial class PlayPause :  IEquatable<PlayPause>, IValidatableObject
    {
        /// <summary>
        ...
        public PlayPause(PlayPauseCommandCommand command = default(PlayPauseCommandCommand), PlayPauseAllOfState state = default(PlayPauseAllOfState))
        {
            ...
            this.Command = command ?? throw new ArgumentNullException("command is a required property for PlayPause and cannot be null");
            this.State = state;
        }
        ...
        public PlayPauseCommandCommand Command { get; set; }

        /// <summary>
        /// Gets or Sets State
        /// </summary>
        [DataMember(Name="state", EmitDefaultValue=false)]
        public PlayPauseAllOfState State { get; set; }
        ...
        {
            return this.Equals(input as PlayPause);
        }

        /// <summary>
        /// Returns true if PlayPause instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayPause to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayPause input)
        {
            if (input == null)
                return false;
