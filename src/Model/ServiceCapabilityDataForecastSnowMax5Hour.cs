...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax5Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax5Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax5Hour : IEquatable<ServiceCapabilityDataForecastSnowMax5Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax5Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 5 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax5Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 5 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 5 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax5Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax5Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax5Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax5Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax5Hour input)
        {
            if (input == null)
            {
                return false;
