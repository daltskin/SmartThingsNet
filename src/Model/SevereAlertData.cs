...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SevereAlertData")]
    public partial class SevereAlertData : IEquatable<SevereAlertData>, IValidatableObject
    {
        /// <summary>
        /// Defines Severity
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum UNKNOWNSEVERITY for value: UNKNOWN_SEVERITY
            /// </summary>
            [EnumMember(Value = "UNKNOWN_SEVERITY")]
            UNKNOWNSEVERITY = 1,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SevereAlertData" /> class.
        /// </summary>
        /// <param name="headlineText">headlineText.</param>
        /// <param name="detailUrl">detailUrl.</param>
        /// <param name="startTime">startTime.</param>
        /// <param name="endTime">endTime.</param>
        /// <param name="severity">severity.</param>
        /// <param name="state">state.</param>
        public SevereAlertData(string headlineText = default(string), string detailUrl = default(string), string startTime = default(string), string endTime = default(string), SeverityEnum? severity = default(SeverityEnum?), StateEnum? state = default(StateEnum?))
        {
        ...
        /// <summary>
        /// Gets or Sets DetailUrl
        /// </summary>
        [DataMember(Name = "detailUrl", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SevereAlertData {\n");
        ...
        {
            return this.Equals(input as SevereAlertData);
        }

        /// <summary>
        /// Returns true if SevereAlertData instances are equal
        /// </summary>
        /// <param name="input">Instance of SevereAlertData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SevereAlertData input)
        {
            if (input == null)
            {
                return false;
