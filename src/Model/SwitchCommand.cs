...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SwitchCommand :  IEquatable<SwitchCommand>, IValidatableObject
    {
        /// <summary>
        ...
        public SwitchCommand(SwitchCommandCommand command = default(SwitchCommandCommand))
        {
            ...
            this.Command = command ?? throw new ArgumentNullException("command is a required property for SwitchCommand and cannot be null");
        }
        ...
        {
            return this.Equals(input as SwitchCommand);
        }

        /// <summary>
        /// Returns true if SwitchCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchCommand input)
        {
            if (input == null)
                return false;
