...
namespace SmartThingsNet.Model
{
    ...
    /// GenerateStOauthBody
    /// </summary>
    [DataContract(Name = "GenerateStOauthBody")]
    public partial class GenerateStOauthBody : IEquatable<GenerateStOauthBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateStOauthBody" /> class.
        /// </summary>
        /// <param name="endpointAppId">SmartThings Schema App id for the partner.</param>
        public GenerateStOauthBody(string endpointAppId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateStOauthBody {\n");
        ...
        {
            return this.Equals(input as GenerateStOauthBody);
        }

        /// <summary>
        /// Returns true if GenerateStOauthBody instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateStOauthBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateStOauthBody input)
        {
            if (input == null)
            {
                return false;
