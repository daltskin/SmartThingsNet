...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateAppOAuthRequest")]
    public partial class GenerateAppOAuthRequest : IEquatable<GenerateAppOAuthRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateAppOAuthRequest" /> class.
        /// </summary>
        /// <param name="clientName">A name given to the OAuth Client..</param>
        /// <param name="scope">A list of SmartThings API OAuth scope identifiers that maybe required to execute your integration..</param>
        public GenerateAppOAuthRequest(string clientName = default(string), List<string> scope = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateAppOAuthRequest {\n");
        ...
        {
            return this.Equals(input as GenerateAppOAuthRequest);
        }

        /// <summary>
        /// Returns true if GenerateAppOAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateAppOAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateAppOAuthRequest input)
        {
            if (input == null)
            {
                return false;
