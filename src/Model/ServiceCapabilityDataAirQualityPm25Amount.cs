...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityPm25Amount
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_pm25Amount")]
    public partial class ServiceCapabilityDataAirQualityPm25Amount : IEquatable<ServiceCapabilityDataAirQualityPm25Amount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityPm25Amount" /> class.
        /// </summary>
        /// <param name="value">amount of particulate matter less than 2.5 microns in ug/m3.</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityPm25Amount(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// amount of particulate matter less than 2.5 microns in ug/m3
        /// </summary>
        /// <value>amount of particulate matter less than 2.5 microns in ug/m3</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityPm25Amount {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityPm25Amount);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityPm25Amount instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityPm25Amount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityPm25Amount input)
        {
            if (input == null)
            {
                return false;
