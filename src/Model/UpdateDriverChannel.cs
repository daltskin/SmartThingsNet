...
namespace SmartThingsNet.Model
{
    ...
    /// UpdateDriverChannel
    /// </summary>
    [DataContract(Name = "UpdateDriverChannel")]
    public partial class UpdateDriverChannel : IEquatable<UpdateDriverChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDriverChannel" /> class.
        /// </summary>
        /// <param name="version">The version of the driver revision being returned.</param>
        public UpdateDriverChannel(string version = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDriverChannel {\n");
        ...
        {
            return this.Equals(input as UpdateDriverChannel);
        }

        /// <summary>
        /// Returns true if UpdateDriverChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDriverChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDriverChannel input)
        {
            if (input == null)
            {
                return false;
