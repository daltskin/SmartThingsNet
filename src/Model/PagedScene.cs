...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedScene :  IEquatable<PagedScene>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedScene" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedScene(List<SceneSummary> items = default(List<SceneSummary>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        {
            return this.Equals(input as PagedScene);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PagedScene input)
        {
            if (input == null)
                return false;
