...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedDevices")]
    public partial class PagedDevices : IEquatable<PagedDevices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDevices" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedDevices(List<Device> items = default(List<Device>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        {
            return this.Equals(input as PagedDevices);
        }

        /// <summary>
        /// Returns true if PagedDevices instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedDevices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedDevices input)
        {
            if (input == null)
            {
                return false;
