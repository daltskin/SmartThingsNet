...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    /// <value>The installed app lifecycle. The lifecycle will be one of: * CREATE - Invoked when an application is created. * INSTALL - Invoked when an application is installed. * UPDATE - Invoked when an application is updated. * DELETE - Invoked when an application is deleted. * OTHER - </value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum InstalledAppLifecycle
    {
        /// <summary>
