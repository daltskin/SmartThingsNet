...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedSchedules")]
    public partial class PagedSchedules : IEquatable<PagedSchedules>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedSchedules" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedSchedules(List<Schedule> items = default(List<Schedule>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedSchedules {\n");
        ...
        {
            return this.Equals(input as PagedSchedules);
        }

        /// <summary>
        /// Returns true if PagedSchedules instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedSchedules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedSchedules input)
        {
            if (input == null)
            {
                return false;
