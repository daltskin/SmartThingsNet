...
namespace SmartThingsNet.Model
{
    ...
    /// PoCodes
    /// </summary>
    [DataContract(Name = "poCodes")]
    public partial class PoCodes : IEquatable<PoCodes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoCodes" /> class.
        /// </summary>
        ...
        /// <param name="po">Po code. Should begin with &#39;___PO_CODE&#39; (required).</param>
        public PoCodes(string label = default(string), string po = default(string))
        {
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for PoCodes and cannot be null");
            }
            this.Label = label;
            // to ensure "po" is required (not null)
            if (po == null) {
                throw new ArgumentNullException("po is a required property for PoCodes and cannot be null");
            }
            this.Po = po;
        }
        ...
        /// </summary>
        /// <value>Po code. Should begin with &#39;___PO_CODE&#39;</value>
        [DataMember(Name = "po", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as PoCodes);
        }

        /// <summary>
        /// Returns true if PoCodes instances are equal
        /// </summary>
        /// <param name="input">Instance of PoCodes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoCodes input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // Po (string) pattern
            Regex regexPo = new Regex(@"^___PO_CODE_[a-zA-Z0-9_]+$", RegexOptions.CultureInvariant);
            if (false == regexPo.Match(this.Po).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Po, must match a pattern of " + regexPo, new [] { "Po" });
            }
