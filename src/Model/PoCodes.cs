...
namespace SmartThingsNet.Model
{
    ...
    public partial class PoCodes :  IEquatable<PoCodes>, IValidatableObject
    {
        ...
        public PoCodes(string label = default(string), string po = default(string))
        {
            ...
            this.Label = label ?? throw new ArgumentNullException("label is a required property for PoCodes and cannot be null");
            // to ensure "po" is required (not null)
            this.Po = po ?? throw new ArgumentNullException("po is a required property for PoCodes and cannot be null");
        }
