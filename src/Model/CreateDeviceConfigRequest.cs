...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateDeviceConfigRequest")]
    public partial class CreateDeviceConfigRequest : IEquatable<CreateDeviceConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDeviceConfigRequest {\n");
        ...
        {
            return this.Equals(input as CreateDeviceConfigRequest);
        }

        /// <summary>
        /// Returns true if CreateDeviceConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDeviceConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDeviceConfigRequest input)
        {
            if (input == null)
            {
                return false;
