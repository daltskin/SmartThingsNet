...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceProfileBase
    /// </summary>
    [DataContract(Name = "DeviceProfileBase")]
    public partial class DeviceProfileBase : IEquatable<DeviceProfileBase>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceProfileBase {\n");
        ...
        {
            return this.Equals(input as DeviceProfileBase);
        }

        /// <summary>
        /// Returns true if DeviceProfileBase instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceProfileBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceProfileBase input)
        {
            if (input == null)
            {
                return false;
