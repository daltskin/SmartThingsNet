...
namespace SmartThingsNet.Model
{
    ...
    /// OcfDeviceDetails
    /// </summary>
    [DataContract(Name = "OcfDeviceDetails")]
    public partial class OcfDeviceDetails : IEquatable<OcfDeviceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OcfDeviceDetails" /> class.
        /// </summary>
        /// <param name="deviceId">ID of the device.</param>
        /// <param name="ocfDeviceType">OCF device type.</param>
        /// <param name="name">Name of the device.</param>
        /// <param name="specVersion">OCF spec version.</param>
        /// <param name="verticalDomainSpecVersion">OCF vertical domain spec version.</param>
        /// <param name="manufacturerName">OCF manufacturer name.</param>
        /// <param name="modelNumber">OCF model number.</param>
        /// <param name="platformVersion">OCF platform version.</param>
        /// <param name="platformOS">OCF platform OS.</param>
        /// <param name="hwVersion">OCF platform H/W version.</param>
        /// <param name="firmwareVersion">OCF firmware version.</param>
        /// <param name="vendorId">OCF vendor ID.</param>
        /// <param name="vendorResourceClientServerVersion">OCF vendor resource client/server version.</param>
        /// <param name="locale">Language code.</param>
        /// <param name="lastSignupTime">The time when the device is signed up lastly.</param>
        public OcfDeviceDetails(string deviceId = default(string), string ocfDeviceType = default(string), string name = default(string), string specVersion = default(string), string verticalDomainSpecVersion = default(string), string manufacturerName = default(string), string modelNumber = default(string), string platformVersion = default(string), string platformOS = default(string), string hwVersion = default(string), string firmwareVersion = default(string), string vendorId = default(string), string vendorResourceClientServerVersion = default(string), string locale = default(string), string lastSignupTime = default(string))
        {
            this.DeviceId = deviceId;
            this.OcfDeviceType = ocfDeviceType;
            this.Name = name;
            this.SpecVersion = specVersion;
            this.VerticalDomainSpecVersion = verticalDomainSpecVersion;
            ...
            this.VendorResourceClientServerVersion = vendorResourceClientServerVersion;
            this.Locale = locale;
        ...
        /// OCF device type
        /// </summary>
        /// <value>OCF device type</value>
        [DataMember(Name = "ocfDeviceType", EmitDefaultValue = false)]
        ...
        /// OCF spec version
        /// </summary>
        /// <value>OCF spec version</value>
        [DataMember(Name = "specVersion", EmitDefaultValue = false)]
        public string SpecVersion { get; set; }

        /// <summary>
        /// OCF vertical domain spec version
        /// </summary>
        /// <value>OCF vertical domain spec version</value>
        [DataMember(Name = "verticalDomainSpecVersion", EmitDefaultValue = false)]
        public string VerticalDomainSpecVersion { get; set; }

        /// <summary>
        /// OCF manufacturer name
        /// </summary>
        /// <value>OCF manufacturer name</value>
        ...
        /// OCF model number
        /// </summary>
        /// <value>OCF model number</value>
        [DataMember(Name = "modelNumber", EmitDefaultValue = false)]
        public string ModelNumber { get; set; }

        /// <summary>
        /// OCF platform version
        /// </summary>
        /// <value>OCF platform version</value>
        ...
        /// OCF platform OS
        /// </summary>
        /// <value>OCF platform OS</value>
        [DataMember(Name = "platformOS", EmitDefaultValue = false)]
        public string PlatformOS { get; set; }

        /// <summary>
        /// OCF platform H/W version
        /// </summary>
        /// <value>OCF platform H/W version</value>
        [DataMember(Name = "hwVersion", EmitDefaultValue = false)]
        public string HwVersion { get; set; }

        /// <summary>
        /// OCF firmware version
        /// </summary>
        /// <value>OCF firmware version</value>
        ...
        /// OCF vendor ID
        /// </summary>
        /// <value>OCF vendor ID</value>
        [DataMember(Name = "vendorId", EmitDefaultValue = false)]
        public string VendorId { get; set; }

        /// <summary>
        /// OCF vendor resource client/server version
        /// </summary>
        /// <value>OCF vendor resource client/server version</value>
        [DataMember(Name = "vendorResourceClientServerVersion", EmitDefaultValue = false)]
        public string VendorResourceClientServerVersion { get; set; }
        ...
        /// <summary>
        /// The time when the device is signed up lastly
        /// </summary>
        /// <value>The time when the device is signed up lastly</value>
        [DataMember(Name = "lastSignupTime", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OcfDeviceDetails {\n");
            sb.Append("  DeviceId: ").Append(DeviceId).Append("\n");
            sb.Append("  OcfDeviceType: ").Append(OcfDeviceType).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  SpecVersion: ").Append(SpecVersion).Append("\n");
            sb.Append("  VerticalDomainSpecVersion: ").Append(VerticalDomainSpecVersion).Append("\n");
            ...
            sb.Append("  PlatformOS: ").Append(PlatformOS).Append("\n");
            sb.Append("  HwVersion: ").Append(HwVersion).Append("\n");
            sb.Append("  FirmwareVersion: ").Append(FirmwareVersion).Append("\n");
            sb.Append("  VendorId: ").Append(VendorId).Append("\n");
            sb.Append("  VendorResourceClientServerVersion: ").Append(VendorResourceClientServerVersion).Append("\n");
            sb.Append("  Locale: ").Append(Locale).Append("\n");
            sb.Append("  LastSignupTime: ").Append(LastSignupTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OcfDeviceDetails);
        }

        /// <summary>
        /// Returns true if OcfDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of OcfDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OcfDeviceDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OcfDeviceType == input.OcfDeviceType ||
                    (this.OcfDeviceType != null &&
                    this.OcfDeviceType.Equals(input.OcfDeviceType))
                ) && 
                (
                ...
                (
                    this.VerticalDomainSpecVersion == input.VerticalDomainSpecVersion ||
                    (this.VerticalDomainSpecVersion != null &&
                    this.VerticalDomainSpecVersion.Equals(input.VerticalDomainSpecVersion))
                ) && 
                (
                ...
                (
                    this.PlatformOS == input.PlatformOS ||
                    (this.PlatformOS != null &&
                    this.PlatformOS.Equals(input.PlatformOS))
                ) && 
                (
                ...
                (
                    this.VendorResourceClientServerVersion == input.VendorResourceClientServerVersion ||
                    (this.VendorResourceClientServerVersion != null &&
                    this.VendorResourceClientServerVersion.Equals(input.VendorResourceClientServerVersion))
                ) && 
                (
                ...
                (
                    this.LastSignupTime == input.LastSignupTime ||
                    (this.LastSignupTime != null &&
                    this.LastSignupTime.Equals(input.LastSignupTime))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OcfDeviceType != null)
                {
                    hashCode = (hashCode * 59) + this.OcfDeviceType.GetHashCode();
                }
                if (this.Name != null)
                {
                ...
                if (this.VerticalDomainSpecVersion != null)
                {
                    hashCode = (hashCode * 59) + this.VerticalDomainSpecVersion.GetHashCode();
                }
                ...
                if (this.PlatformOS != null)
                {
                    hashCode = (hashCode * 59) + this.PlatformOS.GetHashCode();
                }
                ...
                if (this.VendorResourceClientServerVersion != null)
                {
                    hashCode = (hashCode * 59) + this.VendorResourceClientServerVersion.GetHashCode();
                }
                if (this.Locale != null)
                {
                    hashCode = (hashCode * 59) + this.Locale.GetHashCode();
                }
                if (this.LastSignupTime != null)
                {
                    hashCode = (hashCode * 59) + this.LastSignupTime.GetHashCode();
                }
                return hashCode;
            }
        }
