...
namespace SmartThingsNet.Model
{
    ...
    /// StatesArrayItem
    /// </summary>
    [DataContract(Name = "statesArrayItem")]
    public partial class StatesArrayItem : IEquatable<StatesArrayItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatesArrayItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatesArrayItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatesArrayItem" /> class.
        /// </summary>
        ...
        public StatesArrayItem(string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), string capability = default(string), int version = 1, string component = default(string), VisibleCondition visibleCondition = default(VisibleCondition), bool composite = false, string group = "main", List<Object> formatInfo = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatesArrayItem {\n");
        ...
        {
            return this.Equals(input as StatesArrayItem);
        }

        /// <summary>
        /// Returns true if StatesArrayItem instances are equal
        /// </summary>
        /// <param name="input">Instance of StatesArrayItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatesArrayItem input)
        {
            if (input == null)
            {
                return false;
