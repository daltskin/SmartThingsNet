...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneModeRequest")]
    public partial class SceneModeRequest : IEquatable<SceneModeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneModeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SceneModeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneModeRequest" /> class.
        /// </summary>
        /// <param name="modeId">The id of the mode (required).</param>
        ...
        public SceneModeRequest(string modeId = default(string), string actionId = default(string), string modeName = default(string))
        {
            // to ensure "modeId" is required (not null)
            if (modeId == null) {
                throw new ArgumentNullException("modeId is a required property for SceneModeRequest and cannot be null");
            }
            this.ModeId = modeId;
        ...
        /// The id of the mode
        /// </summary>
        /// <value>The id of the mode</value>
        [DataMember(Name = "modeId", IsRequired = true, EmitDefaultValue = false)]
        public string ModeId { get; set; }

        /// <summary>
        /// the id of the action to be created. Optional, sent by Reaver only
        /// </summary>
        /// <value>the id of the action to be created. Optional, sent by Reaver only</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneModeRequest {\n");
        ...
        {
            return this.Equals(input as SceneModeRequest);
        }

        /// <summary>
        /// Returns true if SceneModeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneModeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneModeRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    (this.ModeId != null &&
                    this.ModeId.Equals(input.ModeId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ModeId != null)
                {
                    hashCode = (hashCode * 59) + this.ModeId.GetHashCode();
                }
