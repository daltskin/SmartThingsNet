...
{
    /// <summary>
    /// MultiArgCommandArguments
    /// </summary>
    [DataContract(Name = "multiArgCommand_arguments")]
    public partial class MultiArgCommandArguments : IEquatable<MultiArgCommandArguments>, IValidatableObject
    {
        /// <summary>
        /// Specify the type of UI component to use to display this action or state. The corresponding field must also be included. For example, if you specify \&quot;list\&quot; here, you must also include the \&quot;list\&quot; key and its object definition for this action or state.
        /// </summary>
        /// <value>Specify the type of UI component to use to display this action or state. The corresponding field must also be included. For example, if you specify \&quot;list\&quot; here, you must also include the \&quot;list\&quot; key and its object definition for this action or state.</value>
        ...
        protected MultiArgCommandArguments() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiArgCommandArguments" /> class.
        /// </summary>
        ...
        public SliderForArgument Slider { get; set; }

        /// <summary>
        /// Gets or Sets List
        /// </summary>
        [DataMember(Name = "list", EmitDefaultValue = false)]
        public ListForArgument List { get; set; }

        /// <summary>
        /// Gets or Sets TextField
        /// </summary>
        [DataMember(Name = "textField", EmitDefaultValue = false)]
        public TextFieldForArgument TextField { get; set; }

        /// <summary>
        /// Gets or Sets NumberField
        /// </summary>
        [DataMember(Name = "numberField", EmitDefaultValue = false)]
        public NumberFieldForArgument NumberField { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultiArgCommandArguments {\n");
        ...
        {
            return this.Equals(input as MultiArgCommandArguments);
        }

        /// <summary>
        /// Returns true if MultiArgCommandArguments instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiArgCommandArguments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiArgCommandArguments input)
        {
            if (input == null)
            {
                return false;
