...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstallConfigurationDetail")]
    public partial class InstallConfigurationDetail : IEquatable<InstallConfigurationDetail>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallConfigurationDetail" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstallConfigurationDetail {\n");
        ...
        {
            return this.Equals(input as InstallConfigurationDetail);
        }

        /// <summary>
        /// Returns true if InstallConfigurationDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of InstallConfigurationDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstallConfigurationDetail input)
        {
            if (input == null)
            {
                return false;
