...
{
    /// <summary>
    /// Request body to update the mutable fields of a developer organization. &#x60;NOTE&#x60;: warehouseGroupId cannot be updated from a present to a null value
    /// </summary>
    [DataContract(Name = "OrganizationUpdateRequest")]
    public partial class OrganizationUpdateRequest : IEquatable<OrganizationUpdateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public OrganizationUpdateRequest(string label = default(string), Guid warehouseGroupId = default(Guid), string mnId = default(string))
        {
            this.Label = label;
        ...
        {
            return this.Equals(input as OrganizationUpdateRequest);
        }

        /// <summary>
        /// Returns true if OrganizationUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationUpdateRequest input)
        {
            if (input == null)
            {
                return false;
