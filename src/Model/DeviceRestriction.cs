...
{
    /// <summary>
    /// The restriction to limit actions a device can take.
    /// </summary>
    [DataContract(Name = "DeviceRestriction")]
    public partial class DeviceRestriction : IEquatable<DeviceRestriction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceRestriction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceRestriction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceRestriction" /> class.
        /// </summary>
        /// <param name="tier">The restriction level of an entity to limit actions it can take. (required).</param>
        /// <param name="historyRetentionTTLDays">The number of days to retain the state before deletion..</param>
        /// <param name="visibleWhenRestricted">Indicate whether or not the entity is visible when restricted. (default to false).</param>
        public DeviceRestriction(int tier = default(int), int historyRetentionTTLDays = default(int), bool visibleWhenRestricted = false)
        {
            this.Tier = tier;
            this.HistoryRetentionTTLDays = historyRetentionTTLDays;
            this.VisibleWhenRestricted = visibleWhenRestricted;
        }

        /// <summary>
        /// The restriction level of an entity to limit actions it can take.
        /// </summary>
        /// <value>The restriction level of an entity to limit actions it can take.</value>
        [DataMember(Name = "tier", IsRequired = true, EmitDefaultValue = false)]
        public int Tier { get; set; }

        /// <summary>
        /// The number of days to retain the state before deletion.
        /// </summary>
        /// <value>The number of days to retain the state before deletion.</value>
        [DataMember(Name = "historyRetentionTTLDays", EmitDefaultValue = false)]
        public int HistoryRetentionTTLDays { get; set; }

        /// <summary>
        /// Indicate whether or not the entity is visible when restricted.
        /// </summary>
        /// <value>Indicate whether or not the entity is visible when restricted.</value>
        [DataMember(Name = "visibleWhenRestricted", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceRestriction {\n");
            sb.Append("  Tier: ").Append(Tier).Append("\n");
            sb.Append("  HistoryRetentionTTLDays: ").Append(HistoryRetentionTTLDays).Append("\n");
            sb.Append("  VisibleWhenRestricted: ").Append(VisibleWhenRestricted).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DeviceRestriction);
        }

        /// <summary>
        /// Returns true if DeviceRestriction instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceRestriction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceRestriction input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HistoryRetentionTTLDays == input.HistoryRetentionTTLDays ||
                    this.HistoryRetentionTTLDays.Equals(input.HistoryRetentionTTLDays)
                ) && 
                (
                    this.VisibleWhenRestricted == input.VisibleWhenRestricted ||
                    this.VisibleWhenRestricted.Equals(input.VisibleWhenRestricted)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.HistoryRetentionTTLDays.GetHashCode();
                hashCode = (hashCode * 59) + this.VisibleWhenRestricted.GetHashCode();
                return hashCode;
            }
        }
