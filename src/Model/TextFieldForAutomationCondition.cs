...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "textFieldForAutomationCondition")]
    public partial class TextFieldForAutomationCondition : IEquatable<TextFieldForAutomationCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextFieldForAutomationCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TextFieldForAutomationCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TextFieldForAutomationCondition" /> class.
        /// </summary>
        ...
        public TextFieldForAutomationCondition(string value = default(string), string valueType = default(string), List<double> range = default(List<double>))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TextFieldForAutomationCondition and cannot be null");
            }
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TextFieldForAutomationCondition {\n");
        ...
        {
            return this.Equals(input as TextFieldForAutomationCondition);
        }

        /// <summary>
        /// Returns true if TextFieldForAutomationCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of TextFieldForAutomationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextFieldForAutomationCondition input)
        {
            if (input == null)
            {
                return false;
