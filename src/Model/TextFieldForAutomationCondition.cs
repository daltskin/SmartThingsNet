...
namespace SmartThingsNet.Model
{
    ...
    public partial class TextFieldForAutomationCondition :  IEquatable<TextFieldForAutomationCondition>, IValidatableObject
    {
        ...
        public TextFieldForAutomationCondition(string value = default(string), List<double> range = default(List<double>))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for TextFieldForAutomationCondition and cannot be null");
            this.Range = range;
        }
