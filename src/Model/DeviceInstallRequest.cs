...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceInstallRequest")]
    public partial class DeviceInstallRequest : IEquatable<DeviceInstallRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceInstallRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceInstallRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceInstallRequest" /> class.
        /// </summary>
        /// <param name="label">The label for the Device..</param>
        /// <param name="locationId">The ID of the Location with which the device is associated. (required).</param>
        /// <param name="roomId">The ID of the Room with which to associate the Device is associated. The Room must be valid for the Location of the Device. .</param>
        /// <param name="app">app (required).</param>
        public DeviceInstallRequest(string label = default(string), string locationId = default(string), string roomId = default(string), DeviceInstallRequestApp app = default(DeviceInstallRequestApp))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for DeviceInstallRequest and cannot be null");
            }
            this.LocationId = locationId;
            // to ensure "app" is required (not null)
            if (app == null) {
                throw new ArgumentNullException("app is a required property for DeviceInstallRequest and cannot be null");
            }
            this.App = app;
            this.Label = label;
            this.RoomId = roomId;
        ...
        /// </summary>
        /// <value>The label for the Device.</value>
        ...
        /// <summary>
        /// The ID of the Room with which to associate the Device is associated. The Room must be valid for the Location of the Device. 
        /// </summary>
        /// <value>The ID of the Room with which to associate the Device is associated. The Room must be valid for the Location of the Device. </value>
        ...
        public DeviceInstallRequestApp App { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceInstallRequest {\n");
        ...
        {
            return this.Equals(input as DeviceInstallRequest);
        }

        /// <summary>
        /// Returns true if DeviceInstallRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceInstallRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceInstallRequest input)
        {
            if (input == null)
            {
                return false;
