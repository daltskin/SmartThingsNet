...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceInstallRequest :  IEquatable<DeviceInstallRequest>, IValidatableObject
    {
        ...
        public DeviceInstallRequest(string label = default(string), string locationId = default(string), DeviceInstallRequestApp app = default(DeviceInstallRequestApp))
        {
            // to ensure "locationId" is required (not null)
            this.LocationId = locationId ?? throw new ArgumentNullException("locationId is a required property for DeviceInstallRequest and cannot be null");
            // to ensure "app" is required (not null)
            this.App = app ?? throw new ArgumentNullException("app is a required property for DeviceInstallRequest and cannot be null");
            this.Label = label;
        }
