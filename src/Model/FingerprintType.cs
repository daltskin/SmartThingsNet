...
namespace SmartThingsNet.Model
{
    ...
    /// Type of fingerprint
    /// </summary>
    /// <value>Type of fingerprint</value>
    ...
    public enum FingerprintType
    {
        ...
        /// <summary>
        /// Enum ZIGBEEGENERIC for value: ZIGBEE_GENERIC
        /// </summary>
        [EnumMember(Value = "ZIGBEE_GENERIC")]
        ZIGBEEGENERIC = 2,

        /// <summary>
        /// Enum ZIGBEEMANUFACTURER for value: ZIGBEE_MANUFACTURER
        /// </summary>
        [EnumMember(Value = "ZIGBEE_MANUFACTURER")]
        ZIGBEEMANUFACTURER = 3,

        /// <summary>
        /// Enum ZWAVEMANUFACTURER for value: ZWAVE_MANUFACTURER
        /// </summary>
        [EnumMember(Value = "ZWAVE_MANUFACTURER")]
        ZWAVEMANUFACTURER = 4,

        /// <summary>
        /// Enum ZWAVEGENERIC for value: ZWAVE_GENERIC
        /// </summary>
        [EnumMember(Value = "ZWAVE_GENERIC")]
        ZWAVEGENERIC = 5
