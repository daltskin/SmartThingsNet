...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IrDeviceDetails_functionCodes")]
    public partial class IrDeviceDetailsFunctionCodes : IEquatable<IrDeviceDetailsFunctionCodes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IrDeviceDetailsFunctionCodes" /> class.
        /// </summary>
        /// <param name="_default">_default.</param>
        public IrDeviceDetailsFunctionCodes(string _default = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IrDeviceDetailsFunctionCodes {\n");
        ...
        {
            return this.Equals(input as IrDeviceDetailsFunctionCodes);
        }

        /// <summary>
        /// Returns true if IrDeviceDetailsFunctionCodes instances are equal
        /// </summary>
        /// <param name="input">Instance of IrDeviceDetailsFunctionCodes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IrDeviceDetailsFunctionCodes input)
        {
            if (input == null)
            {
                return false;
