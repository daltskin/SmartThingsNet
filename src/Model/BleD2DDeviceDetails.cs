...
namespace SmartThingsNet.Model
{
    ...
    /// BleD2DDeviceDetails
    /// </summary>
    [DataContract(Name = "BleD2DDeviceDetails")]
    public partial class BleD2DDeviceDetails : IEquatable<BleD2DDeviceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BleD2DDeviceDetails" /> class.
        /// </summary>
        /// <param name="encryptionKey">Security encryption key..</param>
        /// <param name="cipher">Key for the decrypt..</param>
        /// <param name="advertisingId">BLE Advertising Id..</param>
        /// <param name="identifier">Unique device identifier..</param>
        /// <param name="configurationVersion">configurationVersion.</param>
        /// <param name="configurationUrl">configurationUrl.</param>
        /// <param name="metadata">metadata.</param>
        public BleD2DDeviceDetails(string encryptionKey = default(string), string cipher = default(string), string advertisingId = default(string), string identifier = default(string), string configurationVersion = default(string), string configurationUrl = default(string), Object metadata = default(Object))
        {
        ...
        /// </summary>
        /// <value>Security encryption key.</value>
        ...
        /// Key for the decrypt.
        /// </summary>
        /// <value>Key for the decrypt.</value>
        ...
        /// BLE Advertising Id.
        /// </summary>
        /// <value>BLE Advertising Id.</value>
        ...
        /// </summary>
        [DataMember(Name = "configurationUrl", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BleD2DDeviceDetails {\n");
        ...
        {
            return this.Equals(input as BleD2DDeviceDetails);
        }

        /// <summary>
        /// Returns true if BleD2DDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of BleD2DDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BleD2DDeviceDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.Cipher != null &&
                    this.Cipher.Equals(input.Cipher))
                ) && 
                (
                    this.AdvertisingId == input.AdvertisingId ||
                    (this.AdvertisingId != null &&
                    this.AdvertisingId.Equals(input.AdvertisingId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AdvertisingId.GetHashCode();
                }
