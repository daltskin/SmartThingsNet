...
namespace SmartThingsNet.Model
{
    ...
    /// ViperDeviceDetails
    /// </summary>
    [DataContract(Name = "ViperDeviceDetails")]
    public partial class ViperDeviceDetails : IEquatable<ViperDeviceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViperDeviceDetails" /> class.
        /// </summary>
        ...
        /// <param name="swVersion">swVersion.</param>
        /// <param name="hwVersion">hwVersion.</param>
        public ViperDeviceDetails(string uniqueIdentifier = default(string), string manufacturerName = default(string), string modelName = default(string), string swVersion = default(string), string hwVersion = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets SwVersion
        /// </summary>
        [DataMember(Name = "swVersion", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ViperDeviceDetails {\n");
        ...
        {
            return this.Equals(input as ViperDeviceDetails);
        }

        /// <summary>
        /// Returns true if ViperDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ViperDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViperDeviceDetails input)
        {
            if (input == null)
            {
                return false;
