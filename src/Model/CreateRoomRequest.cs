...
namespace SmartThingsNet.Model
{
    ...
    public partial class CreateRoomRequest :  IEquatable<CreateRoomRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreateRoomRequest" /> class.
        /// </summary>
        /// <param name="name">A name given for the room (eg. Living Room) (required).</param>
        public CreateRoomRequest(string name = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateRoomRequest and cannot be null");
        }
