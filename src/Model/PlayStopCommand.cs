...
{
    /// <summary>
    /// Display type for a play/stop button.
    /// </summary>
    [DataContract(Name = "playStopCommand")]
    public partial class PlayStopCommand : IEquatable<PlayStopCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayStopCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopCommand" /> class.
        /// </summary>
        /// <param name="command">command (required).</param>
        public PlayStopCommand(PlayStopCommandCommand command = default(PlayStopCommandCommand))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for PlayStopCommand and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayStopCommand {\n");
        ...
        {
            return this.Equals(input as PlayStopCommand);
        }

        /// <summary>
        /// Returns true if PlayStopCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayStopCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayStopCommand input)
        {
            if (input == null)
            {
                return false;
