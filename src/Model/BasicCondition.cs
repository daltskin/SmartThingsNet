...
namespace SmartThingsNet.Model
{
    ...
    /// BasicCondition
    /// </summary>
    [DataContract(Name = "BasicCondition")]
    public partial class BasicCondition : IEquatable<BasicCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasicCondition {\n");
        ...
        {
            return this.Equals(input as BasicCondition);
        }

        /// <summary>
        /// Returns true if BasicCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicCondition input)
        {
            if (input == null)
            {
                return false;
