...
namespace SmartThingsNet.Model
{
    ...
    public partial class Invitation : IEquatable<Invitation>, IValidatableObject
    {
        ...
        [DataMember(Name = "invitationId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "inviterUsername", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "deliveryMethods", IsRequired = true, EmitDefaultValue = false)]
