...
namespace SmartThingsNet.Model
{
    ...
    public partial class Invitation : IEquatable<Invitation>, IValidatableObject
    {
        ...
        /// <param name="inviterUsername">The username for the inviter..</param>
        /// <param name="entityType">entityType.</param>
        /// <param name="entityId">The identifier for the specific entity you are inviting access to..</param>
        /// <param name="deliveryMethods">deliveryMethods.</param>
        /// <param name="status">status.</param>
        /// <param name="expiration">The IS0-8601 date time string in UTC for the expiration of an invitation..</param>
        ...
        /// <summary>
        /// The username for the inviter.
        /// </summary>
        /// <value>The username for the inviter.</value>
        [DataMember(Name = "inviterUsername", EmitDefaultValue = false)]
        public string InviterUsername { get; set; }

        /// <summary>
        /// The identifier for the specific entity you are inviting access to.
        /// </summary>
        /// <value>The identifier for the specific entity you are inviting access to.</value>
        ...
        public List<Delivery> DeliveryMethods { get; set; }

        /// <summary>
        /// The IS0-8601 date time string in UTC for the expiration of an invitation.
        /// </summary>
        /// <value>The IS0-8601 date time string in UTC for the expiration of an invitation.</value>
