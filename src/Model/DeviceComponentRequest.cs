...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceComponentRequest")]
    public partial class DeviceComponentRequest : IEquatable<DeviceComponentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceComponentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceComponentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceComponentRequest" /> class.
        /// </summary>
        /// <param name="label">UTF-8 label for the component..</param>
        /// <param name="id">id (required).</param>
        /// <param name="capabilities">A list of &#x60;[ 1..20 ]&#x60; capabilities for this component. (required).</param>
        /// <param name="categories">categories (required).</param>
        /// <param name="restrictions">restrictions.</param>
        public DeviceComponentRequest(string label = default(string), string id = default(string), List<CapabilityReferenceRequest> capabilities = default(List<CapabilityReferenceRequest>), List<DeviceCategory> categories = default(List<DeviceCategory>), Restriction restrictions = default(Restriction))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DeviceComponentRequest and cannot be null");
            }
            this.Id = id;
            // to ensure "capabilities" is required (not null)
            if (capabilities == null) {
                throw new ArgumentNullException("capabilities is a required property for DeviceComponentRequest and cannot be null");
            }
            this.Capabilities = capabilities;
            // to ensure "categories" is required (not null)
            if (categories == null) {
                throw new ArgumentNullException("categories is a required property for DeviceComponentRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>UTF-8 label for the component.</value>
        ...
        /// </summary>
        /// <value>A list of &#x60;[ 1..20 ]&#x60; capabilities for this component.</value>
        [DataMember(Name = "capabilities", IsRequired = true, EmitDefaultValue = false)]
        public List<CapabilityReferenceRequest> Capabilities { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceComponentRequest {\n");
        ...
        {
            return this.Equals(input as DeviceComponentRequest);
        }

        /// <summary>
        /// Returns true if DeviceComponentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceComponentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceComponentRequest input)
        {
            if (input == null)
            {
                return false;
