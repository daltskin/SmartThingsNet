...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SwitchForArgument :  IEquatable<SwitchForArgument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchForArgument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwitchForArgument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchForArgument" /> class.
        /// </summary>
        /// <param name="name">Argument name of a command (required).</param>
        /// <param name="on">Value for &#39;on&#39; (required).</param>
        /// <param name="off">Value for &#39;off&#39; (required).</param>
        public SwitchForArgument(string name = default(string), string on = default(string), string off = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SwitchForArgument and cannot be null");
            // to ensure "on" is required (not null)
            this.On = on ?? throw new ArgumentNullException("on is a required property for SwitchForArgument and cannot be null");
            // to ensure "off" is required (not null)
            this.Off = off ?? throw new ArgumentNullException("off is a required property for SwitchForArgument and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwitchForArgument {\n");
        ...
        {
            return this.Equals(input as SwitchForArgument);
        }

        /// <summary>
        /// Returns true if SwitchForArgument instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchForArgument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchForArgument input)
        {
            if (input == null)
                return false;
