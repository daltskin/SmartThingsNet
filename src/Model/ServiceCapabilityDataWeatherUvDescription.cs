...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherUvDescription
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_uvDescription")]
    public partial class ServiceCapabilityDataWeatherUvDescription : IEquatable<ServiceCapabilityDataWeatherUvDescription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherUvDescription" /> class.
        /// </summary>
        /// <param name="value">(This attribute is not available in Korea and Japan) The UV index description which complements the uvIndex value .</param>
        /// <param name="unit">unit.</param>
        public ServiceCapabilityDataWeatherUvDescription(string value = default(string), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is not available in Korea and Japan) The UV index description which complements the uvIndex value 
        /// </summary>
        /// <value>(This attribute is not available in Korea and Japan) The UV index description which complements the uvIndex value </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherUvDescription {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherUvDescription);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherUvDescription instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherUvDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherUvDescription input)
        {
            if (input == null)
            {
                return false;
