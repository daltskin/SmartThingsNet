...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LessThanOrEqualsCondition : SimpleCondition,  IEquatable<LessThanOrEqualsCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public LessThanOrEqualsCondition(string id = default(string), Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?)) : base(id, left, right, aggregation)
        {
        }
