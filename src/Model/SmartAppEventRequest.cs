...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SmartAppEventRequest")]
    public partial class SmartAppEventRequest : IEquatable<SmartAppEventRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartAppEventRequest" /> class.
        /// </summary>
        /// <param name="name">An arbitrary name for the custom SmartApp event.  Typically useful as a hook for in-app routing..</param>
        /// <param name="attributes">An arbitrary set of key / value pairs useful for passing any custom metadata.  * Supports a maximum of 10 entries. * Maximum key length: 36 Unicode characters in UTF-8 * Maximum value length: 256 Unicode characters in UTF-8 * Allowed characters for *keys* are letters, plus the following special characters: &#x60;:&#x60;, &#x60;_&#x60; * Allowed characters for *values* are letters, whitespace, and numbers, plus the following special characters: &#x60;+&#x60;, &#x60;-&#x60;, &#x60;&#x3D;&#x60;, &#x60;.&#x60;, &#x60;_&#x60;, &#x60;:&#x60;, &#x60;/&#x60; * If you need characters outside this allowed set, you can apply standard base-64 encoding. .</param>
        public SmartAppEventRequest(string name = default(string), Dictionary<string, string> attributes = default(Dictionary<string, string>))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>An arbitrary name for the custom SmartApp event.  Typically useful as a hook for in-app routing.</value>
        ...
        /// </summary>
        /// <value>An arbitrary set of key / value pairs useful for passing any custom metadata.  * Supports a maximum of 10 entries. * Maximum key length: 36 Unicode characters in UTF-8 * Maximum value length: 256 Unicode characters in UTF-8 * Allowed characters for *keys* are letters, plus the following special characters: &#x60;:&#x60;, &#x60;_&#x60; * Allowed characters for *values* are letters, whitespace, and numbers, plus the following special characters: &#x60;+&#x60;, &#x60;-&#x60;, &#x60;&#x3D;&#x60;, &#x60;.&#x60;, &#x60;_&#x60;, &#x60;:&#x60;, &#x60;/&#x60; * If you need characters outside this allowed set, you can apply standard base-64 encoding. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SmartAppEventRequest {\n");
        ...
        {
            return this.Equals(input as SmartAppEventRequest);
        }

        /// <summary>
        /// Returns true if SmartAppEventRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SmartAppEventRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmartAppEventRequest input)
        {
            if (input == null)
            {
                return false;
