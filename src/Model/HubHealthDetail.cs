...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HubHealthDetail")]
    public partial class HubHealthDetail : IEquatable<HubHealthDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HubHealthDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HubHealthDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HubHealthDetail" /> class.
        /// </summary>
        /// <param name="subscriptionName">A name for the subscription that will be passed to the installed app..</param>
        /// <param name="locationId">The id of the location that both the app and hubs are in (required).</param>
        public HubHealthDetail(string subscriptionName = default(string), string locationId = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for HubHealthDetail and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The id of the location that both the app and hubs are in</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HubHealthDetail {\n");
        ...
        {
            return this.Equals(input as HubHealthDetail);
        }

        /// <summary>
        /// Returns true if HubHealthDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of HubHealthDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HubHealthDetail input)
        {
            if (input == null)
            {
                return false;
