...
namespace SmartThingsNet.Model
{
    ...
    /// ServiceLocationInfo
    /// </summary>
    [DataContract(Name = "ServiceLocationInfo")]
    public partial class ServiceLocationInfo : IEquatable<ServiceLocationInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceLocationInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceLocationInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceLocationInfo" /> class.
        /// </summary>
        ...
        public ServiceLocationInfo(string locationId = default(string), List<ServiceLocationInfoSubscriptions> subscriptions = default(List<ServiceLocationInfoSubscriptions>), float latitude = default(float), float longitude = default(float), string city = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for ServiceLocationInfo and cannot be null");
            }
            this.LocationId = locationId;
            // to ensure "subscriptions" is required (not null)
            if (subscriptions == null) {
                throw new ArgumentNullException("subscriptions is a required property for ServiceLocationInfo and cannot be null");
            }
        ...
        public List<ServiceLocationInfoSubscriptions> Subscriptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceLocationInfo {\n");
        ...
        {
            return this.Equals(input as ServiceLocationInfo);
        }

        /// <summary>
        /// Returns true if ServiceLocationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceLocationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceLocationInfo input)
        {
            if (input == null)
            {
                return false;
