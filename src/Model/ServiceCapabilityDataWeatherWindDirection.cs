...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherWindDirection
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_windDirection")]
    public partial class ServiceCapabilityDataWeatherWindDirection : IEquatable<ServiceCapabilityDataWeatherWindDirection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherWindDirection" /> class.
        /// </summary>
        /// <param name="value">The magnetic wind direction from which the wind blows expressed in degrees.  Range - 0&lt;&#x3D;wind_dire_deg&lt;&#x3D;350, in 10 degree intervals .</param>
        /// <param name="unit">°.</param>
        public ServiceCapabilityDataWeatherWindDirection(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// The magnetic wind direction from which the wind blows expressed in degrees.  Range - 0&lt;&#x3D;wind_dire_deg&lt;&#x3D;350, in 10 degree intervals 
        /// </summary>
        /// <value>The magnetic wind direction from which the wind blows expressed in degrees.  Range - 0&lt;&#x3D;wind_dire_deg&lt;&#x3D;350, in 10 degree intervals </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherWindDirection {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherWindDirection);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherWindDirection instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherWindDirection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherWindDirection input)
        {
            if (input == null)
            {
                return false;
