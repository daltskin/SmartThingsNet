...
namespace SmartThingsNet.Model
{
    ...
    /// SceneSummary
    /// </summary>
    [DataContract(Name = "SceneSummary")]
    public partial class SceneSummary : IEquatable<SceneSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneSummary" /> class.
        /// </summary>
        /// <param name="sceneId">The unique identifier of the Scene.</param>
        /// <param name="sceneName">The user-defined name of the Scene.</param>
        /// <param name="sceneIcon">The name of the icon.</param>
        /// <param name="sceneColor">The color of the icon.</param>
        /// <param name="locationId">Location of the Scene.</param>
        /// <param name="createdBy">The unique identifier of the user that created the scene.</param>
        /// <param name="createdDate">The date the scene was created.</param>
        /// <param name="lastUpdatedDate">The date the scene was last updated.</param>
        /// <param name="lastExecutedDate">The date the scene was last executed.</param>
        /// <param name="editable">Whether or not this scene can be edited by the logged in user using the version of the app that made the request.</param>
        /// <param name="apiVersion">apiVersion.</param>
        public SceneSummary(string sceneId = default(string), string sceneName = default(string), string sceneIcon = default(string), string sceneColor = default(string), string locationId = default(string), string createdBy = default(string), DateTime createdDate = default(DateTime), DateTime lastUpdatedDate = default(DateTime), DateTime lastExecutedDate = default(DateTime), bool editable = default(bool), string apiVersion = default(string))
        {
        ...
        /// </summary>
        /// <value>The unique identifier of the Scene</value>
        ...
        /// </summary>
        /// <value>The user-defined name of the Scene</value>
        ...
        [DataMember(Name = "sceneIcon", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "sceneColor", EmitDefaultValue = false)]
        public string SceneColor { get; set; }

        /// <summary>
        /// Location of the Scene
        /// </summary>
        /// <value>Location of the Scene</value>
        ...
        /// </summary>
        /// <value>The unique identifier of the user that created the scene</value>
        ...
        /// </summary>
        /// <value>The date the scene was created</value>
        ...
        /// </summary>
        /// <value>The date the scene was last updated</value>
        ...
        /// </summary>
        /// <value>The date the scene was last executed</value>
        [DataMember(Name = "lastExecutedDate", EmitDefaultValue = false)]
        public DateTime LastExecutedDate { get; set; }

        /// <summary>
        /// Whether or not this scene can be edited by the logged in user using the version of the app that made the request
        /// </summary>
        /// <value>Whether or not this scene can be edited by the logged in user using the version of the app that made the request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneSummary {\n");
            sb.Append("  SceneId: ").Append(SceneId).Append("\n");
            sb.Append("  SceneName: ").Append(SceneName).Append("\n");
            sb.Append("  SceneIcon: ").Append(SceneIcon).Append("\n");
            sb.Append("  SceneColor: ").Append(SceneColor).Append("\n");
            sb.Append("  LocationId: ").Append(LocationId).Append("\n");
            sb.Append("  CreatedBy: ").Append(CreatedBy).Append("\n");
            sb.Append("  CreatedDate: ").Append(CreatedDate).Append("\n");
            sb.Append("  LastUpdatedDate: ").Append(LastUpdatedDate).Append("\n");
            sb.Append("  LastExecutedDate: ").Append(LastExecutedDate).Append("\n");
        ...
        {
            return this.Equals(input as SceneSummary);
        }

        /// <summary>
        /// Returns true if SceneSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneSummary to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SceneIcon.GetHashCode();
                }
                if (this.SceneColor != null)
                {
                    hashCode = (hashCode * 59) + this.SceneColor.GetHashCode();
                }
                ...
                if (this.LastExecutedDate != null)
                {
                    hashCode = (hashCode * 59) + this.LastExecutedDate.GetHashCode();
                }
