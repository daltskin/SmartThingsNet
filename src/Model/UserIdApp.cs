...
namespace SmartThingsNet.Model
{
    ...
    /// UserIdApp
    /// </summary>
    [DataContract(Name = "UserIdApp")]
    public partial class UserIdApp : IEquatable<UserIdApp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserIdApp" /> class.
        /// </summary>
        /// <param name="userId">UserId.</param>
        /// <param name="endpointApps">endpointApps.</param>
        public UserIdApp(string userId = default(string), List<EndpointApp> endpointApps = default(List<EndpointApp>))
        {
            this.UserId = userId;
        ...
        /// <summary>
        /// Gets or Sets EndpointApps
        /// </summary>
        [DataMember(Name = "endpointApps", EmitDefaultValue = false)]
        public List<EndpointApp> EndpointApps { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserIdApp {\n");
            sb.Append("  UserId: ").Append(UserId).Append("\n");
            sb.Append("  EndpointApps: ").Append(EndpointApps).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UserIdApp);
        }

        /// <summary>
        /// Returns true if UserIdApp instances are equal
        /// </summary>
        /// <param name="input">Instance of UserIdApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserIdApp input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EndpointApps == input.EndpointApps ||
                    this.EndpointApps != null &&
                    input.EndpointApps != null &&
                    this.EndpointApps.SequenceEqual(input.EndpointApps)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EndpointApps != null)
                {
                    hashCode = (hashCode * 59) + this.EndpointApps.GetHashCode();
                }
                return hashCode;
            }
        }
