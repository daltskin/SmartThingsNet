...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SceneRequest :  IEquatable<SceneRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public SceneRequest(string sceneName = default(string), string sceneIcon = default(string), string sceneColor = default(string), List<SceneDeviceRequest> devices = default(List<SceneDeviceRequest>), List<List<string>> sequences = default(List<List<string>>), SceneModeRequest mode = default(SceneModeRequest), SceneSecurityModeRequest securityMode = default(SceneSecurityModeRequest), List<SceneDeviceGroupRequest> devicegroups = default(List<SceneDeviceGroupRequest>))
        {
            ...
            this.Devices = devices ?? throw new ArgumentNullException("devices is a required property for SceneRequest and cannot be null");
        ...
        /// </summary>
        /// <value>Non-sequential list of device actions</value>
        [DataMember(Name="devices", EmitDefaultValue=false)]
        public List<SceneDeviceRequest> Devices { get; set; }
        ...
        public SceneModeRequest Mode { get; set; }

        /// <summary>
        /// Gets or Sets SecurityMode
        /// </summary>
        [DataMember(Name="securityMode", EmitDefaultValue=false)]
        public SceneSecurityModeRequest SecurityMode { get; set; }

        /// <summary>
        /// List of device group actions
        /// </summary>
        /// <value>List of device group actions</value>
        [DataMember(Name="devicegroups", EmitDefaultValue=false)]
        public List<SceneDeviceGroupRequest> Devicegroups { get; set; }
        ...
        {
            return this.Equals(input as SceneRequest);
        }

        /// <summary>
        /// Returns true if SceneRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Sequences.SequenceEqual(input.Sequences)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Sequences != null)
                    hashCode = hashCode * 59 + this.Sequences.GetHashCode();
                if (this.Mode != null)
