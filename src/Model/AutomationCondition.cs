...
namespace SmartThingsNet.Model
{
    ...
    /// AutomationCondition
    /// </summary>
    [DataContract(Name = "automationCondition")]
    public partial class AutomationCondition : IEquatable<AutomationCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationCondition {\n");
        ...
        {
            return this.Equals(input as AutomationCondition);
        }

        /// <summary>
        /// Returns true if AutomationCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationCondition input)
        {
            if (input == null)
            {
                return false;
