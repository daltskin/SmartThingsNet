...
{
    /// <summary>
    /// DeviceConfigEntryForDashboardAction
    /// </summary>
    [DataContract(Name = "deviceConfigEntryForDashboardAction")]
    public partial class DeviceConfigEntryForDashboardAction : IEquatable<DeviceConfigEntryForDashboardAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryForDashboardAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceConfigEntryForDashboardAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryForDashboardAction" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntryForDashboardAction {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntryForDashboardAction);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntryForDashboardAction instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntryForDashboardAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntryForDashboardAction input)
        {
            if (input == null)
            {
                return false;
