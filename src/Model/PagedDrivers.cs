...
{
    /// <summary>
    /// A paginated array of Drivers.
    /// </summary>
    [DataContract(Name = "PagedDrivers")]
    public partial class PagedDrivers : IEquatable<PagedDrivers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDrivers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedDrivers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDrivers" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="links">links (required).</param>
        public PagedDrivers(List<PagedDriver> items = default(List<PagedDriver>), Links links = default(Links))
        {
            // to ensure "items" is required (not null)
            if (items == null) {
                throw new ArgumentNullException("items is a required property for PagedDrivers and cannot be null");
            }
            this.Items = items;
            // to ensure "links" is required (not null)
            if (links == null) {
                throw new ArgumentNullException("links is a required property for PagedDrivers and cannot be null");
            }
            this.Links = links;
        }
        ...
        public List<PagedDriver> Items { get; set; }
        ...
        {
            return this.Equals(input as PagedDrivers);
        }

        /// <summary>
        /// Returns true if PagedDrivers instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedDrivers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedDrivers input)
        {
            if (input == null)
            {
                return false;
