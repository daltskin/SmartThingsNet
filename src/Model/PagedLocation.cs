...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedLocation")]
    public partial class PagedLocation : IEquatable<PagedLocation>, IValidatableObject
    {
        /// <summary>
        /// Defines Allowed
        /// </summary>
        ...
        {
            return this.Equals(input as PagedLocation);
        }

        /// <summary>
        /// Returns true if PagedLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedLocation input)
        {
            if (input == null)
            {
                return false;
