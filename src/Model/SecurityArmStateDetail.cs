...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SecurityArmStateDetail")]
    public partial class SecurityArmStateDetail : IEquatable<SecurityArmStateDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityArmStateDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SecurityArmStateDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityArmStateDetail" /> class.
        /// </summary>
        /// <param name="subscriptionName">A name for the subscription that will be passed to the installed app..</param>
        /// <param name="locationId">The id of the location that both the app and the security system are in. (required).</param>
        public SecurityArmStateDetail(string subscriptionName = default(string), string locationId = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for SecurityArmStateDetail and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The id of the location that both the app and the security system are in.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityArmStateDetail {\n");
        ...
        {
            return this.Equals(input as SecurityArmStateDetail);
        }

        /// <summary>
        /// Returns true if SecurityArmStateDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityArmStateDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityArmStateDetail input)
        {
            if (input == null)
            {
                return false;
