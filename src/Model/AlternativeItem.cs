...
namespace SmartThingsNet.Model
{
    ...
    /// AlternativeItem
    /// </summary>
    [DataContract(Name = "alternativeItem")]
    public partial class AlternativeItem : IEquatable<AlternativeItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>This shows the active or inactive state of the value. &#x60;active&#x60; is shown in color, while &#x60;inactive&#x60; value is shown dimmed in the UI view. For example, Motion sensor capability would have &#x60;detected&#x60; as active and in color and &#x60;clear&#x60; as inactive and dimmed so that a user can see the &#x60;detected&#x60; event easily.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlternativeItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AlternativeItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AlternativeItem" /> class.
        /// </summary>
        /// <param name="key">The label string to be displayed when the &#39;key&#39; is evaluated. (required).</param>
        /// <param name="value">The alternative string to be displayed when the &#x60;key&#x60; is selected. (required).</param>
        /// <param name="type">This shows the active or inactive state of the value. &#x60;active&#x60; is shown in color, while &#x60;inactive&#x60; value is shown dimmed in the UI view. For example, Motion sensor capability would have &#x60;detected&#x60; as active and in color and &#x60;clear&#x60; as inactive and dimmed so that a user can see the &#x60;detected&#x60; event easily. (default to TypeEnum.Active).</param>
        /// <param name="iconUrl">Icon Id used to retrieve icons to be drawn on the UI Client. If iconUrl is omitted, then UI client shows default icon of device&#39;s category..</param>
        /// <param name="description">Additional description for each value. This description is shown in detail view or automation under this particular key..</param>
        public AlternativeItem(string key = default(string), string value = default(string), TypeEnum? type = TypeEnum.Active, string iconUrl = default(string), string description = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for AlternativeItem and cannot be null");
            }
            this.Key = key;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for AlternativeItem and cannot be null");
            }
            this.Value = value;
            this.Type = type;
        ...
        /// </summary>
        /// <value>The label string to be displayed when the &#39;key&#39; is evaluated.</value>
        ...
        /// </summary>
        /// <value>The alternative string to be displayed when the &#x60;key&#x60; is selected.</value>
        [DataMember(Name = "value", IsRequired = true, EmitDefaultValue = false)]
        public string Value { get; set; }

        /// <summary>
        /// Icon Id used to retrieve icons to be drawn on the UI Client. If iconUrl is omitted, then UI client shows default icon of device&#39;s category.
        /// </summary>
        /// <value>Icon Id used to retrieve icons to be drawn on the UI Client. If iconUrl is omitted, then UI client shows default icon of device&#39;s category.</value>
        ...
        /// </summary>
        /// <value>Additional description for each value. This description is shown in detail view or automation under this particular key.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlternativeItem {\n");
        ...
        {
            return this.Equals(input as AlternativeItem);
        }

        /// <summary>
        /// Returns true if AlternativeItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AlternativeItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlternativeItem input)
        {
            if (input == null)
            {
                return false;
