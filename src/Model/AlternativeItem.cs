...
namespace SmartThingsNet.Model
{
    ...
    public partial class AlternativeItem :  IEquatable<AlternativeItem>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="AlternativeItem" /> class.
        /// </summary>
        /// <param name="key">The attribute value which will cause this alternative string to be displayed. The attribute to be evaluated will be the one that is used in the &#x60;label&#x60; or &#x60;value&#x60;. (required).</param>
        /// <param name="value">The label string to be displayed when the &#39;key&#39; is evaluated. (required).</param>
        ...
        public AlternativeItem(string key = default(string), string value = default(string), TypeEnum? type = TypeEnum.Active, string description = default(string))
        {
            // to ensure "key" is required (not null)
            this.Key = key ?? throw new ArgumentNullException("key is a required property for AlternativeItem and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for AlternativeItem and cannot be null");
            this.Type = type;
            this.Description = description;
        }
        
        /// <summary>
        /// The attribute value which will cause this alternative string to be displayed. The attribute to be evaluated will be the one that is used in the &#x60;label&#x60; or &#x60;value&#x60;.
        /// </summary>
        /// <value>The attribute value which will cause this alternative string to be displayed. The attribute to be evaluated will be the one that is used in the &#x60;label&#x60; or &#x60;value&#x60;.</value>
