...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneDeviceRequest")]
    public partial class SceneDeviceRequest : IEquatable<SceneDeviceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneDeviceRequest" /> class.
        /// </summary>
        /// <param name="deviceId">the id of the device.</param>
        /// <param name="actionId">the id of the action to be created. Optional, sent by Reaver only.</param>
        /// <param name="components">components.</param>
        public SceneDeviceRequest(string deviceId = default(string), string actionId = default(string), List<SceneComponent> components = default(List<SceneComponent>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneDeviceRequest {\n");
        ...
        {
            return this.Equals(input as SceneDeviceRequest);
        }

        /// <summary>
        /// Returns true if SceneDeviceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneDeviceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneDeviceRequest input)
        {
            if (input == null)
            {
                return false;
