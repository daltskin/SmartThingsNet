...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedMessageTemplate")]
    public partial class PagedMessageTemplate : IEquatable<PagedMessageTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedMessageTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedMessageTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedMessageTemplate" /> class.
        /// </summary>
        /// <param name="appId">A globally unique identifier for an app. (required).</param>
        /// <param name="messageTemplateKey">messageTemplateKey (required).</param>
        public PagedMessageTemplate(Guid appId = default(Guid), string messageTemplateKey = default(string))
        {
            this.AppId = appId;
            // to ensure "messageTemplateKey" is required (not null)
            if (messageTemplateKey == null) {
                throw new ArgumentNullException("messageTemplateKey is a required property for PagedMessageTemplate and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A globally unique identifier for an app.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedMessageTemplate {\n");
        ...
        {
            return this.Equals(input as PagedMessageTemplate);
        }

        /// <summary>
        /// Returns true if PagedMessageTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedMessageTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedMessageTemplate input)
        {
            if (input == null)
            {
                return false;
