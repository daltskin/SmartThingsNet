...
{
    /// <summary>
    /// DeviceConfigEntryForDashboardStateAllOf
    /// </summary>
    [DataContract(Name = "deviceConfigEntryForDashboardState_allOf")]
    public partial class DeviceConfigEntryForDashboardStateAllOf : IEquatable<DeviceConfigEntryForDashboardStateAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryForDashboardStateAllOf" /> class.
        /// </summary>
        ...
        public DeviceConfigEntryForDashboardStateAllOf(int idx = 0, string group = "main", List<CapabilityValueForDashboardState> values = default(List<CapabilityValueForDashboardState>), bool composite = false, List<Object> formatInfo = default(List<Object>))
        {
            this.Idx = idx;
        ...
        /// <summary>
        /// An index among the multiple items of dashboard provided in the capability presentation.
        /// </summary>
        /// <value>An index among the multiple items of dashboard provided in the capability presentation.</value>
        ...
        public List<CapabilityValueForDashboardState> Values { get; set; }

        /// <summary>
        /// To specify composite use of different state items. If composite is true, multiple states items in the same group are combined to a label.
        /// </summary>
        /// <value>To specify composite use of different state items. If composite is true, multiple states items in the same group are combined to a label.</value>
        ...
        /// </summary>
        [DataMember(Name = "formatInfo", EmitDefaultValue = false)]
        public List<Object> FormatInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntryForDashboardStateAllOf {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntryForDashboardStateAllOf);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntryForDashboardStateAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntryForDashboardStateAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntryForDashboardStateAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.FormatInfo == input.FormatInfo ||
                    this.FormatInfo != null &&
                    input.FormatInfo != null &&
                    this.FormatInfo.SequenceEqual(input.FormatInfo)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.FormatInfo.GetHashCode();
                }
                return hashCode;
            }
        }
