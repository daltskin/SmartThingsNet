...
{
    /// <summary>
    /// To specify multiple arguments command and displayType of each argument.
    /// </summary>
    [DataContract]
    public partial class MultiArgCommand :  IEquatable<MultiArgCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiArgCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiArgCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiArgCommand" /> class.
        /// </summary>
        /// <param name="command">Command name to trigger (required).</param>
        /// <param name="arguments">arguments (required).</param>
        public MultiArgCommand(string command = default(string), List<MultiArgCommandArguments> arguments = default(List<MultiArgCommandArguments>))
        {
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for MultiArgCommand and cannot be null");
            // to ensure "arguments" is required (not null)
            this.Arguments = arguments ?? throw new ArgumentNullException("arguments is a required property for MultiArgCommand and cannot be null");
        }
        
        /// <summary>
        /// Command name to trigger
        /// </summary>
        /// <value>Command name to trigger</value>
        ...
        public List<MultiArgCommandArguments> Arguments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultiArgCommand {\n");
        ...
        {
            return this.Equals(input as MultiArgCommand);
        }

        /// <summary>
        /// Returns true if MultiArgCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiArgCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiArgCommand input)
        {
            if (input == null)
                return false;
