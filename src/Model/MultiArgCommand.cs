...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "multiArgCommand")]
    public partial class MultiArgCommand : IEquatable<MultiArgCommand>, IValidatableObject
    {
        ...
        public MultiArgCommand(string command = default(string), List<MultiArgCommandArguments> arguments = default(List<MultiArgCommandArguments>))
        {
            ...
            if (command == null) {
                throw new ArgumentNullException("command is a required property for MultiArgCommand and cannot be null");
            }
            this.Command = command;
            // to ensure "arguments" is required (not null)
            if (arguments == null) {
                throw new ArgumentNullException("arguments is a required property for MultiArgCommand and cannot be null");
            }
