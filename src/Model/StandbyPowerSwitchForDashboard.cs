...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "standbyPowerSwitchForDashboard")]
    public partial class StandbyPowerSwitchForDashboard : IEquatable<StandbyPowerSwitchForDashboard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StandbyPowerSwitchForDashboard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StandbyPowerSwitchForDashboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StandbyPowerSwitchForDashboard" /> class.
        /// </summary>
        /// <param name="command">command (required).</param>
        /// <param name="state">state.</param>
        public StandbyPowerSwitchForDashboard(SwitchCommandCommand command = default(SwitchCommandCommand), SwitchStateForDashboardState state = default(SwitchStateForDashboardState))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for StandbyPowerSwitchForDashboard and cannot be null");
            }
        ...
        public SwitchCommandCommand Command { get; set; }

        /// <summary>
        /// Gets or Sets State
        /// </summary>
        [DataMember(Name = "state", EmitDefaultValue = false)]
        public SwitchStateForDashboardState State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StandbyPowerSwitchForDashboard {\n");
        ...
        {
            return this.Equals(input as StandbyPowerSwitchForDashboard);
        }

        /// <summary>
        /// Returns true if StandbyPowerSwitchForDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of StandbyPowerSwitchForDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandbyPowerSwitchForDashboard input)
        {
            if (input == null)
            {
                return false;
