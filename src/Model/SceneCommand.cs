...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneCommand")]
    public partial class SceneCommand : IEquatable<SceneCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneCommand" /> class.
        /// </summary>
        /// <param name="arguments">the command arguments.</param>
        public SceneCommand(List<SceneArgument> arguments = default(List<SceneArgument>))
        {
        ...
        public List<SceneArgument> Arguments { get; set; }
        ...
        {
            return this.Equals(input as SceneCommand);
        }

        /// <summary>
        /// Returns true if SceneCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneCommand input)
        {
            if (input == null)
            {
                return false;
