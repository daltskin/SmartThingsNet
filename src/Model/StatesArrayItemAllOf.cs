...
{
    /// <summary>
    /// StatesArrayItemAllOf
    /// </summary>
    [DataContract(Name = "statesArrayItem_allOf")]
    public partial class StatesArrayItemAllOf : IEquatable<StatesArrayItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatesArrayItemAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatesArrayItemAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatesArrayItemAllOf" /> class.
        /// </summary>
        ...
        public StatesArrayItemAllOf(string component = default(string), VisibleCondition visibleCondition = default(VisibleCondition), bool composite = false, string group = "main", List<Object> formatInfo = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatesArrayItemAllOf {\n");
        ...
        {
            return this.Equals(input as StatesArrayItemAllOf);
        }

        /// <summary>
        /// Returns true if StatesArrayItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StatesArrayItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatesArrayItemAllOf input)
        {
            if (input == null)
            {
                return false;
