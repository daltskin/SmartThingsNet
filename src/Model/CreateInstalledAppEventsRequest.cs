...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateInstalledAppEventsRequest")]
    public partial class CreateInstalledAppEventsRequest : IEquatable<CreateInstalledAppEventsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateInstalledAppEventsRequest" /> class.
        /// </summary>
        /// <param name="smartAppEvents">An array of smartapp events used to trigger client behavior in loaded web plugin detail pages.  Events will be delivered to JavaScript event handler of all active client processes related to parameterized installed app. .</param>
        /// <param name="smartAppDashboardCardEvents">An array of smartapp dashboard card events used to trigger client behavior for dashboard cards. Dashboard card events are directives to a SmartThings client to take actions in relation to lifecycle changes to a specific dashboard card.  These events are not delivered to the web plugin event handler. .</param>
        public CreateInstalledAppEventsRequest(List<SmartAppEventRequest> smartAppEvents = default(List<SmartAppEventRequest>), List<SmartAppDashboardCardEventRequest> smartAppDashboardCardEvents = default(List<SmartAppDashboardCardEventRequest>))
        {
            this.SmartAppEvents = smartAppEvents;
            this.SmartAppDashboardCardEvents = smartAppDashboardCardEvents;
        }
        ...
        /// </summary>
        /// <value>An array of smartapp events used to trigger client behavior in loaded web plugin detail pages.  Events will be delivered to JavaScript event handler of all active client processes related to parameterized installed app. </value>
        [DataMember(Name = "smartAppEvents", EmitDefaultValue = false)]
        public List<SmartAppEventRequest> SmartAppEvents { get; set; }
        ...
        /// </summary>
        /// <value>An array of smartapp dashboard card events used to trigger client behavior for dashboard cards. Dashboard card events are directives to a SmartThings client to take actions in relation to lifecycle changes to a specific dashboard card.  These events are not delivered to the web plugin event handler. </value>
        [DataMember(Name = "smartAppDashboardCardEvents", EmitDefaultValue = false)]
        public List<SmartAppDashboardCardEventRequest> SmartAppDashboardCardEvents { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateInstalledAppEventsRequest {\n");
            sb.Append("  SmartAppEvents: ").Append(SmartAppEvents).Append("\n");
            sb.Append("  SmartAppDashboardCardEvents: ").Append(SmartAppDashboardCardEvents).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CreateInstalledAppEventsRequest);
        }

        /// <summary>
        /// Returns true if CreateInstalledAppEventsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateInstalledAppEventsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateInstalledAppEventsRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.SmartAppEvents == input.SmartAppEvents ||
                    this.SmartAppEvents != null &&
                    input.SmartAppEvents != null &&
                    this.SmartAppEvents.SequenceEqual(input.SmartAppEvents)
                ) && 
                (
                    this.SmartAppDashboardCardEvents == input.SmartAppDashboardCardEvents ||
                    this.SmartAppDashboardCardEvents != null &&
                    input.SmartAppDashboardCardEvents != null &&
                    this.SmartAppDashboardCardEvents.SequenceEqual(input.SmartAppDashboardCardEvents)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.SmartAppEvents != null)
                {
                    hashCode = (hashCode * 59) + this.SmartAppEvents.GetHashCode();
                }
                if (this.SmartAppDashboardCardEvents != null)
                {
                    hashCode = (hashCode * 59) + this.SmartAppDashboardCardEvents.GetHashCode();
                }
                return hashCode;
            }
        }
