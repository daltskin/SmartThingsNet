...
namespace SmartThingsNet.Model
{
    ...
    /// LocaleReference
    /// </summary>
    [DataContract(Name = "LocaleReference")]
    public partial class LocaleReference : IEquatable<LocaleReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocaleReference" /> class.
        /// </summary>
        /// <param name="tag">The tag of the locale as defined in [RFC bcp47](http://www.rfc-editor.org/rfc/bcp/bcp47.txt)..</param>
        public LocaleReference(string tag = default(string))
        {
            this.Tag = tag;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocaleReference {\n");
        ...
        {
            return this.Equals(input as LocaleReference);
        }

        /// <summary>
        /// Returns true if LocaleReference instances are equal
        /// </summary>
        /// <param name="input">Instance of LocaleReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocaleReference input)
        {
            if (input == null)
            {
                return false;
