...
namespace SmartThingsNet.Model
{
    ...
    /// Device
    /// </summary>
    [DataContract(Name = "DeviceGroupResponse_devices")]
    public partial class DeviceGroupResponseDevices : IEquatable<DeviceGroupResponseDevices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGroupResponseDevices" /> class.
        /// </summary>
        /// <param name="deviceId">GUID representing the device.</param>
        /// <param name="components">Components to add to the group.</param>
        public DeviceGroupResponseDevices(string deviceId = default(string), List<DeviceGroupResponseComponents> components = default(List<DeviceGroupResponseComponents>))
        {
        ...
        /// <summary>
        /// GUID representing the device
        /// </summary>
        /// <value>GUID representing the device</value>
        ...
        /// </summary>
        /// <value>Components to add to the group</value>
        [DataMember(Name = "components", EmitDefaultValue = false)]
        public List<DeviceGroupResponseComponents> Components { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceGroupResponseDevices {\n");
        ...
        {
            return this.Equals(input as DeviceGroupResponseDevices);
        }

        /// <summary>
        /// Returns true if DeviceGroupResponseDevices instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceGroupResponseDevices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceGroupResponseDevices input)
        {
            if (input == null)
            {
                return false;
