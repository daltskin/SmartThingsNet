...
namespace SmartThingsNet.Model
{
    ...
    /// CommandSequence
    /// </summary>
    [DataContract(Name = "CommandSequence")]
    public partial class CommandSequence : IEquatable<CommandSequence>, IValidatableObject
    {
        ...
        public Sequence? Commands { get; set; }

        /// <summary>
        /// Gets or Sets Devices
        /// </summary>
        [DataMember(Name = "devices", EmitDefaultValue = false)]
        public Sequence? Devices { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommandSequence {\n");
        ...
        {
            return this.Equals(input as CommandSequence);
        }

        /// <summary>
        /// Returns true if CommandSequence instances are equal
        /// </summary>
        /// <param name="input">Instance of CommandSequence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommandSequence input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    this.Commands.Equals(input.Commands)
                ) && 
                (
