...
namespace SmartThingsNet.Model
{
    ...
    public partial class Automation : IEquatable<Automation>, IValidatableObject
    {
        ...
        public Automation(List<AutomationListItem> conditions = default(List<AutomationListItem>), List<ActionListItem> actions = default(List<ActionListItem>))
        {
        ...
        public List<AutomationListItem> Conditions { get; set; }
