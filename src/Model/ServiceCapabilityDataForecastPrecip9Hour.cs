...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip9Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip9Hour")]
    public partial class ServiceCapabilityDataForecastPrecip9Hour : IEquatable<ServiceCapabilityDataForecastPrecip9Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip9Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 9 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip9Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 9 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 9 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip9Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip9Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip9Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip9Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip9Hour input)
        {
            if (input == null)
            {
                return false;
