...
namespace SmartThingsNet.Model
{
    ...
    /// ActionsArrayItem
    /// </summary>
    [DataContract(Name = "actionsArrayItem")]
    public partial class ActionsArrayItem : IEquatable<ActionsArrayItem>, IValidatableObject
    {
        /// <summary>
        ...
        public enum DisplayTypeEnum
        {
            ...
            /// <summary>
            /// Enum StatelessPowerToggle for value: statelessPowerToggle
            /// </summary>
            [EnumMember(Value = "statelessPowerToggle")]
            StatelessPowerToggle = 5,
        ...
        public ActionsArrayItem(DisplayTypeEnum displayType = default(DisplayTypeEnum), PushButton pushButton = default(PushButton), ToggleSwitchForDashboard toggleSwitch = default(ToggleSwitchForDashboard), SwitchForDashboard _switch = default(SwitchForDashboard), StandbyPowerSwitchForDashboard standbyPowerSwitch = default(StandbyPowerSwitchForDashboard), StatelessPowerToggleForDashboard statelessPowerToggle = default(StatelessPowerToggleForDashboard), PlayPause playPause = default(PlayPause), PlayStop playStop = default(PlayStop), string group = "main", string capability = default(string), int version = 1, string component = default(string), VisibleCondition visibleCondition = default(VisibleCondition))
        {
        ...
        /// <summary>
        /// Gets or Sets StatelessPowerToggle
        /// </summary>
        [DataMember(Name = "statelessPowerToggle", EmitDefaultValue = false)]
        public StatelessPowerToggleForDashboard StatelessPowerToggle { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionsArrayItem {\n");
            ...
            sb.Append("  StatelessPowerToggle: ").Append(StatelessPowerToggle).Append("\n");
        ...
        {
            return this.Equals(input as ActionsArrayItem);
        }

        /// <summary>
        /// Returns true if ActionsArrayItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionsArrayItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionsArrayItem input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StatelessPowerToggle == input.StatelessPowerToggle ||
                    (this.StatelessPowerToggle != null &&
                    this.StatelessPowerToggle.Equals(input.StatelessPowerToggle))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StatelessPowerToggle != null)
                {
                    hashCode = (hashCode * 59) + this.StatelessPowerToggle.GetHashCode();
                }
