...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin2Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin2Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin2Hour : IEquatable<ServiceCapabilityDataForecastSnowMin2Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin2Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 2 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin2Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 2 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 2 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin2Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin2Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin2Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin2Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin2Hour input)
        {
            if (input == null)
            {
                return false;
