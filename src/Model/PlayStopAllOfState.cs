...
namespace SmartThingsNet.Model
{
    ...
    public partial class PlayStopAllOfState :  IEquatable<PlayStopAllOfState>, IValidatableObject
    {
        ...
        public PlayStopAllOfState(string value = default(string), string play = default(string), string stop = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for PlayStopAllOfState and cannot be null");
            // to ensure "play" is required (not null)
            this.Play = play ?? throw new ArgumentNullException("play is a required property for PlayStopAllOfState and cannot be null");
            // to ensure "stop" is required (not null)
            this.Stop = stop ?? throw new ArgumentNullException("stop is a required property for PlayStopAllOfState and cannot be null");
