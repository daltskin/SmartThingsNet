...
namespace SmartThingsNet.Model
{
    ...
    /// PlayStopAllOfState
    /// </summary>
    [DataContract(Name = "playStop_allOf_state")]
    public partial class PlayStopAllOfState : IEquatable<PlayStopAllOfState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopAllOfState" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayStopAllOfState() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopAllOfState" /> class.
        /// </summary>
        ...
        /// <param name="stop">The value of \&quot;attribute\&quot; which indicates stopped state. When the attribute value equals to this then UI will show stopped state. (required).</param>
        ...
        public PlayStopAllOfState(string value = default(string), string play = default(string), string stop = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), string valueType = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for PlayStopAllOfState and cannot be null");
            }
            this.Value = value;
            // to ensure "play" is required (not null)
            if (play == null) {
                throw new ArgumentNullException("play is a required property for PlayStopAllOfState and cannot be null");
            }
            this.Play = play;
            // to ensure "stop" is required (not null)
            if (stop == null) {
                throw new ArgumentNullException("stop is a required property for PlayStopAllOfState and cannot be null");
            }
            this.Stop = stop;
        ...
        /// </summary>
        /// <value>The value of \&quot;attribute\&quot; which indicates stopped state. When the attribute value equals to this then UI will show stopped state.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayStopAllOfState {\n");
        ...
        {
            return this.Equals(input as PlayStopAllOfState);
        }

        /// <summary>
        /// Returns true if PlayStopAllOfState instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayStopAllOfState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayStopAllOfState input)
        {
            if (input == null)
            {
                return false;
