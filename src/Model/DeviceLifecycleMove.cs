...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceLifecycleMove")]
    public partial class DeviceLifecycleMove : IEquatable<DeviceLifecycleMove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleMove" /> class.
        /// </summary>
        /// <param name="locationId">locationId.</param>
        public DeviceLifecycleMove(string locationId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleMove {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleMove);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleMove instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleMove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleMove input)
        {
            if (input == null)
            {
                return false;
