...
namespace SmartThingsNet.Model
{
    ...
    /// CapabilityCommand
    /// </summary>
    [DataContract(Name = "CapabilityCommand")]
    public partial class CapabilityCommand : IEquatable<CapabilityCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CapabilityCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityCommand" /> class.
        /// </summary>
        /// <param name="name">The name of the command. Unique for the capability (required).</param>
        /// <param name="arguments">An array of argument definitions. The arguments must be supplied in the order specified..</param>
        public CapabilityCommand(string name = default(string), List<Argument> arguments = default(List<Argument>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CapabilityCommand and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The name of the command. Unique for the capability</value>
        ...
        /// </summary>
        /// <value>An array of argument definitions. The arguments must be supplied in the order specified.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityCommand {\n");
        ...
        {
            return this.Equals(input as CapabilityCommand);
        }

        /// <summary>
        /// Returns true if CapabilityCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityCommand input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // Name (string) pattern
            Regex regexName = new Regex(@"^[[a-z]*([A-Z][a-z]*)*]{1,36}$", RegexOptions.CultureInvariant);
