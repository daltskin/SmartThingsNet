...
{
    /// <summary>
    /// Invidiual member to invite to an organization.
    /// </summary>
    [DataContract(Name = "InviteRequestItem")]
    public partial class InviteRequestItem : IEquatable<InviteRequestItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteRequestItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InviteRequestItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteRequestItem" /> class.
        /// </summary>
        /// <param name="email">The E-mail address of the invited party. (required).</param>
        /// <param name="role">role (required).</param>
        public InviteRequestItem(string email = default(string), Role role = default(Role))
        {
            // to ensure "email" is required (not null)
            if (email == null) {
                throw new ArgumentNullException("email is a required property for InviteRequestItem and cannot be null");
            }
            this.Email = email;
            // to ensure "role" is required (not null)
            if (role == null) {
                throw new ArgumentNullException("role is a required property for InviteRequestItem and cannot be null");
            }
            this.Role = role;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InviteRequestItem {\n");
        ...
        {
            return this.Equals(input as InviteRequestItem);
        }

        /// <summary>
        /// Returns true if InviteRequestItem instances are equal
        /// </summary>
        /// <param name="input">Instance of InviteRequestItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InviteRequestItem input)
        {
            if (input == null)
            {
                return false;
