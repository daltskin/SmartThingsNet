...
{
    /// <summary>
    /// CapabilityLocalizationArguments
    /// </summary>
    [DataContract(Name = "CapabilityLocalization_arguments")]
    public partial class CapabilityLocalizationArguments : IEquatable<CapabilityLocalizationArguments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalizationArguments" /> class.
        /// </summary>
        /// <param name="i18n">Map of argument values to localizations.</param>
        /// <param name="label">label.</param>
        /// <param name="description">description.</param>
        public CapabilityLocalizationArguments(Dictionary<string, CapabilityLocalizationI18n> i18n = default(Dictionary<string, CapabilityLocalizationI18n>), string label = default(string), string description = default(string))
        {
            this.I18n = i18n;
            this.Label = label;
        ...
        /// </summary>
        /// <value>Map of argument values to localizations</value>
        [DataMember(Name = "i18n", EmitDefaultValue = false)]
        public Dictionary<string, CapabilityLocalizationI18n> I18n { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityLocalizationArguments {\n");
        ...
        {
            return this.Equals(input as CapabilityLocalizationArguments);
        }

        /// <summary>
        /// Returns true if CapabilityLocalizationArguments instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityLocalizationArguments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityLocalizationArguments input)
        {
            if (input == null)
            {
                return false;
