...
{
    /// <summary>
    /// DeviceLifecycleCreateCategories
    /// </summary>
    [DataContract(Name = "DeviceLifecycleCreate_categories")]
    public partial class DeviceLifecycleCreateCategories : IEquatable<DeviceLifecycleCreateCategories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleCreateCategories" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        public DeviceLifecycleCreateCategories(string name = default(string))
        {
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleCreateCategories {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleCreateCategories);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleCreateCategories instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleCreateCategories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleCreateCategories input)
        {
            if (input == null)
            {
                return false;
