...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DetailViewItem :  IEquatable<DetailViewItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailViewItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DetailViewItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailViewItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DetailViewItem);
        }

        /// <summary>
        /// Returns true if DetailViewItem instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailViewItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailViewItem input)
        {
            if (input == null)
                return false;
