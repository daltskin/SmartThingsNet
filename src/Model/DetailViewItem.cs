...
namespace SmartThingsNet.Model
{
    ...
    /// DetailViewItem
    /// </summary>
    [DataContract(Name = "detailViewItem")]
    public partial class DetailViewItem : IEquatable<DetailViewItem>, IValidatableObject
    {
        ...
        public DetailViewItem(string capability = default(string), int version = 1, string label = default(string), DisplayTypeEnum displayType = default(DisplayTypeEnum), ToggleSwitch toggleSwitch = default(ToggleSwitch), StandbyPowerSwitch standbyPowerSwitch = default(StandbyPowerSwitch), Switch _switch = default(Switch), Slider slider = default(Slider), PushButton pushButton = default(PushButton), TextButton textButton = default(TextButton), PlayPause playPause = default(PlayPause), PlayStop playStop = default(PlayStop), ListForDetailView list = default(ListForDetailView), TextField textField = default(TextField), NumberField numberField = default(NumberField), Stepper stepper = default(Stepper), State state = default(State), MultiArgCommand multiArgCommand = default(MultiArgCommand))
        {
            ...
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for DetailViewItem and cannot be null");
            }
            this.Capability = capability;
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for DetailViewItem and cannot be null");
            }
            this.Label = label;
