...
namespace SmartThingsNet.Model
{
    ...
    /// The type of filter
    /// </summary>
    /// <value>The type of filter</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum SubscriptionFilterTypes
    {
        /// <summary>
        /// Enum LOCATIONIDS for value: LOCATIONIDS
        /// </summary>
        [EnumMember(Value = "LOCATIONIDS")]
        LOCATIONIDS = 1,

        /// <summary>
        /// Enum ROOMIDS for value: ROOMIDS
        /// </summary>
        [EnumMember(Value = "ROOMIDS")]
        ROOMIDS = 2,

        /// <summary>
        /// Enum DEVICEIDS for value: DEVICEIDS
        /// </summary>
        [EnumMember(Value = "DEVICEIDS")]
        DEVICEIDS = 3,

        /// <summary>
        /// Enum INSTALLEDSMARTAPPIDS for value: INSTALLEDSMARTAPPIDS
        /// </summary>
        [EnumMember(Value = "INSTALLEDSMARTAPPIDS")]
        INSTALLEDSMARTAPPIDS = 4,

        /// <summary>
        /// Enum SMARTAPPIDS for value: SMARTAPPIDS
        /// </summary>
        [EnumMember(Value = "SMARTAPPIDS")]
        SMARTAPPIDS = 5
