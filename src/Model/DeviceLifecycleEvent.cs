...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceLifecycleEvent")]
    public partial class DeviceLifecycleEvent : IEquatable<DeviceLifecycleEvent>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleEvent" /> class.
        /// </summary>
        ...
        /// <param name="ownerId">ID for what owns the device lifecyle event. Works in tandem with &#x60;ownerType&#x60; as a composite identifier..</param>
        /// <param name="ownerType">ownerType.</param>
        /// <param name="deviceId">The id of the device..</param>
        /// <param name="deviceName">The name of the device.</param>
        /// <param name="principal">The principal that made the change.</param>
        /// <param name="create">create.</param>
        /// <param name="delete">Delete device lifecycle. .</param>
        /// <param name="update">update.</param>
        /// <param name="moveFrom">moveFrom.</param>
        /// <param name="moveTo">moveTo.</param>
        /// <param name="roomMove">roomMove.</param>
        ...
        /// </summary>
        /// <value>ID for what owns the device lifecyle event. Works in tandem with &#x60;ownerType&#x60; as a composite identifier.</value>
        ...
        /// </summary>
        /// <value>The principal that made the change</value>
        ...
        public DeviceLifecycleCreate Create { get; set; }

        /// <summary>
        /// Delete device lifecycle. 
        /// </summary>
        /// <value>Delete device lifecycle. </value>
        ...
        public DeviceLifecycleUpdate Update { get; set; }

        /// <summary>
        /// Gets or Sets MoveFrom
        /// </summary>
        [DataMember(Name = "moveFrom", EmitDefaultValue = false)]
        public DeviceLifecycleMove MoveFrom { get; set; }

        /// <summary>
        /// Gets or Sets MoveTo
        /// </summary>
        [DataMember(Name = "moveTo", EmitDefaultValue = false)]
        public DeviceLifecycleMove MoveTo { get; set; }

        /// <summary>
        /// Gets or Sets RoomMove
        /// </summary>
        [DataMember(Name = "roomMove", EmitDefaultValue = false)]
        public DeviceLifecycleRoomMove RoomMove { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleEvent {\n");
            ...
            sb.Append("  MoveFrom: ").Append(MoveFrom).Append("\n");
            sb.Append("  MoveTo: ").Append(MoveTo).Append("\n");
            sb.Append("  RoomMove: ").Append(RoomMove).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DeviceLifecycleEvent);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MoveFrom == input.MoveFrom ||
                    (this.MoveFrom != null &&
                    this.MoveFrom.Equals(input.MoveFrom))
                ) && 
                (
                    this.MoveTo == input.MoveTo ||
                    (this.MoveTo != null &&
                    this.MoveTo.Equals(input.MoveTo))
                ) && 
                (
                    this.RoomMove == input.RoomMove ||
                    (this.RoomMove != null &&
                    this.RoomMove.Equals(input.RoomMove))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.MoveFrom.GetHashCode();
                }
                if (this.MoveTo != null)
                {
                    hashCode = (hashCode * 59) + this.MoveTo.GetHashCode();
                }
                if (this.RoomMove != null)
                {
                    hashCode = (hashCode * 59) + this.RoomMove.GetHashCode();
                }
                return hashCode;
            }
        }
