...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComponentTranslations")]
    public partial class ComponentTranslations : IEquatable<ComponentTranslations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentTranslations" /> class.
        /// </summary>
        /// <param name="label">Short UTF-8 text used when displaying the component..</param>
        /// <param name="description">UTF-8 text describing the component..</param>
        public ComponentTranslations(string label = default(string), string description = default(string))
        {
            this.Label = label;
        ...
        /// </summary>
        /// <value>Short UTF-8 text used when displaying the component.</value>
        ...
        /// </summary>
        /// <value>UTF-8 text describing the component.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ComponentTranslations {\n");
        ...
        {
            return this.Equals(input as ComponentTranslations);
        }

        /// <summary>
        /// Returns true if ComponentTranslations instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentTranslations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentTranslations input)
        {
            if (input == null)
            {
                return false;
