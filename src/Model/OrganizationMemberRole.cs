...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationMemberRole")]
    public partial class OrganizationMemberRole : IEquatable<OrganizationMemberRole>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationMemberRole" /> class.
        /// </summary>
        /// <param name="principal">A raw user principal (user uuid)..</param>
        /// <param name="principalType">principalType (default to PrincipalTypeEnum.RAW).</param>
        /// <param name="role">role.</param>
        public OrganizationMemberRole(Guid principal = default(Guid), PrincipalTypeEnum? principalType = PrincipalTypeEnum.RAW, Role role = default(Role))
        {
        ...
        /// <summary>
        /// A raw user principal (user uuid).
        /// </summary>
        /// <value>A raw user principal (user uuid).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationMemberRole {\n");
        ...
        {
            return this.Equals(input as OrganizationMemberRole);
        }

        /// <summary>
        /// Returns true if OrganizationMemberRole instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationMemberRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationMemberRole input)
        {
            if (input == null)
            {
                return false;
