...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModeConfig")]
    public partial class ModeConfig : IEquatable<ModeConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModeConfig" /> class.
        /// </summary>
        /// <param name="modeId">The ID of the mode..</param>
        public ModeConfig(string modeId = default(string))
        {
            this.ModeId = modeId;
        }
        ...
        {
            return this.Equals(input as ModeConfig);
        }

        /// <summary>
        /// Returns true if ModeConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of ModeConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModeConfig input)
        {
            if (input == null)
            {
                return false;
