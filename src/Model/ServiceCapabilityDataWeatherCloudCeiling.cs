...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherCloudCeiling
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_cloudCeiling")]
    public partial class ServiceCapabilityDataWeatherCloudCeiling : IEquatable<ServiceCapabilityDataWeatherCloudCeiling>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherCloudCeiling" /> class.
        /// </summary>
        /// <param name="value">(This attribute is not available in Korea and Japan) Base of lowest Mostly Cloudy or Cloudy layer in meters .</param>
        /// <param name="unit">m.</param>
        public ServiceCapabilityDataWeatherCloudCeiling(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is not available in Korea and Japan) Base of lowest Mostly Cloudy or Cloudy layer in meters 
        /// </summary>
        /// <value>(This attribute is not available in Korea and Japan) Base of lowest Mostly Cloudy or Cloudy layer in meters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherCloudCeiling {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherCloudCeiling);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherCloudCeiling instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherCloudCeiling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherCloudCeiling input)
        {
            if (input == null)
            {
                return false;
