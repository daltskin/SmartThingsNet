...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip3Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip3Hour")]
    public partial class ServiceCapabilityDataForecastPrecip3Hour : IEquatable<ServiceCapabilityDataForecastPrecip3Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip3Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 3 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip3Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 3 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 3 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip3Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip3Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip3Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip3Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip3Hour input)
        {
            if (input == null)
            {
                return false;
