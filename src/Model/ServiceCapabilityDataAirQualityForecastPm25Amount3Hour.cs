...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm25Amount3Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm25Amount3Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm25Amount3Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm25Amount3Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 3 hours dust amount forecast of particulate matter less than 2.5 microns .</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityForecastPm25Amount3Hour(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea) 3 hours dust amount forecast of particulate matter less than 2.5 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 3 hours dust amount forecast of particulate matter less than 2.5 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm25Amount3Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm25Amount3Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm25Amount3Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm25Amount3Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm25Amount3Hour input)
        {
            if (input == null)
            {
                return false;
