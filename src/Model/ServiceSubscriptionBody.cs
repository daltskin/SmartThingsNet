...
{
    /// <summary>
    /// ServiceSubscriptionBody
    /// </summary>
    [DataContract(Name = "ServiceSubscriptionBody")]
    public partial class ServiceSubscriptionBody : IEquatable<ServiceSubscriptionBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// capability name(s). NOTE: alert cannot be combined with other capabilities 
        /// </summary>
        /// <value>capability name(s). NOTE: alert cannot be combined with other capabilities </value>
        [DataMember(Name = "capabilities", IsRequired = true, EmitDefaultValue = false)]
        public List<CapabilitiesEnum> Capabilities { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceSubscriptionBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceSubscriptionBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceSubscriptionBody" /> class.
        /// </summary>
        /// <param name="capabilities">capability name(s). NOTE: alert cannot be combined with other capabilities  (required).</param>
        /// <param name="isaId">InstalledApp ID  (required).</param>
        /// <param name="geoplaceId">Geo Place ID (This ID is only supported in \&quot;alert\&quot; capability) .</param>
        /// <param name="type">DIRECT or EXECUTION delivery, default to DIRECT.</param>
        /// <param name="predicate">JEXL formatted expression. See https://commons.apache.org/proper/commons-jexl/reference/syntax.html .</param>
        public ServiceSubscriptionBody(List<CapabilitiesEnum> capabilities = default(List<CapabilitiesEnum>), string isaId = default(string), string geoplaceId = default(string), string type = default(string), string predicate = default(string))
        {
            // to ensure "capabilities" is required (not null)
            if (capabilities == null) {
                throw new ArgumentNullException("capabilities is a required property for ServiceSubscriptionBody and cannot be null");
            }
            this.Capabilities = capabilities;
            // to ensure "isaId" is required (not null)
            if (isaId == null) {
                throw new ArgumentNullException("isaId is a required property for ServiceSubscriptionBody and cannot be null");
            }
            this.IsaId = isaId;
        ...
        /// <summary>
        /// JEXL formatted expression. See https://commons.apache.org/proper/commons-jexl/reference/syntax.html 
        /// </summary>
        /// <value>JEXL formatted expression. See https://commons.apache.org/proper/commons-jexl/reference/syntax.html </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceSubscriptionBody {\n");
        ...
        {
            return this.Equals(input as ServiceSubscriptionBody);
        }

        /// <summary>
        /// Returns true if ServiceSubscriptionBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceSubscriptionBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceSubscriptionBody input)
        {
            if (input == null)
            {
                return false;
