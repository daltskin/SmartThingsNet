...
{
    /// <summary>
    /// The unit which describes the value of the attribute.
    /// </summary>
    [DataContract(Name = "AttributeProperties_unit")]
    public partial class AttributePropertiesUnit : IEquatable<AttributePropertiesUnit>, IValidatableObject
    {
        /// <summary>
        /// Data type for the unit. This is defined by capability schema as a &#x60;string&#x60;.
        /// </summary>
        /// <value>Data type for the unit. This is defined by capability schema as a &#x60;string&#x60;.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributePropertiesUnit" /> class.
        /// </summary>
        /// <param name="type">Data type for the unit. This is defined by capability schema as a &#x60;string&#x60;. (default to TypeEnum.String).</param>
        /// <param name="_enum">Array of all possible units for the attribute value..</param>
        /// <param name="_default">The default unit to be used for the attribute value..</param>
        public AttributePropertiesUnit(TypeEnum? type = TypeEnum.String, List<string> _enum = default(List<string>), string _default = default(string))
        {
            this.Type = type;
            this.Enum = _enum;
        ...
        /// </summary>
        /// <value>Array of all possible units for the attribute value.</value>
        ...
        /// </summary>
        /// <value>The default unit to be used for the attribute value.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributePropertiesUnit {\n");
        ...
        {
            return this.Equals(input as AttributePropertiesUnit);
        }

        /// <summary>
        /// Returns true if AttributePropertiesUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributePropertiesUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributePropertiesUnit input)
        {
            if (input == null)
            {
                return false;
