...
namespace SmartThingsNet.Model
{
    ...
    /// IfAction
    /// </summary>
    [DataContract(Name = "IfAction")]
    public partial class IfAction : IEquatable<IfAction>, IValidatableObject
    {
        /// <summary>
        ...
        public ChangesCondition Changes { get; set; }

        /// <summary>
        /// Gets or Sets Remains
        /// </summary>
        [DataMember(Name = "remains", EmitDefaultValue = false)]
        public RemainsCondition Remains { get; set; }

        /// <summary>
        /// Gets or Sets Was
        /// </summary>
        [DataMember(Name = "was", EmitDefaultValue = false)]
        public WasCondition Was { get; set; }
        ...
        public List<Action> Else { get; set; }

        /// <summary>
        /// Gets or Sets Sequence
        /// </summary>
        [DataMember(Name = "sequence", EmitDefaultValue = false)]
        public IfActionSequence Sequence { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Remains: ").Append(Remains).Append("\n");
        ...
        {
            return this.Equals(input as IfAction);
        }

        /// <summary>
        /// Returns true if IfAction instances are equal
        /// </summary>
        /// <param name="input">Instance of IfAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IfAction input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Remains == input.Remains ||
                    (this.Remains != null &&
                    this.Remains.Equals(input.Remains))
                ) && 
                (
                    this.Was == input.Was ||
                    (this.Was != null &&
                    this.Was.Equals(input.Was))
                ) && 
                (
                ...
                (
                    ...
                    this.Else != null &&
                    input.Else != null &&
                    this.Else.SequenceEqual(input.Else)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Remains.GetHashCode();
                }
                if (this.Was != null)
                {
                    hashCode = (hashCode * 59) + this.Was.GetHashCode();
                }
                if (this.Then != null)
                {
