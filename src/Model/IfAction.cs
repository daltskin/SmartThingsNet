...
namespace SmartThingsNet.Model
{
    ...
    public partial class IfAction :  IEquatable<IfAction>, IValidatableObject
    {
        ...
        public EqualsCondition EqualsCondition { get; set; }
        ...
        /// </summary>
        [DataMember(Name="greater_than_or_equals", EmitDefaultValue=false)]
        ...
        /// </summary>
        [DataMember(Name="less_than_or_equals", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Unique id for the action</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Equals: ").Append(EqualsCondition).Append("\n");
        ...
        public bool Equals(IfAction input)
        {
            ...
            return 
                ...
                (
                    this.EqualsCondition == input.EqualsCondition ||
                    (this.EqualsCondition != null &&
                    this.EqualsCondition.Equals(input.EqualsCondition))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EqualsCondition != null)
                    hashCode = hashCode * 59 + this.EqualsCondition.GetHashCode();
