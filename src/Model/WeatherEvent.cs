...
{
    /// <summary>
    /// An event representing the current weather forecast.
    /// </summary>
    [DataContract(Name = "WeatherEvent")]
    public partial class WeatherEvent : IEquatable<WeatherEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WeatherEvent" /> class.
        /// </summary>
        /// <param name="weatherData">weatherData.</param>
        /// <param name="airQualityData">airQualityData.</param>
        /// <param name="severeAlertData">severeAlertData.</param>
        /// <param name="geoPlaceId">The id of the GeoPlace..</param>
        public WeatherEvent(WeatherData weatherData = default(WeatherData), AirQualityData airQualityData = default(AirQualityData), SevereAlertData severeAlertData = default(SevereAlertData), string geoPlaceId = default(string))
        {
            this.WeatherData = weatherData;
            this.AirQualityData = airQualityData;
            this.SevereAlertData = severeAlertData;
            this.GeoPlaceId = geoPlaceId;
        }

        /// <summary>
        /// Gets or Sets WeatherData
        /// </summary>
        [DataMember(Name = "weatherData", EmitDefaultValue = false)]
        public WeatherData WeatherData { get; set; }

        /// <summary>
        /// Gets or Sets AirQualityData
        /// </summary>
        [DataMember(Name = "airQualityData", EmitDefaultValue = false)]
        public AirQualityData AirQualityData { get; set; }

        /// <summary>
        /// Gets or Sets SevereAlertData
        /// </summary>
        [DataMember(Name = "severeAlertData", EmitDefaultValue = false)]
        public SevereAlertData SevereAlertData { get; set; }

        /// <summary>
        /// The id of the GeoPlace.
        /// </summary>
        /// <value>The id of the GeoPlace.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WeatherEvent {\n");
            sb.Append("  WeatherData: ").Append(WeatherData).Append("\n");
            sb.Append("  AirQualityData: ").Append(AirQualityData).Append("\n");
            sb.Append("  SevereAlertData: ").Append(SevereAlertData).Append("\n");
        ...
        {
            return this.Equals(input as WeatherEvent);
        }

        /// <summary>
        /// Returns true if WeatherEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of WeatherEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WeatherEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.WeatherData == input.WeatherData ||
                    (this.WeatherData != null &&
                    this.WeatherData.Equals(input.WeatherData))
                ) && 
                (
                    this.AirQualityData == input.AirQualityData ||
                    (this.AirQualityData != null &&
                    this.AirQualityData.Equals(input.AirQualityData))
                ) && 
                (
                    this.SevereAlertData == input.SevereAlertData ||
                    (this.SevereAlertData != null &&
                    this.SevereAlertData.Equals(input.SevereAlertData))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.WeatherData.GetHashCode();
                }
                if (this.AirQualityData != null)
                {
                    hashCode = (hashCode * 59) + this.AirQualityData.GetHashCode();
                }
                if (this.SevereAlertData != null)
                {
                    hashCode = (hashCode * 59) + this.SevereAlertData.GetHashCode();
                }
