...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceProfileReference")]
    public partial class DeviceProfileReference : IEquatable<DeviceProfileReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProfileReference" /> class.
        /// </summary>
        /// <param name="id">The device profile Id.</param>
        public DeviceProfileReference(string id = default(string))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceProfileReference {\n");
        ...
        {
            return this.Equals(input as DeviceProfileReference);
        }

        /// <summary>
        /// Returns true if DeviceProfileReference instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceProfileReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceProfileReference input)
        {
            if (input == null)
            {
                return false;
