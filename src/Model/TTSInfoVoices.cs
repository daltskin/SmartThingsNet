...
{
    /// <summary>
    /// Options available for each voice
    /// </summary>
    [DataContract(Name = "TTSInfo_voices")]
    public partial class TTSInfoVoices : IEquatable<TTSInfoVoices>, IValidatableObject
    {
        /// <summary>
        /// Gender of the voice
        /// </summary>
        /// <value>Gender of the voice</value>
        ...
        /// <summary>
        /// Defines SupportedEngines
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SupportedEnginesEnum
        {
            /// <summary>
        ...
        /// <summary>
        /// Supported engines for the voice. This option will be available only when TTSProvider is Amazon Polly
        /// </summary>
        /// <value>Supported engines for the voice. This option will be available only when TTSProvider is Amazon Polly</value>
        [DataMember(Name = "SupportedEngines", EmitDefaultValue = false)]
        public List<SupportedEnginesEnum> SupportedEngines { get; set; }
        /// <summary>
        /// TTS provider for the voice
        /// </summary>
        /// <value>TTS provider for the voice</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>TTS provider for the voice</value>
        [DataMember(Name = "TTSProvider", IsRequired = true, EmitDefaultValue = false)]
        public TTSProviderEnum TTSProvider { get; set; }
        /// <summary>
        /// Defines SpeakingStyle
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Supported speaking styles for the voice.  This option will be available only when TTSProvider is Amazon Polly, engine is neural, and voiceIds are one of the following - Matthew, Joanna, Lupe
        /// </summary>
        /// <value>Supported speaking styles for the voice.  This option will be available only when TTSProvider is Amazon Polly, engine is neural, and voiceIds are one of the following - Matthew, Joanna, Lupe</value>
        [DataMember(Name = "SpeakingStyle", EmitDefaultValue = false)]
        public List<SpeakingStyleEnum> SpeakingStyle { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TTSInfoVoices" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TTSInfoVoices() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TTSInfoVoices" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Voice id of the voice
        /// </summary>
        /// <value>Voice id of the voice</value>
        ...
        /// </summary>
        /// <value>Language code of the voice</value>
        ...
        /// </summary>
        /// <value>Language of the voice</value>
        [DataMember(Name = "LanguageName", IsRequired = true, EmitDefaultValue = false)]
        public string LanguageName { get; set; }

        /// <summary>
        /// Name of the voice
        /// </summary>
        /// <value>Name of the voice</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TTSInfoVoices {\n");
            sb.Append("  Gender: ").Append(Gender).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  LanguageCode: ").Append(LanguageCode).Append("\n");
            sb.Append("  LanguageName: ").Append(LanguageName).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  SupportedEngines: ").Append(SupportedEngines).Append("\n");
        ...
        {
            return this.Equals(input as TTSInfoVoices);
        }

        /// <summary>
        /// Returns true if TTSInfoVoices instances are equal
        /// </summary>
        /// <param name="input">Instance of TTSInfoVoices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TTSInfoVoices input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SupportedEngines == input.SupportedEngines ||
                    this.SupportedEngines.SequenceEqual(input.SupportedEngines)
                ) && 
                (
                ...
                (
                    ...
                    this.SpeakingStyle.SequenceEqual(input.SpeakingStyle)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SupportedEngines.GetHashCode();
