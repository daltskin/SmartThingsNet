...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherWindGust
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_windGust")]
    public partial class ServiceCapabilityDataWeatherWindGust : IEquatable<ServiceCapabilityDataWeatherWindGust>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherWindGust" /> class.
        /// </summary>
        /// <param name="value">This data field contains information about sudden and temporary variations of the average Wind Speed in kilometers per hour. .</param>
        /// <param name="unit">Km/h.</param>
        public ServiceCapabilityDataWeatherWindGust(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// This data field contains information about sudden and temporary variations of the average Wind Speed in kilometers per hour. 
        /// </summary>
        /// <value>This data field contains information about sudden and temporary variations of the average Wind Speed in kilometers per hour. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherWindGust {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherWindGust);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherWindGust instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherWindGust to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherWindGust input)
        {
            if (input == null)
            {
                return false;
