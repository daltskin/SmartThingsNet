...
{
    /// <summary>
    /// ServiceNewSubscription
    /// </summary>
    [DataContract(Name = "ServiceNewSubscription")]
    public partial class ServiceNewSubscription : IEquatable<ServiceNewSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceNewSubscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceNewSubscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceNewSubscription" /> class.
        /// </summary>
        /// <param name="locationId">location ID (required).</param>
        /// <param name="subscriptionId">subscription ID created.</param>
        public ServiceNewSubscription(string locationId = default(string), string subscriptionId = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for ServiceNewSubscription and cannot be null");
            }
        ...
        /// </summary>
        /// <value>subscription ID created</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceNewSubscription {\n");
        ...
        {
            return this.Equals(input as ServiceNewSubscription);
        }

        /// <summary>
        /// Returns true if ServiceNewSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceNewSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceNewSubscription input)
        {
            if (input == null)
            {
                return false;
