...
{
    /// <summary>
    /// ChangesConditionAllOf
    /// </summary>
    [DataContract(Name = "ChangesCondition_allOf")]
    public partial class ChangesConditionAllOf : IEquatable<ChangesConditionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangesConditionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangesConditionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangesConditionAllOf" /> class.
        /// </summary>
        /// <param name="id">Unique id for the condition (required).</param>
        /// <param name="operand">operand.</param>
        public ChangesConditionAllOf(string id = default(string), Operand operand = default(Operand))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ChangesConditionAllOf and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangesConditionAllOf {\n");
        ...
        {
            return this.Equals(input as ChangesConditionAllOf);
        }

        /// <summary>
        /// Returns true if ChangesConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangesConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangesConditionAllOf input)
        {
            if (input == null)
            {
                return false;
