...
namespace SmartThingsNet.Model
{
    ...
    /// PagedDriver
    /// </summary>
    [DataContract(Name = "PagedDriver")]
    public partial class PagedDriver : IEquatable<PagedDriver>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDriver" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedDriver() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDriver" /> class.
        /// </summary>
        /// <param name="driverId">The ID of the Sprocket driver (required).</param>
        /// <param name="name">The name of the driver (required).</param>
        /// <param name="packageKey">A user scoped package key that&#39;s used to lookup the respective driver record (required).</param>
        /// <param name="deviceIntegrationProfiles">deviceIntegrationProfiles.</param>
        /// <param name="permissions">permissions.</param>
        /// <param name="version">The version of the driver revision being returned.</param>
        public PagedDriver(string driverId = default(string), string name = default(string), string packageKey = default(string), List<DeviceIntegrationProfileKey> deviceIntegrationProfiles = default(List<DeviceIntegrationProfileKey>), List<DriverPermission> permissions = default(List<DriverPermission>), string version = default(string))
        {
            // to ensure "driverId" is required (not null)
            if (driverId == null) {
                throw new ArgumentNullException("driverId is a required property for PagedDriver and cannot be null");
            }
            this.DriverId = driverId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for PagedDriver and cannot be null");
            }
            this.Name = name;
            // to ensure "packageKey" is required (not null)
            if (packageKey == null) {
                throw new ArgumentNullException("packageKey is a required property for PagedDriver and cannot be null");
            }
            this.PackageKey = packageKey;
            this.DeviceIntegrationProfiles = deviceIntegrationProfiles;
            this.Permissions = permissions;
            this._Version = version;
        }

        /// <summary>
        /// The ID of the Sprocket driver
        /// </summary>
        /// <value>The ID of the Sprocket driver</value>
        ...
        /// <summary>
        /// A user scoped package key that&#39;s used to lookup the respective driver record
        /// </summary>
        /// <value>A user scoped package key that&#39;s used to lookup the respective driver record</value>
        [DataMember(Name = "packageKey", IsRequired = true, EmitDefaultValue = false)]
        public string PackageKey { get; set; }

        /// <summary>
        /// Gets or Sets DeviceIntegrationProfiles
        /// </summary>
        [DataMember(Name = "deviceIntegrationProfiles", EmitDefaultValue = false)]
        public List<DeviceIntegrationProfileKey> DeviceIntegrationProfiles { get; set; }

        /// <summary>
        /// Gets or Sets Permissions
        /// </summary>
        [DataMember(Name = "permissions", EmitDefaultValue = false)]
        public List<DriverPermission> Permissions { get; set; }

        /// <summary>
        /// The version of the driver revision being returned
        /// </summary>
        /// <value>The version of the driver revision being returned</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedDriver {\n");
            sb.Append("  DriverId: ").Append(DriverId).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  PackageKey: ").Append(PackageKey).Append("\n");
            sb.Append("  DeviceIntegrationProfiles: ").Append(DeviceIntegrationProfiles).Append("\n");
        ...
        {
            return this.Equals(input as PagedDriver);
        }

        /// <summary>
        /// Returns true if PagedDriver instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedDriver to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedDriver input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PackageKey == input.PackageKey ||
                    (this.PackageKey != null &&
                    this.PackageKey.Equals(input.PackageKey))
                ) && 
                (
                    this.DeviceIntegrationProfiles == input.DeviceIntegrationProfiles ||
                    this.DeviceIntegrationProfiles != null &&
                    input.DeviceIntegrationProfiles != null &&
                    this.DeviceIntegrationProfiles.SequenceEqual(input.DeviceIntegrationProfiles)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PackageKey.GetHashCode();
                }
                if (this.DeviceIntegrationProfiles != null)
                {
                    hashCode = (hashCode * 59) + this.DeviceIntegrationProfiles.GetHashCode();
                }
        ...
        {
            // PackageKey (string) pattern
            Regex regexPackageKey = new Regex(@"^[a-zA-Z0-9 _\/\\\\\\-()\\\\[\\\\]{}\\.]{1,36}$", RegexOptions.CultureInvariant);
            if (false == regexPackageKey.Match(this.PackageKey).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PackageKey, must match a pattern of " + regexPackageKey, new [] { "PackageKey" });
            }
