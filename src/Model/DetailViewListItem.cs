...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DetailViewListItem :  IEquatable<DetailViewListItem>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetailViewListItem {\n");
        ...
        {
            return this.Equals(input as DetailViewListItem);
        }

        /// <summary>
        /// Returns true if DetailViewListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailViewListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailViewListItem input)
        {
            if (input == null)
                return false;
