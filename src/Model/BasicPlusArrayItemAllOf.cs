...
{
    /// <summary>
    /// BasicPlusArrayItemAllOf
    /// </summary>
    [DataContract(Name = "basicPlusArrayItem_allOf")]
    public partial class BasicPlusArrayItemAllOf : IEquatable<BasicPlusArrayItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicPlusArrayItemAllOf" /> class.
        /// </summary>
        /// <param name="component">component.</param>
        public BasicPlusArrayItemAllOf(string component = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasicPlusArrayItemAllOf {\n");
        ...
        {
            return this.Equals(input as BasicPlusArrayItemAllOf);
        }

        /// <summary>
        /// Returns true if BasicPlusArrayItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicPlusArrayItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicPlusArrayItemAllOf input)
        {
            if (input == null)
            {
                return false;
