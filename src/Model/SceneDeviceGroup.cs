...
namespace SmartThingsNet.Model
{
    ...
    /// SceneDeviceGroup
    /// </summary>
    [DataContract(Name = "SceneDeviceGroup")]
    public partial class SceneDeviceGroup : IEquatable<SceneDeviceGroup>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneDeviceGroup {\n");
        ...
        {
            return this.Equals(input as SceneDeviceGroup);
        }

        /// <summary>
        /// Returns true if SceneDeviceGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneDeviceGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneDeviceGroup input)
        {
            if (input == null)
            {
                return false;
