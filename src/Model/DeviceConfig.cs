...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceConfig : IEquatable<DeviceConfig>, IValidatableObject
    {
        ...
        /// <param name="componentId">The component ID on the device..</param>
        /// <param name="permissions">permissions.</param>
        public DeviceConfig(string deviceId = default(string), string componentId = default(string), List<string> permissions = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>The component ID on the device.</value>
