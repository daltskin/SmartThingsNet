...
namespace SmartThingsNet.Model
{
    ...
    /// VisibleCondition
    /// </summary>
    [DataContract(Name = "visibleCondition")]
    public partial class VisibleCondition : IEquatable<VisibleCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public VisibleCondition(string capability = default(string), int version = 1, string component = default(string), string value = default(string), Operator _operator = default(Operator), string operand = default(string))
        {
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for VisibleCondition and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VisibleCondition {\n");
        ...
        {
            return this.Equals(input as VisibleCondition);
        }

        /// <summary>
        /// Returns true if VisibleCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of VisibleCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VisibleCondition input)
        {
            if (input == null)
            {
                return false;
