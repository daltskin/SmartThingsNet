...
namespace SmartThingsNet.Model
{
    ...
    public partial class VisibleCondition : IEquatable<VisibleCondition>, IValidatableObject
    {
        ...
        public VisibleCondition(string capability = default(string), int version = 1, string component = "main", string value = default(string), Operator _operator = default(Operator), string operand = default(string))
        {
