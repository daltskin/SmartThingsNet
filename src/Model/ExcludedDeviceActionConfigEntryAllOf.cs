...
{
    /// <summary>
    /// ExcludedDeviceActionConfigEntryAllOf
    /// </summary>
    [DataContract(Name = "excludedDeviceActionConfigEntry_allOf")]
    public partial class ExcludedDeviceActionConfigEntryAllOf : IEquatable<ExcludedDeviceActionConfigEntryAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedDeviceActionConfigEntryAllOf" /> class.
        /// </summary>
        /// <param name="exclusion">To exclude specified automation in &#x60;exclude&#x60; when this item is selected by the user..</param>
        public ExcludedDeviceActionConfigEntryAllOf(List<ExcludedActionItemId> exclusion = default(List<ExcludedActionItemId>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedDeviceActionConfigEntryAllOf {\n");
        ...
        {
            return this.Equals(input as ExcludedDeviceActionConfigEntryAllOf);
        }

        /// <summary>
        /// Returns true if ExcludedDeviceActionConfigEntryAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedDeviceActionConfigEntryAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedDeviceActionConfigEntryAllOf input)
        {
            if (input == null)
            {
                return false;
