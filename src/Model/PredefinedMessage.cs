...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PredefinedMessage")]
    public partial class PredefinedMessage : IEquatable<PredefinedMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PredefinedMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PredefinedMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PredefinedMessage" /> class.
        /// </summary>
        /// <param name="messageTemplateKey">messageTemplateKey (required).</param>
        /// <param name="defaultVariables">A map&lt;string,string&gt; with the key representing the variable name, and the value representing the verbiage to be replaced in template string. &#x60;defaultVariables&#x60; are only used when there are no matching &#x60;localeVariables&#x60;. .</param>
        /// <param name="localeVariables">Variables to resolve for specific locales. .</param>
        public PredefinedMessage(string messageTemplateKey = default(string), Dictionary<string, string> defaultVariables = default(Dictionary<string, string>), List<LocaleVariables> localeVariables = default(List<LocaleVariables>))
        {
            // to ensure "messageTemplateKey" is required (not null)
            if (messageTemplateKey == null) {
                throw new ArgumentNullException("messageTemplateKey is a required property for PredefinedMessage and cannot be null");
            }
            this.MessageTemplateKey = messageTemplateKey;
            this.DefaultVariables = defaultVariables;
            this.LocaleVariables = localeVariables;
        }

        /// <summary>
        /// Gets or Sets MessageTemplateKey
        /// </summary>
        [DataMember(Name = "messageTemplateKey", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A map&lt;string,string&gt; with the key representing the variable name, and the value representing the verbiage to be replaced in template string. &#x60;defaultVariables&#x60; are only used when there are no matching &#x60;localeVariables&#x60;. </value>
        [DataMember(Name = "defaultVariables", EmitDefaultValue = false)]
        public Dictionary<string, string> DefaultVariables { get; set; }

        /// <summary>
        /// Variables to resolve for specific locales. 
        /// </summary>
        /// <value>Variables to resolve for specific locales. </value>
        [DataMember(Name = "localeVariables", EmitDefaultValue = false)]
        public List<LocaleVariables> LocaleVariables { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PredefinedMessage {\n");
            sb.Append("  MessageTemplateKey: ").Append(MessageTemplateKey).Append("\n");
            sb.Append("  DefaultVariables: ").Append(DefaultVariables).Append("\n");
            sb.Append("  LocaleVariables: ").Append(LocaleVariables).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PredefinedMessage);
        }

        /// <summary>
        /// Returns true if PredefinedMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of PredefinedMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PredefinedMessage input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.MessageTemplateKey == input.MessageTemplateKey ||
                    (this.MessageTemplateKey != null &&
                    this.MessageTemplateKey.Equals(input.MessageTemplateKey))
                ) && 
                (
                    this.DefaultVariables == input.DefaultVariables ||
                    this.DefaultVariables != null &&
                    input.DefaultVariables != null &&
                    this.DefaultVariables.SequenceEqual(input.DefaultVariables)
                ) && 
                (
                    this.LocaleVariables == input.LocaleVariables ||
                    this.LocaleVariables != null &&
                    input.LocaleVariables != null &&
                    this.LocaleVariables.SequenceEqual(input.LocaleVariables)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DefaultVariables.GetHashCode();
                }
                if (this.LocaleVariables != null)
                {
                    hashCode = (hashCode * 59) + this.LocaleVariables.GetHashCode();
                }
                return hashCode;
            }
        }
