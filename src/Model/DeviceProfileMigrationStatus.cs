...
{
    /// <summary>
    /// Describes the migration status (from v1 -&gt; v2). This profile will be available in a backwards compatible fashion regardless.
    /// </summary>
    [DataContract(Name = "DeviceProfileMigrationStatus")]
    public partial class DeviceProfileMigrationStatus : IEquatable<DeviceProfileMigrationStatus>, IValidatableObject
    {
        /// <summary>
        /// Defines MigrationStatus
        /// </summary>
        ...
        public enum MigrationStatusEnum
        {
            ...
            /// <summary>
            /// Enum NOTMIGRATED for value: NOT_MIGRATED
            /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "migrationStatus", IsRequired = true, EmitDefaultValue = false)]
        public MigrationStatusEnum MigrationStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProfileMigrationStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceProfileMigrationStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProfileMigrationStatus" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceProfileMigrationStatus {\n");
        ...
        {
            return this.Equals(input as DeviceProfileMigrationStatus);
        }

        /// <summary>
        /// Returns true if DeviceProfileMigrationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceProfileMigrationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceProfileMigrationStatus input)
        {
            if (input == null)
            {
                return false;
