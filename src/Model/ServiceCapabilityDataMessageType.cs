...
{
    /// <summary>
    /// ServiceCapabilityDataMessageType
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_messageType")]
    public partial class ServiceCapabilityDataMessageType : IEquatable<ServiceCapabilityDataMessageType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataMessageType" /> class.
        /// </summary>
        /// <param name="value">1: new 2: update 3: cancel .</param>
        public ServiceCapabilityDataMessageType(int value = default(int))
        {
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>1: new 2: update 3: cancel </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataMessageType {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataMessageType);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataMessageType instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataMessageType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataMessageType input)
        {
            if (input == null)
            {
                return false;
