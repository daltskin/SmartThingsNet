...
namespace SmartThingsNet.Model
{
    ...
    public partial class DateOperand : IEquatable<DateOperand>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DateOperand);
        }

        /// <summary>
        /// Returns true if DateOperand instances are equal
        /// </summary>
        /// <param name="input">Instance of DateOperand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateOperand input)
        {
            if (input == null)
            {
                return false;
