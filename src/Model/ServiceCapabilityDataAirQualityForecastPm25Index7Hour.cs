...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm25Index7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm25Index7Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm25Index7Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm25Index7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm25Index7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 7 hours index forecast of particulate matter less than 2.5 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm25Index7Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) 7 hours index forecast of particulate matter less than 2.5 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 7 hours index forecast of particulate matter less than 2.5 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm25Index7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm25Index7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm25Index7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm25Index7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm25Index7Hour input)
        {
            if (input == null)
            {
                return false;
