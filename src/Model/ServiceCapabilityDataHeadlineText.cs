...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_headlineText")]
    public partial class ServiceCapabilityDataHeadlineText : IEquatable<ServiceCapabilityDataHeadlineText>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataHeadlineText" /> class.
        /// </summary>
        /// <param name="value">severe alert headline text.</param>
        public ServiceCapabilityDataHeadlineText(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// severe alert headline text
        /// </summary>
        /// <value>severe alert headline text</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataHeadlineText {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataHeadlineText);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataHeadlineText instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataHeadlineText to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataHeadlineText input)
        {
            if (input == null)
            {
                return false;
