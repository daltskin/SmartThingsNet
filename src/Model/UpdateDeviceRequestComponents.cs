...
{
    /// <summary>
    /// UpdateDeviceRequestComponents
    /// </summary>
    [DataContract]
    public partial class UpdateDeviceRequestComponents :  IEquatable<UpdateDeviceRequestComponents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDeviceRequestComponents" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDeviceRequestComponents() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDeviceRequestComponents" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="categories">A case-sensitive string from the pre-defined list of valid categories [/devicecategories](#/operation/listCategories). (required).</param>
        public UpdateDeviceRequestComponents(string id = default(string), List<string> categories = default(List<string>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for UpdateDeviceRequestComponents and cannot be null");
            // to ensure "categories" is required (not null)
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for UpdateDeviceRequestComponents and cannot be null");
        }
        ...
        /// </summary>
        /// <value>A case-sensitive string from the pre-defined list of valid categories [/devicecategories](#/operation/listCategories).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDeviceRequestComponents {\n");
        ...
        {
            return this.Equals(input as UpdateDeviceRequestComponents);
        }

        /// <summary>
        /// Returns true if UpdateDeviceRequestComponents instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDeviceRequestComponents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDeviceRequestComponents input)
        {
            if (input == null)
                return false;
