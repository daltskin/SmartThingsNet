...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateDeviceProfileRequest")]
    public partial class UpdateDeviceProfileRequest : IEquatable<UpdateDeviceProfileRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDeviceProfileRequest" /> class.
        /// </summary>
        /// <param name="components">A list of &#x60;[ 1..20 ]&#x60; components for this profile..</param>
        ...
        public UpdateDeviceProfileRequest(List<DeviceComponentRequest> components = default(List<DeviceComponentRequest>), Dictionary<string, string> metadata = default(Dictionary<string, string>), List<PreferenceRequest> preferences = default(List<PreferenceRequest>))
        {
        ...
        /// </summary>
        /// <value>A list of &#x60;[ 1..20 ]&#x60; components for this profile.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDeviceProfileRequest {\n");
        ...
        {
            return this.Equals(input as UpdateDeviceProfileRequest);
        }

        /// <summary>
        /// Returns true if UpdateDeviceProfileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDeviceProfileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDeviceProfileRequest input)
        {
            if (input == null)
            {
                return false;
