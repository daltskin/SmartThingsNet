...
namespace SmartThingsNet.Model
{
    ...
    public partial class UpdateDeviceProfileRequest :  IEquatable<UpdateDeviceProfileRequest>, IValidatableObject
    {
        ...
        public UpdateDeviceProfileRequest(List<DeviceComponentReference> components = default(List<DeviceComponentReference>), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
