...
namespace SmartThingsNet.Model
{
    ...
    public partial class ListForArgument :  IEquatable<ListForArgument>, IValidatableObject
    {
        ...
        /// <param name="name">Argument name of a command.</param>
        public ListForArgument(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string), string name = default(string))
        {
            // to ensure "alternatives" is required (not null)
            this.Alternatives = alternatives ?? throw new ArgumentNullException("alternatives is a required property for ListForArgument and cannot be null");
