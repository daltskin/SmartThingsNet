...
namespace SmartThingsNet.Model
{
    ...
    /// ListForArgument
    /// </summary>
    [DataContract(Name = "listForArgument")]
    public partial class ListForArgument : IEquatable<ListForArgument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForArgument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForArgument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForArgument" /> class.
        /// </summary>
        ...
        /// <param name="name">Argument name of a command (required).</param>
        /// <param name="argumentType">The data type of the &#x60;argument&#x60;. It&#39;s automatically filled from the given capability..</param>
        public ListForArgument(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string), string name = default(string), string argumentType = default(string))
        {
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for ListForArgument and cannot be null");
            }
            this.Alternatives = alternatives;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for ListForArgument and cannot be null");
            }
            this.Name = name;
        ...
        /// <summary>
        /// Argument name of a command
        /// </summary>
        /// <value>Argument name of a command</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForArgument {\n");
        ...
        {
            return this.Equals(input as ListForArgument);
        }

        /// <summary>
        /// Returns true if ListForArgument instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForArgument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForArgument input)
        {
            if (input == null)
            {
                return false;
