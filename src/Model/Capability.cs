...
namespace SmartThingsNet.Model
{
    ...
    public partial class Capability :  IEquatable<Capability>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">A URL safe unique identifier for the capability..</param>
        /// <param name="version">The version number of the capability..</param>
        /// <param name="status">The status of the capability. * __proposed__ - The capability is currently under development / in review.  The capability definition may go through changes, some of which may currently not function properly. * __live__ - The capability has been through review and the definition has been codified.  Once a definition transitions from proposed to live, it cannot be altered. * __deprecated__ - The capability is marked for removal in future versions.  It should only be used during a short period of time to allow for existing integrations and automations to continue to work while the transition to a newer definition is made. * __dead__ - A previously deprecated definition is now ready for removal.  Usage of the deprecated definition had dropped to a sufficiently low enough level to warrant removal.  The dead definition still exists but it can no longer be used or implemented by devices. .</param>
        /// <param name="name">An alphanumeric English language name for the capability..</param>
        ...
        public Capability(string id = default(string), int version = default(int), StatusEnum? status = default(StatusEnum?), string name = default(string), Dictionary<string, CapabilityAttribute> attributes = default(Dictionary<string, CapabilityAttribute>), Dictionary<string, CapabilityCommand> commands = default(Dictionary<string, CapabilityCommand>))
        {
            this.Id = id;
