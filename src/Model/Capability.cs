...
namespace SmartThingsNet.Model
{
    ...
    {
        /// <summary>
        /// The status of the capability. * __proposed__ - The capability is currently under development / in review.  The capability definition may go through changes, some of which may currently not function properly. * __live__ - The capability has been through review and the definition has been codified.  Once a definition transitions from proposed to live, it cannot be altered. * __deprecated__ - The capability is marked for removal in future versions.  It should only be used during a short period of time to allow for existing integrations and automations to continue to work while the transition to a newer definition is made. * __dead__ - A previously deprecated definition is now ready for removal.  Usage of the deprecated definition had dropped to a sufficiently low enough level to warrant removal.  The dead definition still exists but it can no longer be used or implemented by devices. 
        /// </summary>
        /// <value>The status of the capability. * __proposed__ - The capability is currently under development / in review.  The capability definition may go through changes, some of which may currently not function properly. * __live__ - The capability has been through review and the definition has been codified.  Once a definition transitions from proposed to live, it cannot be altered. * __deprecated__ - The capability is marked for removal in future versions.  It should only be used during a short period of time to allow for existing integrations and automations to continue to work while the transition to a newer definition is made. * __dead__ - A previously deprecated definition is now ready for removal.  Usage of the deprecated definition had dropped to a sufficiently low enough level to warrant removal.  The dead definition still exists but it can no longer be used or implemented by devices. </value>
        ...
        /// Initializes a new instance of the <see cref="Capability" /> class.
        /// </summary>
        /// <param name="id">A URL safe unique identifier for the capability. (required).</param>
        /// <param name="version">The version number of the capability. (required).</param>
        /// <param name="status">The status of the capability. * __proposed__ - The capability is currently under development / in review.  The capability definition may go through changes, some of which may currently not function properly. * __live__ - The capability has been through review and the definition has been codified.  Once a definition transitions from proposed to live, it cannot be altered. * __deprecated__ - The capability is marked for removal in future versions.  It should only be used during a short period of time to allow for existing integrations and automations to continue to work while the transition to a newer definition is made. * __dead__ - A previously deprecated definition is now ready for removal.  Usage of the deprecated definition had dropped to a sufficiently low enough level to warrant removal.  The dead definition still exists but it can no longer be used or implemented by devices.  (required).</param>
        /// <param name="name">An alphanumeric English language name for the capability. (required).</param>
        /// <param name="ephemeral">ephemeral (default to false).</param>
        /// <param name="attributes">A mapping of attribute names to their definitions. All attribute names are lower camelcase..</param>
        /// <param name="commands">A mapping of command names to their definitions. All command names are lower camelcase..</param>
        public Capability(string id = default(string), int version = default(int), StatusEnum status = default(StatusEnum), string name = default(string), bool ephemeral = false, Dictionary<string, CapabilityAttribute> attributes = default(Dictionary<string, CapabilityAttribute>), Dictionary<string, CapabilityCommand> commands = default(Dictionary<string, CapabilityCommand>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for Capability and cannot be null");
            }
            this.Id = id;
            ...
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Capability and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>A URL safe unique identifier for the capability.</value>
        ...
        /// </summary>
        /// <value>An alphanumeric English language name for the capability.</value>
        ...
        /// </summary>
        [DataMember(Name = "ephemeral", EmitDefaultValue = true)]
        public bool Ephemeral { get; set; }

        /// <summary>
        /// A mapping of attribute names to their definitions. All attribute names are lower camelcase.
        /// </summary>
        /// <value>A mapping of attribute names to their definitions. All attribute names are lower camelcase.</value>
        [DataMember(Name = "attributes", EmitDefaultValue = false)]
        public Dictionary<string, CapabilityAttribute> Attributes { get; set; }

        /// <summary>
        /// A mapping of command names to their definitions. All command names are lower camelcase.
        /// </summary>
        /// <value>A mapping of command names to their definitions. All command names are lower camelcase.</value>
        [DataMember(Name = "commands", EmitDefaultValue = false)]
        public Dictionary<string, CapabilityCommand> Commands { get; set; }
