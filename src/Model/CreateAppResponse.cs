...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAppResponse")]
    public partial class CreateAppResponse : IEquatable<CreateAppResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateAppResponse(App app = default(App), Guid oauthClientId = default(Guid), Guid oauthClientSecret = default(Guid))
        {
            this.App = app;
        ...
        /// <summary>
        /// Returns true if CreateAppResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAppResponse to be compared</param>
        /// <returns>Boolean</returns>
