...
namespace SmartThingsNet.Model
{
    ...
    /// AppOAuth
    /// </summary>
    [DataContract(Name = "AppOAuth")]
    public partial class AppOAuth : IEquatable<AppOAuth>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppOAuth" /> class.
        /// </summary>
        ...
        /// <param name="redirectUris">A list of redirect URIs..</param>
        public AppOAuth(string clientName = default(string), List<string> scope = default(List<string>), List<string> redirectUris = default(List<string>))
        {
        ...
        {
            return this.Equals(input as AppOAuth);
        }

        /// <summary>
        /// Returns true if AppOAuth instances are equal
        /// </summary>
        /// <param name="input">Instance of AppOAuth to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppOAuth input)
        {
            if (input == null)
            {
                return false;
