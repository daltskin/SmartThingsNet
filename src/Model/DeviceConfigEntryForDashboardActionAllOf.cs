...
{
    /// <summary>
    /// DeviceConfigEntryForDashboardActionAllOf
    /// </summary>
    [DataContract(Name = "deviceConfigEntryForDashboardAction_allOf")]
    public partial class DeviceConfigEntryForDashboardActionAllOf : IEquatable<DeviceConfigEntryForDashboardActionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryForDashboardActionAllOf" /> class.
        /// </summary>
        ...
        public DeviceConfigEntryForDashboardActionAllOf(int idx = 0, string group = "main")
        {
            this.Idx = idx;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntryForDashboardActionAllOf {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntryForDashboardActionAllOf);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntryForDashboardActionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntryForDashboardActionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntryForDashboardActionAllOf input)
        {
            if (input == null)
            {
                return false;
