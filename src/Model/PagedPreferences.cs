...
namespace SmartThingsNet.Model
{
    ...
    /// PagedPreferences
    /// </summary>
    [DataContract(Name = "PagedPreferences")]
    public partial class PagedPreferences : IEquatable<PagedPreferences>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedPreferences" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedPreferences(List<PreferenceResponse> items = default(List<PreferenceResponse>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<PreferenceResponse> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedPreferences {\n");
        ...
        {
            return this.Equals(input as PagedPreferences);
        }

        /// <summary>
        /// Returns true if PagedPreferences instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedPreferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedPreferences input)
        {
            if (input == null)
            {
                return false;
