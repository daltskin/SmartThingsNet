...
{
    /// <summary>
    /// ZigbeeManufacturerFingerprint
    /// </summary>
    [DataContract(Name = "ZigbeeManufacturerFingerprint")]
    public partial class ZigbeeManufacturerFingerprint : IEquatable<ZigbeeManufacturerFingerprint>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Reported manufacturer of the device</value>
        ...
        /// </summary>
        /// <value>Reported model of the device</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZigbeeManufacturerFingerprint {\n");
        ...
        {
            return this.Equals(input as ZigbeeManufacturerFingerprint);
        }

        /// <summary>
        /// Returns true if ZigbeeManufacturerFingerprint instances are equal
        /// </summary>
        /// <param name="input">Instance of ZigbeeManufacturerFingerprint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZigbeeManufacturerFingerprint input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.Manufacturer != null && this.Manufacturer.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Manufacturer, length must be less than 32.", new [] { "Manufacturer" });
            }

            // Manufacturer (string) minLength
            if (this.Manufacturer != null && this.Manufacturer.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Manufacturer, length must be greater than 0.", new [] { "Manufacturer" });
            }

            // Model (string) maxLength
            if (this.Model != null && this.Model.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Model, length must be less than 32.", new [] { "Model" });
            }

            // Model (string) minLength
            if (this.Model != null && this.Model.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Model, length must be greater than 0.", new [] { "Model" });
            }
