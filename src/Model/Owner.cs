...
namespace SmartThingsNet.Model
{
    ...
    public partial class Owner :  IEquatable<Owner>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The account type which owns the specific domain item.</value>
        ...
        /// </summary>
        /// <param name="ownerType">The account type which owns the specific domain item. (default to OwnerTypeEnum.USER).</param>
        /// <param name="ownerId">A global idenfifier for owner..</param>
        ...
        /// </summary>
        /// <value>A global idenfifier for owner.</value>
