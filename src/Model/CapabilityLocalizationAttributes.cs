...
{
    /// <summary>
    /// CapabilityLocalizationAttributes
    /// </summary>
    [DataContract(Name = "CapabilityLocalization_attributes")]
    public partial class CapabilityLocalizationAttributes : IEquatable<CapabilityLocalizationAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalizationAttributes" /> class.
        /// </summary>
        /// <param name="label">The localized version of the label value.</param>
        /// <param name="description">A localized description of what the attribute represents.</param>
        /// <param name="displayTemplate">A template string for the text that will be displayed regarding the attribute state..</param>
        /// <param name="i18n">Map of state property (value, unit, etc..) to localization mapping.</param>
        public CapabilityLocalizationAttributes(string label = default(string), string description = default(string), string displayTemplate = default(string), Dictionary<string, Dictionary<string, Object>> i18n = default(Dictionary<string, Dictionary<string, Object>>))
        {
            this.Label = label;
        ...
        /// </summary>
        /// <value>The localized version of the label value</value>
        ...
        /// </summary>
        /// <value>A localized description of what the attribute represents</value>
        ...
        /// </summary>
        /// <value>A template string for the text that will be displayed regarding the attribute state.</value>
        ...
        /// </summary>
        /// <value>Map of state property (value, unit, etc..) to localization mapping</value>
        [DataMember(Name = "i18n", EmitDefaultValue = false)]
        public Dictionary<string, Dictionary<string, Object>> I18n { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityLocalizationAttributes {\n");
        ...
        {
            return this.Equals(input as CapabilityLocalizationAttributes);
        }

        /// <summary>
        /// Returns true if CapabilityLocalizationAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityLocalizationAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityLocalizationAttributes input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DisplayTemplate == input.DisplayTemplate ||
                    (this.DisplayTemplate != null &&
                    this.DisplayTemplate.Equals(input.DisplayTemplate))
                ) && 
                (
                    this.I18n == input.I18n ||
                    this.I18n != null &&
                    input.I18n != null &&
                    this.I18n.SequenceEqual(input.I18n)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DisplayTemplate.GetHashCode();
                }
                if (this.I18n != null)
                {
