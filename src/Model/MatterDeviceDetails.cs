...
{
    /// <summary>
    /// Device Profile information for Matter devices. This field will be empty if the device type is not MATTER
    /// </summary>
    [DataContract(Name = "MatterDeviceDetails")]
    public partial class MatterDeviceDetails : IEquatable<MatterDeviceDetails>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MatterDeviceDetails" /> class.
        /// </summary>
        ...
        /// <param name="uniqueId">Optional Vendor-supplied unique identifier..</param>
        public MatterDeviceDetails(string driverId = default(string), string hubId = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string networkId = default(string), bool executingLocally = default(bool), string uniqueId = default(string))
        {
        ...
        /// </summary>
        /// <value>Optional Vendor-supplied unique identifier.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MatterDeviceDetails {\n");
        ...
        {
            return this.Equals(input as MatterDeviceDetails);
        }

        /// <summary>
        /// Returns true if MatterDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of MatterDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatterDeviceDetails input)
        {
            if (input == null)
            {
                return false;
