...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstalledApp_iconImage")]
    public partial class InstalledAppIconImage : IEquatable<InstalledAppIconImage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstalledAppIconImage" /> class.
        /// </summary>
        /// <param name="url">A default icon image url for an app. https url required. .</param>
        public InstalledAppIconImage(string url = default(string))
        {
            this.Url = url;
        }
        ...
        /// </summary>
        /// <value>A default icon image url for an app. https url required. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstalledAppIconImage {\n");
        ...
        {
            return this.Equals(input as InstalledAppIconImage);
        }

        /// <summary>
        /// Returns true if InstalledAppIconImage instances are equal
        /// </summary>
        /// <param name="input">Instance of InstalledAppIconImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstalledAppIconImage input)
        {
            if (input == null)
            {
                return false;
