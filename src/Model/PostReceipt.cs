...
namespace SmartThingsNet.Model
{
    ...
    /// PostReceipt
    /// </summary>
    [DataContract(Name = "PostReceipt")]
    public partial class PostReceipt : IEquatable<PostReceipt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostReceipt" /> class.
        /// </summary>
        /// <param name="endpointAppId">endpointAppId.</param>
        /// <param name="stClientId">stClientId.</param>
        /// <param name="stClientSecret">stClientSecret.</param>
        public PostReceipt(Guid endpointAppId = default(Guid), Guid stClientId = default(Guid), Guid stClientSecret = default(Guid))
        {
        ...
        /// <summary>
        /// Gets or Sets EndpointAppId
        /// </summary>
        [DataMember(Name = "endpointAppId", EmitDefaultValue = false)]
        public Guid EndpointAppId { get; set; }

        /// <summary>
        /// Gets or Sets StClientId
        /// </summary>
        [DataMember(Name = "stClientId", EmitDefaultValue = false)]
        public Guid StClientId { get; set; }

        /// <summary>
        /// Gets or Sets StClientSecret
        /// </summary>
        [DataMember(Name = "stClientSecret", EmitDefaultValue = false)]
        public Guid StClientSecret { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostReceipt {\n");
            sb.Append("  EndpointAppId: ").Append(EndpointAppId).Append("\n");
            sb.Append("  StClientId: ").Append(StClientId).Append("\n");
            sb.Append("  StClientSecret: ").Append(StClientSecret).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PostReceipt);
        }

        /// <summary>
        /// Returns true if PostReceipt instances are equal
        /// </summary>
        /// <param name="input">Instance of PostReceipt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostReceipt input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StClientId == input.StClientId ||
                    (this.StClientId != null &&
                    this.StClientId.Equals(input.StClientId))
                ) && 
                (
                    this.StClientSecret == input.StClientSecret ||
                    (this.StClientSecret != null &&
                    this.StClientSecret.Equals(input.StClientSecret))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StClientId != null)
                {
                    hashCode = (hashCode * 59) + this.StClientId.GetHashCode();
                }
                if (this.StClientSecret != null)
                {
                    hashCode = (hashCode * 59) + this.StClientSecret.GetHashCode();
                }
                return hashCode;
            }
        }
