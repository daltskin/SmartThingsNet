...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceHealthDetail")]
    public partial class DeviceHealthDetail : IEquatable<DeviceHealthDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceHealthDetail" /> class.
        /// </summary>
        ...
        public DeviceHealthDetail(List<string> deviceIds = default(List<string>), string subscriptionName = default(string), string locationId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceHealthDetail {\n");
        ...
        {
            return this.Equals(input as DeviceHealthDetail);
        }

        /// <summary>
        /// Returns true if DeviceHealthDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceHealthDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceHealthDetail input)
        {
            if (input == null)
            {
                return false;
