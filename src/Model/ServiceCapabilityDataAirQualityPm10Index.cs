...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityPm10Index
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_pm10Index")]
    public partial class ServiceCapabilityDataAirQualityPm10Index : IEquatable<ServiceCapabilityDataAirQualityPm10Index>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityPm10Index" /> class.
        /// </summary>
        /// <param name="value">index of particulate matter less than 10 microns.</param>
        /// <param name="unit">EPA.</param>
        public ServiceCapabilityDataAirQualityPm10Index(int value = default(int), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// index of particulate matter less than 10 microns
        /// </summary>
        /// <value>index of particulate matter less than 10 microns</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityPm10Index {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityPm10Index);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityPm10Index instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityPm10Index to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityPm10Index input)
        {
            if (input == null)
            {
                return false;
