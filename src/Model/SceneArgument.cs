...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneArgument")]
    public partial class SceneArgument : IEquatable<SceneArgument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneArgument" /> class.
        /// </summary>
        /// <param name="name">the name of the command.</param>
        /// <param name="schema">the schema of the command.</param>
        /// <param name="value">The value being set for the capability command.</param>
        public SceneArgument(string name = default(string), Object schema = default(Object), Object value = default(Object))
        {
            this.Name = name;
            this.Schema = schema;
            this.Value = value;
        ...
        /// </summary>
        /// <value>the schema of the command</value>
        ...
        /// </summary>
        /// <value>The value being set for the capability command</value>
        ...
        {
            return this.Equals(input as SceneArgument);
        }

        /// <summary>
        /// Returns true if SceneArgument instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneArgument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneArgument input)
        {
            if (input == null)
            {
                return false;
