...
{
    /// <summary>
    /// DeviceConfigEntryBase
    /// </summary>
    [DataContract(Name = "deviceConfigEntryBase")]
    public partial class DeviceConfigEntryBase : IEquatable<DeviceConfigEntryBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceConfigEntryBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryBase" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntryBase {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntryBase);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntryBase instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntryBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntryBase input)
        {
            if (input == null)
            {
                return false;
