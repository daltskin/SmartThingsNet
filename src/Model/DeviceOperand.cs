...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceOperand
    /// </summary>
    [DataContract(Name = "DeviceOperand")]
    public partial class DeviceOperand : IEquatable<DeviceOperand>, IValidatableObject
    {
        ...
        public DeviceOperand(List<string> devices = default(List<string>), string component = default(string), string capability = default(string), string attribute = default(string), string path = default(string), OperandAggregationMode? aggregation = default(OperandAggregationMode?), TriggerMode? trigger = default(TriggerMode?))
        {
            // to ensure "devices" is required (not null)
            if (devices == null) {
                throw new ArgumentNullException("devices is a required property for DeviceOperand and cannot be null");
            }
            this.Devices = devices;
            // to ensure "component" is required (not null)
            if (component == null) {
                throw new ArgumentNullException("component is a required property for DeviceOperand and cannot be null");
            }
            this.Component = component;
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for DeviceOperand and cannot be null");
            }
            this.Capability = capability;
            // to ensure "attribute" is required (not null)
            if (attribute == null) {
                throw new ArgumentNullException("attribute is a required property for DeviceOperand and cannot be null");
            }
        ...
        {
            return this.Equals(input as DeviceOperand);
        }

        /// <summary>
        /// Returns true if DeviceOperand instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceOperand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceOperand input)
        {
            if (input == null)
            {
                return false;
