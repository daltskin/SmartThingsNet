...
{
    /// <summary>
    /// To specify separate commands for play and stop, use the \&quot;play\&quot; and \&quot;stop\&quot; fields respectively. To specify a single command, use “name” for the command and the \&quot; play\&quot; and \&quot;stop\&quot; fields for the arguments.
    /// </summary>
    [DataContract]
    public partial class PlayStop :  IEquatable<PlayStop>, IValidatableObject
    {
        /// <summary>
        ...
        public PlayStop(PlayStopCommandCommand command = default(PlayStopCommandCommand), PlayStopAllOfState state = default(PlayStopAllOfState))
        {
            ...
            this.Command = command ?? throw new ArgumentNullException("command is a required property for PlayStop and cannot be null");
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state is a required property for PlayStop and cannot be null");
        }
        ...
        public PlayStopCommandCommand Command { get; set; }

        /// <summary>
        /// Gets or Sets State
        /// </summary>
        [DataMember(Name="state", EmitDefaultValue=false)]
        public PlayStopAllOfState State { get; set; }
        ...
        {
            return this.Equals(input as PlayStop);
        }

        /// <summary>
        /// Returns true if PlayStop instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayStop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayStop input)
        {
            if (input == null)
                return false;
