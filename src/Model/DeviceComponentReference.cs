...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceComponentReference :  IEquatable<DeviceComponentReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceComponentReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceComponentReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceComponentReference" /> class.
        /// </summary>
        ...
        public DeviceComponentReference(string id = default(string), List<CapabilityReference> capabilities = default(List<CapabilityReference>), List<DeviceCategory> categories = default(List<DeviceCategory>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for DeviceComponentReference and cannot be null");
            // to ensure "capabilities" is required (not null)
            this.Capabilities = capabilities ?? throw new ArgumentNullException("capabilities is a required property for DeviceComponentReference and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceComponentReference {\n");
        ...
        {
            return this.Equals(input as DeviceComponentReference);
        }

        /// <summary>
        /// Returns true if DeviceComponentReference instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceComponentReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceComponentReference input)
        {
            if (input == null)
                return false;
