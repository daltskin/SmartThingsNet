...
namespace SmartThingsNet.Model
{
    ...
    public partial class Mode :  IEquatable<Mode>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Mode" /> class.
        /// </summary>
        /// <param name="id">Globally unique id for the mode. (required).</param>
        /// <param name="label">A name provided by the User. Unique per location, updatable. (required).</param>
        /// <param name="name">A name provided when the mode was created. The name is unique per location, and can not be updated. (required).</param>
        public Mode(string id = default(string), string label = default(string), string name = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Mode and cannot be null");
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for Mode and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Mode and cannot be null");
        }
        
        /// <summary>
        /// Globally unique id for the mode.
        /// </summary>
        /// <value>Globally unique id for the mode.</value>
        ...
        /// </summary>
        /// <value>A name provided by the User. Unique per location, updatable.</value>
        ...
        /// </summary>
        /// <value>A name provided when the mode was created. The name is unique per location, and can not be updated.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Label, length must be less than 25.", new [] { "Label" });
            }
