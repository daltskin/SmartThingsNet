...
namespace SmartThingsNet.Model
{
    ...
    public partial class Mode : IEquatable<Mode>, IValidatableObject
    {
        ...
        public Mode(string id = default(string), string label = default(string), string name = default(string))
        {
            ...
            if (id == null) {
                throw new ArgumentNullException("id is a required property for Mode and cannot be null");
            }
            this.Id = id;
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for Mode and cannot be null");
            }
            this.Label = label;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Mode and cannot be null");
            }
            this.Name = name;
        }
