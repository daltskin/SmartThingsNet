...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RuleAllOf :  IEquatable<RuleAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public RuleAllOf(string id = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for RuleAllOf and cannot be null");
        }
        ...
        {
            return this.Equals(input as RuleAllOf);
        }

        /// <summary>
        /// Returns true if RuleAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RuleAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuleAllOf input)
        {
            if (input == null)
                return false;
