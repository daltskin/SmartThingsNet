...
namespace SmartThingsNet.Model
{
    ...
    /// IfActionSequence
    /// </summary>
    [DataContract(Name = "IfActionSequence")]
    public partial class IfActionSequence : IEquatable<IfActionSequence>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IfActionSequence {\n");
        ...
        {
            return this.Equals(input as IfActionSequence);
        }

        /// <summary>
        /// Returns true if IfActionSequence instances are equal
        /// </summary>
        /// <param name="input">Instance of IfActionSequence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IfActionSequence input)
        {
            if (input == null)
            {
                return false;
