...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    /// <value>For hub-connected devices on protocols with multiple security levels, the security level the device was added with. Values ZWAVE_S2_FAILED, ZWAVE_S0_FAILED, ZWAVE_S2_DOWNGRADE, and ZWAVE_S0_DOWNGRADE should be treated as failures and prompt the user to remove and re-add the device. Other Z-Wave values are success cases. </value>
    ...
    public enum DeviceNetworkSecurityLevel
    {
        ...
        /// <summary>
        /// Enum ZWAVELEGACYNONSECURE for value: ZWAVE_LEGACY_NON_SECURE
        /// </summary>
        [EnumMember(Value = "ZWAVE_LEGACY_NON_SECURE")]
        ZWAVELEGACYNONSECURE = 2,

        /// <summary>
        /// Enum ZWAVES0LEGACY for value: ZWAVE_S0_LEGACY
        /// </summary>
        [EnumMember(Value = "ZWAVE_S0_LEGACY")]
        ZWAVES0LEGACY = 3,

        /// <summary>
        /// Enum ZWAVES0FALLBACK for value: ZWAVE_S0_FALLBACK
        /// </summary>
        [EnumMember(Value = "ZWAVE_S0_FALLBACK")]
        ZWAVES0FALLBACK = 4,

        /// <summary>
        /// Enum ZWAVES2UNAUTHENTICATED for value: ZWAVE_S2_UNAUTHENTICATED
        /// </summary>
        [EnumMember(Value = "ZWAVE_S2_UNAUTHENTICATED")]
        ZWAVES2UNAUTHENTICATED = 5,

        /// <summary>
        /// Enum ZWAVES2AUTHENTICATED for value: ZWAVE_S2_AUTHENTICATED
        /// </summary>
        [EnumMember(Value = "ZWAVE_S2_AUTHENTICATED")]
        ZWAVES2AUTHENTICATED = 6,

        /// <summary>
        /// Enum ZWAVES2ACCESSCONTROL for value: ZWAVE_S2_ACCESS_CONTROL
        /// </summary>
        [EnumMember(Value = "ZWAVE_S2_ACCESS_CONTROL")]
        ZWAVES2ACCESSCONTROL = 7,

        /// <summary>
        /// Enum ZWAVES2FAILED for value: ZWAVE_S2_FAILED
        /// </summary>
        [EnumMember(Value = "ZWAVE_S2_FAILED")]
        ZWAVES2FAILED = 8,

        /// <summary>
        /// Enum ZWAVES0FAILED for value: ZWAVE_S0_FAILED
        /// </summary>
        [EnumMember(Value = "ZWAVE_S0_FAILED")]
        ZWAVES0FAILED = 9,

        /// <summary>
        /// Enum ZWAVES2DOWNGRADE for value: ZWAVE_S2_DOWNGRADE
        /// </summary>
        [EnumMember(Value = "ZWAVE_S2_DOWNGRADE")]
        ZWAVES2DOWNGRADE = 10,

        /// <summary>
        /// Enum ZWAVES0DOWNGRADE for value: ZWAVE_S0_DOWNGRADE
        /// </summary>
        [EnumMember(Value = "ZWAVE_S0_DOWNGRADE")]
        ZWAVES0DOWNGRADE = 11
