...
{
    /// <summary>
    /// CapabilityPresentationAllOf
    /// </summary>
    [DataContract(Name = "capabilityPresentation_allOf")]
    public partial class CapabilityPresentationAllOf : IEquatable<CapabilityPresentationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityPresentationAllOf" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="version">The version number of the capability. (default to 1).</param>
        public CapabilityPresentationAllOf(string id = default(string), int version = 1)
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityPresentationAllOf {\n");
        ...
        {
            return this.Equals(input as CapabilityPresentationAllOf);
        }

        /// <summary>
        /// Returns true if CapabilityPresentationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityPresentationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityPresentationAllOf input)
        {
            if (input == null)
            {
                return false;
