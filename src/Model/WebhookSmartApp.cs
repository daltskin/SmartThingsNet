...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookSmartApp")]
    public partial class WebhookSmartApp : IEquatable<WebhookSmartApp>, IValidatableObject
    {
        ...
        public AppTargetStatus? TargetStatus { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookSmartApp" /> class.
        /// </summary>
        /// <param name="targetUrl">A URL that should be invoked during execution..</param>
        /// <param name="targetStatus">targetStatus.</param>
        /// <param name="publicKey">The public half of an RSA key pair.  Useful for verifying a Webhook execution request signature to ensure it came from SmartThings. .</param>
        /// <param name="signatureType">signatureType.</param>
        public WebhookSmartApp(string targetUrl = default(string), AppTargetStatus? targetStatus = default(AppTargetStatus?), string publicKey = default(string), SignatureType? signatureType = default(SignatureType?))
        {
        ...
        /// </summary>
        /// <value>A URL that should be invoked during execution.</value>
        ...
        /// </summary>
        /// <value>The public half of an RSA key pair.  Useful for verifying a Webhook execution request signature to ensure it came from SmartThings. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookSmartApp {\n");
        ...
        {
            return this.Equals(input as WebhookSmartApp);
        }

        /// <summary>
        /// Returns true if WebhookSmartApp instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookSmartApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookSmartApp input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.TargetStatus.Equals(input.TargetStatus)
                ) && 
                (
