...
namespace SmartThingsNet.Model
{
    ...
    /// PreferenceRequest
    /// </summary>
    [DataContract(Name = "PreferenceRequest")]
    public partial class PreferenceRequest : IEquatable<PreferenceRequest>, IValidatableObject
    {

        /// <summary>
        /// Gets or Sets PreferenceType
        /// </summary>
        [DataMember(Name = "preferenceType", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The ID of the preference</value>
        [DataMember(Name = "preferenceId", EmitDefaultValue = false)]
        public string PreferenceId { get; set; }

        /// <summary>
        /// An alphanumeric English language name for this preference. Will be appended to a namespace to generate the full preference id.
        /// </summary>
        /// <value>An alphanumeric English language name for this preference. Will be appended to a namespace to generate the full preference id.</value>
        ...
        /// </summary>
        /// <value>A short description for this preference.</value>
        ...
        /// </summary>
        /// <value>A long description for this preference.</value>
        [DataMember(Name = "description", EmitDefaultValue = false)]
        public string Description { get; set; }

        /// <summary>
        /// A flag describing whether this preference is explicit, or inline.
        /// </summary>
        /// <value>A flag describing whether this preference is explicit, or inline.</value>
        [DataMember(Name = "explicit", EmitDefaultValue = true)]
        public bool Explicit { get; set; }

        /// <summary>
        /// A flag describing whether this property is required or not.
        /// </summary>
        /// <value>A flag describing whether this property is required or not.</value>
        ...
        public PreferenceRequestDefinition Definition { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PreferenceId: ").Append(PreferenceId).Append("\n");
        ...
        {
            return this.Equals(input as PreferenceRequest);
        }

        /// <summary>
        /// Returns true if PreferenceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PreferenceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreferenceRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.PreferenceId == input.PreferenceId ||
                    (this.PreferenceId != null &&
                    this.PreferenceId.Equals(input.PreferenceId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PreferenceId.GetHashCode();
                }
                if (this.Name != null)
                {
