...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "numberFieldForAutomationAction")]
    public partial class NumberFieldForAutomationAction : IEquatable<NumberFieldForAutomationAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberFieldForAutomationAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumberFieldForAutomationAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberFieldForAutomationAction" /> class.
        /// </summary>
        ...
        public NumberFieldForAutomationAction(string command = default(string), string argumentType = default(string), string unit = default(string), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for NumberFieldForAutomationAction and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberFieldForAutomationAction {\n");
        ...
        {
            return this.Equals(input as NumberFieldForAutomationAction);
        }

        /// <summary>
        /// Returns true if NumberFieldForAutomationAction instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberFieldForAutomationAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberFieldForAutomationAction input)
        {
            if (input == null)
            {
                return false;
