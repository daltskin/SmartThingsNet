...
namespace SmartThingsNet.Model
{
    ...
    public partial class NumberFieldForAutomationAction :  IEquatable<NumberFieldForAutomationAction>, IValidatableObject
    {
        ...
        public NumberFieldForAutomationAction(string command = default(string), string unit = default(string), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for NumberFieldForAutomationAction and cannot be null");
            this.Unit = unit;
            this.Range = range;
        }
