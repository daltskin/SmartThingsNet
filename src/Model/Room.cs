...
namespace SmartThingsNet.Model
{
    ...
    public partial class Room : IEquatable<Room>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Room" /> class.
        /// </summary>
        /// <param name="roomId">The ID of the room. (required).</param>
        /// <param name="locationId">The ID of the parent Location. (required).</param>
        /// <param name="name">A name for the room (e.g. Living Room) (required).</param>
        /// <param name="backgroundImage">Not currently in use..</param>
        /// <param name="created">The timestamp of when a room was created in UTC..</param>
        /// <param name="lastModified">The timestamp of when a room was last updated in UTC..</param>
        public Room(Guid roomId = default(Guid), Guid locationId = default(Guid), string name = default(string), string backgroundImage = default(string), DateTime created = default(DateTime), DateTime lastModified = default(DateTime))
        {
            this.RoomId = roomId;
            this.LocationId = locationId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for Room and cannot be null");
            }
            this.Name = name;
        ...
        [DataMember(Name = "roomId", IsRequired = true, EmitDefaultValue = false)]
        public Guid RoomId { get; set; }

        /// <summary>
        /// The ID of the parent Location.
        /// </summary>
        /// <value>The ID of the parent Location.</value>
        [DataMember(Name = "locationId", IsRequired = true, EmitDefaultValue = false)]
        public Guid LocationId { get; set; }

        /// <summary>
        /// A name for the room (e.g. Living Room)
        /// </summary>
        /// <value>A name for the room (e.g. Living Room)</value>
        ...
        /// <summary>
        /// The timestamp of when a room was created in UTC.
        /// </summary>
        /// <value>The timestamp of when a room was created in UTC.</value>
        [DataMember(Name = "created", EmitDefaultValue = false)]
        public DateTime Created { get; set; }

        /// <summary>
        /// The timestamp of when a room was last updated in UTC.
        /// </summary>
        /// <value>The timestamp of when a room was last updated in UTC.</value>
