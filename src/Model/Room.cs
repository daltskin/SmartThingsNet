...
namespace SmartThingsNet.Model
{
    ...
    public partial class Room :  IEquatable<Room>, IValidatableObject
    {
        ...
        /// <param name="name">A name given for the room (eg. Living Room).</param>
        /// <param name="backgroundImage">Not currently in use..</param>
        public Room(Guid roomId = default(Guid), Guid locationId = default(Guid), string name = default(string), string backgroundImage = default(string))
        {
            this.RoomId = roomId;
        ...
        /// </summary>
        /// <value>A name given for the room (eg. Living Room)</value>
