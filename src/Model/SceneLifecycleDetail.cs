...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneLifecycleDetail")]
    public partial class SceneLifecycleDetail : IEquatable<SceneLifecycleDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneLifecycleDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SceneLifecycleDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneLifecycleDetail" /> class.
        /// </summary>
        /// <param name="subscriptionName">A name for the subscription that will be passed to the installed app..</param>
        /// <param name="locationId">The id of the location that both the app and scenes are in. (required).</param>
        public SceneLifecycleDetail(string subscriptionName = default(string), string locationId = default(string))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for SceneLifecycleDetail and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The id of the location that both the app and scenes are in.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneLifecycleDetail {\n");
        ...
        {
            return this.Equals(input as SceneLifecycleDetail);
        }

        /// <summary>
        /// Returns true if SceneLifecycleDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneLifecycleDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneLifecycleDetail input)
        {
            if (input == null)
            {
                return false;
