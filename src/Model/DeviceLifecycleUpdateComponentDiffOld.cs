...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceLifecycleUpdate_componentDiff_old")]
    public partial class DeviceLifecycleUpdateComponentDiffOld : IEquatable<DeviceLifecycleUpdateComponentDiffOld>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleUpdateComponentDiffOld" /> class.
        /// </summary>
        ...
        public DeviceLifecycleUpdateComponentDiffOld(string id = default(string), string label = default(string), List<DeviceLifecycleCreateCategories> categories = default(List<DeviceLifecycleCreateCategories>), List<DeviceLifecycleUpdateComponentDiffOldCapabilities> capabilities = default(List<DeviceLifecycleUpdateComponentDiffOldCapabilities>), string icon = default(string))
        {
            this.Id = id;
            this.Label = label;
        ...
        public List<DeviceLifecycleCreateCategories> Categories { get; set; }

        /// <summary>
        /// Gets or Sets Capabilities
        /// </summary>
        [DataMember(Name = "capabilities", EmitDefaultValue = false)]
        public List<DeviceLifecycleUpdateComponentDiffOldCapabilities> Capabilities { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleUpdateComponentDiffOld {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleUpdateComponentDiffOld);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleUpdateComponentDiffOld instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleUpdateComponentDiffOld to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleUpdateComponentDiffOld input)
        {
            if (input == null)
            {
                return false;
