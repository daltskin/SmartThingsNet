...
{
    /// <summary>
    /// PublicDeviceConfigurationAllOf
    /// </summary>
    [DataContract(Name = "PublicDeviceConfiguration_allOf")]
    public partial class PublicDeviceConfigurationAllOf : IEquatable<PublicDeviceConfigurationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDeviceConfigurationAllOf" /> class.
        /// </summary>
        ...
        public PublicDeviceConfigurationAllOf(string presentationId = default(string), string manufacturerName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublicDeviceConfigurationAllOf {\n");
        ...
        {
            return this.Equals(input as PublicDeviceConfigurationAllOf);
        }

        /// <summary>
        /// Returns true if PublicDeviceConfigurationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicDeviceConfigurationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicDeviceConfigurationAllOf input)
        {
            if (input == null)
            {
                return false;
