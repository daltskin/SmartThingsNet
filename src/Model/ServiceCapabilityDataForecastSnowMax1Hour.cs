...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax1Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax1Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax1Hour : IEquatable<ServiceCapabilityDataForecastSnowMax1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax1Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium one hour forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax1Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium one hour forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium one hour forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax1Hour input)
        {
            if (input == null)
            {
                return false;
