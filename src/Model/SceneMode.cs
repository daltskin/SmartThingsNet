...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneMode")]
    public partial class SceneMode : IEquatable<SceneMode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneMode" /> class.
        /// </summary>
        /// <param name="modeId">the id of the mode.</param>
        /// <param name="modeName">the name of the mode.</param>
        public SceneMode(string modeId = default(string), string modeName = default(string))
        {
            this.ModeId = modeId;
        ...
        {
            return this.Equals(input as SceneMode);
        }

        /// <summary>
        /// Returns true if SceneMode instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneMode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneMode input)
        {
            if (input == null)
            {
                return false;
