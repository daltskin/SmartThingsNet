...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AttributeSchema")]
    public partial class AttributeSchema : IEquatable<AttributeSchema>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>For schema this will always be object and is the only allowed value.</value>
        ...
        /// </summary>
        /// <value>Provide requirement for &#x60;value&#x60;, &#x60;unit&#x60;, and &#x60;data&#x60; fields.</value>
        [DataMember(Name = "required", EmitDefaultValue = false)]
        public List<RequiredEnum> Required { get; set; }
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="AttributeSchema" /> class.
        /// </summary>
        /// <param name="title">The capability&#39;s name, no spaces..</param>
        /// <param name="type">For schema this will always be object and is the only allowed value..</param>
        /// <param name="properties">properties (required).</param>
        /// <param name="additionalProperties">additionalProperties.</param>
        /// <param name="required">Provide requirement for &#x60;value&#x60;, &#x60;unit&#x60;, and &#x60;data&#x60; fields..</param>
        public AttributeSchema(string title = default(string), TypeEnum? type = default(TypeEnum?), AttributeProperties properties = default(AttributeProperties), bool additionalProperties = default(bool), List<RequiredEnum> required = default(List<RequiredEnum>))
        {
            ...
            if (properties == null) {
                throw new ArgumentNullException("properties is a required property for AttributeSchema and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The capability&#39;s name, no spaces.</value>
        ...
        public AttributeProperties Properties { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributeSchema {\n");
        ...
        {
            return this.Equals(input as AttributeSchema);
        }

        /// <summary>
        /// Returns true if AttributeSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributeSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeSchema input)
        {
            if (input == null)
            {
                return false;
