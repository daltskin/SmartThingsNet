...
namespace SmartThingsNet.Model
{
    ...
    public partial class SimpleValue : IEquatable<SimpleValue>, IValidatableObject
    {
        ...
        public enum ValueTypeEnum
        {
            ...
            /// <summary>
            /// Enum INTVALUE for value: INT_VALUE
            /// </summary>
            [EnumMember(Value = "INT_VALUE")]
            INTVALUE = 2,

            /// <summary>
            /// Enum DOUBLEVALUE for value: DOUBLE_VALUE
            /// </summary>
            [EnumMember(Value = "DOUBLE_VALUE")]
            DOUBLEVALUE = 3,

            /// <summary>
            /// Enum STRINGVALUE for value: STRING_VALUE
            /// </summary>
            [EnumMember(Value = "STRING_VALUE")]
            STRINGVALUE = 4,

            /// <summary>
            /// Enum BOOLEANVALUE for value: BOOLEAN_VALUE
            /// </summary>
            [EnumMember(Value = "BOOLEAN_VALUE")]
            BOOLEANVALUE = 5
        ...
        public SimpleValue(ValueTypeEnum? valueType = default(ValueTypeEnum?), int intValue = default(int), double doubleValue = default(double), string stringValue = default(string), bool boolValue = default(bool))
        {
