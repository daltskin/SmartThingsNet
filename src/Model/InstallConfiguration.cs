...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstallConfiguration")]
    public partial class InstallConfiguration : IEquatable<InstallConfiguration>, IValidatableObject
    {
        ...
        public InstallConfigurationStatus? ConfigurationStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstallConfiguration" /> class.
        /// </summary>
        /// <param name="installedAppId">The ID of the installed app..</param>
        /// <param name="configurationId">The ID to this configration instance..</param>
        ...
        public InstallConfiguration(Guid installedAppId = default(Guid), Guid configurationId = default(Guid), InstallConfigurationStatus? configurationStatus = default(InstallConfigurationStatus?), DateTime createdDate = default(DateTime), DateTime lastUpdatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The ID to this configration instance.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstallConfiguration {\n");
        ...
        {
            return this.Equals(input as InstallConfiguration);
        }

        /// <summary>
        /// Returns true if InstallConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of InstallConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstallConfiguration input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ConfigurationStatus == input.ConfigurationStatus ||
                    this.ConfigurationStatus.Equals(input.ConfigurationStatus)
                ) && 
                (
