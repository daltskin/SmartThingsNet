...
namespace SmartThingsNet.Model
{
    ...
    public partial class Subscription : IEquatable<Subscription>, IValidatableObject
    {
        ...
        public SubscriptionSource? SourceType { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>The id of the subscribing app.</value>
        ...
        public DeviceSubscriptionDetail Device { get; set; }

        /// <summary>
        /// Gets or Sets Capability
        /// </summary>
        [DataMember(Name = "capability", EmitDefaultValue = false)]
        public CapabilitySubscriptionDetail Capability { get; set; }

        /// <summary>
        /// Gets or Sets Mode
        /// </summary>
        [DataMember(Name = "mode", EmitDefaultValue = false)]
        public ModeSubscriptionDetail Mode { get; set; }

        /// <summary>
        /// Gets or Sets DeviceLifecycle
        /// </summary>
        [DataMember(Name = "deviceLifecycle", EmitDefaultValue = false)]
        public DeviceLifecycleDetail DeviceLifecycle { get; set; }

        /// <summary>
        /// Gets or Sets DeviceHealth
        /// </summary>
        [DataMember(Name = "deviceHealth", EmitDefaultValue = false)]
        public DeviceHealthDetail DeviceHealth { get; set; }

        /// <summary>
        /// Gets or Sets SecurityArmState
        /// </summary>
        [DataMember(Name = "securityArmState", EmitDefaultValue = false)]
        public SecurityArmStateDetail SecurityArmState { get; set; }

        /// <summary>
        /// Gets or Sets HubHealth
        /// </summary>
        [DataMember(Name = "hubHealth", EmitDefaultValue = false)]
        public HubHealthDetail HubHealth { get; set; }

        /// <summary>
        /// Gets or Sets SceneLifecycle
        /// </summary>
        [DataMember(Name = "sceneLifecycle", EmitDefaultValue = false)]
        public SceneLifecycleDetail SceneLifecycle { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeviceLifecycle: ").Append(DeviceLifecycle).Append("\n");
            sb.Append("  DeviceHealth: ").Append(DeviceHealth).Append("\n");
            sb.Append("  SecurityArmState: ").Append(SecurityArmState).Append("\n");
            sb.Append("  HubHealth: ").Append(HubHealth).Append("\n");
            sb.Append("  SceneLifecycle: ").Append(SceneLifecycle).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Subscription input)
        {
            ...
            return 
                ...
                (
                    this.DeviceLifecycle == input.DeviceLifecycle ||
                    (this.DeviceLifecycle != null &&
                    this.DeviceLifecycle.Equals(input.DeviceLifecycle))
                ) && 
                (
                    this.DeviceHealth == input.DeviceHealth ||
                    (this.DeviceHealth != null &&
                    this.DeviceHealth.Equals(input.DeviceHealth))
                ) && 
                (
                    this.SecurityArmState == input.SecurityArmState ||
                    (this.SecurityArmState != null &&
                    this.SecurityArmState.Equals(input.SecurityArmState))
                ) && 
                (
                    this.HubHealth == input.HubHealth ||
                    (this.HubHealth != null &&
                    this.HubHealth.Equals(input.HubHealth))
                ) && 
                (
                    this.SceneLifecycle == input.SceneLifecycle ||
                    (this.SceneLifecycle != null &&
                    this.SceneLifecycle.Equals(input.SceneLifecycle))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeviceLifecycle != null)
                {
                    hashCode = (hashCode * 59) + this.DeviceLifecycle.GetHashCode();
                }
                if (this.DeviceHealth != null)
                {
                    hashCode = (hashCode * 59) + this.DeviceHealth.GetHashCode();
                }
                if (this.SecurityArmState != null)
                {
                    hashCode = (hashCode * 59) + this.SecurityArmState.GetHashCode();
                }
                if (this.HubHealth != null)
                {
                    hashCode = (hashCode * 59) + this.HubHealth.GetHashCode();
                }
                if (this.SceneLifecycle != null)
                {
                    hashCode = (hashCode * 59) + this.SceneLifecycle.GetHashCode();
                }
                return hashCode;
            }
        }
