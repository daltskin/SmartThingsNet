...
namespace SmartThingsNet.Model
{
    ...
    public partial class NumberFieldForArgument :  IEquatable<NumberFieldForArgument>, IValidatableObject
    {
        ...
        public NumberFieldForArgument(string name = default(string), List<double> range = default(List<double>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for NumberFieldForArgument and cannot be null");
            this.Range = range;
        }
