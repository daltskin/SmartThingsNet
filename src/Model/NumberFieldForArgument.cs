...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "numberFieldForArgument")]
    public partial class NumberFieldForArgument : IEquatable<NumberFieldForArgument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberFieldForArgument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumberFieldForArgument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberFieldForArgument" /> class.
        /// </summary>
        ...
        public NumberFieldForArgument(string name = default(string), string argumentType = default(string), List<double> range = default(List<double>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for NumberFieldForArgument and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberFieldForArgument {\n");
        ...
        {
            return this.Equals(input as NumberFieldForArgument);
        }

        /// <summary>
        /// Returns true if NumberFieldForArgument instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberFieldForArgument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberFieldForArgument input)
        {
            if (input == null)
            {
                return false;
