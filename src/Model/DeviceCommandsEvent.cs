...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceCommandsEvent")]
    public partial class DeviceCommandsEvent : IEquatable<DeviceCommandsEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceCommandsEvent" /> class.
        /// </summary>
        /// <param name="eventId">The id of the event..</param>
        /// <param name="deviceId">The guid of the device that the commands are for..</param>
        /// <param name="profileId">The device profile ID of the device instance..</param>
        /// <param name="externalId">The external ID that was set during install of a device..</param>
        /// <param name="commands">commands.</param>
        public DeviceCommandsEvent(string eventId = default(string), string deviceId = default(string), string profileId = default(string), string externalId = default(string), List<DeviceCommandsEventCommand> commands = default(List<DeviceCommandsEventCommand>))
        {
        ...
        /// </summary>
        /// <value>The guid of the device that the commands are for.</value>
        ...
        /// </summary>
        /// <value>The device profile ID of the device instance.</value>
        ...
        /// </summary>
        /// <value>The external ID that was set during install of a device.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceCommandsEvent {\n");
        ...
        {
            return this.Equals(input as DeviceCommandsEvent);
        }

        /// <summary>
        /// Returns true if DeviceCommandsEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCommandsEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCommandsEvent input)
        {
            if (input == null)
            {
                return false;
