...
namespace SmartThingsNet.Model
{
    ...
    /// SliderAllOf
    /// </summary>
    [DataContract(Name = "slider_allOf")]
    public partial class SliderAllOf : IEquatable<SliderAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderAllOf" /> class.
        /// </summary>
        ...
        public SliderAllOf(string command = default(string), string argumentType = default(string), string value = default(string), string valueType = default(string))
        {
        ...
        {
            return this.Equals(input as SliderAllOf);
        }

        /// <summary>
        /// Returns true if SliderAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderAllOf input)
        {
            if (input == null)
            {
                return false;
