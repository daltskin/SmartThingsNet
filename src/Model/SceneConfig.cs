...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneConfig")]
    public partial class SceneConfig : IEquatable<SceneConfig>, IValidatableObject
    {
        /// <summary>
        ...
        public SceneConfig(string sceneId = default(string), List<string> permissions = default(List<string>))
        {
        ...
        {
            return this.Equals(input as SceneConfig);
        }

        /// <summary>
        /// Returns true if SceneConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneConfig input)
        {
            if (input == null)
            {
                return false;
