...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationCreateRequest")]
    public partial class OrganizationCreateRequest : IEquatable<OrganizationCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public OrganizationCreateRequest(string label = default(string), Guid warehouseGroupId = default(Guid), string mnId = default(string), string manufacturerName = default(string), string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for OrganizationCreateRequest and cannot be null");
            }
            this.Name = name;
            this.Label = label;
        ...
        {
            return this.Equals(input as OrganizationCreateRequest);
        }

        /// <summary>
        /// Returns true if OrganizationCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationCreateRequest input)
        {
            if (input == null)
            {
                return false;
