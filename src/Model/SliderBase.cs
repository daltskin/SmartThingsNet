...
namespace SmartThingsNet.Model
{
    ...
    /// SliderBase
    /// </summary>
    [DataContract(Name = "sliderBase")]
    public partial class SliderBase : IEquatable<SliderBase>, IValidatableObject
    {
        /// <summary>
        ...
        public SliderBase(List<double> range = default(List<double>), double step = default(double), string unit = default(string))
        {
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for SliderBase and cannot be null");
            }
            this.Range = range;
            this.Step = step;
            this.Unit = unit;
        ...
        {
            return this.Equals(input as SliderBase);
        }

        /// <summary>
        /// Returns true if SliderBase instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderBase input)
        {
            if (input == null)
            {
                return false;
