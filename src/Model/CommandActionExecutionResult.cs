...
{
    /// <summary>
    /// The result of a command action execution
    /// </summary>
    [DataContract(Name = "CommandActionExecutionResult")]
    public partial class CommandActionExecutionResult : IEquatable<CommandActionExecutionResult>, IValidatableObject
    {
        ...
        protected CommandActionExecutionResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandActionExecutionResult" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Device ID for device actions</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommandActionExecutionResult {\n");
        ...
        {
            return this.Equals(input as CommandActionExecutionResult);
        }

        /// <summary>
        /// Returns true if CommandActionExecutionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of CommandActionExecutionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommandActionExecutionResult input)
        {
            if (input == null)
            {
                return false;
