...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_temperature1Hour")]
    public partial class ServiceCapabilityDataForecastTemperature1Hour : IEquatable<ServiceCapabilityDataForecastTemperature1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastTemperature1Hour" /> class.
        /// </summary>
        /// <param name="value">Rolling hour temperature in Celcius. .</param>
        /// <param name="unit">C.</param>
        public ServiceCapabilityDataForecastTemperature1Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// Rolling hour temperature in Celcius. 
        /// </summary>
        /// <value>Rolling hour temperature in Celcius. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastTemperature1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastTemperature1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastTemperature1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastTemperature1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastTemperature1Hour input)
        {
            if (input == null)
            {
                return false;
