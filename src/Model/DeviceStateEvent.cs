...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceStateEvent
    /// </summary>
    [DataContract(Name = "DeviceStateEvent")]
    public partial class DeviceStateEvent : IEquatable<DeviceStateEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceStateEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceStateEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceStateEvent" /> class.
        /// </summary>
        /// <param name="component">The name of the component on this device, default is &#39;main&#39;..</param>
        /// <param name="capability">Capability that this event relates to..</param>
        /// <param name="attribute">Name of the capability attribute that this event relates to..</param>
        /// <param name="value">Value associated with the event. The valid value depends on the capability. (required).</param>
        /// <param name="unit">Unit of the value field..</param>
        /// <param name="data">Key value pairs about the state of the device. Valid values depend on the capability..</param>
        public DeviceStateEvent(string component = default(string), string capability = default(string), string attribute = default(string), Object value = default(Object), string unit = default(string), Dictionary<string, Object> data = default(Dictionary<string, Object>))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for DeviceStateEvent and cannot be null");
            }
            this.Value = value;
        ...
        /// </summary>
        /// <value>The name of the component on this device, default is &#39;main&#39;.</value>
        ...
        /// </summary>
        /// <value>Capability that this event relates to.</value>
        ...
        /// </summary>
        /// <value>Name of the capability attribute that this event relates to.</value>
        ...
        /// </summary>
        /// <value>Value associated with the event. The valid value depends on the capability.</value>
        ...
        /// </summary>
        /// <value>Key value pairs about the state of the device. Valid values depend on the capability.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceStateEvent {\n");
        ...
        {
            return this.Equals(input as DeviceStateEvent);
        }

        /// <summary>
        /// Returns true if DeviceStateEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceStateEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceStateEvent input)
        {
            if (input == null)
            {
                return false;
