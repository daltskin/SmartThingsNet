...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax2Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax2Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax2Hour : IEquatable<ServiceCapabilityDataForecastSnowMax2Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax2Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 2 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax2Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 2 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 2 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax2Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax2Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax2Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax2Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax2Hour input)
        {
            if (input == null)
            {
                return false;
