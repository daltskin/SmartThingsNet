...
namespace SmartThingsNet.Model
{
    ...
    /// CommandClasses
    /// </summary>
    [DataContract(Name = "CommandClasses")]
    public partial class CommandClasses : IEquatable<CommandClasses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandClasses" /> class.
        /// </summary>
        /// <param name="either">List of 8-bit command class identifiers to match regardless of controlled or supported.</param>
        /// <param name="controlled">List of 8-bit command class identifiers that are controlled.</param>
        /// <param name="supported">List of 8-bit command class identifiers that are supported.</param>
        public CommandClasses(List<int> either = default(List<int>), List<int> controlled = default(List<int>), List<int> supported = default(List<int>))
        {
            this.Either = either;
        ...
        /// </summary>
        /// <value>List of 8-bit command class identifiers to match regardless of controlled or supported</value>
        [DataMember(Name = "either", EmitDefaultValue = false)]
        public List<int> Either { get; set; }

        /// <summary>
        /// List of 8-bit command class identifiers that are controlled
        /// </summary>
        /// <value>List of 8-bit command class identifiers that are controlled</value>
        [DataMember(Name = "controlled", EmitDefaultValue = false)]
        public List<int> Controlled { get; set; }

        /// <summary>
        /// List of 8-bit command class identifiers that are supported
        /// </summary>
        /// <value>List of 8-bit command class identifiers that are supported</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommandClasses {\n");
        ...
        {
            return this.Equals(input as CommandClasses);
        }

        /// <summary>
        /// Returns true if CommandClasses instances are equal
        /// </summary>
        /// <param name="input">Instance of CommandClasses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommandClasses input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    this.Either != null &&
                    input.Either != null &&
                    this.Either.SequenceEqual(input.Either)
                ) && 
                (
                    this.Controlled == input.Controlled ||
                    this.Controlled != null &&
                    input.Controlled != null &&
                    this.Controlled.SequenceEqual(input.Controlled)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Controlled.GetHashCode();
                }
