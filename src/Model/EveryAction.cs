...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EveryAction :  IEquatable<EveryAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EveryAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EveryAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EveryAction" /> class.
        /// </summary>
        ...
        public EveryAction(string id = default(string), Interval interval = default(Interval), TimeOperand specific = default(TimeOperand), List<Action> actions = default(List<Action>))
        {
            // to ensure "actions" is required (not null)
            this.Actions = actions ?? throw new ArgumentNullException("actions is a required property for EveryAction and cannot be null");
            this.Id = id;
        ...
        public TimeOperand Specific { get; set; }
        ...
        {
            return this.Equals(input as EveryAction);
        }

        /// <summary>
        /// Returns true if EveryAction instances are equal
        /// </summary>
        /// <param name="input">Instance of EveryAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EveryAction input)
        {
            if (input == null)
                return false;
