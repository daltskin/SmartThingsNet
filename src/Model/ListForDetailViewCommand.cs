...
namespace SmartThingsNet.Model
{
    ...
    public partial class ListForDetailViewCommand :  IEquatable<ListForDetailViewCommand>, IValidatableObject
    {
        ...
        public ListForDetailViewCommand(string name = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string))
        {
            // to ensure "alternatives" is required (not null)
            this.Alternatives = alternatives ?? throw new ArgumentNullException("alternatives is a required property for ListForDetailViewCommand and cannot be null");
            this.Name = name;
