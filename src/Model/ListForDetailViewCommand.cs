...
{
    /// <summary>
    /// ListForDetailViewCommand
    /// </summary>
    [DataContract(Name = "listForDetailView_command")]
    public partial class ListForDetailViewCommand : IEquatable<ListForDetailViewCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForDetailViewCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForDetailViewCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForDetailViewCommand" /> class.
        /// </summary>
        /// <param name="name">name refers to command name and key of the alternatives is the argument of the command.</param>
        /// <param name="alternatives">A collection of strings that can replace the attribute value in the &#x60;label&#x60; or &#x60;value&#x60;. Must be human-readable for the UI client to display. (required).</param>
        /// <param name="argumentType">The data type of the &#x60;argument&#x60;. It&#39;s automatically filled from the given capability..</param>
        /// <param name="supportedValues">The attribute name specified in supportedValues is an array that has values supported at runtime..</param>
        public ListForDetailViewCommand(string name = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), string argumentType = default(string), string supportedValues = default(string))
        {
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for ListForDetailViewCommand and cannot be null");
            }
        ...
        /// </summary>
        /// <value>name refers to command name and key of the alternatives is the argument of the command</value>
        [DataMember(Name = "name", EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// A collection of strings that can replace the attribute value in the &#x60;label&#x60; or &#x60;value&#x60;. Must be human-readable for the UI client to display.
        /// </summary>
        /// <value>A collection of strings that can replace the attribute value in the &#x60;label&#x60; or &#x60;value&#x60;. Must be human-readable for the UI client to display.</value>
        [DataMember(Name = "alternatives", IsRequired = true, EmitDefaultValue = false)]
        public List<AlternativeItem> Alternatives { get; set; }

        /// <summary>
        /// The data type of the &#x60;argument&#x60;. It&#39;s automatically filled from the given capability.
        /// </summary>
        /// <value>The data type of the &#x60;argument&#x60;. It&#39;s automatically filled from the given capability.</value>
        [DataMember(Name = "argumentType", EmitDefaultValue = false)]
        public string ArgumentType { get; set; }

        /// <summary>
        /// The attribute name specified in supportedValues is an array that has values supported at runtime.
        /// </summary>
        /// <value>The attribute name specified in supportedValues is an array that has values supported at runtime.</value>
        [DataMember(Name = "supportedValues", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForDetailViewCommand {\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  Alternatives: ").Append(Alternatives).Append("\n");
            sb.Append("  ArgumentType: ").Append(ArgumentType).Append("\n");
            sb.Append("  SupportedValues: ").Append(SupportedValues).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ListForDetailViewCommand);
        }

        /// <summary>
        /// Returns true if ListForDetailViewCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForDetailViewCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForDetailViewCommand input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ArgumentType == input.ArgumentType ||
                    (this.ArgumentType != null &&
                    this.ArgumentType.Equals(input.ArgumentType))
                ) && 
                (
                    this.SupportedValues == input.SupportedValues ||
                    (this.SupportedValues != null &&
                    this.SupportedValues.Equals(input.SupportedValues))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ArgumentType.GetHashCode();
                }
                if (this.SupportedValues != null)
                {
                    hashCode = (hashCode * 59) + this.SupportedValues.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        {
            // SupportedValues (string) pattern
            Regex regexSupportedValues = new Regex(@"(^[[a-z]*([A-Z][a-z]*)*){1,36}(\\.value)+", RegexOptions.CultureInvariant);
            if (false == regexSupportedValues.Match(this.SupportedValues).Success)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SupportedValues, must match a pattern of " + regexSupportedValues, new [] { "SupportedValues" });
            }
