...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityNo2Index
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_no2Index")]
    public partial class ServiceCapabilityDataAirQualityNo2Index : IEquatable<ServiceCapabilityDataAirQualityNo2Index>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityNo2Index" /> class.
        /// </summary>
        /// <param name="value">(Available for non-Korea Only) index of Nitrogen Dioxide pollutant.</param>
        /// <param name="unit">EPA.</param>
        public ServiceCapabilityDataAirQualityNo2Index(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for non-Korea Only) index of Nitrogen Dioxide pollutant
        /// </summary>
        /// <value>(Available for non-Korea Only) index of Nitrogen Dioxide pollutant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityNo2Index {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityNo2Index);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityNo2Index instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityNo2Index to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityNo2Index input)
        {
            if (input == null)
            {
                return false;
