...
{
    /// <summary>
    /// Display type for a play/pause button.
    /// </summary>
    [DataContract]
    public partial class PlayPauseCommand :  IEquatable<PlayPauseCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayPauseCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayPauseCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayPauseCommand" /> class.
        /// </summary>
        ...
        public PlayPauseCommand(PlayPauseCommandCommand command = default(PlayPauseCommandCommand))
        {
            ...
            this.Command = command ?? throw new ArgumentNullException("command is a required property for PlayPauseCommand and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayPauseCommand {\n");
        ...
        {
            return this.Equals(input as PlayPauseCommand);
        }

        /// <summary>
        /// Returns true if PlayPauseCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayPauseCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayPauseCommand input)
        {
            if (input == null)
                return false;
