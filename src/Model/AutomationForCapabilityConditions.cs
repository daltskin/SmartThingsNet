...
{
    /// <summary>
    /// AutomationForCapabilityConditions
    /// </summary>
    [DataContract(Name = "automationForCapability_conditions")]
    public partial class AutomationForCapabilityConditions : IEquatable<AutomationForCapabilityConditions>, IValidatableObject
    {
        /// <summary>
        ...
        protected AutomationForCapabilityConditions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationForCapabilityConditions" /> class.
        /// </summary>
        ...
        public AutomationForCapabilityConditions(string label = default(string), DisplayTypeEnum displayType = default(DisplayTypeEnum), SliderForAutomationCondition slider = default(SliderForAutomationCondition), ListForAutomationCondition list = default(ListForAutomationCondition), NumberFieldForAutomationCondition numberField = default(NumberFieldForAutomationCondition), TextFieldForAutomationCondition textField = default(TextFieldForAutomationCondition), EnumSliderForAutomationCondition enumSlider = default(EnumSliderForAutomationCondition), bool emphasis = default(bool))
        {
            ...
            if (label == null) {
                throw new ArgumentNullException("label is a required property for AutomationForCapabilityConditions and cannot be null");
            }
            this.Label = label;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationForCapabilityConditions {\n");
        ...
        {
            return this.Equals(input as AutomationForCapabilityConditions);
        }

        /// <summary>
        /// Returns true if AutomationForCapabilityConditions instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationForCapabilityConditions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationForCapabilityConditions input)
        {
            if (input == null)
            {
                return false;
