...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityCoAmount
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_coAmount")]
    public partial class ServiceCapabilityDataAirQualityCoAmount : IEquatable<ServiceCapabilityDataAirQualityCoAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityCoAmount" /> class.
        /// </summary>
        /// <param name="value">(Available for Korea Only) Carbon Monoxide pollutant in ug/m3.</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityCoAmount(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for Korea Only) Carbon Monoxide pollutant in ug/m3
        /// </summary>
        /// <value>(Available for Korea Only) Carbon Monoxide pollutant in ug/m3</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityCoAmount {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityCoAmount);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityCoAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityCoAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityCoAmount input)
        {
            if (input == null)
            {
                return false;
