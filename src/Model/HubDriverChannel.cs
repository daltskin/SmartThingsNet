...
namespace SmartThingsNet.Model
{
    ...
    /// HubDriverChannel
    /// </summary>
    [DataContract(Name = "HubDriverChannel")]
    public partial class HubDriverChannel : IEquatable<HubDriverChannel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HubDriverChannel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HubDriverChannel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HubDriverChannel" /> class.
        /// </summary>
        /// <param name="channelId">Unique Identifier of the channel (required).</param>
        /// <param name="name">User friendly Identifier for Channel (required).</param>
        /// <param name="description">Description of Channel and Contained Drivers.</param>
        /// <param name="createdDate">ISO-8601 timestamp of creation of channel.</param>
        /// <param name="lastModifiedDate">ISO-8601 timestamp of last modification of channel.</param>
        /// <param name="subscriptionUrl">Url to web interface to modifiy channel subscriptions.</param>
        public HubDriverChannel(string channelId = default(string), string name = default(string), string description = default(string), string createdDate = default(string), string lastModifiedDate = default(string), string subscriptionUrl = default(string))
        {
            // to ensure "channelId" is required (not null)
            if (channelId == null) {
                throw new ArgumentNullException("channelId is a required property for HubDriverChannel and cannot be null");
            }
            this.ChannelId = channelId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for HubDriverChannel and cannot be null");
            }
            this.Name = name;
        ...
        /// <summary>
        /// User friendly Identifier for Channel
        /// </summary>
        /// <value>User friendly Identifier for Channel</value>
        [DataMember(Name = "name", IsRequired = true, EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Description of Channel and Contained Drivers
        /// </summary>
        /// <value>Description of Channel and Contained Drivers</value>
        ...
        /// </summary>
        /// <value>ISO-8601 timestamp of creation of channel</value>
        ...
        /// </summary>
        /// <value>ISO-8601 timestamp of last modification of channel</value>
        [DataMember(Name = "lastModifiedDate", EmitDefaultValue = false)]
        public string LastModifiedDate { get; set; }

        /// <summary>
        /// Url to web interface to modifiy channel subscriptions
        /// </summary>
        /// <value>Url to web interface to modifiy channel subscriptions</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HubDriverChannel {\n");
        ...
        {
            return this.Equals(input as HubDriverChannel);
        }

        /// <summary>
        /// Returns true if HubDriverChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of HubDriverChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HubDriverChannel input)
        {
            if (input == null)
            {
                return false;
