...
namespace SmartThingsNet.Model
{
    ...
    public partial class OrganizationResponse : IEquatable<OrganizationResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="OrganizationResponse" /> class.
        /// </summary>
        /// <param name="label">A pretty name for a developer organization..</param>
        /// <param name="warehouseGroupId">The groupId that corresponds to this organization in warehouse..</param>
        /// <param name="mnId">Legacy &#x60;mnId&#x60; (also &#x60;mnid&#x60;) field used by some Samsung services..</param>
        /// <param name="manufacturerName">Manufacturer name for the organization..</param>
        /// <param name="name">A unique name for an organization. Alphanumeric names only (no spaces or special characters) must start with a letter. This will be the \&quot;namespace\&quot; for the custom capabilities for this org. (required).</param>
        /// <param name="developerGroupId">The user group for organization developers..</param>
        /// <param name="adminGroupId">The user group for organization admins..</param>
        /// <param name="organizationId">A generated UUID for an organization. (required).</param>
        /// <param name="isDefaultUserOrg">Denotes whether this is the default user org for the caller. (default to false).</param>
        public OrganizationResponse(string label = default(string), Guid warehouseGroupId = default(Guid), string mnId = default(string), string manufacturerName = default(string), string name = default(string), string developerGroupId = default(string), string adminGroupId = default(string), Guid organizationId = default(Guid), bool isDefaultUserOrg = false)
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for OrganizationResponse and cannot be null");
            }
            this.Name = name;
            ...
            this.IsDefaultUserOrg = isDefaultUserOrg;
        }

        /// <summary>
        /// A pretty name for a developer organization.
        /// </summary>
        /// <value>A pretty name for a developer organization.</value>
        [DataMember(Name = "label", EmitDefaultValue = false)]
        public string Label { get; set; }

        /// <summary>
        /// The groupId that corresponds to this organization in warehouse.
        /// </summary>
        /// <value>The groupId that corresponds to this organization in warehouse.</value>
        [DataMember(Name = "warehouseGroupId", EmitDefaultValue = false)]
        public Guid WarehouseGroupId { get; set; }

        /// <summary>
        /// Legacy &#x60;mnId&#x60; (also &#x60;mnid&#x60;) field used by some Samsung services.
        /// </summary>
        /// <value>Legacy &#x60;mnId&#x60; (also &#x60;mnid&#x60;) field used by some Samsung services.</value>
        [DataMember(Name = "mnId", EmitDefaultValue = false)]
        public string MnId { get; set; }

        /// <summary>
        /// Manufacturer name for the organization.
        /// </summary>
        /// <value>Manufacturer name for the organization.</value>
        [DataMember(Name = "manufacturerName", EmitDefaultValue = false)]
        public string ManufacturerName { get; set; }

        /// <summary>
        /// A unique name for an organization. Alphanumeric names only (no spaces or special characters) must start with a letter. This will be the \&quot;namespace\&quot; for the custom capabilities for this org.
        /// </summary>
        /// <value>A unique name for an organization. Alphanumeric names only (no spaces or special characters) must start with a letter. This will be the \&quot;namespace\&quot; for the custom capabilities for this org.</value>
        ...
        /// </summary>
        /// <value>The user group for organization developers.</value>
        [DataMember(Name = "developerGroupId", EmitDefaultValue = false)]
        public string DeveloperGroupId { get; set; }

        /// <summary>
        /// The user group for organization admins.
        /// </summary>
        /// <value>The user group for organization admins.</value>
        ...
        /// </summary>
        /// <value>A generated UUID for an organization.</value>
        ...
        /// </summary>
        /// <value>Denotes whether this is the default user org for the caller.</value>
        [DataMember(Name = "isDefaultUserOrg", EmitDefaultValue = true)]
        public bool IsDefaultUserOrg { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WarehouseGroupId: ").Append(WarehouseGroupId).Append("\n");
            sb.Append("  MnId: ").Append(MnId).Append("\n");
            sb.Append("  ManufacturerName: ").Append(ManufacturerName).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  DeveloperGroupId: ").Append(DeveloperGroupId).Append("\n");
            sb.Append("  AdminGroupId: ").Append(AdminGroupId).Append("\n");
            sb.Append("  OrganizationId: ").Append(OrganizationId).Append("\n");
            sb.Append("  IsDefaultUserOrg: ").Append(IsDefaultUserOrg).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(OrganizationResponse input)
        {
            ...
            return 
                ...
                (
                    this.WarehouseGroupId == input.WarehouseGroupId ||
                    (this.WarehouseGroupId != null &&
                    this.WarehouseGroupId.Equals(input.WarehouseGroupId))
                ) && 
                (
                    this.MnId == input.MnId ||
                    (this.MnId != null &&
                    this.MnId.Equals(input.MnId))
                ) && 
                (
                ...
                (
                    this.DeveloperGroupId == input.DeveloperGroupId ||
                    (this.DeveloperGroupId != null &&
                    this.DeveloperGroupId.Equals(input.DeveloperGroupId))
                ) && 
                (
                    this.AdminGroupId == input.AdminGroupId ||
                    (this.AdminGroupId != null &&
                    this.AdminGroupId.Equals(input.AdminGroupId))
                ) && 
                (
                ...
                (
                    this.IsDefaultUserOrg == input.IsDefaultUserOrg ||
                    this.IsDefaultUserOrg.Equals(input.IsDefaultUserOrg)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WarehouseGroupId != null)
                {
                    hashCode = (hashCode * 59) + this.WarehouseGroupId.GetHashCode();
                }
                if (this.MnId != null)
                {
                    hashCode = (hashCode * 59) + this.MnId.GetHashCode();
                }
                ...
                if (this.DeveloperGroupId != null)
                {
                    hashCode = (hashCode * 59) + this.DeveloperGroupId.GetHashCode();
                }
                if (this.AdminGroupId != null)
                {
                    hashCode = (hashCode * 59) + this.AdminGroupId.GetHashCode();
                }
                if (this.OrganizationId != null)
                {
                    hashCode = (hashCode * 59) + this.OrganizationId.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.IsDefaultUserOrg.GetHashCode();
                return hashCode;
            }
        }
