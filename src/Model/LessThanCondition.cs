...
namespace SmartThingsNet.Model
{
    ...
    /// LessThanCondition
    /// </summary>
    [DataContract(Name = "LessThanCondition")]
    public partial class LessThanCondition : IEquatable<LessThanCondition>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LessThanCondition" /> class.
        /// </summary>
        ...
        public LessThanCondition(Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            if (left == null) {
                throw new ArgumentNullException("left is a required property for LessThanCondition and cannot be null");
            }
            this.Left = left;
            // to ensure "right" is required (not null)
            if (right == null) {
                throw new ArgumentNullException("right is a required property for LessThanCondition and cannot be null");
            }
            this.Right = right;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LessThanCondition {\n");
        ...
        {
            return this.Equals(input as LessThanCondition);
        }

        /// <summary>
        /// Returns true if LessThanCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of LessThanCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LessThanCondition input)
        {
            if (input == null)
            {
                return false;
