...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LessThanCondition : SimpleCondition,  IEquatable<LessThanCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public LessThanCondition(string id = default(string), Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?)) : base(id, left, right, aggregation)
        {
        }
