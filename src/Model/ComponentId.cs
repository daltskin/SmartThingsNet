...
namespace SmartThingsNet.Model
{
    ...
    /// ComponentId
    /// </summary>
    [DataContract(Name = "ComponentId")]
    public partial class ComponentId : IEquatable<ComponentId>, IValidatableObject
    {
        /// <summary>
        ...
        public ComponentId(string component = default(string))
        {
        ...
        {
            return this.Equals(input as ComponentId);
        }

        /// <summary>
        /// Returns true if ComponentId instances are equal
        /// </summary>
        /// <param name="input">Instance of ComponentId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentId input)
        {
            if (input == null)
            {
                return false;
