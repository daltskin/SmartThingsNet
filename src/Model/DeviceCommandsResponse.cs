...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceCommandsResponse")]
    public partial class DeviceCommandsResponse : IEquatable<DeviceCommandsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceCommandsResponse" /> class.
        /// </summary>
        /// <param name="results">results.</param>
        public DeviceCommandsResponse(List<CommandResult> results = default(List<CommandResult>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceCommandsResponse {\n");
        ...
        {
            return this.Equals(input as DeviceCommandsResponse);
        }

        /// <summary>
        /// Returns true if DeviceCommandsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCommandsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCommandsResponse input)
        {
            if (input == null)
            {
                return false;
