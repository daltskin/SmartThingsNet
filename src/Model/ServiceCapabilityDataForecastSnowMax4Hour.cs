...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax4Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax4Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax4Hour : IEquatable<ServiceCapabilityDataForecastSnowMax4Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax4Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 4 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax4Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 4 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 4 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax4Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax4Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax4Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax4Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax4Hour input)
        {
            if (input == null)
            {
                return false;
