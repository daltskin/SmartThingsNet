...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "switchStateForDashboard")]
    public partial class SwitchStateForDashboard : IEquatable<SwitchStateForDashboard>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwitchStateForDashboard {\n");
        ...
        {
            return this.Equals(input as SwitchStateForDashboard);
        }

        /// <summary>
        /// Returns true if SwitchStateForDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchStateForDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchStateForDashboard input)
        {
            if (input == null)
            {
                return false;
