...
namespace SmartThingsNet.Model
{
    ...
    public partial class Rule : IEquatable<Rule>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The owner of the rule is either a location or user</value>
        [DataMember(Name = "ownerType", IsRequired = false, EmitDefaultValue = false)]
        ...
        /// Initializes a new instance of the <see cref="Rule" /> class.
        /// </summary>
        /// <param name="name">The name for the Rule (required).</param>
        ...
        /// </summary>
        /// <value>The name for the Rule</value>
        ...
        [DataMember(Name = "dateCreated", IsRequired = false, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "dateUpdated", IsRequired = false, EmitDefaultValue = false)]
