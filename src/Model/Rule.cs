...
namespace SmartThingsNet.Model
{
    ...
    public partial class Rule :  IEquatable<Rule>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Rule" /> class.
        /// </summary>
        /// <param name="name">Name for the rule (required).</param>
        /// <param name="actions">actions (required).</param>
        /// <param name="timeZoneId">Time zone ID for this rule. This overrides the location time zone ID, but is overridden by time zone ID provided by each operand individually.</param>
        /// <param name="id">Unique id for the rule (required).</param>
        public Rule(string name = default(string), List<Action> actions = default(List<Action>), string timeZoneId = default(string), string id = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Rule and cannot be null");
            // to ensure "actions" is required (not null)
            this.Actions = actions ?? throw new ArgumentNullException("actions is a required property for Rule and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Rule and cannot be null");
        ...
        /// </summary>
        /// <value>Time zone ID for this rule. This overrides the location time zone ID, but is overridden by time zone ID provided by each operand individually</value>
