...
namespace SmartThingsNet.Model
{
    ...
    /// AppDeviceDetails
    /// </summary>
    [DataContract(Name = "AppDeviceDetails")]
    public partial class AppDeviceDetails : IEquatable<AppDeviceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppDeviceDetails" /> class.
        /// </summary>
        /// <param name="installedAppId">The ID of the installed app that integrates this device..</param>
        /// <param name="externalId">A field to store an ID from a system external to SmartThings..</param>
        /// <param name="profile">profile.</param>
        public AppDeviceDetails(string installedAppId = default(string), string externalId = default(string), DeviceProfileReference profile = default(DeviceProfileReference))
        {
        ...
        /// </summary>
        /// <value>The ID of the installed app that integrates this device.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppDeviceDetails {\n");
        ...
        {
            return this.Equals(input as AppDeviceDetails);
        }

        /// <summary>
        /// Returns true if AppDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of AppDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppDeviceDetails input)
        {
            if (input == null)
            {
                return false;
