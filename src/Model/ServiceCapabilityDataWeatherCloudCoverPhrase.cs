...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherCloudCoverPhrase
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_cloudCoverPhrase")]
    public partial class ServiceCapabilityDataWeatherCloudCoverPhrase : IEquatable<ServiceCapabilityDataWeatherCloudCoverPhrase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherCloudCoverPhrase" /> class.
        /// </summary>
        /// <param name="value">(This attribute is not available in Korea and Japan) Descriptive sky cover - based on percentage of cloud cover.  Range - Clear: coverage &lt; 0.09375; Partly Cloudy: coverage &lt; .59375; Mostly Cloudy: coverage &lt; .75; Cloudy: coverage &gt;&#x3D; .75 .</param>
        public ServiceCapabilityDataWeatherCloudCoverPhrase(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is not available in Korea and Japan) Descriptive sky cover - based on percentage of cloud cover.  Range - Clear: coverage &lt; 0.09375; Partly Cloudy: coverage &lt; .59375; Mostly Cloudy: coverage &lt; .75; Cloudy: coverage &gt;&#x3D; .75 
        /// </summary>
        /// <value>(This attribute is not available in Korea and Japan) Descriptive sky cover - based on percentage of cloud cover.  Range - Clear: coverage &lt; 0.09375; Partly Cloudy: coverage &lt; .59375; Mostly Cloudy: coverage &lt; .75; Cloudy: coverage &gt;&#x3D; .75 </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherCloudCoverPhrase {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherCloudCoverPhrase);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherCloudCoverPhrase instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherCloudCoverPhrase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherCloudCoverPhrase input)
        {
            if (input == null)
            {
                return false;
