...
{
    /// <summary>
    /// Special case details may be desired to describe the attribute that may not be used the same as a value. Some examples are a timeout or a lock code.
    /// </summary>
    [DataContract(Name = "AttributeProperties_data")]
    public partial class AttributePropertiesData : IEquatable<AttributePropertiesData>, IValidatableObject
    {
        /// <summary>
        /// The data type for the &#x60;data&#x60; schema is object.
        /// </summary>
        /// <value>The data type for the &#x60;data&#x60; schema is object.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributePropertiesData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttributePropertiesData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributePropertiesData" /> class.
        /// </summary>
        /// <param name="type">The data type for the &#x60;data&#x60; schema is object. (required) (default to TypeEnum.Object).</param>
        /// <param name="additionalProperties">Indicates if properties not explicitly defined by the schema are allowed. Default is false. (default to false).</param>
        /// <param name="required">An array of the properties the &#x60;data&#x60; schema requires..</param>
        /// <param name="properties">Objects can be described in JSON schema for the &#x60;data&#x60; that should be stored on this attribute..</param>
        public AttributePropertiesData(TypeEnum type = TypeEnum.Object, bool additionalProperties = false, List<string> required = default(List<string>), Object properties = default(Object))
        {
            this.Type = type;
        ...
        /// </summary>
        /// <value>Indicates if properties not explicitly defined by the schema are allowed. Default is false.</value>
        ...
        /// </summary>
        /// <value>An array of the properties the &#x60;data&#x60; schema requires.</value>
        ...
        /// </summary>
        /// <value>Objects can be described in JSON schema for the &#x60;data&#x60; that should be stored on this attribute.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributePropertiesData {\n");
        ...
        {
            return this.Equals(input as AttributePropertiesData);
        }

        /// <summary>
        /// Returns true if AttributePropertiesData instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributePropertiesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributePropertiesData input)
        {
            if (input == null)
            {
                return false;
