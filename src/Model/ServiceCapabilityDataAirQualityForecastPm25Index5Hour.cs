...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm25Index5Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm25Index5Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm25Index5Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm25Index5Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm25Index5Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 5 hours index forecast of particulate matter less than 2.5 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm25Index5Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) 5 hours index forecast of particulate matter less than 2.5 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 5 hours index forecast of particulate matter less than 2.5 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm25Index5Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm25Index5Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm25Index5Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm25Index5Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm25Index5Hour input)
        {
            if (input == null)
            {
                return false;
