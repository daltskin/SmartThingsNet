...
{
    /// <summary>
    /// DeviceConfigEntryForDashboardState
    /// </summary>
    [DataContract(Name = "deviceConfigEntryForDashboardState")]
    public partial class DeviceConfigEntryForDashboardState : IEquatable<DeviceConfigEntryForDashboardState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryForDashboardState" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceConfigEntryForDashboardState() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryForDashboardState" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntryForDashboardState {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntryForDashboardState);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntryForDashboardState instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntryForDashboardState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntryForDashboardState input)
        {
            if (input == null)
            {
                return false;
