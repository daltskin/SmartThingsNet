...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimerEvent")]
    public partial class TimerEvent : IEquatable<TimerEvent>, IValidatableObject
    {
        ...
        /// <param name="name">The name of the schedule that caused this event..</param>
        /// <param name="type">type.</param>
        /// <param name="time">The IS0-8601 date time strings in UTC that this event was scheduled for..</param>
        /// <param name="expression">The CRON expression if the schedule was of type CRON..</param>
        public TimerEvent(string eventId = default(string), string name = default(string), TimerType? type = default(TimerType?), DateTime time = default(DateTime), string expression = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the schedule that caused this event.</value>
        ...
        /// </summary>
        /// <value>The IS0-8601 date time strings in UTC that this event was scheduled for.</value>
        ...
        /// </summary>
        /// <value>The CRON expression if the schedule was of type CRON.</value>
        ...
        {
            return this.Equals(input as TimerEvent);
        }

        /// <summary>
        /// Returns true if TimerEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of TimerEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimerEvent input)
        {
            if (input == null)
            {
                return false;
