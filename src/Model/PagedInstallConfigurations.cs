...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedInstallConfigurations")]
    public partial class PagedInstallConfigurations : IEquatable<PagedInstallConfigurations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedInstallConfigurations" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedInstallConfigurations(List<InstallConfiguration> items = default(List<InstallConfiguration>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<InstallConfiguration> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedInstallConfigurations {\n");
        ...
        {
            return this.Equals(input as PagedInstallConfigurations);
        }

        /// <summary>
        /// Returns true if PagedInstallConfigurations instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedInstallConfigurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedInstallConfigurations input)
        {
            if (input == null)
            {
                return false;
