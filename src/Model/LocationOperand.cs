...
namespace SmartThingsNet.Model
{
    ...
    /// LocationOperand
    /// </summary>
    [DataContract(Name = "LocationOperand")]
    public partial class LocationOperand : IEquatable<LocationOperand>, IValidatableObject
    {
        ...
        public LocationAttribute Attribute { get; set; }
        ...
        /// <summary>
        /// Required for User level rule, optional for Location level in request. Will always be present in response for both.
        /// </summary>
        /// <value>Required for User level rule, optional for Location level in request. Will always be present in response for both.</value>
        ...
        {
            return this.Equals(input as LocationOperand);
        }

        /// <summary>
        /// Returns true if LocationOperand instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationOperand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationOperand input)
        {
            if (input == null)
            {
                return false;
