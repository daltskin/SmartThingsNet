...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateRoomRequest :  IEquatable<UpdateRoomRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRoomRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRoomRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRoomRequest" /> class.
        /// </summary>
        /// <param name="name">A name for the room. (required).</param>
        public UpdateRoomRequest(string name = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for UpdateRoomRequest and cannot be null");
        }
        
        /// <summary>
        /// A name for the room.
        /// </summary>
        /// <value>A name for the room.</value>
        ...
        {
            return this.Equals(input as UpdateRoomRequest);
        }

        /// <summary>
        /// Returns true if UpdateRoomRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRoomRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRoomRequest input)
        {
            if (input == null)
                return false;
