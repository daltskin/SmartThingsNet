...
{
    /// <summary>
    /// A paginated array of driver channel details.
    /// </summary>
    [DataContract(Name = "PagedDriverChannels")]
    public partial class PagedDriverChannels : IEquatable<PagedDriverChannels>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDriverChannels" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedDriverChannels() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDriverChannels" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="links">links.</param>
        public PagedDriverChannels(List<DriverChannel> items = default(List<DriverChannel>), Links links = default(Links))
        {
            // to ensure "items" is required (not null)
            if (items == null) {
                throw new ArgumentNullException("items is a required property for PagedDriverChannels and cannot be null");
            }
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<DriverChannel> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedDriverChannels {\n");
        ...
        {
            return this.Equals(input as PagedDriverChannels);
        }

        /// <summary>
        /// Returns true if PagedDriverChannels instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedDriverChannels to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedDriverChannels input)
        {
            if (input == null)
            {
                return false;
