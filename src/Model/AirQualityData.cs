...
namespace SmartThingsNet.Model
{
    ...
    /// Air quality data 
    /// </summary>
    [DataContract(Name = "AirQualityData")]
    public partial class AirQualityData : IEquatable<AirQualityData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AirQualityData" /> class.
        /// </summary>
        /// <param name="airQualityIndex">airQualityIndex.</param>
        /// <param name="o3AmountInUgm3">o3AmountInUgm3.</param>
        /// <param name="o3Index">o3Index.</param>
        /// <param name="no2AmountInUgm3">no2AmountInUgm3.</param>
        /// <param name="no2Index">no2Index.</param>
        /// <param name="so2AmountInUgm3">so2AmountInUgm3.</param>
        /// <param name="so2Index">so2Index.</param>
        /// <param name="coAmountInUgm3">coAmountInUgm3.</param>
        /// <param name="coIndex">coIndex.</param>
        /// <param name="pm10AmountInUgm3">pm10AmountInUgm3.</param>
        /// <param name="pm10Index">pm10Index.</param>
        /// <param name="pm25AmountInUgm3">pm25AmountInUgm3.</param>
        /// <param name="pm25Index">pm25Index.</param>
        public AirQualityData(int airQualityIndex = default(int), double o3AmountInUgm3 = default(double), int o3Index = default(int), double no2AmountInUgm3 = default(double), int no2Index = default(int), double so2AmountInUgm3 = default(double), int so2Index = default(int), double coAmountInUgm3 = default(double), int coIndex = default(int), double pm10AmountInUgm3 = default(double), int pm10Index = default(int), double pm25AmountInUgm3 = default(double), int pm25Index = default(int))
        {
            this.AirQualityIndex = airQualityIndex;
            this.O3AmountInUgm3 = o3AmountInUgm3;
            this.O3Index = o3Index;
            this.No2AmountInUgm3 = no2AmountInUgm3;
            this.No2Index = no2Index;
            this.So2AmountInUgm3 = so2AmountInUgm3;
            this.So2Index = so2Index;
            this.CoAmountInUgm3 = coAmountInUgm3;
            this.CoIndex = coIndex;
            this.Pm10AmountInUgm3 = pm10AmountInUgm3;
            this.Pm10Index = pm10Index;
            this.Pm25AmountInUgm3 = pm25AmountInUgm3;
        ...
        /// <summary>
        /// Gets or Sets O3AmountInUgm3
        /// </summary>
        [DataMember(Name = "o3AmountInUgm3", EmitDefaultValue = false)]
        public double O3AmountInUgm3 { get; set; }
        ...
        /// <summary>
        /// Gets or Sets No2AmountInUgm3
        /// </summary>
        [DataMember(Name = "no2AmountInUgm3", EmitDefaultValue = false)]
        public double No2AmountInUgm3 { get; set; }
        ...
        /// <summary>
        /// Gets or Sets So2AmountInUgm3
        /// </summary>
        [DataMember(Name = "so2AmountInUgm3", EmitDefaultValue = false)]
        public double So2AmountInUgm3 { get; set; }
        ...
        /// <summary>
        /// Gets or Sets CoAmountInUgm3
        /// </summary>
        [DataMember(Name = "coAmountInUgm3", EmitDefaultValue = false)]
        public double CoAmountInUgm3 { get; set; }
        ...
        /// <summary>
        /// Gets or Sets Pm10AmountInUgm3
        /// </summary>
        [DataMember(Name = "pm10AmountInUgm3", EmitDefaultValue = false)]
        public double Pm10AmountInUgm3 { get; set; }
        ...
        /// <summary>
        /// Gets or Sets Pm25AmountInUgm3
        /// </summary>
        [DataMember(Name = "pm25AmountInUgm3", EmitDefaultValue = false)]
        public double Pm25AmountInUgm3 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AirQualityData {\n");
            sb.Append("  AirQualityIndex: ").Append(AirQualityIndex).Append("\n");
            sb.Append("  O3AmountInUgm3: ").Append(O3AmountInUgm3).Append("\n");
            sb.Append("  O3Index: ").Append(O3Index).Append("\n");
            sb.Append("  No2AmountInUgm3: ").Append(No2AmountInUgm3).Append("\n");
            sb.Append("  No2Index: ").Append(No2Index).Append("\n");
            sb.Append("  So2AmountInUgm3: ").Append(So2AmountInUgm3).Append("\n");
            sb.Append("  So2Index: ").Append(So2Index).Append("\n");
            sb.Append("  CoAmountInUgm3: ").Append(CoAmountInUgm3).Append("\n");
            sb.Append("  CoIndex: ").Append(CoIndex).Append("\n");
            sb.Append("  Pm10AmountInUgm3: ").Append(Pm10AmountInUgm3).Append("\n");
            sb.Append("  Pm10Index: ").Append(Pm10Index).Append("\n");
            sb.Append("  Pm25AmountInUgm3: ").Append(Pm25AmountInUgm3).Append("\n");
        ...
        {
            return this.Equals(input as AirQualityData);
        }

        /// <summary>
        /// Returns true if AirQualityData instances are equal
        /// </summary>
        /// <param name="input">Instance of AirQualityData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AirQualityData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.O3AmountInUgm3 == input.O3AmountInUgm3 ||
                    this.O3AmountInUgm3.Equals(input.O3AmountInUgm3)
                ) && 
                (
                ...
                (
                    this.No2AmountInUgm3 == input.No2AmountInUgm3 ||
                    this.No2AmountInUgm3.Equals(input.No2AmountInUgm3)
                ) && 
                (
                ...
                (
                    this.So2AmountInUgm3 == input.So2AmountInUgm3 ||
                    this.So2AmountInUgm3.Equals(input.So2AmountInUgm3)
                ) && 
                (
                ...
                (
                    this.CoAmountInUgm3 == input.CoAmountInUgm3 ||
                    this.CoAmountInUgm3.Equals(input.CoAmountInUgm3)
                ) && 
                (
                ...
                (
                    this.Pm10AmountInUgm3 == input.Pm10AmountInUgm3 ||
                    this.Pm10AmountInUgm3.Equals(input.Pm10AmountInUgm3)
                ) && 
                (
                ...
                (
                    this.Pm25AmountInUgm3 == input.Pm25AmountInUgm3 ||
                    this.Pm25AmountInUgm3.Equals(input.Pm25AmountInUgm3)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.O3AmountInUgm3.GetHashCode();
                hashCode = (hashCode * 59) + this.O3Index.GetHashCode();
                hashCode = (hashCode * 59) + this.No2AmountInUgm3.GetHashCode();
                hashCode = (hashCode * 59) + this.No2Index.GetHashCode();
                hashCode = (hashCode * 59) + this.So2AmountInUgm3.GetHashCode();
                hashCode = (hashCode * 59) + this.So2Index.GetHashCode();
                hashCode = (hashCode * 59) + this.CoAmountInUgm3.GetHashCode();
                hashCode = (hashCode * 59) + this.CoIndex.GetHashCode();
                hashCode = (hashCode * 59) + this.Pm10AmountInUgm3.GetHashCode();
                hashCode = (hashCode * 59) + this.Pm10Index.GetHashCode();
                hashCode = (hashCode * 59) + this.Pm25AmountInUgm3.GetHashCode();
