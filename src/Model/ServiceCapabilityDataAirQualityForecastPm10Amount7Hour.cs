...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm10Amount7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm10Amount7Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm10Amount7Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm10Amount7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm10Amount7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 7 hours dust amount forecast of particulate matter less than 10 microns .</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityForecastPm10Amount7Hour(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea) 7 hours dust amount forecast of particulate matter less than 10 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 7 hours dust amount forecast of particulate matter less than 10 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm10Amount7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm10Amount7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm10Amount7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm10Amount7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm10Amount7Hour input)
        {
            if (input == null)
            {
                return false;
