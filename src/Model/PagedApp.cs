...
namespace SmartThingsNet.Model
{
    ...
    /// PagedApp
    /// </summary>
    [DataContract(Name = "PagedApp")]
    public partial class PagedApp : IEquatable<PagedApp>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PagedApp);
        }

        /// <summary>
        /// Returns true if PagedApp instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedApp input)
        {
            if (input == null)
            {
                return false;
