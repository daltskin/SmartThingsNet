...
{
    /// <summary>
    /// GenerateConfigExclusion
    /// </summary>
    [DataContract(Name = "GenerateConfigExclusion")]
    public partial class GenerateConfigExclusion : IEquatable<GenerateConfigExclusion>, IValidatableObject
    {
        /// <summary>
        /// Defines View
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum DETAILVIEW for value: DETAIL_VIEW
            /// </summary>
            [EnumMember(Value = "DETAIL_VIEW")]
            DETAILVIEW = 1,
            ...
            /// <summary>
            /// Enum AUTOMATIONACTIONS for value: AUTOMATION_ACTIONS
            /// </summary>
            [EnumMember(Value = "AUTOMATION_ACTIONS")]
            AUTOMATIONACTIONS = 3,

            /// <summary>
            /// Enum AUTOMATIONCONDITIONS for value: AUTOMATION_CONDITIONS
            /// </summary>
            [EnumMember(Value = "AUTOMATION_CONDITIONS")]
            AUTOMATIONCONDITIONS = 4
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateConfigExclusion" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GenerateConfigExclusion() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateConfigExclusion" /> class.
        /// </summary>
        /// <param name="component">Human readable identifier for a device component..</param>
        /// <param name="id">id (required).</param>
        /// <param name="version">version.</param>
        /// <param name="view">view.</param>
        public GenerateConfigExclusion(string component = default(string), string id = default(string), int version = default(int), ViewEnum? view = default(ViewEnum?))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for GenerateConfigExclusion and cannot be null");
            }
            this.Id = id;
        ...
        /// <summary>
        /// Human readable identifier for a device component.
        /// </summary>
        /// <value>Human readable identifier for a device component.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateConfigExclusion {\n");
        ...
        {
            return this.Equals(input as GenerateConfigExclusion);
        }

        /// <summary>
        /// Returns true if GenerateConfigExclusion instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateConfigExclusion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateConfigExclusion input)
        {
            if (input == null)
            {
                return false;
