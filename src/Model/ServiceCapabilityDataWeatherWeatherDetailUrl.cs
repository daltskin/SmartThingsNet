...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherWeatherDetailUrl
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_weatherDetailUrl")]
    public partial class ServiceCapabilityDataWeatherWeatherDetailUrl : IEquatable<ServiceCapabilityDataWeatherWeatherDetailUrl>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherWeatherDetailUrl" /> class.
        /// </summary>
        /// <param name="value">A detail URL from weather vendor with a detail weather information web page .</param>
        public ServiceCapabilityDataWeatherWeatherDetailUrl(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// A detail URL from weather vendor with a detail weather information web page 
        /// </summary>
        /// <value>A detail URL from weather vendor with a detail weather information web page </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherWeatherDetailUrl {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherWeatherDetailUrl);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherWeatherDetailUrl instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherWeatherDetailUrl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherWeatherDetailUrl input)
        {
            if (input == null)
            {
                return false;
