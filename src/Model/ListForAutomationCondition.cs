...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listForAutomationCondition")]
    public partial class ListForAutomationCondition : IEquatable<ListForAutomationCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForAutomationCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForAutomationCondition" /> class.
        /// </summary>
        ...
        /// <param name="valueType">The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability..</param>
        public ListForAutomationCondition(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string), string value = default(string), string valueType = default(string))
        {
            // to ensure "alternatives" is required (not null)
            if (alternatives == null) {
                throw new ArgumentNullException("alternatives is a required property for ListForAutomationCondition and cannot be null");
            }
            this.Alternatives = alternatives;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ListForAutomationCondition and cannot be null");
            }
            this.Value = value;
        ...
        /// <summary>
        /// The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability.
        /// </summary>
        /// <value>The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForAutomationCondition {\n");
        ...
        {
            return this.Equals(input as ListForAutomationCondition);
        }

        /// <summary>
        /// Returns true if ListForAutomationCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForAutomationCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForAutomationCondition input)
        {
            if (input == null)
            {
                return false;
