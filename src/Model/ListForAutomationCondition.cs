...
namespace SmartThingsNet.Model
{
    ...
    public partial class ListForAutomationCondition :  IEquatable<ListForAutomationCondition>, IValidatableObject
    {
        ...
        public ListForAutomationCondition(List<AlternativeItem> alternatives = default(List<AlternativeItem>), string supportedValues = default(string), string value = default(string))
        {
            // to ensure "alternatives" is required (not null)
            this.Alternatives = alternatives ?? throw new ArgumentNullException("alternatives is a required property for ListForAutomationCondition and cannot be null");
