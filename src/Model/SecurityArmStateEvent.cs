...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SecurityArmStateEvent")]
    public partial class SecurityArmStateEvent : IEquatable<SecurityArmStateEvent>, IValidatableObject
    {
        /// <summary>
        /// The arm state of a security system. 
        /// </summary>
        /// <value>The arm state of a security system. </value>
        ...
        public enum ArmStateEnum
        {
            ...
            /// <summary>
            /// Enum ARMEDSTAY for value: ARMED_STAY
            /// </summary>
            [EnumMember(Value = "ARMED_STAY")]
            ARMEDSTAY = 2,

            /// <summary>
            /// Enum ARMEDAWAY for value: ARMED_AWAY
            /// </summary>
            [EnumMember(Value = "ARMED_AWAY")]
            ARMEDAWAY = 3,

            /// <summary>
            /// Enum DISARMED for value: DISARMED
            /// </summary>
            [EnumMember(Value = "DISARMED")]
            DISARMED = 4
        ...
        /// </summary>
        /// <value>The arm state of a security system. </value>
        [DataMember(Name = "armState", EmitDefaultValue = false)]
        public ArmStateEnum? ArmState { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityArmStateEvent" /> class.
        /// </summary>
        /// <param name="eventId">The id of the event..</param>
        /// <param name="locationId">The id of the location in which the event was triggered..</param>
        /// <param name="armState">The arm state of a security system. .</param>
        /// <param name="optionalArguments">A set of key / value pairs useful for passing any optional arguments. .</param>
        public SecurityArmStateEvent(string eventId = default(string), string locationId = default(string), ArmStateEnum? armState = default(ArmStateEnum?), Dictionary<string, SimpleValue> optionalArguments = default(Dictionary<string, SimpleValue>))
        {
        ...
        /// </summary>
        /// <value>A set of key / value pairs useful for passing any optional arguments. </value>
        [DataMember(Name = "optionalArguments", EmitDefaultValue = false)]
        public Dictionary<string, SimpleValue> OptionalArguments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityArmStateEvent {\n");
            sb.Append("  EventId: ").Append(EventId).Append("\n");
            sb.Append("  LocationId: ").Append(LocationId).Append("\n");
            sb.Append("  ArmState: ").Append(ArmState).Append("\n");
            sb.Append("  OptionalArguments: ").Append(OptionalArguments).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SecurityArmStateEvent);
        }

        /// <summary>
        /// Returns true if SecurityArmStateEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityArmStateEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityArmStateEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ArmState == input.ArmState ||
                    this.ArmState.Equals(input.ArmState)
                ) && 
                (
                    this.OptionalArguments == input.OptionalArguments ||
                    this.OptionalArguments != null &&
                    input.OptionalArguments != null &&
                    this.OptionalArguments.SequenceEqual(input.OptionalArguments)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ArmState.GetHashCode();
                if (this.OptionalArguments != null)
                {
                    hashCode = (hashCode * 59) + this.OptionalArguments.GetHashCode();
                }
                return hashCode;
            }
        }
