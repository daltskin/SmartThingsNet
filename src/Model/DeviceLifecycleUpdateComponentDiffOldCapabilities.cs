...
{
    /// <summary>
    /// DeviceLifecycleUpdateComponentDiffOldCapabilities
    /// </summary>
    [DataContract(Name = "DeviceLifecycleUpdate_componentDiff_old_capabilities")]
    public partial class DeviceLifecycleUpdateComponentDiffOldCapabilities : IEquatable<DeviceLifecycleUpdateComponentDiffOldCapabilities>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleUpdateComponentDiffOldCapabilities" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="version">version.</param>
        public DeviceLifecycleUpdateComponentDiffOldCapabilities(string id = default(string), int version = default(int))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleUpdateComponentDiffOldCapabilities {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleUpdateComponentDiffOldCapabilities);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleUpdateComponentDiffOldCapabilities instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleUpdateComponentDiffOldCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleUpdateComponentDiffOldCapabilities input)
        {
            if (input == null)
            {
                return false;
