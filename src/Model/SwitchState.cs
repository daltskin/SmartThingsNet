...
namespace SmartThingsNet.Model
{
    ...
    /// SwitchState
    /// </summary>
    [DataContract(Name = "switchState")]
    public partial class SwitchState : IEquatable<SwitchState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchState" /> class.
        /// </summary>
        /// <param name="state">state.</param>
        public SwitchState(SwitchStateState state = default(SwitchStateState))
        {
            this.State = state;
        }
        ...
        {
            return this.Equals(input as SwitchState);
        }

        /// <summary>
        /// Returns true if SwitchState instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchState input)
        {
            if (input == null)
            {
                return false;
