...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PermissionConfig")]
    public partial class PermissionConfig : IEquatable<PermissionConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PermissionConfig" /> class.
        /// </summary>
        /// <param name="permissions">permissions.</param>
        public PermissionConfig(List<string> permissions = default(List<string>))
        {
        ...
        {
            return this.Equals(input as PermissionConfig);
        }

        /// <summary>
        /// Returns true if PermissionConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of PermissionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PermissionConfig input)
        {
            if (input == null)
            {
                return false;
