...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneSecurityModeRequest")]
    public partial class SceneSecurityModeRequest : IEquatable<SceneSecurityModeRequest>, IValidatableObject
    {
        /// <summary>
        /// The id of the security mode
        /// </summary>
        /// <value>The id of the security mode</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SecurityEnum
        {
            /// <summary>
            /// Enum SetArmStay for value: setArmStay
            /// </summary>
            [EnumMember(Value = "setArmStay")]
            SetArmStay = 1,

            /// <summary>
            /// Enum SetArmAway for value: setArmAway
            /// </summary>
            [EnumMember(Value = "setArmAway")]
            SetArmAway = 2,

            /// <summary>
            /// Enum Disarm for value: disarm
            /// </summary>
        ...
        protected SceneSecurityModeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneSecurityModeRequest" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Additional query param</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneSecurityModeRequest {\n");
        ...
        {
            return this.Equals(input as SceneSecurityModeRequest);
        }

        /// <summary>
        /// Returns true if SceneSecurityModeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneSecurityModeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneSecurityModeRequest input)
        {
            if (input == null)
            {
                return false;
