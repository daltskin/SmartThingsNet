...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData")]
    public partial class ServiceCapabilityData : IEquatable<ServiceCapabilityData>, IValidatableObject
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        public List<NameEnum> Name { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceCapabilityData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityData" /> class.
        /// </summary>
        /// <param name="locationId">location ID (required).</param>
        /// <param name="name">capability name(s).</param>
        /// <param name="alert">alert.</param>
        /// <param name="airQuality">airQuality.</param>
        /// <param name="forecast">forecast.</param>
        /// <param name="airQualityForecast">airQualityForecast.</param>
        /// <param name="weather">weather.</param>
        public ServiceCapabilityData(string locationId = default(string), List<NameEnum> name = default(List<NameEnum>), List<ServiceCapabilityDataAlert> alert = default(List<ServiceCapabilityDataAlert>), ServiceCapabilityDataAirQuality airQuality = default(ServiceCapabilityDataAirQuality), ServiceCapabilityDataForecast forecast = default(ServiceCapabilityDataForecast), ServiceCapabilityDataAirQualityForecast airQualityForecast = default(ServiceCapabilityDataAirQualityForecast), ServiceCapabilityDataWeather weather = default(ServiceCapabilityDataWeather))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for ServiceCapabilityData and cannot be null");
            }
            ...
            this.AirQualityForecast = airQualityForecast;
        ...
        public List<ServiceCapabilityDataAlert> Alert { get; set; }

        /// <summary>
        /// Gets or Sets AirQuality
        /// </summary>
        [DataMember(Name = "airQuality", EmitDefaultValue = false)]
        public ServiceCapabilityDataAirQuality AirQuality { get; set; }

        /// <summary>
        /// Gets or Sets Forecast
        /// </summary>
        [DataMember(Name = "forecast", EmitDefaultValue = false)]
        public ServiceCapabilityDataForecast Forecast { get; set; }

        /// <summary>
        /// Gets or Sets AirQualityForecast
        /// </summary>
        [DataMember(Name = "airQualityForecast", EmitDefaultValue = false)]
        public ServiceCapabilityDataAirQualityForecast AirQualityForecast { get; set; }

        /// <summary>
        /// Gets or Sets Weather
        /// </summary>
        [DataMember(Name = "weather", EmitDefaultValue = false)]
        public ServiceCapabilityDataWeather Weather { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityData {\n");
            ...
            sb.Append("  AirQualityForecast: ").Append(AirQualityForecast).Append("\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityData);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityData instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Alert != null &&
                    input.Alert != null &&
                    this.Alert.SequenceEqual(input.Alert)
                ) && 
                (
                ...
                (
                    this.AirQualityForecast == input.AirQualityForecast ||
                    (this.AirQualityForecast != null &&
                    this.AirQualityForecast.Equals(input.AirQualityForecast))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AirQualityForecast != null)
                {
                    hashCode = (hashCode * 59) + this.AirQualityForecast.GetHashCode();
                }
