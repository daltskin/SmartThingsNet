...
namespace SmartThingsNet.Model
{
    ...
    public partial class Message :  IEquatable<Message>, IValidatableObject
    {
        ...
        public Message(string fallbackLocale = default(string), List<MessageTemplate> templates = default(List<MessageTemplate>))
        {
            // to ensure "fallbackLocale" is required (not null)
            this.FallbackLocale = fallbackLocale ?? throw new ArgumentNullException("fallbackLocale is a required property for Message and cannot be null");
            // to ensure "templates" is required (not null)
            this.Templates = templates ?? throw new ArgumentNullException("templates is a required property for Message and cannot be null");
        }
