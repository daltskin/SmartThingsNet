...
{
    /// <summary>
    /// CreateDeviceConfigRequestAutomation
    /// </summary>
    [DataContract]
    public partial class CreateDeviceConfigRequestAutomation :  IEquatable<CreateDeviceConfigRequestAutomation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeviceConfigRequestAutomation" /> class.
        /// </summary>
        /// <param name="conditions">conditions.</param>
        /// <param name="actions">actions.</param>
        public CreateDeviceConfigRequestAutomation(List<DeviceConfigEntry> conditions = default(List<DeviceConfigEntry>), List<DeviceConfigEntry> actions = default(List<DeviceConfigEntry>))
        {
        ...
        public List<DeviceConfigEntry> Conditions { get; set; }

        /// <summary>
        /// Gets or Sets Actions
        /// </summary>
        [DataMember(Name="actions", EmitDefaultValue=false)]
        public List<DeviceConfigEntry> Actions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDeviceConfigRequestAutomation {\n");
        ...
        {
            return this.Equals(input as CreateDeviceConfigRequestAutomation);
        }

        /// <summary>
        /// Returns true if CreateDeviceConfigRequestAutomation instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDeviceConfigRequestAutomation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDeviceConfigRequestAutomation input)
        {
            if (input == null)
                return false;
