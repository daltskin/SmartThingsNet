...
{
    /// <summary>
    /// ServiceCapabilityDataSeverity
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_severity")]
    public partial class ServiceCapabilityDataSeverity : IEquatable<ServiceCapabilityDataSeverity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataSeverity" /> class.
        /// </summary>
        /// <param name="value">severity of the alert. Smaller the number the more severe the alert is..</param>
        public ServiceCapabilityDataSeverity(int value = default(int))
        {
            this.Value = value;
        }

        /// <summary>
        /// severity of the alert. Smaller the number the more severe the alert is.
        /// </summary>
        /// <value>severity of the alert. Smaller the number the more severe the alert is.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataSeverity {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataSeverity);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataSeverity instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataSeverity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataSeverity input)
        {
            if (input == null)
            {
                return false;
