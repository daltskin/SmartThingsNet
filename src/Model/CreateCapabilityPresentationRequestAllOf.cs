...
{
    /// <summary>
    /// CreateCapabilityPresentationRequestAllOf
    /// </summary>
    [DataContract(Name = "CreateCapabilityPresentationRequest_allOf")]
    public partial class CreateCapabilityPresentationRequestAllOf : IEquatable<CreateCapabilityPresentationRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCapabilityPresentationRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCapabilityPresentationRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCapabilityPresentationRequestAllOf" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="version">The version number of the capability. (required) (default to 1).</param>
        public CreateCapabilityPresentationRequestAllOf(string id = default(string), int version = 1)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for CreateCapabilityPresentationRequestAllOf and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCapabilityPresentationRequestAllOf {\n");
        ...
        {
            return this.Equals(input as CreateCapabilityPresentationRequestAllOf);
        }

        /// <summary>
        /// Returns true if CreateCapabilityPresentationRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCapabilityPresentationRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCapabilityPresentationRequestAllOf input)
        {
            if (input == null)
            {
                return false;
