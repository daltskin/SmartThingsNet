...
namespace SmartThingsNet.Model
{
    ...
    /// PlayedText
    /// </summary>
    [DataContract(Name = "PlayedText")]
    public partial class PlayedText : IEquatable<PlayedText>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayedText" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayedText() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayedText" /> class.
        /// </summary>
        /// <param name="message">message to indicate success (required).</param>
        public PlayedText(string message = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for PlayedText and cannot be null");
            }
        ...
        {
            return this.Equals(input as PlayedText);
        }

        /// <summary>
        /// Returns true if PlayedText instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayedText to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayedText input)
        {
            if (input == null)
            {
                return false;
