...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateAppOAuthRequest")]
    public partial class UpdateAppOAuthRequest : IEquatable<UpdateAppOAuthRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAppOAuthRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAppOAuthRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAppOAuthRequest" /> class.
        /// </summary>
        /// <param name="clientName">A name given to the OAuth Client. (required).</param>
        /// <param name="scope">A list of SmartThings API OAuth scope identifiers that maybe required to execute your integration. (required).</param>
        /// <param name="redirectUris">A list of redirect URIs. (required).</param>
        public UpdateAppOAuthRequest(string clientName = default(string), List<string> scope = default(List<string>), List<string> redirectUris = default(List<string>))
        {
            // to ensure "clientName" is required (not null)
            if (clientName == null) {
                throw new ArgumentNullException("clientName is a required property for UpdateAppOAuthRequest and cannot be null");
            }
            this.ClientName = clientName;
            // to ensure "scope" is required (not null)
            if (scope == null) {
                throw new ArgumentNullException("scope is a required property for UpdateAppOAuthRequest and cannot be null");
            }
            this.Scope = scope;
            // to ensure "redirectUris" is required (not null)
            if (redirectUris == null) {
                throw new ArgumentNullException("redirectUris is a required property for UpdateAppOAuthRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A name given to the OAuth Client.</value>
        ...
        /// </summary>
        /// <value>A list of SmartThings API OAuth scope identifiers that maybe required to execute your integration.</value>
        ...
        /// </summary>
        /// <value>A list of redirect URIs.</value>
        [DataMember(Name = "redirectUris", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAppOAuthRequest {\n");
        ...
        {
            return this.Equals(input as UpdateAppOAuthRequest);
        }

        /// <summary>
        /// Returns true if UpdateAppOAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAppOAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAppOAuthRequest input)
        {
            if (input == null)
            {
                return false;
