...
namespace SmartThingsNet.Model
{
    ...
    public partial class UpdateAppOAuthRequest :  IEquatable<UpdateAppOAuthRequest>, IValidatableObject
    {
        ...
        public UpdateAppOAuthRequest(string clientName = default(string), List<string> scope = default(List<string>), List<string> redirectUris = default(List<string>))
        {
            ...
            this.ClientName = clientName ?? throw new ArgumentNullException("clientName is a required property for UpdateAppOAuthRequest and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for UpdateAppOAuthRequest and cannot be null");
            // to ensure "redirectUris" is required (not null)
            this.RedirectUris = redirectUris ?? throw new ArgumentNullException("redirectUris is a required property for UpdateAppOAuthRequest and cannot be null");
        }
