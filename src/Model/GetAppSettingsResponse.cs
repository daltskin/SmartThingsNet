...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetAppSettingsResponse")]
    public partial class GetAppSettingsResponse : IEquatable<GetAppSettingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAppSettingsResponse" /> class.
        /// </summary>
        /// <param name="settings">settings.</param>
        public GetAppSettingsResponse(Dictionary<string, string> settings = default(Dictionary<string, string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAppSettingsResponse {\n");
        ...
        {
            return this.Equals(input as GetAppSettingsResponse);
        }

        /// <summary>
        /// Returns true if GetAppSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAppSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAppSettingsResponse input)
        {
            if (input == null)
            {
                return false;
