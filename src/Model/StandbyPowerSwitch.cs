...
namespace SmartThingsNet.Model
{
    ...
    /// StandbyPowerSwitch
    /// </summary>
    [DataContract(Name = "standbyPowerSwitch")]
    public partial class StandbyPowerSwitch : IEquatable<StandbyPowerSwitch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StandbyPowerSwitch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StandbyPowerSwitch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StandbyPowerSwitch" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StandbyPowerSwitch {\n");
        ...
        {
            return this.Equals(input as StandbyPowerSwitch);
        }

        /// <summary>
        /// Returns true if StandbyPowerSwitch instances are equal
        /// </summary>
        /// <param name="input">Instance of StandbyPowerSwitch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandbyPowerSwitch input)
        {
            if (input == null)
            {
                return false;
