...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm10Index1Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm10Index1Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm10Index1Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm10Index1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm10Index1Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) one hour index forecast of particulate matter less than 10 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm10Index1Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) one hour index forecast of particulate matter less than 10 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) one hour index forecast of particulate matter less than 10 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm10Index1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm10Index1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm10Index1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm10Index1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm10Index1Hour input)
        {
            if (input == null)
            {
                return false;
