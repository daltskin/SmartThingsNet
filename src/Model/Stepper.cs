...
namespace SmartThingsNet.Model
{
    ...
    public partial class Stepper :  IEquatable<Stepper>, IValidatableObject
    {
        ...
        public Stepper(StepperCommand command = default(StepperCommand), string value = default(string), double step = default(double), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for Stepper and cannot be null");
            this.Step = step;
            // to ensure "range" is required (not null)
            this.Range = range ?? throw new ArgumentNullException("range is a required property for Stepper and cannot be null");
            this.Value = value;
        }
