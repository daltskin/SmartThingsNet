...
{
    /// <summary>
    /// This display type creates a stepper which can trigger \&quot;increase\&quot; and \&quot;decrease\&quot; commands. The user must specify either a \&quot;command\&quot; field alone or \&quot;increase\&quot; / \&quot;decrease\&quot; fields for commands without an argument.
    /// </summary>
    [DataContract(Name = "stepper")]
    public partial class Stepper : IEquatable<Stepper>, IValidatableObject
    {
        /// <summary>
        ...
        public Stepper(StepperCommand command = default(StepperCommand), string value = default(string), string valueType = default(string), double step = default(double), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for Stepper and cannot be null");
            }
            this.Command = command;
            this.Step = step;
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for Stepper and cannot be null");
            }
            this.Range = range;
            this.Value = value;
        ...
        public StepperCommand Command { get; set; }
        ...
        {
            return this.Equals(input as Stepper);
        }

        /// <summary>
        /// Returns true if Stepper instances are equal
        /// </summary>
        /// <param name="input">Instance of Stepper to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Stepper input)
        {
            if (input == null)
            {
                return false;
