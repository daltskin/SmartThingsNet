...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceLifecycleCreate")]
    public partial class DeviceLifecycleCreate : IEquatable<DeviceLifecycleCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleCreate" /> class.
        /// </summary>
        ...
        public DeviceLifecycleCreate(string presentationId = default(string), string manufacturerName = default(string), List<DeviceLifecycleCreateCategories> categories = default(List<DeviceLifecycleCreateCategories>), string parentDeviceId = default(string), string hubId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleCreate {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleCreate);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleCreate input)
        {
            if (input == null)
            {
                return false;
