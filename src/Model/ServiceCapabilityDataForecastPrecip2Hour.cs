...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip2Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip2Hour")]
    public partial class ServiceCapabilityDataForecastPrecip2Hour : IEquatable<ServiceCapabilityDataForecastPrecip2Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip2Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 2 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip2Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 2 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 2 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip2Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip2Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip2Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip2Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip2Hour input)
        {
            if (input == null)
            {
                return false;
