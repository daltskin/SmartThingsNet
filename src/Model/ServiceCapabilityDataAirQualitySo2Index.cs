...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualitySo2Index
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_so2Index")]
    public partial class ServiceCapabilityDataAirQualitySo2Index : IEquatable<ServiceCapabilityDataAirQualitySo2Index>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualitySo2Index" /> class.
        /// </summary>
        /// <param name="value">(Available for non-Korea Only) index of Sulfur Dioxide pollutant.</param>
        /// <param name="unit">EPA.</param>
        public ServiceCapabilityDataAirQualitySo2Index(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for non-Korea Only) index of Sulfur Dioxide pollutant
        /// </summary>
        /// <value>(Available for non-Korea Only) index of Sulfur Dioxide pollutant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualitySo2Index {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualitySo2Index);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualitySo2Index instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualitySo2Index to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualitySo2Index input)
        {
            if (input == null)
            {
                return false;
