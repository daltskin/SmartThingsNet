...
{
    /// <summary>
    /// DeviceProfileResponseAllOf
    /// </summary>
    [DataContract(Name = "DeviceProfileResponse_allOf")]
    public partial class DeviceProfileResponseAllOf : IEquatable<DeviceProfileResponseAllOf>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProfileResponseAllOf" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="preferences">preferences.</param>
        /// <param name="components">components.</param>
        public DeviceProfileResponseAllOf(DeviceProfileStatus? status = default(DeviceProfileStatus?), List<PreferenceResponse> preferences = default(List<PreferenceResponse>), List<DeviceComponent> components = default(List<DeviceComponent>))
        {
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceProfileResponseAllOf {\n");
        ...
        {
            return this.Equals(input as DeviceProfileResponseAllOf);
        }

        /// <summary>
        /// Returns true if DeviceProfileResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceProfileResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceProfileResponseAllOf input)
        {
            if (input == null)
            {
                return false;
