...
namespace SmartThingsNet.Model
{
    ...
    public partial class TTSBody : IEquatable<TTSBody>, IValidatableObject
    {
        ...
        public TTSBody(string text = default(string), string languageCode = default(string), string voiceId = default(string), AudioFormatEnum? audioFormat = default(AudioFormatEnum?), TtsProviderEnum? ttsProvider = default(TtsProviderEnum?), EngineEnum? engine = default(EngineEnum?), SpeakingStyleEnum? speakingStyle = default(SpeakingStyleEnum?))
        {
            ...
            if (languageCode == null) {
                throw new ArgumentNullException("languageCode is a required property for TTSBody and cannot be null");
            }
            this.LanguageCode = languageCode;
            // to ensure "voiceId" is required (not null)
            if (voiceId == null) {
                throw new ArgumentNullException("voiceId is a required property for TTSBody and cannot be null");
            }
