...
namespace SmartThingsNet.Model
{
    ...
    public partial class Notice : IEquatable<Notice>, IValidatableObject
    {
        ...
        public NoticeCode? Code { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="Notice" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        /// <param name="badgeUrl">The url of the badge icon for the notice card.</param>
        /// <param name="message">The localized message to be displayed.</param>
        /// <param name="actions">The action(s) a user can take to resolve this notice.</param>
        public Notice(NoticeCode? code = default(NoticeCode?), string badgeUrl = default(string), string message = default(string), List<NoticeAction> actions = default(List<NoticeAction>))
        {
            this.Code = code;
        ...
        /// </summary>
        /// <value>The url of the badge icon for the notice card</value>
        ...
        /// </summary>
        /// <value>The localized message to be displayed</value>
        ...
        /// </summary>
        /// <value>The action(s) a user can take to resolve this notice</value>
        [DataMember(Name = "actions", EmitDefaultValue = false)]
        public List<NoticeAction> Actions { get; set; }
        ...
        public bool Equals(Notice input)
        {
            ...
            return 
                ...
                (
                    this.BadgeUrl == input.BadgeUrl ||
                    (this.BadgeUrl != null &&
                    this.BadgeUrl.Equals(input.BadgeUrl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.BadgeUrl.GetHashCode();
                }
