...
{
    /// <summary>
    /// RemainsConditionAllOf
    /// </summary>
    [DataContract(Name = "RemainsCondition_allOf")]
    public partial class RemainsConditionAllOf : IEquatable<RemainsConditionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemainsConditionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemainsConditionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemainsConditionAllOf" /> class.
        /// </summary>
        ...
        public RemainsConditionAllOf(string id = default(string), Operand operand = default(Operand), Interval duration = default(Interval), bool latching = false)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for RemainsConditionAllOf and cannot be null");
            }
            this.Id = id;
            // to ensure "duration" is required (not null)
            if (duration == null) {
                throw new ArgumentNullException("duration is a required property for RemainsConditionAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemainsConditionAllOf {\n");
        ...
        {
            return this.Equals(input as RemainsConditionAllOf);
        }

        /// <summary>
        /// Returns true if RemainsConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RemainsConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemainsConditionAllOf input)
        {
            if (input == null)
            {
                return false;
