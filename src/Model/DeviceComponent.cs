...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceComponent
    /// </summary>
    [DataContract(Name = "DeviceComponent")]
    public partial class DeviceComponent : IEquatable<DeviceComponent>, IValidatableObject
    {
        /// <summary>
        ...
        public DeviceComponent(string label = default(string), string id = default(string), List<CapabilityReference> capabilities = default(List<CapabilityReference>), List<DeviceCategory> categories = default(List<DeviceCategory>), Restriction restrictions = default(Restriction))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DeviceComponent and cannot be null");
            }
            this.Id = id;
            // to ensure "capabilities" is required (not null)
            if (capabilities == null) {
                throw new ArgumentNullException("capabilities is a required property for DeviceComponent and cannot be null");
            }
            this.Capabilities = capabilities;
            // to ensure "categories" is required (not null)
            if (categories == null) {
                throw new ArgumentNullException("categories is a required property for DeviceComponent and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceComponent {\n");
        ...
        {
            return this.Equals(input as DeviceComponent);
        }

        /// <summary>
        /// Returns true if DeviceComponent instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceComponent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceComponent input)
        {
            if (input == null)
            {
                return false;
