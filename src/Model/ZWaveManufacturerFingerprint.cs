...
{
    /// <summary>
    /// ZWaveManufacturerFingerprint
    /// </summary>
    [DataContract(Name = "ZWaveManufacturerFingerprint")]
    public partial class ZWaveManufacturerFingerprint : IEquatable<ZWaveManufacturerFingerprint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZWaveManufacturerFingerprint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ZWaveManufacturerFingerprint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ZWaveManufacturerFingerprint" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>16-bit manufacturer identifier assigned by the Z-Wave Specification</value>
        ...
        /// </summary>
        /// <value>16-bit manufacturer defined product identifier</value>
        ...
        /// </summary>
        /// <value>16-bit manufacturer defined product type</value>
        [DataMember(Name = "productType", IsRequired = true, EmitDefaultValue = false)]
        public int ProductType { get; set; }

        /// <summary>
        /// Gets or Sets DeviceIntegrationProfileKey
        /// </summary>
        [DataMember(Name = "deviceIntegrationProfileKey", EmitDefaultValue = false)]
        public DeviceIntegrationProfileKey DeviceIntegrationProfileKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ZWaveManufacturerFingerprint {\n");
            sb.Append("  ManufacturerId: ").Append(ManufacturerId).Append("\n");
            sb.Append("  ProductId: ").Append(ProductId).Append("\n");
            sb.Append("  ProductType: ").Append(ProductType).Append("\n");
            sb.Append("  DeviceIntegrationProfileKey: ").Append(DeviceIntegrationProfileKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ZWaveManufacturerFingerprint);
        }

        /// <summary>
        /// Returns true if ZWaveManufacturerFingerprint instances are equal
        /// </summary>
        /// <param name="input">Instance of ZWaveManufacturerFingerprint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ZWaveManufacturerFingerprint input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DeviceIntegrationProfileKey == input.DeviceIntegrationProfileKey ||
                    (this.DeviceIntegrationProfileKey != null &&
                    this.DeviceIntegrationProfileKey.Equals(input.DeviceIntegrationProfileKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DeviceIntegrationProfileKey != null)
                {
                    hashCode = (hashCode * 59) + this.DeviceIntegrationProfileKey.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        {
            // ManufacturerId (int) maximum
            if (this.ManufacturerId > (int)65535)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ManufacturerId, must be a value less than or equal to 65535.", new [] { "ManufacturerId" });
            }

            // ManufacturerId (int) minimum
            if (this.ManufacturerId < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ManufacturerId, must be a value greater than or equal to 0.", new [] { "ManufacturerId" });
            }

            // ProductId (int) maximum
            if (this.ProductId > (int)65535)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProductId, must be a value less than or equal to 65535.", new [] { "ProductId" });
            }

            // ProductId (int) minimum
            if (this.ProductId < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProductId, must be a value greater than or equal to 0.", new [] { "ProductId" });
            }

            // ProductType (int) maximum
            if (this.ProductType > (int)65535)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProductType, must be a value less than or equal to 65535.", new [] { "ProductType" });
            }

            // ProductType (int) minimum
            if (this.ProductType < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProductType, must be a value greater than or equal to 0.", new [] { "ProductType" });
            }
