...
namespace SmartThingsNet.Model
{
    ...
    /// DriverRevision
    /// </summary>
    [DataContract(Name = "DriverRevision")]
    public partial class DriverRevision : IEquatable<DriverRevision>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverRevision" /> class.
        /// </summary>
        ...
        public DriverRevision(string driverId = default(string), string version = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverRevision {\n");
        ...
        {
            return this.Equals(input as DriverRevision);
        }

        /// <summary>
        /// Returns true if DriverRevision instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverRevision to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverRevision input)
        {
            if (input == null)
            {
                return false;
