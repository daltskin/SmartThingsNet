...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LambdaSmartApp")]
    public partial class LambdaSmartApp : IEquatable<LambdaSmartApp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LambdaSmartApp" /> class.
        /// </summary>
        /// <param name="functions">A list of AWS arns referencing a Lambda function..</param>
        public LambdaSmartApp(List<string> functions = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LambdaSmartApp {\n");
        ...
        {
            return this.Equals(input as LambdaSmartApp);
        }

        /// <summary>
        /// Returns true if LambdaSmartApp instances are equal
        /// </summary>
        /// <param name="input">Instance of LambdaSmartApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LambdaSmartApp input)
        {
            if (input == null)
            {
                return false;
