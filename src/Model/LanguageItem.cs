...
namespace SmartThingsNet.Model
{
    ...
    public partial class LanguageItem : IEquatable<LanguageItem>, IValidatableObject
    {
        ...
        public LanguageItem(string locale = default(string), List<PoCodes> poCodes = default(List<PoCodes>))
        {
            ...
            if (locale == null) {
                throw new ArgumentNullException("locale is a required property for LanguageItem and cannot be null");
            }
            this.Locale = locale;
            // to ensure "poCodes" is required (not null)
            if (poCodes == null) {
                throw new ArgumentNullException("poCodes is a required property for LanguageItem and cannot be null");
            }
        ...
        [DataMember(Name = "poCodes", IsRequired = true, EmitDefaultValue = false)]
