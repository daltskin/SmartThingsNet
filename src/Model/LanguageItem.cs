...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LanguageItem :  IEquatable<LanguageItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="LanguageItem" /> class.
        /// </summary>
        /// <param name="locale">ICU locale (required).</param>
        /// <param name="poCodes">The list of resources that contain translated text (required).</param>
        public LanguageItem(string locale = default(string), List<PoCodes> poCodes = default(List<PoCodes>))
        {
            // to ensure "locale" is required (not null)
            this.Locale = locale ?? throw new ArgumentNullException("locale is a required property for LanguageItem and cannot be null");
            // to ensure "poCodes" is required (not null)
            this.PoCodes = poCodes ?? throw new ArgumentNullException("poCodes is a required property for LanguageItem and cannot be null");
        }
        
        /// <summary>
        /// ICU locale
        /// </summary>
        /// <value>ICU locale</value>
        ...
        /// </summary>
        /// <value>The list of resources that contain translated text</value>
        [DataMember(Name="poCodes", EmitDefaultValue=false)]
        public List<PoCodes> PoCodes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PoCodes: ").Append(PoCodes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LanguageItem);
        }

        /// <summary>
        /// Returns true if LanguageItem instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PoCodes == input.PoCodes ||
                    this.PoCodes != null &&
                    input.PoCodes != null &&
                    this.PoCodes.SequenceEqual(input.PoCodes)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PoCodes != null)
                    hashCode = hashCode * 59 + this.PoCodes.GetHashCode();
                return hashCode;
            }
        }
