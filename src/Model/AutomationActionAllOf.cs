...
{
    /// <summary>
    /// AutomationActionAllOf
    /// </summary>
    [DataContract(Name = "automationAction_allOf")]
    public partial class AutomationActionAllOf : IEquatable<AutomationActionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        protected AutomationActionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationActionAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationActionAllOf {\n");
        ...
        {
            return this.Equals(input as AutomationActionAllOf);
        }

        /// <summary>
        /// Returns true if AutomationActionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationActionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationActionAllOf input)
        {
            if (input == null)
            {
                return false;
