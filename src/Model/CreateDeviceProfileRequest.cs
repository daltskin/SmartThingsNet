...
namespace SmartThingsNet.Model
{
    ...
    public partial class CreateDeviceProfileRequest :  IEquatable<CreateDeviceProfileRequest>, IValidatableObject
    {
        ...
        public CreateDeviceProfileRequest(string name = default(string), List<DeviceComponentReference> components = default(List<DeviceComponentReference>), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateDeviceProfileRequest and cannot be null");
            // to ensure "components" is required (not null)
            this.Components = components ?? throw new ArgumentNullException("components is a required property for CreateDeviceProfileRequest and cannot be null");
        ...
        public List<DeviceComponentReference> Components { get; set; }
