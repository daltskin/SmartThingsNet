...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateDeviceProfileRequest")]
    public partial class CreateDeviceProfileRequest : IEquatable<CreateDeviceProfileRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeviceProfileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateDeviceProfileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeviceProfileRequest" /> class.
        /// </summary>
        /// <param name="name">A name for the device profile. (required).</param>
        /// <param name="components">A list of components for this profile. Exactly 1 component ID must be &#x60;main&#x60;. (required).</param>
        /// <param name="preferences">A list of preferences for this profile, whether implicit or explicit..</param>
        /// <param name="metadata">Additional information about the device profile, limited to 10 entries..</param>
        public CreateDeviceProfileRequest(string name = default(string), List<DeviceComponentRequest> components = default(List<DeviceComponentRequest>), List<PreferenceRequest> preferences = default(List<PreferenceRequest>), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CreateDeviceProfileRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "components" is required (not null)
            if (components == null) {
                throw new ArgumentNullException("components is a required property for CreateDeviceProfileRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A name for the device profile.</value>
        ...
        /// </summary>
        /// <value>A list of components for this profile. Exactly 1 component ID must be &#x60;main&#x60;.</value>
        [DataMember(Name = "components", IsRequired = true, EmitDefaultValue = false)]
        public List<DeviceComponentRequest> Components { get; set; }

        /// <summary>
        /// A list of preferences for this profile, whether implicit or explicit.
        /// </summary>
        /// <value>A list of preferences for this profile, whether implicit or explicit.</value>
        [DataMember(Name = "preferences", EmitDefaultValue = false)]
        public List<PreferenceRequest> Preferences { get; set; }

        /// <summary>
        /// Additional information about the device profile, limited to 10 entries.
        /// </summary>
        /// <value>Additional information about the device profile, limited to 10 entries.</value>
        ...
        {
            return this.Equals(input as CreateDeviceProfileRequest);
        }

        /// <summary>
        /// Returns true if CreateDeviceProfileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDeviceProfileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDeviceProfileRequest input)
        {
            if (input == null)
            {
                return false;
