...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecipMin10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precipMin10Hour")]
    public partial class ServiceCapabilityDataForecastPrecipMin10Hour : IEquatable<ServiceCapabilityDataForecastPrecipMin10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecipMin10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) minimium 10 hour forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecipMin10Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) minimium 10 hour forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) minimium 10 hour forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecipMin10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecipMin10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecipMin10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecipMin10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecipMin10Hour input)
        {
            if (input == null)
            {
                return false;
