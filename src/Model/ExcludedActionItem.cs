...
namespace SmartThingsNet.Model
{
    ...
    /// ExcludedActionItem
    /// </summary>
    [DataContract(Name = "excludedActionItem")]
    public partial class ExcludedActionItem : IEquatable<ExcludedActionItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedActionItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedActionItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedActionItem" /> class.
        /// </summary>
        /// <param name="value">To express that a specific value is selected.</param>
        /// <param name="exclude">exclude (required).</param>
        public ExcludedActionItem(Object value = default(Object), List<ExcludedActionItemExclude> exclude = default(List<ExcludedActionItemExclude>))
        {
            // to ensure "exclude" is required (not null)
            if (exclude == null) {
                throw new ArgumentNullException("exclude is a required property for ExcludedActionItem and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedActionItem {\n");
        ...
        {
            return this.Equals(input as ExcludedActionItem);
        }

        /// <summary>
        /// Returns true if ExcludedActionItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedActionItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedActionItem input)
        {
            if (input == null)
            {
                return false;
