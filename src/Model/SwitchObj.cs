...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SwitchObj :  IEquatable<SwitchObj>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SwitchObj);
        }

        /// <summary>
        /// Returns true if SwitchObj instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchObj to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchObj input)
        {
            if (input == null)
                return false;
