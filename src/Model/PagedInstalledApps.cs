...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedInstalledApps")]
    public partial class PagedInstalledApps : IEquatable<PagedInstalledApps>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedInstalledApps" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedInstalledApps(List<InstalledApp> items = default(List<InstalledApp>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<InstalledApp> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedInstalledApps {\n");
        ...
        {
            return this.Equals(input as PagedInstalledApps);
        }

        /// <summary>
        /// Returns true if PagedInstalledApps instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedInstalledApps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedInstalledApps input)
        {
            if (input == null)
            {
                return false;
