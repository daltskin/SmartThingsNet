...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "textFieldForAutomationAction")]
    public partial class TextFieldForAutomationAction : IEquatable<TextFieldForAutomationAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextFieldForAutomationAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TextFieldForAutomationAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TextFieldForAutomationAction" /> class.
        /// </summary>
        ...
        public TextFieldForAutomationAction(string command = default(string), string argumentType = default(string), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for TextFieldForAutomationAction and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TextFieldForAutomationAction {\n");
        ...
        {
            return this.Equals(input as TextFieldForAutomationAction);
        }

        /// <summary>
        /// Returns true if TextFieldForAutomationAction instances are equal
        /// </summary>
        /// <param name="input">Instance of TextFieldForAutomationAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextFieldForAutomationAction input)
        {
            if (input == null)
            {
                return false;
