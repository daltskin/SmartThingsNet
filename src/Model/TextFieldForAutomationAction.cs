...
namespace SmartThingsNet.Model
{
    ...
    public partial class TextFieldForAutomationAction :  IEquatable<TextFieldForAutomationAction>, IValidatableObject
    {
        ...
        public TextFieldForAutomationAction(string command = default(string), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for TextFieldForAutomationAction and cannot be null");
            this.Range = range;
        }
