...
{
    /// <summary>
    /// A paginated array of channel details.
    /// </summary>
    [DataContract(Name = "PagedDetailedChannels")]
    public partial class PagedDetailedChannels : IEquatable<PagedDetailedChannels>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDetailedChannels" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedDetailedChannels() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedDetailedChannels" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="links">links.</param>
        public PagedDetailedChannels(List<DetailedChannel> items = default(List<DetailedChannel>), Links links = default(Links))
        {
            // to ensure "items" is required (not null)
            if (items == null) {
                throw new ArgumentNullException("items is a required property for PagedDetailedChannels and cannot be null");
            }
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<DetailedChannel> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedDetailedChannels {\n");
        ...
        {
            return this.Equals(input as PagedDetailedChannels);
        }

        /// <summary>
        /// Returns true if PagedDetailedChannels instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedDetailedChannels to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedDetailedChannels input)
        {
            if (input == null)
            {
                return false;
