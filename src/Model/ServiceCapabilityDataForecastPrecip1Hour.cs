...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip1Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip1Hour")]
    public partial class ServiceCapabilityDataForecastPrecip1Hour : IEquatable<ServiceCapabilityDataForecastPrecip1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip1Hour" /> class.
        /// </summary>
        /// <param name="value">Rolling hour liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip1Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// Rolling hour liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>Rolling hour liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip1Hour input)
        {
            if (input == null)
            {
                return false;
