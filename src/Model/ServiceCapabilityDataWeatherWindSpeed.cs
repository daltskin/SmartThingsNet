...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherWindSpeed
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_windSpeed")]
    public partial class ServiceCapabilityDataWeatherWindSpeed : IEquatable<ServiceCapabilityDataWeatherWindSpeed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherWindSpeed" /> class.
        /// </summary>
        /// <param name="value">The wind information reported in the hourly current conditions corresponds to a 10-minute average called the sustained wind speed in kilometers per hour .</param>
        /// <param name="unit">Km/h.</param>
        public ServiceCapabilityDataWeatherWindSpeed(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// The wind information reported in the hourly current conditions corresponds to a 10-minute average called the sustained wind speed in kilometers per hour 
        /// </summary>
        /// <value>The wind information reported in the hourly current conditions corresponds to a 10-minute average called the sustained wind speed in kilometers per hour </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherWindSpeed {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherWindSpeed);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherWindSpeed instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherWindSpeed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherWindSpeed input)
        {
            if (input == null)
            {
                return false;
