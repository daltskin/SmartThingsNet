...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlayStopAllOf :  IEquatable<PlayStopAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayStopAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopAllOf" /> class.
        /// </summary>
        ...
        public PlayStopAllOf(PlayStopAllOfState state = default(PlayStopAllOfState))
        {
            ...
            this.State = state ?? throw new ArgumentNullException("state is a required property for PlayStopAllOf and cannot be null");
        }
        ...
        {
            return this.Equals(input as PlayStopAllOf);
        }

        /// <summary>
        /// Returns true if PlayStopAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayStopAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayStopAllOf input)
        {
            if (input == null)
                return false;
