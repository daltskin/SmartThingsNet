...
namespace SmartThingsNet.Model
{
    ...
    /// PreferenceResponse
    /// </summary>
    [DataContract(Name = "PreferenceResponse")]
    [JsonConverter(typeof(JsonSubtypes), "PreferenceType")]
    public partial class PreferenceResponse : IEquatable<PreferenceResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// An alphanumeric English language name for this preference.
        /// </summary>
        /// <value>An alphanumeric English language name for this preference.</value>
        ...
        {
            return this.Equals(input as PreferenceResponse);
        }

        /// <summary>
        /// Returns true if PreferenceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PreferenceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreferenceResponse input)
        {
            if (input == null)
            {
                return false;
