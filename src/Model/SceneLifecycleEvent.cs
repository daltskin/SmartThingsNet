...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneLifecycleEvent")]
    public partial class SceneLifecycleEvent : IEquatable<SceneLifecycleEvent>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SceneLifecycleEvent" /> class.
        /// </summary>
        ...
        /// <param name="version">The version of the scene..</param>
        /// <param name="migrateUuid">The migration owner uuid.</param>
        /// <param name="create">Create scene lifecycle. .</param>
        /// <param name="update">Update scene lifecycle. .</param>
        /// <param name="delete">Delete scene lifecycle. .</param>
        /// <param name="createForBixby">Create scene lifecycle for bixby. .</param>
        /// <param name="updateForBixby">Create scene lifecycle for bixby. .</param>
        /// <param name="deleteForBixby">Create scene lifecycle for bixby. .</param>
        public SceneLifecycleEvent(SceneLifecycle? lifecycle = default(SceneLifecycle?), string eventId = default(string), string locationId = default(string), string sceneId = default(string), string version = default(string), string migrateUuid = default(string), Object create = default(Object), Object update = default(Object), Object delete = default(Object), Object createForBixby = default(Object), Object updateForBixby = default(Object), Object deleteForBixby = default(Object))
        {
            ...
            this.Update = update;
            this.Delete = delete;
            this.CreateForBixby = createForBixby;
            this.UpdateForBixby = updateForBixby;
            this.DeleteForBixby = deleteForBixby;
        }
        ...
        /// The id of the scene.
        /// </summary>
        /// <value>The id of the scene.</value>
        ...
        /// </summary>
        /// <value>The version of the scene.</value>
        [DataMember(Name = "version", EmitDefaultValue = false)]
        public string _Version { get; set; }

        /// <summary>
        /// The migration owner uuid
        /// </summary>
        /// <value>The migration owner uuid</value>
        [DataMember(Name = "migrateUuid", EmitDefaultValue = false)]
        public string MigrateUuid { get; set; }

        /// <summary>
        /// Create scene lifecycle. 
        /// </summary>
        /// <value>Create scene lifecycle. </value>
        ...
        /// </summary>
        /// <value>Update scene lifecycle. </value>
        ...
        /// </summary>
        /// <value>Delete scene lifecycle. </value>
        [DataMember(Name = "delete", EmitDefaultValue = false)]
        public Object Delete { get; set; }

        /// <summary>
        /// Create scene lifecycle for bixby. 
        /// </summary>
        /// <value>Create scene lifecycle for bixby. </value>
        [DataMember(Name = "createForBixby", EmitDefaultValue = false)]
        public Object CreateForBixby { get; set; }

        /// <summary>
        /// Create scene lifecycle for bixby. 
        /// </summary>
        /// <value>Create scene lifecycle for bixby. </value>
        [DataMember(Name = "updateForBixby", EmitDefaultValue = false)]
        public Object UpdateForBixby { get; set; }

        /// <summary>
        /// Create scene lifecycle for bixby. 
        /// </summary>
        /// <value>Create scene lifecycle for bixby. </value>
        [DataMember(Name = "deleteForBixby", EmitDefaultValue = false)]
        public Object DeleteForBixby { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneLifecycleEvent {\n");
            sb.Append("  Lifecycle: ").Append(Lifecycle).Append("\n");
            sb.Append("  EventId: ").Append(EventId).Append("\n");
            sb.Append("  LocationId: ").Append(LocationId).Append("\n");
            sb.Append("  SceneId: ").Append(SceneId).Append("\n");
            sb.Append("  _Version: ").Append(_Version).Append("\n");
            sb.Append("  MigrateUuid: ").Append(MigrateUuid).Append("\n");
            sb.Append("  Create: ").Append(Create).Append("\n");
            sb.Append("  Update: ").Append(Update).Append("\n");
            sb.Append("  Delete: ").Append(Delete).Append("\n");
            sb.Append("  CreateForBixby: ").Append(CreateForBixby).Append("\n");
            sb.Append("  UpdateForBixby: ").Append(UpdateForBixby).Append("\n");
            sb.Append("  DeleteForBixby: ").Append(DeleteForBixby).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SceneLifecycleEvent);
        }

        /// <summary>
        /// Returns true if SceneLifecycleEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneLifecycleEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneLifecycleEvent input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MigrateUuid == input.MigrateUuid ||
                    (this.MigrateUuid != null &&
                    this.MigrateUuid.Equals(input.MigrateUuid))
                ) && 
                (
                ...
                (
                    this.CreateForBixby == input.CreateForBixby ||
                    (this.CreateForBixby != null &&
                    this.CreateForBixby.Equals(input.CreateForBixby))
                ) && 
                (
                    this.UpdateForBixby == input.UpdateForBixby ||
                    (this.UpdateForBixby != null &&
                    this.UpdateForBixby.Equals(input.UpdateForBixby))
                ) && 
                (
                    this.DeleteForBixby == input.DeleteForBixby ||
                    (this.DeleteForBixby != null &&
                    this.DeleteForBixby.Equals(input.DeleteForBixby))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MigrateUuid != null)
                {
                    hashCode = (hashCode * 59) + this.MigrateUuid.GetHashCode();
                }
                if (this.Create != null)
                {
                ...
                if (this.CreateForBixby != null)
                {
                    hashCode = (hashCode * 59) + this.CreateForBixby.GetHashCode();
                }
                if (this.UpdateForBixby != null)
                {
                    hashCode = (hashCode * 59) + this.UpdateForBixby.GetHashCode();
                }
                if (this.DeleteForBixby != null)
                {
                    hashCode = (hashCode * 59) + this.DeleteForBixby.GetHashCode();
                }
                return hashCode;
            }
        }
