...
namespace SmartThingsNet.Model
{
    ...
    public partial class SceneLifecycleEvent :  IEquatable<SceneLifecycleEvent>, IValidatableObject
    {
        ...
        public SceneLifecycleEvent(SceneLifecycle? lifecycle = default(SceneLifecycle?), string eventId = default(string), string locationId = default(string), string sceneId = default(string), Object create = default(Object), Object update = default(Object), Object delete = default(Object))
        {
