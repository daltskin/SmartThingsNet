...
namespace SmartThingsNet.Model
{
    ...
    /// PatchItem
    /// </summary>
    [DataContract(Name = "patchItem")]
    public partial class PatchItem : IEquatable<PatchItem>, IValidatableObject
    {
        /// <summary>
        /// Operation objects MUST have exactly one \&quot;op\&quot; member, whose value indicates the operation to perform
        /// </summary>
        /// <value>Operation objects MUST have exactly one \&quot;op\&quot; member, whose value indicates the operation to perform</value>
        ...
        /// </summary>
        /// <value>path specifies a string format for identifying a specific value within a JSON document. It is used by all operations in patch to specify the part of the document to operate on.</value>
        ...
        {
            return this.Equals(input as PatchItem);
        }

        /// <summary>
        /// Returns true if PatchItem instances are equal
        /// </summary>
        /// <param name="input">Instance of PatchItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchItem input)
        {
            if (input == null)
            {
                return false;
