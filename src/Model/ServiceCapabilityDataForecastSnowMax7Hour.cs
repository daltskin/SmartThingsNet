...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax7Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax7Hour : IEquatable<ServiceCapabilityDataForecastSnowMax7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 7 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax7Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 7 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 7 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax7Hour input)
        {
            if (input == null)
            {
                return false;
