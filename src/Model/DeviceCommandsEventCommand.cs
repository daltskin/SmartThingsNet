...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceCommandsEventCommand")]
    public partial class DeviceCommandsEventCommand : IEquatable<DeviceCommandsEventCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceCommandsEventCommand" /> class.
        /// </summary>
        /// <param name="componentId">componentId.</param>
        /// <param name="capability">capability.</param>
        /// <param name="command">command.</param>
        /// <param name="arguments">arguments.</param>
        public DeviceCommandsEventCommand(string componentId = default(string), string capability = default(string), string command = default(string), List<Object> arguments = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceCommandsEventCommand {\n");
        ...
        {
            return this.Equals(input as DeviceCommandsEventCommand);
        }

        /// <summary>
        /// Returns true if DeviceCommandsEventCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCommandsEventCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCommandsEventCommand input)
        {
            if (input == null)
            {
                return false;
