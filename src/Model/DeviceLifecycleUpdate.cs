...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceLifecycleUpdate")]
    public partial class DeviceLifecycleUpdate : IEquatable<DeviceLifecycleUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleUpdate" /> class.
        /// </summary>
        /// <param name="labelDiff">labelDiff.</param>
        /// <param name="presentationKeysDiff">presentationKeysDiff.</param>
        /// <param name="componentDiff">componentDiff.</param>
        /// <param name="iconDiff">iconDiff.</param>
        public DeviceLifecycleUpdate(DeviceLifecycleUpdateLabelDiff labelDiff = default(DeviceLifecycleUpdateLabelDiff), DeviceLifecycleUpdatePresentationKeysDiff presentationKeysDiff = default(DeviceLifecycleUpdatePresentationKeysDiff), DeviceLifecycleUpdateComponentDiff componentDiff = default(DeviceLifecycleUpdateComponentDiff), IconDiff iconDiff = default(IconDiff))
        {
            this.LabelDiff = labelDiff;
            this.PresentationKeysDiff = presentationKeysDiff;
            this.ComponentDiff = componentDiff;
            this.IconDiff = iconDiff;
        }

        /// <summary>
        /// Gets or Sets LabelDiff
        /// </summary>
        [DataMember(Name = "labelDiff", EmitDefaultValue = false)]
        public DeviceLifecycleUpdateLabelDiff LabelDiff { get; set; }

        /// <summary>
        /// Gets or Sets PresentationKeysDiff
        /// </summary>
        [DataMember(Name = "presentationKeysDiff", EmitDefaultValue = false)]
        public DeviceLifecycleUpdatePresentationKeysDiff PresentationKeysDiff { get; set; }

        /// <summary>
        /// Gets or Sets ComponentDiff
        /// </summary>
        [DataMember(Name = "componentDiff", EmitDefaultValue = false)]
        public DeviceLifecycleUpdateComponentDiff ComponentDiff { get; set; }

        /// <summary>
        /// Gets or Sets IconDiff
        /// </summary>
        [DataMember(Name = "iconDiff", EmitDefaultValue = false)]
        public IconDiff IconDiff { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleUpdate {\n");
            sb.Append("  LabelDiff: ").Append(LabelDiff).Append("\n");
            sb.Append("  PresentationKeysDiff: ").Append(PresentationKeysDiff).Append("\n");
            sb.Append("  ComponentDiff: ").Append(ComponentDiff).Append("\n");
            sb.Append("  IconDiff: ").Append(IconDiff).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DeviceLifecycleUpdate);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleUpdate input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.LabelDiff == input.LabelDiff ||
                    (this.LabelDiff != null &&
                    this.LabelDiff.Equals(input.LabelDiff))
                ) && 
                (
                    this.PresentationKeysDiff == input.PresentationKeysDiff ||
                    (this.PresentationKeysDiff != null &&
                    this.PresentationKeysDiff.Equals(input.PresentationKeysDiff))
                ) && 
                (
                    this.ComponentDiff == input.ComponentDiff ||
                    (this.ComponentDiff != null &&
                    this.ComponentDiff.Equals(input.ComponentDiff))
                ) && 
                (
                    this.IconDiff == input.IconDiff ||
                    (this.IconDiff != null &&
                    this.IconDiff.Equals(input.IconDiff))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LabelDiff.GetHashCode();
                }
                if (this.PresentationKeysDiff != null)
                {
                    hashCode = (hashCode * 59) + this.PresentationKeysDiff.GetHashCode();
                }
                if (this.ComponentDiff != null)
                {
                    hashCode = (hashCode * 59) + this.ComponentDiff.GetHashCode();
                }
                if (this.IconDiff != null)
                {
                    hashCode = (hashCode * 59) + this.IconDiff.GetHashCode();
                }
                return hashCode;
            }
        }
