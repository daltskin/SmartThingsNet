...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateAppRequest :  IEquatable<UpdateAppRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateAppRequest(string displayName = default(string), string description = default(string), bool singleInstance = false, IconImage iconImage = default(IconImage), AppType appType = default(AppType), List<AppClassification> classifications = default(List<AppClassification>), CreateOrUpdateLambdaSmartAppRequest lambdaSmartApp = default(CreateOrUpdateLambdaSmartAppRequest), CreateOrUpdateWebhookSmartAppRequest webhookSmartApp = default(CreateOrUpdateWebhookSmartAppRequest), AppUISettings ui = default(AppUISettings))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for UpdateAppRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for UpdateAppRequest and cannot be null");
            this.AppType = appType;
            // to ensure "classifications" is required (not null)
            this.Classifications = classifications ?? throw new ArgumentNullException("classifications is a required property for UpdateAppRequest and cannot be null");
        ...
        /// <summary>
        /// Returns true if UpdateAppRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAppRequest to be compared</param>
        /// <returns>Boolean</returns>
