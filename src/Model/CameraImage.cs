...
{
    /// <summary>
    /// To specifiy attribute path for a captured image.
    /// </summary>
    [DataContract(Name = "camera_image")]
    public partial class CameraImage : IEquatable<CameraImage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CameraImage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CameraImage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CameraImage" /> class.
        /// </summary>
        ...
        /// <param name="value">Notation which indicates the value of an attribute (required).</param>
        public CameraImage(string capability = default(string), int version = 1, string component = "main", string value = default(string))
        {
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for CameraImage and cannot be null");
            }
            this.Capability = capability;
            // to ensure "component" is required (not null)
            if (component == null) {
                throw new ArgumentNullException("component is a required property for CameraImage and cannot be null");
            }
            this.Component = component;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CameraImage and cannot be null");
            }
            this.Value = value;
        ...
        /// <summary>
        /// Notation which indicates the value of an attribute
        /// </summary>
        /// <value>Notation which indicates the value of an attribute</value>
        ...
        {
            return this.Equals(input as CameraImage);
        }

        /// <summary>
        /// Returns true if CameraImage instances are equal
        /// </summary>
        /// <param name="input">Instance of CameraImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CameraImage input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            Regex regexValue = new Regex(@"(^[[a-z]*([A-Z][a-z]*)*){1,36}(\\.value)+", RegexOptions.CultureInvariant);
