...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm10Index2Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm10Index2Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm10Index2Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm10Index2Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 2 hours index forecast of particulate matter less than 10 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm10Index2Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) 2 hours index forecast of particulate matter less than 10 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 2 hours index forecast of particulate matter less than 10 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm10Index2Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm10Index2Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm10Index2Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm10Index2Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm10Index2Hour input)
        {
            if (input == null)
            {
                return false;
