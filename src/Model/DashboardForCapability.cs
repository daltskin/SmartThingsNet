...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dashboardForCapability")]
    public partial class DashboardForCapability : IEquatable<DashboardForCapability>, IValidatableObject
    {
        ...
        public DashboardForCapability(List<StateItem> states = default(List<StateItem>), List<ActionItem> actions = default(List<ActionItem>), List<BasicPlusItem> basicPlus = default(List<BasicPlusItem>))
        {
            this.States = states;
