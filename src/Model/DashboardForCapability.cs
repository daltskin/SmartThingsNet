...
{
    /// <summary>
    /// The dashboard is the main view in the SmartThings app that shows a list of devices and their state.
    /// </summary>
    [DataContract]
    public partial class DashboardForCapability :  IEquatable<DashboardForCapability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardForCapability" /> class.
        /// </summary>
        /// <param name="states">states.</param>
        /// <param name="actions">actions.</param>
        /// <param name="basicPlus">basicPlus.</param>
        public DashboardForCapability(List<DashboardForCapabilityStates> states = default(List<DashboardForCapabilityStates>), List<DashboardForCapabilityActions> actions = default(List<DashboardForCapabilityActions>), List<BasicPlusItem> basicPlus = default(List<BasicPlusItem>))
        {
            this.States = states;
        ...
        public List<DashboardForCapabilityStates> States { get; set; }

        /// <summary>
        /// Gets or Sets Actions
        /// </summary>
        [DataMember(Name="actions", EmitDefaultValue=false)]
        public List<DashboardForCapabilityActions> Actions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DashboardForCapability {\n");
        ...
        {
            return this.Equals(input as DashboardForCapability);
        }

        /// <summary>
        /// Returns true if DashboardForCapability instances are equal
        /// </summary>
        /// <param name="input">Instance of DashboardForCapability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DashboardForCapability input)
        {
            if (input == null)
                return false;
