...
{
    /// <summary>
    /// ExcludedDeviceConditionConfigEntry
    /// </summary>
    [DataContract(Name = "excludedDeviceConditionConfigEntry")]
    public partial class ExcludedDeviceConditionConfigEntry : IEquatable<ExcludedDeviceConditionConfigEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedDeviceConditionConfigEntry" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedDeviceConditionConfigEntry() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedDeviceConditionConfigEntry" /> class.
        /// </summary>
        ...
        public ExcludedDeviceConditionConfigEntry(string component = default(string), string capability = default(string), int version = 1, VisibleCondition visibleCondition = default(VisibleCondition), List<CapabilityValue> values = default(List<CapabilityValue>), List<PatchItem> patch = default(List<PatchItem>), List<ExcludedConditionItemId> exclusion = default(List<ExcludedConditionItemId>))
        {
            // to ensure "component" is required (not null)
            if (component == null) {
                throw new ArgumentNullException("component is a required property for ExcludedDeviceConditionConfigEntry and cannot be null");
            }
            this.Component = component;
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for ExcludedDeviceConditionConfigEntry and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "component", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A list of valid values for the command argument or attribute that can override those defined by the alternatives provided in the capability presentation.</value>
        [DataMember(Name = "values", EmitDefaultValue = false)]
        public List<CapabilityValue> Values { get; set; }
        ...
        /// </summary>
        /// <value>A format which is applied some operations(add / replace / remove) from the rfc6902(https://tools.ietf.org/html/rfc6902#section-4). Please note that array in the patch is sequentially processed.</value>
        [DataMember(Name = "patch", EmitDefaultValue = false)]
        public List<PatchItem> Patch { get; set; }

        /// <summary>
        /// To exclude specified automation in &#x60;exclude&#x60; when this item is selected by the user.
        /// </summary>
        /// <value>To exclude specified automation in &#x60;exclude&#x60; when this item is selected by the user.</value>
        [DataMember(Name = "exclusion", EmitDefaultValue = false)]
        public List<ExcludedConditionItemId> Exclusion { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedDeviceConditionConfigEntry {\n");
        ...
        {
            return this.Equals(input as ExcludedDeviceConditionConfigEntry);
        }

        /// <summary>
        /// Returns true if ExcludedDeviceConditionConfigEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedDeviceConditionConfigEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedDeviceConditionConfigEntry input)
        {
            if (input == null)
            {
                return false;
