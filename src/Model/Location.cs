...
namespace SmartThingsNet.Model
{
    ...
    public partial class Location : IEquatable<Location>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum Wlocations for value: w:locations
            /// </summary>
            [EnumMember(Value = "w:locations")]
            Wlocations = 1,

            /// <summary>
            /// Enum Dlocations for value: d:locations
            /// </summary>
            [EnumMember(Value = "d:locations")]
            Dlocations = 2,

            /// <summary>
            /// Enum Wdevices for value: w:devices
            /// </summary>
            [EnumMember(Value = "w:devices")]
            Wdevices = 3,

            /// <summary>
            /// Enum Wlocationsgeo for value: w:locations:geo
            /// </summary>
            [EnumMember(Value = "w:locations:geo")]
            Wlocationsgeo = 4,

            /// <summary>
            /// Enum Wrooms for value: w:rooms
            /// </summary>
            [EnumMember(Value = "w:rooms")]
            Wrooms = 5
        ...
        /// <summary>
        /// List of client-facing action identifiers that are currently permitted for the user. &lt;ul&gt; &lt;li&gt; w:locations - the user can change the name of the location &lt;li&gt; d:locations - the user can delete the location &lt;li&gt; w:devices - the user can create devices on the location &lt;li&gt; w:locations:geo - the user can edit the geo-coordinates of the location &lt;li&gt; w:rooms - the user can create rooms on the location &lt;/ul&gt; If the value of this property is not null, then any of the above actions not included in the list value of the property are currently prohibited for the user. 
        /// </summary>
        /// <value>List of client-facing action identifiers that are currently permitted for the user. &lt;ul&gt; &lt;li&gt; w:locations - the user can change the name of the location &lt;li&gt; d:locations - the user can delete the location &lt;li&gt; w:devices - the user can create devices on the location &lt;li&gt; w:locations:geo - the user can edit the geo-coordinates of the location &lt;li&gt; w:rooms - the user can create rooms on the location &lt;/ul&gt; If the value of this property is not null, then any of the above actions not included in the list value of the property are currently prohibited for the user. </value>
        [DataMember(Name = "allowed", EmitDefaultValue = false)]
        public List<AllowedEnum> Allowed { get; set; }
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Location" /> class.
        /// </summary>
        /// <param name="allowed">List of client-facing action identifiers that are currently permitted for the user. &lt;ul&gt; &lt;li&gt; w:locations - the user can change the name of the location &lt;li&gt; d:locations - the user can delete the location &lt;li&gt; w:devices - the user can create devices on the location &lt;li&gt; w:locations:geo - the user can edit the geo-coordinates of the location &lt;li&gt; w:rooms - the user can create rooms on the location &lt;/ul&gt; If the value of this property is not null, then any of the above actions not included in the list value of the property are currently prohibited for the user. .</param>
        ...
        /// <param name="lastModified">The timestamp of when a location was last updated in UTC..</param>
        public Location(List<AllowedEnum> allowed = default(List<AllowedEnum>), Guid locationId = default(Guid), string name = default(string), string countryCode = default(string), decimal latitude = default(decimal), decimal longitude = default(decimal), int regionRadius = default(int), string temperatureScale = default(string), string timeZoneId = default(string), string locale = default(string), string backgroundImage = default(string), Dictionary<string, string> additionalProperties = default(Dictionary<string, string>), LocationParent parent = default(LocationParent), DateTime created = default(DateTime), DateTime lastModified = default(DateTime))
        {
            ...
            if (countryCode == null) {
                throw new ArgumentNullException("countryCode is a required property for Location and cannot be null");
            }
        ...
        [DataMember(Name = "locationId", IsRequired = false, EmitDefaultValue = false)]
        public Guid LocationId { get; set; }

        /// <summary>
        /// A name given for the location (eg. Home)
        /// </summary>
        /// <value>A name given for the location (eg. Home)</value>
        ...
        /// </summary>
        /// <value>An ID matching the Java Time Zone ID of the location. Automatically generated if latitude and longitude have been provided. </value>
        ...
        /// </summary>
        /// <value>Not currently in use.</value>
        ...
        /// </summary>
        /// <value>The timestamp of when a location was created in UTC.</value>
        ...
        /// </summary>
        /// <value>The timestamp of when a location was last updated in UTC.</value>
