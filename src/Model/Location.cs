...
namespace SmartThingsNet.Model
{
    ...
    public partial class Location : IEquatable<Location>, IValidatableObject
    {
        ...
        /// <summary>
        /// List of client-facing action identifiers that are currently permitted for the user. If the value of this property is not null, then any action not included in the list value of the property is currently prohibited for the user.   &lt;ul&gt;   &lt;li&gt; w:locations - the user can change the name of the location   &lt;li&gt; d:locations - the user can delete the location   &lt;li&gt; w:devices - the user can create devices on the location   &lt;li&gt; w:locations:geo - the user can edit the geo-coordinates of the location   &lt;li&gt; w:rooms - the user can create rooms on the location   &lt;/ul&gt; 
        /// </summary>
        /// <value>List of client-facing action identifiers that are currently permitted for the user. If the value of this property is not null, then any action not included in the list value of the property is currently prohibited for the user.   &lt;ul&gt;   &lt;li&gt; w:locations - the user can change the name of the location   &lt;li&gt; d:locations - the user can delete the location   &lt;li&gt; w:devices - the user can create devices on the location   &lt;li&gt; w:locations:geo - the user can edit the geo-coordinates of the location   &lt;li&gt; w:rooms - the user can create rooms on the location   &lt;/ul&gt; </value>
        ...
        public Location(Guid locationId = default(Guid), string name = default(string), string countryCode = default(string), decimal latitude = default(decimal), decimal longitude = default(decimal), int regionRadius = default(int), string temperatureScale = default(string), string timeZoneId = default(string), string locale = default(string), string backgroundImage = default(string), Dictionary<string, string> additionalProperties = default(Dictionary<string, string>), List<AllowedEnum> allowed = default(List<AllowedEnum>), LocationParent parent = default(LocationParent), DateTime created = default(DateTime), DateTime lastModified = default(DateTime))
        {
