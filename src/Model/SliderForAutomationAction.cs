...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sliderForAutomationAction")]
    public partial class SliderForAutomationAction : IEquatable<SliderForAutomationAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SliderForAutomationAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationAction" /> class.
        /// </summary>
        ...
        public SliderForAutomationAction(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string command = default(string), string argumentType = default(string))
        {
            // to ensure "range" is required (not null)
            if (range == null) {
                throw new ArgumentNullException("range is a required property for SliderForAutomationAction and cannot be null");
            }
            this.Range = range;
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for SliderForAutomationAction and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderForAutomationAction {\n");
        ...
        {
            return this.Equals(input as SliderForAutomationAction);
        }

        /// <summary>
        /// Returns true if SliderForAutomationAction instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderForAutomationAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderForAutomationAction input)
        {
            if (input == null)
            {
                return false;
