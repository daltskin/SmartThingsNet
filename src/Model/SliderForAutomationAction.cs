...
namespace SmartThingsNet.Model
{
    ...
    public partial class SliderForAutomationAction :  IEquatable<SliderForAutomationAction>, IValidatableObject
    {
        ...
        public SliderForAutomationAction(List<double> range = default(List<double>), double step = default(double), string unit = default(string), string command = default(string))
        {
            // to ensure "range" is required (not null)
            this.Range = range ?? throw new ArgumentNullException("range is a required property for SliderForAutomationAction and cannot be null");
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for SliderForAutomationAction and cannot be null");
            this.Step = step;
            this.Unit = unit;
        }
