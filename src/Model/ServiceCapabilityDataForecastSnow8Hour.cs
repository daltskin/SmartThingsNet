...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow8Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow8Hour")]
    public partial class ServiceCapabilityDataForecastSnow8Hour : IEquatable<ServiceCapabilityDataForecastSnow8Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow8Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 8 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow8Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 8 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 8 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow8Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow8Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow8Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow8Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow8Hour input)
        {
            if (input == null)
            {
                return false;
