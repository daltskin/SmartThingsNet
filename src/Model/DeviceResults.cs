...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceResults
    /// </summary>
    [DataContract(Name = "DeviceResults")]
    public partial class DeviceResults : IEquatable<DeviceResults>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceResults" /> class.
        /// </summary>
        /// <param name="deviceId">deviceId created by DM.</param>
        /// <param name="name">initial device name from the partner.</param>
        public DeviceResults(string deviceId = default(string), string name = default(string))
        {
        ...
        /// </summary>
        /// <value>deviceId created by DM</value>
        ...
        /// </summary>
        /// <value>initial device name from the partner</value>
        ...
        {
            return this.Equals(input as DeviceResults);
        }

        /// <summary>
        /// Returns true if DeviceResults instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceResults input)
        {
            if (input == null)
            {
                return false;
