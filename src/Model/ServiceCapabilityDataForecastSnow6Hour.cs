...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow6Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow6Hour")]
    public partial class ServiceCapabilityDataForecastSnow6Hour : IEquatable<ServiceCapabilityDataForecastSnow6Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow6Hour" /> class.
        /// </summary>
        /// <param name="value">6 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow6Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// 6 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>6 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow6Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow6Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow6Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow6Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow6Hour input)
        {
            if (input == null)
            {
                return false;
