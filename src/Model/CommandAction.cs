...
namespace SmartThingsNet.Model
{
    ...
    /// CommandAction
    /// </summary>
    [DataContract(Name = "CommandAction")]
    public partial class CommandAction : IEquatable<CommandAction>, IValidatableObject
    {
        /// <summary>
        ...
        public CommandAction(List<string> devices = default(List<string>), List<DeviceCommand> commands = default(List<DeviceCommand>), CommandSequence sequence = default(CommandSequence))
        {
            // to ensure "devices" is required (not null)
            if (devices == null) {
                throw new ArgumentNullException("devices is a required property for CommandAction and cannot be null");
            }
            this.Devices = devices;
            // to ensure "commands" is required (not null)
            if (commands == null) {
                throw new ArgumentNullException("commands is a required property for CommandAction and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "commands", IsRequired = true, EmitDefaultValue = false)]
        ...
        public CommandSequence Sequence { get; set; }
        ...
        {
            return this.Equals(input as CommandAction);
        }

        /// <summary>
        /// Returns true if CommandAction instances are equal
        /// </summary>
        /// <param name="input">Instance of CommandAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommandAction input)
        {
            if (input == null)
            {
                return false;
