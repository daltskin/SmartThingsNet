...
namespace SmartThingsNet.Model
{
    ...
    public partial class CommandAction :  IEquatable<CommandAction>, IValidatableObject
    {
        ...
        public CommandAction(string id = default(string), List<string> devices = default(List<string>), List<DeviceCommand> commands = default(List<DeviceCommand>))
        {
            // to ensure "devices" is required (not null)
            this.Devices = devices ?? throw new ArgumentNullException("devices is a required property for CommandAction and cannot be null");
            // to ensure "commands" is required (not null)
            this.Commands = commands ?? throw new ArgumentNullException("commands is a required property for CommandAction and cannot be null");
            this.Id = id;
        }
