...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateAppSettingsResponse")]
    public partial class UpdateAppSettingsResponse : IEquatable<UpdateAppSettingsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAppSettingsResponse" /> class.
        /// </summary>
        /// <param name="settings">settings.</param>
        public UpdateAppSettingsResponse(Dictionary<string, string> settings = default(Dictionary<string, string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAppSettingsResponse {\n");
        ...
        {
            return this.Equals(input as UpdateAppSettingsResponse);
        }

        /// <summary>
        /// Returns true if UpdateAppSettingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAppSettingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAppSettingsResponse input)
        {
            if (input == null)
            {
                return false;
