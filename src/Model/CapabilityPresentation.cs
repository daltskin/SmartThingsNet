...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "capabilityPresentation")]
    public partial class CapabilityPresentation : IEquatable<CapabilityPresentation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityPresentation" /> class.
        /// </summary>
        ...
        public CapabilityPresentation(string id = default(string), int version = 1, DashboardForCapability dashboard = default(DashboardForCapability), List<Object> detailView = default(List<Object>), AutomationForCapability automation = default(AutomationForCapability))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityPresentation {\n");
        ...
        {
            return this.Equals(input as CapabilityPresentation);
        }

        /// <summary>
        /// Returns true if CapabilityPresentation instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityPresentation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityPresentation input)
        {
            if (input == null)
            {
                return false;
