...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GreaterThanOrEqualsCondition : SimpleCondition,  IEquatable<GreaterThanOrEqualsCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public GreaterThanOrEqualsCondition(string id = default(string), Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?)) : base(id, left, right, aggregation)
        {
        }
