...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GreaterThanOrEqualsCondition")]
    public partial class GreaterThanOrEqualsCondition : IEquatable<GreaterThanOrEqualsCondition>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GreaterThanOrEqualsCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GreaterThanOrEqualsCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GreaterThanOrEqualsCondition" /> class.
        /// </summary>
        ...
        public GreaterThanOrEqualsCondition(Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            if (left == null) {
                throw new ArgumentNullException("left is a required property for GreaterThanOrEqualsCondition and cannot be null");
            }
            this.Left = left;
            // to ensure "right" is required (not null)
            if (right == null) {
                throw new ArgumentNullException("right is a required property for GreaterThanOrEqualsCondition and cannot be null");
            }
            this.Right = right;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GreaterThanOrEqualsCondition {\n");
        ...
        {
            return this.Equals(input as GreaterThanOrEqualsCondition);
        }

        /// <summary>
        /// Returns true if GreaterThanOrEqualsCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of GreaterThanOrEqualsCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GreaterThanOrEqualsCondition input)
        {
            if (input == null)
            {
                return false;
