...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin9Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin9Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin9Hour : IEquatable<ServiceCapabilityDataForecastSnowMin9Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin9Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 9 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin9Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 9 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 9 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin9Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin9Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin9Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin9Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin9Hour input)
        {
            if (input == null)
            {
                return false;
