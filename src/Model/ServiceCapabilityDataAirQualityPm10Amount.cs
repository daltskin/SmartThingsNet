...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityPm10Amount
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_pm10Amount")]
    public partial class ServiceCapabilityDataAirQualityPm10Amount : IEquatable<ServiceCapabilityDataAirQualityPm10Amount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityPm10Amount" /> class.
        /// </summary>
        /// <param name="value">amount of particulate matter less than 10 microns in ug/m3.</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityPm10Amount(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// amount of particulate matter less than 10 microns in ug/m3
        /// </summary>
        /// <value>amount of particulate matter less than 10 microns in ug/m3</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityPm10Amount {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityPm10Amount);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityPm10Amount instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityPm10Amount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityPm10Amount input)
        {
            if (input == null)
            {
                return false;
