...
namespace SmartThingsNet.Model
{
    ...
    /// {\&quot;status\&quot;: \&quot;success\&quot;}
    /// </summary>
    [DataContract(Name = "StandardSuccessResponse")]
    public partial class StandardSuccessResponse : IEquatable<StandardSuccessResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StandardSuccessResponse" /> class.
        /// </summary>
        /// <param name="status">status (default to StatusEnum.Success).</param>
        public StandardSuccessResponse(StatusEnum? status = StatusEnum.Success)
        {
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StandardSuccessResponse {\n");
        ...
        {
            return this.Equals(input as StandardSuccessResponse);
        }

        /// <summary>
        /// Returns true if StandardSuccessResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StandardSuccessResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandardSuccessResponse input)
        {
            if (input == null)
            {
                return false;
