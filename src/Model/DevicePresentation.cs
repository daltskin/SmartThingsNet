...
namespace SmartThingsNet.Model
{
    ...
    /// DevicePresentation
    /// </summary>
    [DataContract(Name = "devicePresentation")]
    public partial class DevicePresentation : IEquatable<DevicePresentation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DevicePresentation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DevicePresentation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DevicePresentation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DevicePresentation {\n");
        ...
        {
            return this.Equals(input as DevicePresentation);
        }

        /// <summary>
        /// Returns true if DevicePresentation instances are equal
        /// </summary>
        /// <param name="input">Instance of DevicePresentation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DevicePresentation input)
        {
            if (input == null)
            {
                return false;
