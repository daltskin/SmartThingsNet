...
namespace SmartThingsNet.Model
{
    ...
    /// AttributeState
    /// </summary>
    [DataContract(Name = "AttributeState")]
    public partial class AttributeState : IEquatable<AttributeState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeState" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        /// <param name="data">data.</param>
        /// <param name="timestamp">Will always be 0 timezone offset.</param>
        public AttributeState(Object value = default(Object), string unit = default(string), Dictionary<string, Object> data = default(Dictionary<string, Object>), DateTime timestamp = default(DateTime))
        {
            this.Value = value;
            this.Unit = unit;
            this.Data = data;
        ...
        /// </summary>
        /// <value>Will always be 0 timezone offset</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributeState {\n");
        ...
        {
            return this.Equals(input as AttributeState);
        }

        /// <summary>
        /// Returns true if AttributeState instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributeState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeState input)
        {
            if (input == null)
            {
                return false;
