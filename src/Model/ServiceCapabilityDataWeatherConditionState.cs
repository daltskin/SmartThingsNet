...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherConditionState
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_conditionState")]
    public partial class ServiceCapabilityDataWeatherConditionState : IEquatable<ServiceCapabilityDataWeatherConditionState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherConditionState" /> class.
        /// </summary>
        /// <param name="value">enumerated string of [CLEAR, SNOW, RAIN, CLOUDY, STORM, DUSTY, FOGGY].</param>
        public ServiceCapabilityDataWeatherConditionState(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// enumerated string of [CLEAR, SNOW, RAIN, CLOUDY, STORM, DUSTY, FOGGY]
        /// </summary>
        /// <value>enumerated string of [CLEAR, SNOW, RAIN, CLOUDY, STORM, DUSTY, FOGGY]</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherConditionState {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherConditionState);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherConditionState instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherConditionState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherConditionState input)
        {
            if (input == null)
            {
                return false;
