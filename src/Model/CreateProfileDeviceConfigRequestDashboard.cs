...
{
    /// <summary>
    /// CreateProfileDeviceConfigRequestDashboard
    /// </summary>
    [DataContract(Name = "CreateProfileDeviceConfigRequest_dashboard")]
    public partial class CreateProfileDeviceConfigRequestDashboard : IEquatable<CreateProfileDeviceConfigRequestDashboard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProfileDeviceConfigRequestDashboard" /> class.
        /// </summary>
        /// <param name="states">states.</param>
        /// <param name="actions">actions.</param>
        /// <param name="basicPlus">basicPlus.</param>
        /// <param name="groupVisibleConditions">groupVisibleConditions.</param>
        public CreateProfileDeviceConfigRequestDashboard(List<DeviceConfigEntryForDashboardState> states = default(List<DeviceConfigEntryForDashboardState>), List<DeviceConfigEntryForDashboardAction> actions = default(List<DeviceConfigEntryForDashboardAction>), List<BasicPlusItem> basicPlus = default(List<BasicPlusItem>), GroupVisibleConditions groupVisibleConditions = default(GroupVisibleConditions))
        {
            this.States = states;
            this.Actions = actions;
            this.BasicPlus = basicPlus;
            this.GroupVisibleConditions = groupVisibleConditions;
        }
        ...
        public List<DeviceConfigEntryForDashboardState> States { get; set; }

        /// <summary>
        /// Gets or Sets Actions
        /// </summary>
        [DataMember(Name = "actions", EmitDefaultValue = false)]
        public List<DeviceConfigEntryForDashboardAction> Actions { get; set; }

        /// <summary>
        /// Gets or Sets BasicPlus
        /// </summary>
        [DataMember(Name = "basicPlus", EmitDefaultValue = false)]
        public List<BasicPlusItem> BasicPlus { get; set; }

        /// <summary>
        /// Gets or Sets GroupVisibleConditions
        /// </summary>
        [DataMember(Name = "groupVisibleConditions", EmitDefaultValue = false)]
        public GroupVisibleConditions GroupVisibleConditions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateProfileDeviceConfigRequestDashboard {\n");
            sb.Append("  States: ").Append(States).Append("\n");
            sb.Append("  Actions: ").Append(Actions).Append("\n");
            sb.Append("  BasicPlus: ").Append(BasicPlus).Append("\n");
            sb.Append("  GroupVisibleConditions: ").Append(GroupVisibleConditions).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CreateProfileDeviceConfigRequestDashboard);
        }

        /// <summary>
        /// Returns true if CreateProfileDeviceConfigRequestDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProfileDeviceConfigRequestDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProfileDeviceConfigRequestDashboard input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.BasicPlus == input.BasicPlus ||
                    this.BasicPlus != null &&
                    input.BasicPlus != null &&
                    this.BasicPlus.SequenceEqual(input.BasicPlus)
                ) && 
                (
                    this.GroupVisibleConditions == input.GroupVisibleConditions ||
                    (this.GroupVisibleConditions != null &&
                    this.GroupVisibleConditions.Equals(input.GroupVisibleConditions))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BasicPlus != null)
                {
                    hashCode = (hashCode * 59) + this.BasicPlus.GetHashCode();
                }
                if (this.GroupVisibleConditions != null)
                {
                    hashCode = (hashCode * 59) + this.GroupVisibleConditions.GetHashCode();
                }
                return hashCode;
            }
        }
