...
namespace SmartThingsNet.Model
{
    ...
    public partial class CreateProfileDeviceConfigRequestDashboard : IEquatable<CreateProfileDeviceConfigRequestDashboard>, IValidatableObject
    {
        ...
        public CreateProfileDeviceConfigRequestDashboard(List<DeviceConfigEntryForDashboardState> states = default(List<DeviceConfigEntryForDashboardState>), List<DeviceConfigEntryForDashboardAction> actions = default(List<DeviceConfigEntryForDashboardAction>), GroupVisibleConditions groupVisibleConditions = default(GroupVisibleConditions))
        {
            this.States = states;
