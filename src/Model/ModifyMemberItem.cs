...
{
    /// <summary>
    /// A member to be modified according to the available types of modifications. For a &#x60;CHANGE_ROLE&#x60; modification, the &#x60;role&#x60; property will be required.
    /// </summary>
    [DataContract(Name = "ModifyMemberItem")]
    public partial class ModifyMemberItem : IEquatable<ModifyMemberItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyMemberItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifyMemberItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyMemberItem" /> class.
        /// </summary>
        /// <param name="member">member (required).</param>
        /// <param name="modification">modification (required).</param>
        /// <param name="role">role.</param>
        public ModifyMemberItem(OrganizationMember member = default(OrganizationMember), Modification modification = default(Modification), Role role = default(Role))
        {
            // to ensure "member" is required (not null)
            if (member == null) {
                throw new ArgumentNullException("member is a required property for ModifyMemberItem and cannot be null");
            }
            this.Member = member;
            // to ensure "modification" is required (not null)
            if (modification == null) {
                throw new ArgumentNullException("modification is a required property for ModifyMemberItem and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "modification", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyMemberItem {\n");
        ...
        {
            return this.Equals(input as ModifyMemberItem);
        }

        /// <summary>
        /// Returns true if ModifyMemberItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyMemberItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyMemberItem input)
        {
            if (input == null)
            {
                return false;
