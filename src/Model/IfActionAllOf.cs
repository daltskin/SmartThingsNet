...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IfActionAllOf :  IEquatable<IfActionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public IfActionAllOf(string id = default(string), List<Action> then = default(List<Action>), List<Action> _else = default(List<Action>))
        {
            this.Id = id;
            this.Then = then;
            this.Else = _else;
        ...
        {
            return this.Equals(input as IfActionAllOf);
        }

        /// <summary>
        /// Returns true if IfActionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of IfActionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IfActionAllOf input)
        {
            if (input == null)
                return false;
