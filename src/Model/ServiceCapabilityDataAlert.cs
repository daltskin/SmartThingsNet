...
{
    /// <summary>
    /// ServiceCapabilityDataAlert
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_alert")]
    public partial class ServiceCapabilityDataAlert : IEquatable<ServiceCapabilityDataAlert>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAlert" /> class.
        /// </summary>
        /// <param name="lastUpdateTime">lastUpdateTime.</param>
        /// <param name="headlineText">headlineText.</param>
        /// <param name="severity">severity.</param>
        /// <param name="messageType">messageType.</param>
        /// <param name="issueTime">issueTime.</param>
        /// <param name="expireTime">expireTime.</param>
        public ServiceCapabilityDataAlert(ServiceCapabilityDataLastUpdateTime lastUpdateTime = default(ServiceCapabilityDataLastUpdateTime), ServiceCapabilityDataHeadlineText headlineText = default(ServiceCapabilityDataHeadlineText), ServiceCapabilityDataSeverity severity = default(ServiceCapabilityDataSeverity), ServiceCapabilityDataMessageType messageType = default(ServiceCapabilityDataMessageType), ServiceCapabilityDataIssueTime issueTime = default(ServiceCapabilityDataIssueTime), ServiceCapabilityDataExpireTime expireTime = default(ServiceCapabilityDataExpireTime))
        {
        ...
        /// <summary>
        /// Gets or Sets HeadlineText
        /// </summary>
        [DataMember(Name = "headlineText", EmitDefaultValue = false)]
        public ServiceCapabilityDataHeadlineText HeadlineText { get; set; }

        /// <summary>
        /// Gets or Sets Severity
        /// </summary>
        [DataMember(Name = "severity", EmitDefaultValue = false)]
        public ServiceCapabilityDataSeverity Severity { get; set; }

        /// <summary>
        /// Gets or Sets MessageType
        /// </summary>
        [DataMember(Name = "messageType", EmitDefaultValue = false)]
        public ServiceCapabilityDataMessageType MessageType { get; set; }

        /// <summary>
        /// Gets or Sets IssueTime
        /// </summary>
        [DataMember(Name = "issueTime", EmitDefaultValue = false)]
        public ServiceCapabilityDataIssueTime IssueTime { get; set; }

        /// <summary>
        /// Gets or Sets ExpireTime
        /// </summary>
        [DataMember(Name = "expireTime", EmitDefaultValue = false)]
        public ServiceCapabilityDataExpireTime ExpireTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAlert {\n");
            sb.Append("  LastUpdateTime: ").Append(LastUpdateTime).Append("\n");
            sb.Append("  HeadlineText: ").Append(HeadlineText).Append("\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAlert);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAlert instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAlert to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAlert input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HeadlineText == input.HeadlineText ||
                    (this.HeadlineText != null &&
                    this.HeadlineText.Equals(input.HeadlineText))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.HeadlineText.GetHashCode();
                }
