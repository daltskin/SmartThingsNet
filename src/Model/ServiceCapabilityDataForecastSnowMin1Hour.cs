...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin1Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin1Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin1Hour : IEquatable<ServiceCapabilityDataForecastSnowMin1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin1Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium one hour forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin1Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium one hour forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium one hour forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin1Hour input)
        {
            if (input == null)
            {
                return false;
