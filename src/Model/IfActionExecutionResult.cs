...
{
    /// <summary>
    /// The result of a if action execution
    /// </summary>
    [DataContract(Name = "IfActionExecutionResult")]
    public partial class IfActionExecutionResult : IEquatable<IfActionExecutionResult>, IValidatableObject
    {
        ...
        public IfExecutionResult Result { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="IfActionExecutionResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IfActionExecutionResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IfActionExecutionResult" /> class.
        /// </summary>
        /// <param name="result">result (required).</param>
        public IfActionExecutionResult(IfExecutionResult result = default(IfExecutionResult))
        {
            this.Result = result;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IfActionExecutionResult {\n");
        ...
        {
            return this.Equals(input as IfActionExecutionResult);
        }

        /// <summary>
        /// Returns true if IfActionExecutionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of IfActionExecutionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IfActionExecutionResult input)
        {
            if (input == null)
            {
                return false;
