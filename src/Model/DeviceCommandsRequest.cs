...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceCommandsRequest")]
    public partial class DeviceCommandsRequest : IEquatable<DeviceCommandsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceCommandsRequest" /> class.
        /// </summary>
        /// <param name="commands">An array of commands to execute on the Device..</param>
        public DeviceCommandsRequest(List<DeviceCommand> commands = default(List<DeviceCommand>))
        {
        ...
        /// </summary>
        /// <value>An array of commands to execute on the Device.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceCommandsRequest {\n");
        ...
        {
            return this.Equals(input as DeviceCommandsRequest);
        }

        /// <summary>
        /// Returns true if DeviceCommandsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCommandsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCommandsRequest input)
        {
            if (input == null)
            {
                return false;
