...
{
    /// <summary>
    /// DeviceLifecycleUpdateComponentDiff
    /// </summary>
    [DataContract(Name = "DeviceLifecycleUpdate_componentDiff")]
    public partial class DeviceLifecycleUpdateComponentDiff : IEquatable<DeviceLifecycleUpdateComponentDiff>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleUpdateComponentDiff" /> class.
        /// </summary>
        /// <param name="old">old.</param>
        /// <param name="_new">_new.</param>
        public DeviceLifecycleUpdateComponentDiff(DeviceLifecycleUpdateComponentDiffOld old = default(DeviceLifecycleUpdateComponentDiffOld), DeviceLifecycleUpdateComponentDiffOld _new = default(DeviceLifecycleUpdateComponentDiffOld))
        {
            this.Old = old;
            this.New = _new;
        }
        ...
        public DeviceLifecycleUpdateComponentDiffOld Old { get; set; }

        /// <summary>
        /// Gets or Sets New
        /// </summary>
        [DataMember(Name = "new", EmitDefaultValue = false)]
        public DeviceLifecycleUpdateComponentDiffOld New { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleUpdateComponentDiff {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleUpdateComponentDiff);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleUpdateComponentDiff instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleUpdateComponentDiff to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleUpdateComponentDiff input)
        {
            if (input == null)
            {
                return false;
