...
{
    /// <summary>
    /// DeviceConfigEntryAllOf
    /// </summary>
    [DataContract(Name = "deviceConfigEntry_allOf")]
    public partial class DeviceConfigEntryAllOf : IEquatable<DeviceConfigEntryAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigEntryAllOf" /> class.
        /// </summary>
        ...
        public DeviceConfigEntryAllOf(List<CapabilityValue> values = default(List<CapabilityValue>), List<PatchItem> patch = default(List<PatchItem>))
        {
            this.Values = values;
            this.Patch = patch;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigEntryAllOf {\n");
        ...
        {
            return this.Equals(input as DeviceConfigEntryAllOf);
        }

        /// <summary>
        /// Returns true if DeviceConfigEntryAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigEntryAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigEntryAllOf input)
        {
            if (input == null)
            {
                return false;
