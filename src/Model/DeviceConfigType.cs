...
namespace SmartThingsNet.Model
{
    ...
    /// DeviceConfigType
    /// </summary>
    [DataContract(Name = "DeviceConfigType")]
    public partial class DeviceConfigType : IEquatable<DeviceConfigType>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigType" /> class.
        /// </summary>
        /// <param name="type">type (default to TypeEnum.Profile).</param>
        public DeviceConfigType(TypeEnum? type = TypeEnum.Profile)
        {
            this.Type = type;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigType {\n");
        ...
        {
            return this.Equals(input as DeviceConfigType);
        }

        /// <summary>
        /// Returns true if DeviceConfigType instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigType input)
        {
            if (input == null)
            {
                return false;
