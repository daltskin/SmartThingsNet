...
namespace SmartThingsNet.Model
{
    ...
    public partial class UpdateDeviceRequest : IEquatable<UpdateDeviceRequest>, IValidatableObject
    {
        ...
        /// <param name="locationId">The ID of the Location where the Device should be moved to. Not all Devices support Location moves. Moving between some Locations may be rejected depending on the data region used. .</param>
        ...
        public UpdateDeviceRequest(string label = default(string), string locationId = default(string), string roomId = default(string), List<UpdateDeviceComponent> components = default(List<UpdateDeviceComponent>))
        {
            this.Label = label;
        ...
        /// <summary>
        /// The ID of the Location where the Device should be moved to. Not all Devices support Location moves. Moving between some Locations may be rejected depending on the data region used. 
        /// </summary>
        /// <value>The ID of the Location where the Device should be moved to. Not all Devices support Location moves. Moving between some Locations may be rejected depending on the data region used. </value>
        ...
        public List<UpdateDeviceComponent> Components { get; set; }
