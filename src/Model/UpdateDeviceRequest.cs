...
namespace SmartThingsNet.Model
{
    ...
    public partial class UpdateDeviceRequest :  IEquatable<UpdateDeviceRequest>, IValidatableObject
    {
        ...
        protected UpdateDeviceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDeviceRequest" /> class.
        /// </summary>
        /// <param name="label">The label for the device. (required).</param>
        /// <param name="components">components.</param>
        public UpdateDeviceRequest(string label = default(string), List<UpdateDeviceRequestComponents> components = default(List<UpdateDeviceRequestComponents>))
        {
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for UpdateDeviceRequest and cannot be null");
        ...
        public List<UpdateDeviceRequestComponents> Components { get; set; }
