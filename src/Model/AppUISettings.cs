...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppUISettings")]
    public partial class AppUISettings : IEquatable<AppUISettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppUISettings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppUISettings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppUISettings" /> class.
        /// </summary>
        ...
        public AppUISettings(string pluginId = default(string), string pluginUri = default(string), bool dashboardCardsEnabled = default(bool), bool preInstallDashboardCardsEnabled = default(bool))
        {
        ...
        {
            return this.Equals(input as AppUISettings);
        }

        /// <summary>
        /// Returns true if AppUISettings instances are equal
        /// </summary>
        /// <param name="input">Instance of AppUISettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppUISettings input)
        {
            if (input == null)
            {
                return false;
