...
{
    /// <summary>
    /// CapabilityReferenceAllOf
    /// </summary>
    [DataContract(Name = "CapabilityReference_allOf")]
    public partial class CapabilityReferenceAllOf : IEquatable<CapabilityReferenceAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityReferenceAllOf" /> class.
        /// </summary>
        /// <param name="ephemeral">ephemeral.</param>
        public CapabilityReferenceAllOf(bool ephemeral = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityReferenceAllOf {\n");
        ...
        {
            return this.Equals(input as CapabilityReferenceAllOf);
        }

        /// <summary>
        /// Returns true if CapabilityReferenceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityReferenceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityReferenceAllOf input)
        {
            if (input == null)
            {
                return false;
