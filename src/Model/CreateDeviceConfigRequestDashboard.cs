...
{
    /// <summary>
    /// CreateDeviceConfigRequestDashboard
    /// </summary>
    [DataContract]
    public partial class CreateDeviceConfigRequestDashboard :  IEquatable<CreateDeviceConfigRequestDashboard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeviceConfigRequestDashboard" /> class.
        /// </summary>
        /// <param name="states">states.</param>
        /// <param name="actions">actions.</param>
        public CreateDeviceConfigRequestDashboard(List<DeviceConfigEntry> states = default(List<DeviceConfigEntry>), List<DeviceConfigEntry> actions = default(List<DeviceConfigEntry>))
        {
            this.States = states;
        ...
        public List<DeviceConfigEntry> States { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDeviceConfigRequestDashboard {\n");
        ...
        {
            return this.Equals(input as CreateDeviceConfigRequestDashboard);
        }

        /// <summary>
        /// Returns true if CreateDeviceConfigRequestDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDeviceConfigRequestDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDeviceConfigRequestDashboard input)
        {
            if (input == null)
                return false;
