...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "toggleSwitchForDashboard")]
    public partial class ToggleSwitchForDashboard : IEquatable<ToggleSwitchForDashboard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToggleSwitchForDashboard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ToggleSwitchForDashboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ToggleSwitchForDashboard" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToggleSwitchForDashboard {\n");
        ...
        {
            return this.Equals(input as ToggleSwitchForDashboard);
        }

        /// <summary>
        /// Returns true if ToggleSwitchForDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of ToggleSwitchForDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToggleSwitchForDashboard input)
        {
            if (input == null)
            {
                return false;
