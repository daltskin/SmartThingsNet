...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SingleOperandCondition :  IEquatable<SingleOperandCondition>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleOperandCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SingleOperandCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleOperandCondition" /> class.
        /// </summary>
        ...
        public SingleOperandCondition(string id = default(string), Operand left = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            this.Left = left ?? throw new ArgumentNullException("left is a required property for SingleOperandCondition and cannot be null");
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SingleOperandCondition {\n");
        ...
        {
            return this.Equals(input as SingleOperandCondition);
        }

        /// <summary>
        /// Returns true if SingleOperandCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleOperandCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleOperandCondition input)
        {
            if (input == null)
                return false;
