...
namespace SmartThingsNet.Model
{
    ...
    /// ActionSequence
    /// </summary>
    [DataContract(Name = "ActionSequence")]
    public partial class ActionSequence : IEquatable<ActionSequence>, IValidatableObject
    {
        ...
        public Sequence? Actions { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionSequence {\n");
        ...
        {
            return this.Equals(input as ActionSequence);
        }

        /// <summary>
        /// Returns true if ActionSequence instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionSequence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionSequence input)
        {
            if (input == null)
            {
                return false;
