...
{
    /// <summary>
    /// This display type creates numberfield that the user enters a new value and that the new value is passed as an argument to the command
    /// </summary>
    [DataContract(Name = "numberField")]
    public partial class NumberField : IEquatable<NumberField>, IValidatableObject
    {
        /// <summary>
        ...
        public NumberField(string value = default(string), string valueType = default(string), string unit = default(string), string command = default(string), string argumentType = default(string), List<double> range = default(List<double>))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for NumberField and cannot be null");
            }
        ...
        {
            return this.Equals(input as NumberField);
        }

        /// <summary>
        /// Returns true if NumberField instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberField input)
        {
            if (input == null)
            {
                return false;
