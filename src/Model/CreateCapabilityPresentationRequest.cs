...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCapabilityPresentationRequest")]
    public partial class CreateCapabilityPresentationRequest : IEquatable<CreateCapabilityPresentationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCapabilityPresentationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCapabilityPresentationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCapabilityPresentationRequest" /> class.
        /// </summary>
        ...
        /// <param name="version">The version number of the capability. (required) (default to 1).</param>
        public CreateCapabilityPresentationRequest(DashboardForCapability dashboard = default(DashboardForCapability), List<Object> detailView = default(List<Object>), AutomationForCapability automation = default(AutomationForCapability), string id = default(string), int version = 1)
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for CreateCapabilityPresentationRequest and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCapabilityPresentationRequest {\n");
        ...
        {
            return this.Equals(input as CreateCapabilityPresentationRequest);
        }

        /// <summary>
        /// Returns true if CreateCapabilityPresentationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCapabilityPresentationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCapabilityPresentationRequest input)
        {
            if (input == null)
            {
                return false;
