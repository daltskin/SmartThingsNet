...
{
    /// <summary>
    /// Room move device lifecycle. 
    /// </summary>
    [DataContract(Name = "DeviceLifecycleRoomMove")]
    public partial class DeviceLifecycleRoomMove : IEquatable<DeviceLifecycleRoomMove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleRoomMove" /> class.
        /// </summary>
        /// <param name="roomIdFrom">roomIdFrom.</param>
        /// <param name="roomIdTo">roomIdTo.</param>
        public DeviceLifecycleRoomMove(string roomIdFrom = default(string), string roomIdTo = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets RoomIdFrom
        /// </summary>
        [DataMember(Name = "roomIdFrom", EmitDefaultValue = false)]
        public string RoomIdFrom { get; set; }

        /// <summary>
        /// Gets or Sets RoomIdTo
        /// </summary>
        [DataMember(Name = "roomIdTo", EmitDefaultValue = false)]
        public string RoomIdTo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleRoomMove {\n");
            sb.Append("  RoomIdFrom: ").Append(RoomIdFrom).Append("\n");
            sb.Append("  RoomIdTo: ").Append(RoomIdTo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DeviceLifecycleRoomMove);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleRoomMove instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleRoomMove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleRoomMove input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.RoomIdFrom == input.RoomIdFrom ||
                    (this.RoomIdFrom != null &&
                    this.RoomIdFrom.Equals(input.RoomIdFrom))
                ) && 
                (
                    this.RoomIdTo == input.RoomIdTo ||
                    (this.RoomIdTo != null &&
                    this.RoomIdTo.Equals(input.RoomIdTo))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RoomIdFrom != null)
                {
                    hashCode = (hashCode * 59) + this.RoomIdFrom.GetHashCode();
                }
                if (this.RoomIdTo != null)
                {
                    hashCode = (hashCode * 59) + this.RoomIdTo.GetHashCode();
                }
                return hashCode;
            }
        }
