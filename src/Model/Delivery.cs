...
namespace SmartThingsNet.Model
{
    ...
    public partial class Delivery : IEquatable<Delivery>, IValidatableObject
    {
        ...
        /// <param name="deliveryTarget">Target for the delivery type..</param>
        public Delivery(DeliveryType? deliveryType = default(DeliveryType?), string deliveryTarget = default(string))
        {
        ...
        /// <summary>
        /// Target for the delivery type.
        /// </summary>
        /// <value>Target for the delivery type.</value>
        [DataMember(Name = "deliveryTarget", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeliveryTarget: ").Append(DeliveryTarget).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Delivery input)
        {
            ...
            return 
                ...
                (
                    this.DeliveryTarget == input.DeliveryTarget ||
                    (this.DeliveryTarget != null &&
                    this.DeliveryTarget.Equals(input.DeliveryTarget))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DeliveryTarget.GetHashCode();
                }
                return hashCode;
            }
        }
