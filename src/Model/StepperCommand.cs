...
namespace SmartThingsNet.Model
{
    ...
    /// StepperCommand
    /// </summary>
    [DataContract(Name = "stepper_command")]
    public partial class StepperCommand : IEquatable<StepperCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StepperCommand" /> class.
        /// </summary>
        /// <param name="name">To specify a single command like \&quot;setValue(number)\&quot;, use \&quot;command\&quot; field for the command name. If this field is specified then \&quot;increase\&quot; and \&quot;descrease\&quot; fields should not be specified. App will calculate desired value when user clicks \&quot;+\&quot; and \&quot;-\&quot; button in the UI based on the current value of \&quot;attribute\&quot; with specified \&quot;step\&quot;..</param>
        /// <param name="increase">To specify a command for \&quot;increase\&quot; without an argument..</param>
        /// <param name="decrease">To specify a command for \&quot;decrease\&quot; without an argument..</param>
        /// <param name="argumentType">The data type of the &#x60;argument&#x60;. It&#39;s automatically filled from the given capability..</param>
        public StepperCommand(string name = default(string), string increase = default(string), string decrease = default(string), string argumentType = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>To specify a single command like \&quot;setValue(number)\&quot;, use \&quot;command\&quot; field for the command name. If this field is specified then \&quot;increase\&quot; and \&quot;descrease\&quot; fields should not be specified. App will calculate desired value when user clicks \&quot;+\&quot; and \&quot;-\&quot; button in the UI based on the current value of \&quot;attribute\&quot; with specified \&quot;step\&quot;.</value>
        ...
        /// </summary>
        /// <value>To specify a command for \&quot;increase\&quot; without an argument.</value>
        ...
        /// </summary>
        /// <value>To specify a command for \&quot;decrease\&quot; without an argument.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StepperCommand {\n");
        ...
        {
            return this.Equals(input as StepperCommand);
        }

        /// <summary>
        /// Returns true if StepperCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of StepperCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepperCommand input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Increase == input.Increase ||
                    (this.Increase != null &&
                    this.Increase.Equals(input.Increase))
                ) && 
                (
                    this.Decrease == input.Decrease ||
                    (this.Decrease != null &&
                    this.Decrease.Equals(input.Decrease))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Increase.GetHashCode();
                }
                if (this.Decrease != null)
                {
                    hashCode = (hashCode * 59) + this.Decrease.GetHashCode();
                }
