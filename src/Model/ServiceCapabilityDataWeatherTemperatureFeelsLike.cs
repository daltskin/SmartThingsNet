...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherTemperatureFeelsLike
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_temperatureFeelsLike")]
    public partial class ServiceCapabilityDataWeatherTemperatureFeelsLike : IEquatable<ServiceCapabilityDataWeatherTemperatureFeelsLike>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherTemperatureFeelsLike" /> class.
        /// </summary>
        /// <param name="value">An apparent temperature in Celcius .</param>
        /// <param name="unit">C.</param>
        public ServiceCapabilityDataWeatherTemperatureFeelsLike(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// An apparent temperature in Celcius 
        /// </summary>
        /// <value>An apparent temperature in Celcius </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherTemperatureFeelsLike {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherTemperatureFeelsLike);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherTemperatureFeelsLike instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherTemperatureFeelsLike to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherTemperatureFeelsLike input)
        {
            if (input == null)
            {
                return false;
