...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedLocations")]
    public partial class PagedLocations : IEquatable<PagedLocations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedLocations" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedLocations() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedLocations" /> class.
        /// </summary>
        ...
        public PagedLocations(List<PagedLocation> items = default(List<PagedLocation>), Links links = default(Links))
        {
            ...
            if (items == null) {
                throw new ArgumentNullException("items is a required property for PagedLocations and cannot be null");
            }
            this.Items = items;
            this.Links = links;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedLocations {\n");
        ...
        {
            return this.Equals(input as PagedLocations);
        }

        /// <summary>
        /// Returns true if PagedLocations instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedLocations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedLocations input)
        {
            if (input == null)
            {
                return false;
