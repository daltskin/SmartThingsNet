...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceProfileResponse")]
    public partial class DeviceProfileResponse : IEquatable<DeviceProfileResponse>, IValidatableObject
    {
        /// <summary>
        ...
        protected DeviceProfileResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProfileResponse" /> class.
        /// </summary>
        ...
        public DeviceRestriction Restrictions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceProfileResponse {\n");
        ...
        {
            return this.Equals(input as DeviceProfileResponse);
        }

        /// <summary>
        /// Returns true if DeviceProfileResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceProfileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceProfileResponse input)
        {
            if (input == null)
            {
                return false;
