...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceProfileResponse :  IEquatable<DeviceProfileResponse>, IValidatableObject
    {
        ...
        public DeviceProfileResponse(string id = default(string), string name = default(string), List<DeviceComponent> components = default(List<DeviceComponent>), Dictionary<string, string> metadata = default(Dictionary<string, string>), DeviceProfileStatus? status = default(DeviceProfileStatus?))
        {
            this.Id = id;
            this.Name = name;
