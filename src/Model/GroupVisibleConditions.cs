...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "groupVisibleConditions")]
    public partial class GroupVisibleConditions : IEquatable<GroupVisibleConditions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupVisibleConditions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupVisibleConditions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupVisibleConditions" /> class.
        /// </summary>
        ...
        public GroupVisibleConditions(string capability = default(string), int version = 1, string component = default(string), string value = default(string), Operator _operator = default(Operator), string operand = default(string))
        {
            // to ensure "capability" is required (not null)
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for GroupVisibleConditions and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The value that the visible condition evaluates against.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupVisibleConditions {\n");
        ...
        {
            return this.Equals(input as GroupVisibleConditions);
        }

        /// <summary>
        /// Returns true if GroupVisibleConditions instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupVisibleConditions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupVisibleConditions input)
        {
            if (input == null)
            {
                return false;
