...
namespace SmartThingsNet.Model
{
    ...
    /// ScenePagedResult
    /// </summary>
    [DataContract(Name = "ScenePagedResult")]
    public partial class ScenePagedResult : IEquatable<ScenePagedResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenePagedResult" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public ScenePagedResult(List<SceneSummary> items = default(List<SceneSummary>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public List<SceneSummary> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScenePagedResult {\n");
        ...
        {
            return this.Equals(input as ScenePagedResult);
        }

        /// <summary>
        /// Returns true if ScenePagedResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ScenePagedResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScenePagedResult input)
        {
            if (input == null)
            {
                return false;
