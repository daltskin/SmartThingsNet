...
namespace SmartThingsNet.Model
{
    ...
    public partial class Clusters : IEquatable<Clusters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Clusters" /> class.
        /// </summary>
        /// <param name="_client">List of 16-bit cluster identifiers for client clusters.</param>
        /// <param name="server">List of 16-bit cluster identifiers for server clusters.</param>
        public Clusters(List<int> _client = default(List<int>), List<int> server = default(List<int>))
        {
        ...
        /// </summary>
        /// <value>List of 16-bit cluster identifiers for client clusters</value>
        [DataMember(Name = "client", EmitDefaultValue = false)]
        public List<int> _Client { get; set; }

        /// <summary>
        /// List of 16-bit cluster identifiers for server clusters
        /// </summary>
        /// <value>List of 16-bit cluster identifiers for server clusters</value>
