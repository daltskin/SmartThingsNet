...
{
    /// <summary>
    /// CreateProfileDeviceConfigRequestAutomation
    /// </summary>
    [DataContract(Name = "CreateProfileDeviceConfigRequest_automation")]
    public partial class CreateProfileDeviceConfigRequestAutomation : IEquatable<CreateProfileDeviceConfigRequestAutomation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProfileDeviceConfigRequestAutomation" /> class.
        /// </summary>
        /// <param name="conditions">conditions.</param>
        /// <param name="actions">actions.</param>
        public CreateProfileDeviceConfigRequestAutomation(List<ExcludedDeviceConditionConfigEntry> conditions = default(List<ExcludedDeviceConditionConfigEntry>), List<ExcludedDeviceActionConfigEntry> actions = default(List<ExcludedDeviceActionConfigEntry>))
        {
        ...
        public List<ExcludedDeviceConditionConfigEntry> Conditions { get; set; }

        /// <summary>
        /// Gets or Sets Actions
        /// </summary>
        [DataMember(Name = "actions", EmitDefaultValue = false)]
        public List<ExcludedDeviceActionConfigEntry> Actions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateProfileDeviceConfigRequestAutomation {\n");
        ...
        {
            return this.Equals(input as CreateProfileDeviceConfigRequestAutomation);
        }

        /// <summary>
        /// Returns true if CreateProfileDeviceConfigRequestAutomation instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProfileDeviceConfigRequestAutomation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProfileDeviceConfigRequestAutomation input)
        {
            if (input == null)
            {
                return false;
