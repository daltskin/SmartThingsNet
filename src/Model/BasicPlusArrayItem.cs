...
namespace SmartThingsNet.Model
{
    ...
    /// BasicPlusArrayItem
    /// </summary>
    [DataContract(Name = "basicPlusArrayItem")]
    public partial class BasicPlusArrayItem : IEquatable<BasicPlusArrayItem>, IValidatableObject
    {
        /// <summary>
        ...
        public BasicPlusArrayItem(DisplayTypeEnum displayType = default(DisplayTypeEnum), Stepper stepper = default(Stepper), List<Object> feature = default(List<Object>), VisibleCondition visibleCondition = default(VisibleCondition), string capability = default(string), int version = 1, string component = default(string))
        {
            ...
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for BasicPlusArrayItem and cannot be null");
            }
        ...
        /// <summary>
        /// Including a basicPlus item with the “feature” display type adds a shortcut item to the desired detail view.
        /// </summary>
        /// <value>Including a basicPlus item with the “feature” display type adds a shortcut item to the desired detail view.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BasicPlusArrayItem {\n");
        ...
        {
            return this.Equals(input as BasicPlusArrayItem);
        }

        /// <summary>
        /// Returns true if BasicPlusArrayItem instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicPlusArrayItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicPlusArrayItem input)
        {
            if (input == null)
            {
                return false;
