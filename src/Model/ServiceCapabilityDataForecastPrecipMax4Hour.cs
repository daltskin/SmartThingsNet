...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecipMax4Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precipMax4Hour")]
    public partial class ServiceCapabilityDataForecastPrecipMax4Hour : IEquatable<ServiceCapabilityDataForecastPrecipMax4Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecipMax4Hour" /> class.
        /// </summary>
        ...
        public ServiceCapabilityDataForecastPrecipMax4Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecipMax4Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecipMax4Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecipMax4Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecipMax4Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecipMax4Hour input)
        {
            if (input == null)
            {
                return false;
