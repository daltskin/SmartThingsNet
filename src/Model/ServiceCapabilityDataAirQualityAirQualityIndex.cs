...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_airQualityIndex")]
    public partial class ServiceCapabilityDataAirQualityAirQualityIndex : IEquatable<ServiceCapabilityDataAirQualityAirQualityIndex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityAirQualityIndex" /> class.
        /// </summary>
        /// <param name="value">air quality index.</param>
        /// <param name="unit">CAQI.</param>
        public ServiceCapabilityDataAirQualityAirQualityIndex(int value = default(int), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityAirQualityIndex {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityAirQualityIndex);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityAirQualityIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityAirQualityIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityAirQualityIndex input)
        {
            if (input == null)
            {
                return false;
