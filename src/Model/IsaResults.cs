...
namespace SmartThingsNet.Model
{
    ...
    /// IsaResults
    /// </summary>
    [DataContract(Name = "IsaResults")]
    public partial class IsaResults : IEquatable<IsaResults>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>connection status between partner and ST platform</value>
        [DataMember(Name = "partnerSTConnection", IsRequired = true, EmitDefaultValue = false)]
        ...
        protected IsaResults() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IsaResults" /> class.
        /// </summary>
        /// <param name="isaId">isaId installed for the user (required).</param>
        /// <param name="appName">SmartThings Schema connector name given by partner eg Lifx (Connect) (required).</param>
        /// <param name="partnerName">Parnter name eg Lifx Inc (required).</param>
        /// <param name="icon">url of partner icon (required).</param>
        /// <param name="icon2x">url of partner icon in 2x dimensions (required).</param>
        /// <param name="icon3x">url of partner icon in 3x dimensions (required).</param>
        /// <param name="locationId">location of the installed smart app (required).</param>
        /// <param name="partnerSTConnection">connection status between partner and ST platform (required).</param>
        /// <param name="endpointAppId">endpoint app id of the installed smart app (required).</param>
        public IsaResults(string isaId = default(string), string appName = default(string), string partnerName = default(string), string icon = default(string), string icon2x = default(string), string icon3x = default(string), string locationId = default(string), PartnerSTConnectionEnum partnerSTConnection = default(PartnerSTConnectionEnum), string endpointAppId = default(string))
        {
            // to ensure "isaId" is required (not null)
            if (isaId == null) {
                throw new ArgumentNullException("isaId is a required property for IsaResults and cannot be null");
            }
            this.IsaId = isaId;
            // to ensure "appName" is required (not null)
            if (appName == null) {
                throw new ArgumentNullException("appName is a required property for IsaResults and cannot be null");
            }
            this.AppName = appName;
            // to ensure "partnerName" is required (not null)
            if (partnerName == null) {
                throw new ArgumentNullException("partnerName is a required property for IsaResults and cannot be null");
            }
            this.PartnerName = partnerName;
            // to ensure "icon" is required (not null)
            if (icon == null) {
                throw new ArgumentNullException("icon is a required property for IsaResults and cannot be null");
            }
            this.Icon = icon;
            // to ensure "icon2x" is required (not null)
            if (icon2x == null) {
                throw new ArgumentNullException("icon2x is a required property for IsaResults and cannot be null");
            }
            this.Icon2x = icon2x;
            // to ensure "icon3x" is required (not null)
            if (icon3x == null) {
                throw new ArgumentNullException("icon3x is a required property for IsaResults and cannot be null");
            }
            this.Icon3x = icon3x;
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for IsaResults and cannot be null");
            }
            this.LocationId = locationId;
            this.PartnerSTConnection = partnerSTConnection;
            // to ensure "endpointAppId" is required (not null)
            if (endpointAppId == null) {
                throw new ArgumentNullException("endpointAppId is a required property for IsaResults and cannot be null");
            }
        ...
        /// </summary>
        /// <value>isaId installed for the user</value>
        [DataMember(Name = "isaId", IsRequired = true, EmitDefaultValue = false)]
        public string IsaId { get; set; }

        /// <summary>
        /// SmartThings Schema connector name given by partner eg Lifx (Connect)
        /// </summary>
        /// <value>SmartThings Schema connector name given by partner eg Lifx (Connect)</value>
        ...
        /// </summary>
        /// <value>Parnter name eg Lifx Inc</value>
        ...
        [DataMember(Name = "icon2x", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "icon3x", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "endpointAppId", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as IsaResults);
        }

        /// <summary>
        /// Returns true if IsaResults instances are equal
        /// </summary>
        /// <param name="input">Instance of IsaResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IsaResults input)
        {
            if (input == null)
            {
                return false;
