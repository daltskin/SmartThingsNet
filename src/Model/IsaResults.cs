...
namespace SmartThingsNet.Model
{
    ...
    public partial class IsaResults :  IEquatable<IsaResults>, IValidatableObject
    {
        ...
        public IsaResults(string isaId = default(string), string appName = default(string), string partnerName = default(string), string icon = default(string), string icon2x = default(string), string icon3x = default(string), string locationId = default(string))
        {
            this.IsaId = isaId;
