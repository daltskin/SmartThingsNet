...
{
    /// <summary>
    /// To render the captured image and overlay icon in the dashboard card of a camera device.
    /// </summary>
    [DataContract(Name = "camera")]
    public partial class Camera : IEquatable<Camera>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="overlayIcons">To describe the overlay icon and the conditions under which it will be displayed..</param>
        public Camera(CameraImage image = default(CameraImage), List<CameraOverlayIcons> overlayIcons = default(List<CameraOverlayIcons>))
        {
            // to ensure "image" is required (not null)
            if (image == null) {
                throw new ArgumentNullException("image is a required property for Camera and cannot be null");
            }
            this.Image = image;
        ...
        /// <summary>
        /// To describe the overlay icon and the conditions under which it will be displayed.
        /// </summary>
        /// <value>To describe the overlay icon and the conditions under which it will be displayed.</value>
        [DataMember(Name = "overlayIcons", EmitDefaultValue = false)]
        public List<CameraOverlayIcons> OverlayIcons { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OverlayIcons: ").Append(OverlayIcons).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Camera);
        }

        /// <summary>
        /// Returns true if Camera instances are equal
        /// </summary>
        /// <param name="input">Instance of Camera to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Camera input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OverlayIcons == input.OverlayIcons ||
                    this.OverlayIcons != null &&
                    input.OverlayIcons != null &&
                    this.OverlayIcons.SequenceEqual(input.OverlayIcons)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OverlayIcons != null)
                {
                    hashCode = (hashCode * 59) + this.OverlayIcons.GetHashCode();
                }
                return hashCode;
            }
        }
