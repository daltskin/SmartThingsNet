...
namespace SmartThingsNet.Model
{
    ...
    /// IrDeviceDetails
    /// </summary>
    [DataContract(Name = "IrDeviceDetails")]
    public partial class IrDeviceDetails : IEquatable<IrDeviceDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IrDeviceDetails" /> class.
        /// </summary>
        /// <param name="parentDeviceId">The id of the Parent device..</param>
        /// <param name="profileId">The id of the profile that describes the device components and capabilities..</param>
        /// <param name="ocfDeviceType">The OCF Device Type.</param>
        /// <param name="irCode">The id of the ircode.</param>
        /// <param name="functionCodes">functionCodes.</param>
        /// <param name="childDevices">list of child devices.</param>
        /// <param name="metadata">Key value pairs stored in the conductor for the device. UI Metadata information .</param>
        public IrDeviceDetails(string parentDeviceId = default(string), string profileId = default(string), string ocfDeviceType = default(string), string irCode = default(string), IrDeviceDetailsFunctionCodes functionCodes = default(IrDeviceDetailsFunctionCodes), List<IrDeviceDetails> childDevices = default(List<IrDeviceDetails>), Object metadata = default(Object))
        {
        ...
        /// </summary>
        /// <value>The id of the profile that describes the device components and capabilities.</value>
        ...
        /// The OCF Device Type
        /// </summary>
        /// <value>The OCF Device Type</value>
        ...
        /// </summary>
        /// <value>The id of the ircode</value>
        [DataMember(Name = "irCode", EmitDefaultValue = false)]
        public string IrCode { get; set; }

        /// <summary>
        /// Gets or Sets FunctionCodes
        /// </summary>
        [DataMember(Name = "functionCodes", EmitDefaultValue = false)]
        public IrDeviceDetailsFunctionCodes FunctionCodes { get; set; }

        /// <summary>
        /// list of child devices
        /// </summary>
        /// <value>list of child devices</value>
        [DataMember(Name = "childDevices", EmitDefaultValue = false)]
        public List<IrDeviceDetails> ChildDevices { get; set; }

        /// <summary>
        /// Key value pairs stored in the conductor for the device. UI Metadata information 
        /// </summary>
        /// <value>Key value pairs stored in the conductor for the device. UI Metadata information </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IrDeviceDetails {\n");
            sb.Append("  ParentDeviceId: ").Append(ParentDeviceId).Append("\n");
            sb.Append("  ProfileId: ").Append(ProfileId).Append("\n");
            sb.Append("  OcfDeviceType: ").Append(OcfDeviceType).Append("\n");
            sb.Append("  IrCode: ").Append(IrCode).Append("\n");
            sb.Append("  FunctionCodes: ").Append(FunctionCodes).Append("\n");
        ...
        {
            return this.Equals(input as IrDeviceDetails);
        }

        /// <summary>
        /// Returns true if IrDeviceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of IrDeviceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IrDeviceDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IrCode == input.IrCode ||
                    (this.IrCode != null &&
                    this.IrCode.Equals(input.IrCode))
                ) && 
                (
                    this.FunctionCodes == input.FunctionCodes ||
                    (this.FunctionCodes != null &&
                    this.FunctionCodes.Equals(input.FunctionCodes))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IrCode != null)
                {
                    hashCode = (hashCode * 59) + this.IrCode.GetHashCode();
                }
                if (this.FunctionCodes != null)
                {
                    hashCode = (hashCode * 59) + this.FunctionCodes.GetHashCode();
                }
