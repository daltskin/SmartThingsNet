...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceSubscriptionDetail")]
    public partial class DeviceSubscriptionDetail : IEquatable<DeviceSubscriptionDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceSubscriptionDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceSubscriptionDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceSubscriptionDetail" /> class.
        /// </summary>
        /// <param name="deviceId">The GUID of the device that is subscribed to. (required).</param>
        /// <param name="componentId">The component ID on the device that is subscribed to or * for all. (default to &quot;*&quot;).</param>
        /// <param name="capability">Name of the capability that is subscribed to or * for all. (default to &quot;*&quot;).</param>
        /// <param name="attribute">Name of the capabilities attribute or * for all. (default to &quot;*&quot;).</param>
        /// <param name="value">A particular value for the attribute that will trigger the subscription or * for all..</param>
        /// <param name="stateChangeOnly">Only execute the subscription if the subscribed event is a state change from previous events..</param>
        /// <param name="subscriptionName">A name for the subscription that will be passed to the installed app. Must be unique per installed app..</param>
        /// <param name="modes">List of mode ID&#39;s that the subscription will execute for. If not provided then all modes will be supported..</param>
        public DeviceSubscriptionDetail(string deviceId = default(string), string componentId = "*", string capability = "*", string attribute = "*", Object value = default(Object), bool stateChangeOnly = default(bool), string subscriptionName = default(string), List<string> modes = default(List<string>))
        {
            // to ensure "deviceId" is required (not null)
            if (deviceId == null) {
                throw new ArgumentNullException("deviceId is a required property for DeviceSubscriptionDetail and cannot be null");
            }
            this.DeviceId = deviceId;
            // use default value if no "componentId" provided
            this.ComponentId = componentId ?? "*";
            // use default value if no "capability" provided
        ...
        /// </summary>
        /// <value>The GUID of the device that is subscribed to.</value>
        ...
        /// </summary>
        /// <value>The component ID on the device that is subscribed to or * for all.</value>
        ...
        /// </summary>
        /// <value>Name of the capability that is subscribed to or * for all.</value>
        ...
        /// </summary>
        /// <value>Name of the capabilities attribute or * for all.</value>
        ...
        /// </summary>
        /// <value>A particular value for the attribute that will trigger the subscription or * for all.</value>
        ...
        /// </summary>
        /// <value>Only execute the subscription if the subscribed event is a state change from previous events.</value>
        [DataMember(Name = "stateChangeOnly", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>A name for the subscription that will be passed to the installed app. Must be unique per installed app.</value>
        ...
        /// </summary>
        /// <value>List of mode ID&#39;s that the subscription will execute for. If not provided then all modes will be supported.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceSubscriptionDetail {\n");
            sb.Append("  DeviceId: ").Append(DeviceId).Append("\n");
            sb.Append("  ComponentId: ").Append(ComponentId).Append("\n");
            sb.Append("  Capability: ").Append(Capability).Append("\n");
            sb.Append("  Attribute: ").Append(Attribute).Append("\n");
            sb.Append("  Value: ").Append(Value).Append("\n");
            sb.Append("  StateChangeOnly: ").Append(StateChangeOnly).Append("\n");
        ...
        {
            return this.Equals(input as DeviceSubscriptionDetail);
        }

        /// <summary>
        /// Returns true if DeviceSubscriptionDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceSubscriptionDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceSubscriptionDetail input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StateChangeOnly == input.StateChangeOnly ||
                    this.StateChangeOnly.Equals(input.StateChangeOnly)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StateChangeOnly.GetHashCode();
        ...
        {
            // Capability (string) maxLength
            if (this.Capability != null && this.Capability.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Capability, length must be less than 128.", new [] { "Capability" });
            }

            // Capability (string) minLength
            if (this.Capability != null && this.Capability.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Capability, length must be greater than 1.", new [] { "Capability" });
            }

            // Attribute (string) maxLength
            if (this.Attribute != null && this.Attribute.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Attribute, length must be less than 256.", new [] { "Attribute" });
            }

            // Attribute (string) minLength
            if (this.Attribute != null && this.Attribute.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Attribute, length must be greater than 1.", new [] { "Attribute" });
            }
