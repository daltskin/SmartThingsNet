...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceSubscriptionDetail :  IEquatable<DeviceSubscriptionDetail>, IValidatableObject
    {
        ...
        public DeviceSubscriptionDetail(string deviceId = default(string), string componentId = "*", string capability = "*", string attribute = "*", Object value = default(Object), bool stateChangeOnly = default(bool), string subscriptionName = default(string), List<string> modes = default(List<string>))
        {
            ...
            this.DeviceId = deviceId ?? throw new ArgumentNullException("deviceId is a required property for DeviceSubscriptionDetail and cannot be null");
        ...
        [DataMember(Name="stateChangeOnly", EmitDefaultValue=false)]
