...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityO3Index
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_o3Index")]
    public partial class ServiceCapabilityDataAirQualityO3Index : IEquatable<ServiceCapabilityDataAirQualityO3Index>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityO3Index" /> class.
        /// </summary>
        /// <param name="value">(Available for non-Korea Only) index of Ozone pollutant.</param>
        /// <param name="unit">EPA.</param>
        public ServiceCapabilityDataAirQualityO3Index(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for non-Korea Only) index of Ozone pollutant
        /// </summary>
        /// <value>(Available for non-Korea Only) index of Ozone pollutant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityO3Index {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityO3Index);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityO3Index instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityO3Index to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityO3Index input)
        {
            if (input == null)
            {
                return false;
