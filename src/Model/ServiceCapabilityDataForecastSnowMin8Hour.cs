...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin8Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin8Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin8Hour : IEquatable<ServiceCapabilityDataForecastSnowMin8Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin8Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 8 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin8Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 8 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 8 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin8Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin8Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin8Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin8Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin8Hour input)
        {
            if (input == null)
            {
                return false;
