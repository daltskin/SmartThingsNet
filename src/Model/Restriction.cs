...
{
    /// <summary>
    /// A typed model which describes a restriction pertaining to a platform entity.
    /// </summary>
    ...
    public partial class Restriction : IEquatable<Restriction>, IValidatableObject
    {
        ...
        public Restriction(int tier = default(int), int historyRetentionTTLDays = default(int), bool visibleWhenRestricted = false)
        {
            this.Tier = tier;
