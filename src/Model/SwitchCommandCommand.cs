...
namespace SmartThingsNet.Model
{
    ...
    public partial class SwitchCommandCommand :  IEquatable<SwitchCommandCommand>, IValidatableObject
    {
        ...
        public SwitchCommandCommand(string name = default(string), string on = default(string), string off = default(string))
        {
            // to ensure "on" is required (not null)
            this.On = on ?? throw new ArgumentNullException("on is a required property for SwitchCommandCommand and cannot be null");
            // to ensure "off" is required (not null)
            this.Off = off ?? throw new ArgumentNullException("off is a required property for SwitchCommandCommand and cannot be null");
            this.Name = name;
        }
