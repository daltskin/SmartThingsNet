...
{
    /// <summary>
    /// To specify separate commands with no arguments for on and off, use the \&quot;on\&quot; and \&quot;off\&quot; fields respectively. To specify a single command, use \&quot;name\&quot; for the command and the \&quot;on\&quot; and \&quot;off\&quot; fields for the arguments.
    /// </summary>
    [DataContract(Name = "switchCommand_command")]
    public partial class SwitchCommandCommand : IEquatable<SwitchCommandCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchCommandCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwitchCommandCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchCommandCommand" /> class.
        /// </summary>
        ...
        public SwitchCommandCommand(string name = default(string), string on = default(string), string off = default(string), string argumentType = default(string))
        {
            // to ensure "on" is required (not null)
            if (on == null) {
                throw new ArgumentNullException("on is a required property for SwitchCommandCommand and cannot be null");
            }
            this.On = on;
            // to ensure "off" is required (not null)
            if (off == null) {
                throw new ArgumentNullException("off is a required property for SwitchCommandCommand and cannot be null");
            }
            this.Off = off;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwitchCommandCommand {\n");
        ...
        {
            return this.Equals(input as SwitchCommandCommand);
        }

        /// <summary>
        /// Returns true if SwitchCommandCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchCommandCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchCommandCommand input)
        {
            if (input == null)
            {
                return false;
