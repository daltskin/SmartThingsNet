...
{
    /// <summary>
    /// User specifiable fields on Organization creation. Returned fields may be limited depending on access level.
    /// </summary>
    [DataContract(Name = "OrganizationCreateRequest_allOf")]
    public partial class OrganizationCreateRequestAllOf : IEquatable<OrganizationCreateRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationCreateRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationCreateRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationCreateRequestAllOf" /> class.
        /// </summary>
        ...
        public OrganizationCreateRequestAllOf(string manufacturerName = default(string), string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for OrganizationCreateRequestAllOf and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrganizationCreateRequestAllOf {\n");
        ...
        {
            return this.Equals(input as OrganizationCreateRequestAllOf);
        }

        /// <summary>
        /// Returns true if OrganizationCreateRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationCreateRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationCreateRequestAllOf input)
        {
            if (input == null)
            {
                return false;
