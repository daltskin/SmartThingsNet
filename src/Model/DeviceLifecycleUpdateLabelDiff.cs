...
{
    /// <summary>
    /// DeviceLifecycleUpdateLabelDiff
    /// </summary>
    [DataContract(Name = "DeviceLifecycleUpdate_labelDiff")]
    public partial class DeviceLifecycleUpdateLabelDiff : IEquatable<DeviceLifecycleUpdateLabelDiff>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleUpdateLabelDiff" /> class.
        /// </summary>
        /// <param name="old">old.</param>
        /// <param name="_new">_new.</param>
        public DeviceLifecycleUpdateLabelDiff(string old = default(string), string _new = default(string))
        {
            this.Old = old;
            this.New = _new;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleUpdateLabelDiff {\n");
        ...
        {
            return this.Equals(input as DeviceLifecycleUpdateLabelDiff);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleUpdateLabelDiff instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleUpdateLabelDiff to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleUpdateLabelDiff input)
        {
            if (input == null)
            {
                return false;
