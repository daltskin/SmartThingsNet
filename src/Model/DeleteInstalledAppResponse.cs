...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteInstalledAppResponse")]
    public partial class DeleteInstalledAppResponse : IEquatable<DeleteInstalledAppResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteInstalledAppResponse" /> class.
        /// </summary>
        /// <param name="count">count.</param>
        public DeleteInstalledAppResponse(int count = default(int))
        {
            this.Count = count;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteInstalledAppResponse {\n");
        ...
        {
            return this.Equals(input as DeleteInstalledAppResponse);
        }

        /// <summary>
        /// Returns true if DeleteInstalledAppResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteInstalledAppResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteInstalledAppResponse input)
        {
            if (input == null)
            {
                return false;
