...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm10Amount12Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm10Amount12Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm10Amount12Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm10Amount12Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm10Amount12Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 12 hours dust amount forecast of particulate matter less than 10 microns .</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityForecastPm10Amount12Hour(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea) 12 hours dust amount forecast of particulate matter less than 10 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 12 hours dust amount forecast of particulate matter less than 10 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm10Amount12Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm10Amount12Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm10Amount12Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm10Amount12Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm10Amount12Hour input)
        {
            if (input == null)
            {
                return false;
