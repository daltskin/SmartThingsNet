...
namespace SmartThingsNet.Model
{
    ...
    /// DriverFingerprint
    /// </summary>
    [DataContract(Name = "DriverFingerprint")]
    public partial class DriverFingerprint : IEquatable<DriverFingerprint>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverFingerprint" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DriverFingerprint() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DriverFingerprint" /> class.
        /// </summary>
        /// <param name="id">The identifier for the respective fingerprint, unique per driver (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="deviceLabel">Label assigned to device at join time. If this is not set the driver name is used..</param>
        /// <param name="zigbeeGeneric">zigbeeGeneric.</param>
        /// <param name="zigbeeManfacturer">zigbeeManfacturer.</param>
        /// <param name="zwaveManufacturer">zwaveManufacturer.</param>
        /// <param name="zwaveGeneric">zwaveGeneric.</param>
        public DriverFingerprint(string id = default(string), FingerprintType type = default(FingerprintType), string deviceLabel = default(string), ZigbeeGenericFingerprint zigbeeGeneric = default(ZigbeeGenericFingerprint), ZigbeeManufacturerFingerprint zigbeeManfacturer = default(ZigbeeManufacturerFingerprint), ZWaveManufacturerFingerprint zwaveManufacturer = default(ZWaveManufacturerFingerprint), ZWaveGenericFingerprint zwaveGeneric = default(ZWaveGenericFingerprint))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for DriverFingerprint and cannot be null");
            }
            this.Id = id;
            this.Type = type;
            this.DeviceLabel = deviceLabel;
            this.ZigbeeGeneric = zigbeeGeneric;
            this.ZigbeeManfacturer = zigbeeManfacturer;
            this.ZwaveManufacturer = zwaveManufacturer;
            this.ZwaveGeneric = zwaveGeneric;
        }

        /// <summary>
        /// The identifier for the respective fingerprint, unique per driver
        /// </summary>
        /// <value>The identifier for the respective fingerprint, unique per driver</value>
        ...
        /// </summary>
        /// <value>Label assigned to device at join time. If this is not set the driver name is used.</value>
        [DataMember(Name = "deviceLabel", EmitDefaultValue = false)]
        public string DeviceLabel { get; set; }

        /// <summary>
        /// Gets or Sets ZigbeeGeneric
        /// </summary>
        [DataMember(Name = "zigbeeGeneric", EmitDefaultValue = false)]
        public ZigbeeGenericFingerprint ZigbeeGeneric { get; set; }

        /// <summary>
        /// Gets or Sets ZigbeeManfacturer
        /// </summary>
        [DataMember(Name = "zigbeeManfacturer", EmitDefaultValue = false)]
        public ZigbeeManufacturerFingerprint ZigbeeManfacturer { get; set; }

        /// <summary>
        /// Gets or Sets ZwaveManufacturer
        /// </summary>
        [DataMember(Name = "zwaveManufacturer", EmitDefaultValue = false)]
        public ZWaveManufacturerFingerprint ZwaveManufacturer { get; set; }

        /// <summary>
        /// Gets or Sets ZwaveGeneric
        /// </summary>
        [DataMember(Name = "zwaveGeneric", EmitDefaultValue = false)]
        public ZWaveGenericFingerprint ZwaveGeneric { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DriverFingerprint {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  DeviceLabel: ").Append(DeviceLabel).Append("\n");
            sb.Append("  ZigbeeGeneric: ").Append(ZigbeeGeneric).Append("\n");
            sb.Append("  ZigbeeManfacturer: ").Append(ZigbeeManfacturer).Append("\n");
            sb.Append("  ZwaveManufacturer: ").Append(ZwaveManufacturer).Append("\n");
            sb.Append("  ZwaveGeneric: ").Append(ZwaveGeneric).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DriverFingerprint);
        }

        /// <summary>
        /// Returns true if DriverFingerprint instances are equal
        /// </summary>
        /// <param name="input">Instance of DriverFingerprint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriverFingerprint input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ZigbeeGeneric == input.ZigbeeGeneric ||
                    (this.ZigbeeGeneric != null &&
                    this.ZigbeeGeneric.Equals(input.ZigbeeGeneric))
                ) && 
                (
                    this.ZigbeeManfacturer == input.ZigbeeManfacturer ||
                    (this.ZigbeeManfacturer != null &&
                    this.ZigbeeManfacturer.Equals(input.ZigbeeManfacturer))
                ) && 
                (
                    this.ZwaveManufacturer == input.ZwaveManufacturer ||
                    (this.ZwaveManufacturer != null &&
                    this.ZwaveManufacturer.Equals(input.ZwaveManufacturer))
                ) && 
                (
                    this.ZwaveGeneric == input.ZwaveGeneric ||
                    (this.ZwaveGeneric != null &&
                    this.ZwaveGeneric.Equals(input.ZwaveGeneric))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ZigbeeGeneric != null)
                {
                    hashCode = (hashCode * 59) + this.ZigbeeGeneric.GetHashCode();
                }
                if (this.ZigbeeManfacturer != null)
                {
                    hashCode = (hashCode * 59) + this.ZigbeeManfacturer.GetHashCode();
                }
                if (this.ZwaveManufacturer != null)
                {
                    hashCode = (hashCode * 59) + this.ZwaveManufacturer.GetHashCode();
                }
                if (this.ZwaveGeneric != null)
                {
                    hashCode = (hashCode * 59) + this.ZwaveGeneric.GetHashCode();
                }
                return hashCode;
            }
        }
