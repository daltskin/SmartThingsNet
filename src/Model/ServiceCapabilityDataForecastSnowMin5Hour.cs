...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin5Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin5Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin5Hour : IEquatable<ServiceCapabilityDataForecastSnowMin5Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin5Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 5 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin5Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 5 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 5 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin5Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin5Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin5Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin5Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin5Hour input)
        {
            if (input == null)
            {
                return false;
