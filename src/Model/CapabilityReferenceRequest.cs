...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CapabilityReferenceRequest")]
    public partial class CapabilityReferenceRequest : IEquatable<CapabilityReferenceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityReferenceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CapabilityReferenceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityReferenceRequest" /> class.
        /// </summary>
        ...
        public CapabilityReferenceRequest(string id = default(string), int version = default(int), Restriction restrictions = default(Restriction))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for CapabilityReferenceRequest and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityReferenceRequest {\n");
        ...
        {
            return this.Equals(input as CapabilityReferenceRequest);
        }

        /// <summary>
        /// Returns true if CapabilityReferenceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityReferenceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityReferenceRequest input)
        {
            if (input == null)
            {
                return false;
