...
namespace SmartThingsNet.Model
{
    ...
    /// ActionItemAllOf
    /// </summary>
    [DataContract(Name = "actionItem_allOf")]
    public partial class ActionItemAllOf : IEquatable<ActionItemAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionItemAllOf {\n");
        ...
        {
            return this.Equals(input as ActionItemAllOf);
        }

        /// <summary>
        /// Returns true if ActionItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionItemAllOf input)
        {
            if (input == null)
            {
                return false;
