...
{
    /// <summary>
    /// DeviceLifecycleUpdatePresentationKeysDiff
    /// </summary>
    [DataContract(Name = "DeviceLifecycleUpdate_presentationKeysDiff")]
    public partial class DeviceLifecycleUpdatePresentationKeysDiff : IEquatable<DeviceLifecycleUpdatePresentationKeysDiff>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLifecycleUpdatePresentationKeysDiff" /> class.
        /// </summary>
        /// <param name="previousManufacturerName">manufacturerName before the update.</param>
        /// <param name="newManufacturerName">manufacturerName after the update.</param>
        /// <param name="previousPresentationId">presentation ID before the update.</param>
        /// <param name="newPresentationId">presentation ID after the update.</param>
        public DeviceLifecycleUpdatePresentationKeysDiff(string previousManufacturerName = default(string), string newManufacturerName = default(string), Guid previousPresentationId = default(Guid), Guid newPresentationId = default(Guid))
        {
            this.PreviousManufacturerName = previousManufacturerName;
            this.NewManufacturerName = newManufacturerName;
            this.PreviousPresentationId = previousPresentationId;
            this.NewPresentationId = newPresentationId;
        }

        /// <summary>
        /// manufacturerName before the update
        /// </summary>
        /// <value>manufacturerName before the update</value>
        [DataMember(Name = "previousManufacturerName", EmitDefaultValue = false)]
        public string PreviousManufacturerName { get; set; }

        /// <summary>
        /// manufacturerName after the update
        /// </summary>
        /// <value>manufacturerName after the update</value>
        [DataMember(Name = "newManufacturerName", EmitDefaultValue = false)]
        public string NewManufacturerName { get; set; }

        /// <summary>
        /// presentation ID before the update
        /// </summary>
        /// <value>presentation ID before the update</value>
        [DataMember(Name = "previousPresentationId", EmitDefaultValue = false)]
        public Guid PreviousPresentationId { get; set; }

        /// <summary>
        /// presentation ID after the update
        /// </summary>
        /// <value>presentation ID after the update</value>
        [DataMember(Name = "newPresentationId", EmitDefaultValue = false)]
        public Guid NewPresentationId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceLifecycleUpdatePresentationKeysDiff {\n");
            sb.Append("  PreviousManufacturerName: ").Append(PreviousManufacturerName).Append("\n");
            sb.Append("  NewManufacturerName: ").Append(NewManufacturerName).Append("\n");
            sb.Append("  PreviousPresentationId: ").Append(PreviousPresentationId).Append("\n");
            sb.Append("  NewPresentationId: ").Append(NewPresentationId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DeviceLifecycleUpdatePresentationKeysDiff);
        }

        /// <summary>
        /// Returns true if DeviceLifecycleUpdatePresentationKeysDiff instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceLifecycleUpdatePresentationKeysDiff to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceLifecycleUpdatePresentationKeysDiff input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.PreviousManufacturerName == input.PreviousManufacturerName ||
                    (this.PreviousManufacturerName != null &&
                    this.PreviousManufacturerName.Equals(input.PreviousManufacturerName))
                ) && 
                (
                    this.NewManufacturerName == input.NewManufacturerName ||
                    (this.NewManufacturerName != null &&
                    this.NewManufacturerName.Equals(input.NewManufacturerName))
                ) && 
                (
                    this.PreviousPresentationId == input.PreviousPresentationId ||
                    (this.PreviousPresentationId != null &&
                    this.PreviousPresentationId.Equals(input.PreviousPresentationId))
                ) && 
                (
                    this.NewPresentationId == input.NewPresentationId ||
                    (this.NewPresentationId != null &&
                    this.NewPresentationId.Equals(input.NewPresentationId))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PreviousManufacturerName != null)
                {
                    hashCode = (hashCode * 59) + this.PreviousManufacturerName.GetHashCode();
                }
                if (this.NewManufacturerName != null)
                {
                    hashCode = (hashCode * 59) + this.NewManufacturerName.GetHashCode();
                }
                if (this.PreviousPresentationId != null)
                {
                    hashCode = (hashCode * 59) + this.PreviousPresentationId.GetHashCode();
                }
                if (this.NewPresentationId != null)
                {
                    hashCode = (hashCode * 59) + this.NewPresentationId.GetHashCode();
                }
                return hashCode;
            }
        }
