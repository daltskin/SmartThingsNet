...
namespace SmartThingsNet.Model
{
    ...
    public partial class SliderForAutomationConditionAllOf :  IEquatable<SliderForAutomationConditionAllOf>, IValidatableObject
    {
        ...
        public SliderForAutomationConditionAllOf(string value = default(string))
        {
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for SliderForAutomationConditionAllOf and cannot be null");
        }
