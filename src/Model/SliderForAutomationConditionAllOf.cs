...
{
    /// <summary>
    /// SliderForAutomationConditionAllOf
    /// </summary>
    [DataContract(Name = "sliderForAutomationCondition_allOf")]
    public partial class SliderForAutomationConditionAllOf : IEquatable<SliderForAutomationConditionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationConditionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SliderForAutomationConditionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationConditionAllOf" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="valueType">The data type of the &#x60;value&#x60;. It&#39;s automatically filled from the given capability..</param>
        public SliderForAutomationConditionAllOf(string value = default(string), string valueType = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for SliderForAutomationConditionAllOf and cannot be null");
            }
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderForAutomationConditionAllOf {\n");
        ...
        {
            return this.Equals(input as SliderForAutomationConditionAllOf);
        }

        /// <summary>
        /// Returns true if SliderForAutomationConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderForAutomationConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderForAutomationConditionAllOf input)
        {
            if (input == null)
            {
                return false;
