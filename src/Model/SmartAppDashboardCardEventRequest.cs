...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SmartAppDashboardCardEventRequest")]
    public partial class SmartAppDashboardCardEventRequest : IEquatable<SmartAppDashboardCardEventRequest>, IValidatableObject
    {
        ...
        public DashboardCardLifecycle? Lifecycle { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SmartAppDashboardCardEventRequest" /> class.
        /// </summary>
        /// <param name="cardId">A developer defined dashboard card ID..</param>
        /// <param name="lifecycle">lifecycle.</param>
        public SmartAppDashboardCardEventRequest(string cardId = default(string), DashboardCardLifecycle? lifecycle = default(DashboardCardLifecycle?))
        {
            this.CardId = cardId;
        ...
        /// </summary>
        /// <value>A developer defined dashboard card ID.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SmartAppDashboardCardEventRequest {\n");
        ...
        {
            return this.Equals(input as SmartAppDashboardCardEventRequest);
        }

        /// <summary>
        /// Returns true if SmartAppDashboardCardEventRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SmartAppDashboardCardEventRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmartAppDashboardCardEventRequest input)
        {
            if (input == null)
            {
                return false;
