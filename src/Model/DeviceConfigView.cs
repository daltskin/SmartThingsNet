...
{
    /// <summary>
    /// A view in the mobile application that can display a device. &#x60;Detail view&#x60; - The full view of a device. &#x60;Dashboard view&#x60; - The view of a device amongst a list of devices. &#x60;Automation conditions&#x60; - The &#x60;if&#x60; part of an automation. The automation trigger. &#x60;Automation actions&#x60; - The &#x60;then&#x60; part of an automation. The device interaction (command).
    /// </summary>
    [DataContract(Name = "DeviceConfigView")]
    public partial class DeviceConfigView : IEquatable<DeviceConfigView>, IValidatableObject
    {
        /// <summary>
        /// Defines View
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceConfigView" /> class.
        /// </summary>
        /// <param name="view">view.</param>
        public DeviceConfigView(ViewEnum? view = default(ViewEnum?))
        {
            this.View = view;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceConfigView {\n");
        ...
        {
            return this.Equals(input as DeviceConfigView);
        }

        /// <summary>
        /// Returns true if DeviceConfigView instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceConfigView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceConfigView input)
        {
            if (input == null)
            {
                return false;
