...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RemainsCondition")]
    public partial class RemainsCondition : IEquatable<RemainsCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemainsCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemainsCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemainsCondition" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the condition should return true in subsequent executions after initially satisified.
        /// </summary>
        /// <value>Determines whether the condition should return true in subsequent executions after initially satisified.</value>
        [DataMember(Name = "latching", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemainsCondition {\n");
            ...
            sb.Append("  Latching: ").Append(Latching).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RemainsCondition);
        }

        /// <summary>
        /// Returns true if RemainsCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of RemainsCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemainsCondition input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Latching == input.Latching ||
                    this.Latching.Equals(input.Latching)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.Latching.GetHashCode();
                return hashCode;
            }
        }
