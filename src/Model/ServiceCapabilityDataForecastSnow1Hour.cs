...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow1Hour")]
    public partial class ServiceCapabilityDataForecastSnow1Hour : IEquatable<ServiceCapabilityDataForecastSnow1Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow1Hour" /> class.
        /// </summary>
        /// <param name="value">One hour snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow1Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// One hour snowfall amount in centimeters 
        /// </summary>
        /// <value>One hour snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow1Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow1Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow1Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow1Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow1Hour input)
        {
            if (input == null)
            {
                return false;
