...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax9Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax9Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax9Hour : IEquatable<ServiceCapabilityDataForecastSnowMax9Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax9Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 9 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax9Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 9 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 9 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax9Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax9Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax9Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax9Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax9Hour input)
        {
            if (input == null)
            {
                return false;
