...
{
    /// <summary>
    /// This switch triggers power toggle action without showing any status.
    /// </summary>
    [DataContract(Name = "statelessPowerToggleForDashboard")]
    public partial class StatelessPowerToggleForDashboard : IEquatable<StatelessPowerToggleForDashboard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatelessPowerToggleForDashboard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatelessPowerToggleForDashboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatelessPowerToggleForDashboard" /> class.
        /// </summary>
        ...
        public StatelessPowerToggleForDashboard(string command = default(string), string argument = default(string), string argumentType = default(string))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for StatelessPowerToggleForDashboard and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatelessPowerToggleForDashboard {\n");
        ...
        {
            return this.Equals(input as StatelessPowerToggleForDashboard);
        }

        /// <summary>
        /// Returns true if StatelessPowerToggleForDashboard instances are equal
        /// </summary>
        /// <param name="input">Instance of StatelessPowerToggleForDashboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatelessPowerToggleForDashboard input)
        {
            if (input == null)
            {
                return false;
