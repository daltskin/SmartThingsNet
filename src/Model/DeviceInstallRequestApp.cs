...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceInstallRequest_app")]
    public partial class DeviceInstallRequestApp : IEquatable<DeviceInstallRequestApp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceInstallRequestApp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceInstallRequestApp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceInstallRequestApp" /> class.
        /// </summary>
        /// <param name="profileId">The device profile Id (required).</param>
        /// <param name="installedAppId">The ID of the installed application (required).</param>
        /// <param name="externalId">A field to store an ID from a system external to SmartThings..</param>
        public DeviceInstallRequestApp(string profileId = default(string), string installedAppId = default(string), string externalId = default(string))
        {
            // to ensure "profileId" is required (not null)
            if (profileId == null) {
                throw new ArgumentNullException("profileId is a required property for DeviceInstallRequestApp and cannot be null");
            }
            this.ProfileId = profileId;
            // to ensure "installedAppId" is required (not null)
            if (installedAppId == null) {
                throw new ArgumentNullException("installedAppId is a required property for DeviceInstallRequestApp and cannot be null");
            }
        ...
        [DataMember(Name = "profileId", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A field to store an ID from a system external to SmartThings.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceInstallRequestApp {\n");
        ...
        {
            return this.Equals(input as DeviceInstallRequestApp);
        }

        /// <summary>
        /// Returns true if DeviceInstallRequestApp instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceInstallRequestApp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceInstallRequestApp input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExternalId, length must be less than 64.", new [] { "ExternalId" });
            }
