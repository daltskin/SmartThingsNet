...
namespace SmartThingsNet.Model
{
    ...
    public partial class DeviceInstallRequestApp :  IEquatable<DeviceInstallRequestApp>, IValidatableObject
    {
        ...
        public DeviceInstallRequestApp(string profileId = default(string), string installedAppId = default(string), string externalId = default(string))
        {
            ...
            this.ProfileId = profileId ?? throw new ArgumentNullException("profileId is a required property for DeviceInstallRequestApp and cannot be null");
            // to ensure "installedAppId" is required (not null)
            this.InstalledAppId = installedAppId ?? throw new ArgumentNullException("installedAppId is a required property for DeviceInstallRequestApp and cannot be null");
