...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityO3Amount
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQuality_o3Amount")]
    public partial class ServiceCapabilityDataAirQualityO3Amount : IEquatable<ServiceCapabilityDataAirQualityO3Amount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityO3Amount" /> class.
        /// </summary>
        /// <param name="value">(Available for Korea Only) Ozone pollutant in ug/m3.</param>
        /// <param name="unit">μg/m^3.</param>
        public ServiceCapabilityDataAirQualityO3Amount(double value = default(double), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (Available for Korea Only) Ozone pollutant in ug/m3
        /// </summary>
        /// <value>(Available for Korea Only) Ozone pollutant in ug/m3</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityO3Amount {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityO3Amount);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityO3Amount instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityO3Amount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityO3Amount input)
        {
            if (input == null)
            {
                return false;
