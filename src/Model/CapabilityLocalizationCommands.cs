...
{
    /// <summary>
    /// CapabilityLocalizationCommands
    /// </summary>
    [DataContract(Name = "CapabilityLocalization_commands")]
    public partial class CapabilityLocalizationCommands : IEquatable<CapabilityLocalizationCommands>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalizationCommands" /> class.
        /// </summary>
        /// <param name="label">label.</param>
        /// <param name="description">description.</param>
        /// <param name="arguments">Map of argument name to localizations.</param>
        public CapabilityLocalizationCommands(string label = default(string), string description = default(string), Dictionary<string, CapabilityLocalizationArguments> arguments = default(Dictionary<string, CapabilityLocalizationArguments>))
        {
            this.Label = label;
        ...
        /// <summary>
        /// Map of argument name to localizations
        /// </summary>
        /// <value>Map of argument name to localizations</value>
        [DataMember(Name = "arguments", EmitDefaultValue = false)]
        public Dictionary<string, CapabilityLocalizationArguments> Arguments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityLocalizationCommands {\n");
        ...
        {
            return this.Equals(input as CapabilityLocalizationCommands);
        }

        /// <summary>
        /// Returns true if CapabilityLocalizationCommands instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityLocalizationCommands to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityLocalizationCommands input)
        {
            if (input == null)
            {
                return false;
