...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCapabilityRequest")]
    public partial class UpdateCapabilityRequest : IEquatable<UpdateCapabilityRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCapabilityRequest" /> class.
        /// </summary>
        ...
        public UpdateCapabilityRequest(Dictionary<string, CapabilityAttribute> attributes = default(Dictionary<string, CapabilityAttribute>), Dictionary<string, CapabilityCommand> commands = default(Dictionary<string, CapabilityCommand>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateCapabilityRequest {\n");
        ...
        {
            return this.Equals(input as UpdateCapabilityRequest);
        }

        /// <summary>
        /// Returns true if UpdateCapabilityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCapabilityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCapabilityRequest input)
        {
            if (input == null)
            {
                return false;
