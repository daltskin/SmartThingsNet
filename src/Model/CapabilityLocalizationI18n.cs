...
{
    /// <summary>
    /// CapabilityLocalizationI18n
    /// </summary>
    [DataContract(Name = "CapabilityLocalization_i18n")]
    public partial class CapabilityLocalizationI18n : IEquatable<CapabilityLocalizationI18n>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalizationI18n" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CapabilityLocalizationI18n() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalizationI18n" /> class.
        /// </summary>
        /// <param name="label">The localized substitution for the argument value (required).</param>
        public CapabilityLocalizationI18n(string label = default(string))
        {
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for CapabilityLocalizationI18n and cannot be null");
            }
            this.Label = label;
        }
        ...
        /// </summary>
        /// <value>The localized substitution for the argument value</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityLocalizationI18n {\n");
        ...
        {
            return this.Equals(input as CapabilityLocalizationI18n);
        }

        /// <summary>
        /// Returns true if CapabilityLocalizationI18n instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityLocalizationI18n to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityLocalizationI18n input)
        {
            if (input == null)
            {
                return false;
