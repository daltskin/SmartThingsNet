...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax10Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax10Hour : IEquatable<ServiceCapabilityDataForecastSnowMax10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 10 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax10Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 10 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 10 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax10Hour input)
        {
            if (input == null)
            {
                return false;
