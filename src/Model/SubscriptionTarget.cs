...
namespace SmartThingsNet.Model
{
    ...
    /// SubscriptionTarget
    /// </summary>
    [DataContract(Name = "SubscriptionTarget")]
    public partial class SubscriptionTarget : IEquatable<SubscriptionTarget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionTarget" /> class.
        /// </summary>
        /// <param name="url">The address to send events to..</param>
        public SubscriptionTarget(string url = default(string))
        {
            this.Url = url;
        }
        ...
        /// </summary>
        /// <value>The address to send events to.</value>
        ...
        {
            return this.Equals(input as SubscriptionTarget);
        }

        /// <summary>
        /// Returns true if SubscriptionTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionTarget input)
        {
            if (input == null)
            {
                return false;
