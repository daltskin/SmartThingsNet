...
namespace SmartThingsNet.Model
{
    ...
    {
        /// <summary>
        /// Enum DEVICECOMMANDSEVENT for value: DEVICE_COMMANDS_EVENT
        /// </summary>
        [EnumMember(Value = "DEVICE_COMMANDS_EVENT")]
        DEVICECOMMANDSEVENT = 1,

        /// <summary>
        /// Enum DEVICEEVENT for value: DEVICE_EVENT
        /// </summary>
        [EnumMember(Value = "DEVICE_EVENT")]
        DEVICEEVENT = 2,

        /// <summary>
        /// Enum DEVICEHEALTHEVENT for value: DEVICE_HEALTH_EVENT
        /// </summary>
        [EnumMember(Value = "DEVICE_HEALTH_EVENT")]
        DEVICEHEALTHEVENT = 3,

        /// <summary>
        /// Enum DEVICELIFECYCLEEVENT for value: DEVICE_LIFECYCLE_EVENT
        /// </summary>
        [EnumMember(Value = "DEVICE_LIFECYCLE_EVENT")]
        DEVICELIFECYCLEEVENT = 4,

        /// <summary>
        /// Enum HUBHEALTHEVENT for value: HUB_HEALTH_EVENT
        /// </summary>
        [EnumMember(Value = "HUB_HEALTH_EVENT")]
        HUBHEALTHEVENT = 5,

        /// <summary>
        /// Enum MODEEVENT for value: MODE_EVENT
        /// </summary>
        [EnumMember(Value = "MODE_EVENT")]
        MODEEVENT = 6,

        /// <summary>
        /// Enum SCENELIFECYCLEEVENT for value: SCENE_LIFECYCLE_EVENT
        /// </summary>
        [EnumMember(Value = "SCENE_LIFECYCLE_EVENT")]
        SCENELIFECYCLEEVENT = 7,

        /// <summary>
        /// Enum SECURITYARMSTATEEVENT for value: SECURITY_ARM_STATE_EVENT
        /// </summary>
        [EnumMember(Value = "SECURITY_ARM_STATE_EVENT")]
        SECURITYARMSTATEEVENT = 8,

        /// <summary>
        /// Enum TIMEREVENT for value: TIMER_EVENT
        /// </summary>
        [EnumMember(Value = "TIMER_EVENT")]
        TIMEREVENT = 9,

        /// <summary>
        /// Enum INSTALLEDAPPLIFECYCLEEVENT for value: INSTALLED_APP_LIFECYCLE_EVENT
        /// </summary>
        [EnumMember(Value = "INSTALLED_APP_LIFECYCLE_EVENT")]
        INSTALLEDAPPLIFECYCLEEVENT = 10,

        /// <summary>
        /// Enum WEATHEREVENT for value: WEATHER_EVENT
        /// </summary>
        [EnumMember(Value = "WEATHER_EVENT")]
        WEATHEREVENT = 11
