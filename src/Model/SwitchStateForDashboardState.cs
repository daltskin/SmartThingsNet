...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "switchStateForDashboard_state")]
    public partial class SwitchStateForDashboardState : IEquatable<SwitchStateForDashboardState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchStateForDashboardState" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SwitchStateForDashboardState() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SwitchStateForDashboardState" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="on">on (required).</param>
        /// <param name="off">off (required).</param>
        ...
        public SwitchStateForDashboardState(string value = default(string), string on = default(string), string off = default(string), string valueType = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "on" is required (not null)
            if (on == null) {
                throw new ArgumentNullException("on is a required property for SwitchStateForDashboardState and cannot be null");
            }
            this.On = on;
            // to ensure "off" is required (not null)
            if (off == null) {
                throw new ArgumentNullException("off is a required property for SwitchStateForDashboardState and cannot be null");
            }
            this.Off = off;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SwitchStateForDashboardState {\n");
        ...
        {
            return this.Equals(input as SwitchStateForDashboardState);
        }

        /// <summary>
        /// Returns true if SwitchStateForDashboardState instances are equal
        /// </summary>
        /// <param name="input">Instance of SwitchStateForDashboardState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SwitchStateForDashboardState input)
        {
            if (input == null)
            {
                return false;
