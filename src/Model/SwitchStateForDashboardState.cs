...
namespace SmartThingsNet.Model
{
    ...
    public partial class SwitchStateForDashboardState :  IEquatable<SwitchStateForDashboardState>, IValidatableObject
    {
        ...
        public SwitchStateForDashboardState(string value = default(string), string on = default(string), string off = default(string))
        {
            // to ensure "on" is required (not null)
            this.On = on ?? throw new ArgumentNullException("on is a required property for SwitchStateForDashboardState and cannot be null");
            // to ensure "off" is required (not null)
            this.Off = off ?? throw new ArgumentNullException("off is a required property for SwitchStateForDashboardState and cannot be null");
            this.Value = value;
        }
