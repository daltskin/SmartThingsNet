...
namespace SmartThingsNet.Model
{
    ...
    /// TextButtonButtons
    /// </summary>
    [DataContract(Name = "textButton_buttons")]
    public partial class TextButtonButtons : IEquatable<TextButtonButtons>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextButtonButtons" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TextButtonButtons() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TextButtonButtons" /> class.
        /// </summary>
        /// <param name="key">A command name or an argument name of a command to be mapped with this button. (required).</param>
        /// <param name="label">The alternative string to be displayed when the &#x60;key&#x60; is evaluated. (required).</param>
        /// <param name="state">To focus this button according to the current status of given attribute which is mapped with this button..</param>
        public TextButtonButtons(string key = default(string), string label = default(string), string state = default(string))
        {
            // to ensure "key" is required (not null)
            if (key == null) {
                throw new ArgumentNullException("key is a required property for TextButtonButtons and cannot be null");
            }
            this.Key = key;
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for TextButtonButtons and cannot be null");
            }
            this.Label = label;
            this.State = state;
        }
        ...
        /// <summary>
        /// A command name or an argument name of a command to be mapped with this button.
        /// </summary>
        /// <value>A command name or an argument name of a command to be mapped with this button.</value>
        [DataMember(Name = "key", IsRequired = true, EmitDefaultValue = false)]
        public string Key { get; set; }

        /// <summary>
        /// The alternative string to be displayed when the &#x60;key&#x60; is evaluated.
        /// </summary>
        /// <value>The alternative string to be displayed when the &#x60;key&#x60; is evaluated.</value>
        [DataMember(Name = "label", IsRequired = true, EmitDefaultValue = false)]
        public string Label { get; set; }

        /// <summary>
        /// To focus this button according to the current status of given attribute which is mapped with this button.
        /// </summary>
        /// <value>To focus this button according to the current status of given attribute which is mapped with this button.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TextButtonButtons {\n");
        ...
        {
            return this.Equals(input as TextButtonButtons);
        }

        /// <summary>
        /// Returns true if TextButtonButtons instances are equal
        /// </summary>
        /// <param name="input">Instance of TextButtonButtons to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextButtonButtons input)
        {
            if (input == null)
            {
                return false;
