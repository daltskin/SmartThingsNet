...
{
    /// <summary>
    /// The type of device integration (may be null). If the type is DTH, the device implementation is a groovy Device Handler and the details are in the \&quot;dth\&quot; field. If the type is ENDPOINT_APP, the device implementation is a SmartApp and the details are in the \&quot;app\&quot; field. If the type is IR, the details are in the \&quot;ir\&quot; field. If the type is IR_OCF, the details are in the \&quot;irOcf\&quot; field. If the type is OCF, the details are in the \&quot;ocf\&quot; field. If the type is VIPER, the details are in the \&quot;viper\&quot; field. 
    /// </summary>
    /// <value>The type of device integration (may be null). If the type is DTH, the device implementation is a groovy Device Handler and the details are in the \&quot;dth\&quot; field. If the type is ENDPOINT_APP, the device implementation is a SmartApp and the details are in the \&quot;app\&quot; field. If the type is IR, the details are in the \&quot;ir\&quot; field. If the type is IR_OCF, the details are in the \&quot;irOcf\&quot; field. If the type is OCF, the details are in the \&quot;ocf\&quot; field. If the type is VIPER, the details are in the \&quot;viper\&quot; field. </value>
    ...
    public enum DeviceIntegrationType
    {
        ...
        /// <summary>
        /// Enum ENDPOINTAPP for value: ENDPOINT_APP
        /// </summary>
        ...
        /// <summary>
        /// Enum OCF for value: OCF
        /// </summary>
        [EnumMember(Value = "OCF")]
        OCF = 13,

        /// <summary>
        /// Enum PENGYOU for value: PENGYOU
        /// </summary>
