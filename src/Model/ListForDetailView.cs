...
{
    /// <summary>
    /// To specify available values shown in a drop-down UI. User can select one of the value among the list items
    /// </summary>
    [DataContract(Name = "listForDetailView")]
    public partial class ListForDetailView : IEquatable<ListForDetailView>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForDetailView" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListForDetailView() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListForDetailView" /> class.
        /// </summary>
        /// <param name="command">command (required).</param>
        /// <param name="state">state.</param>
        public ListForDetailView(ListForDetailViewCommand command = default(ListForDetailViewCommand), ListForDetailViewState state = default(ListForDetailViewState))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for ListForDetailView and cannot be null");
            }
        ...
        public ListForDetailViewCommand Command { get; set; }

        /// <summary>
        /// Gets or Sets State
        /// </summary>
        [DataMember(Name = "state", EmitDefaultValue = false)]
        public ListForDetailViewState State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListForDetailView {\n");
        ...
        {
            return this.Equals(input as ListForDetailView);
        }

        /// <summary>
        /// Returns true if ListForDetailView instances are equal
        /// </summary>
        /// <param name="input">Instance of ListForDetailView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListForDetailView input)
        {
            if (input == null)
            {
                return false;
