...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "textFieldForArgument")]
    public partial class TextFieldForArgument : IEquatable<TextFieldForArgument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextFieldForArgument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TextFieldForArgument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TextFieldForArgument" /> class.
        /// </summary>
        ...
        public TextFieldForArgument(string name = default(string), string argumentType = default(string), List<double> range = default(List<double>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TextFieldForArgument and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TextFieldForArgument {\n");
        ...
        {
            return this.Equals(input as TextFieldForArgument);
        }

        /// <summary>
        /// Returns true if TextFieldForArgument instances are equal
        /// </summary>
        /// <param name="input">Instance of TextFieldForArgument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextFieldForArgument input)
        {
            if (input == null)
            {
                return false;
