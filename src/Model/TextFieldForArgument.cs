...
namespace SmartThingsNet.Model
{
    ...
    public partial class TextFieldForArgument :  IEquatable<TextFieldForArgument>, IValidatableObject
    {
        ...
        public TextFieldForArgument(string name = default(string), List<double> range = default(List<double>))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for TextFieldForArgument and cannot be null");
            this.Range = range;
        }
