...
{
    /// <summary>
    /// DossierDevicePresentationAllOf
    /// </summary>
    [DataContract(Name = "DossierDevicePresentation_allOf")]
    public partial class DossierDevicePresentationAllOf : IEquatable<DossierDevicePresentationAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DossierDevicePresentationAllOf" /> class.
        /// </summary>
        ...
        public DossierDevicePresentationAllOf(string manufacturerName = default(string), string presentationId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DossierDevicePresentationAllOf {\n");
        ...
        {
            return this.Equals(input as DossierDevicePresentationAllOf);
        }

        /// <summary>
        /// Returns true if DossierDevicePresentationAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DossierDevicePresentationAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DossierDevicePresentationAllOf input)
        {
            if (input == null)
            {
                return false;
