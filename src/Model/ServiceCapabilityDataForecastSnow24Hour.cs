...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow24Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow24Hour")]
    public partial class ServiceCapabilityDataForecastSnow24Hour : IEquatable<ServiceCapabilityDataForecastSnow24Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow24Hour" /> class.
        /// </summary>
        /// <param name="value">Twenty four hour snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow24Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// Twenty four hour snowfall amount in centimeters 
        /// </summary>
        /// <value>Twenty four hour snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow24Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow24Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow24Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow24Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow24Hour input)
        {
            if (input == null)
            {
                return false;
