...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoomConfig")]
    public partial class RoomConfig : IEquatable<RoomConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoomConfig" /> class.
        /// </summary>
        /// <param name="roomId">The ID of the room..</param>
        /// <param name="permissions">permissions.</param>
        public RoomConfig(string roomId = default(string), List<string> permissions = default(List<string>))
        {
            this.RoomId = roomId;
        ...
        {
            return this.Equals(input as RoomConfig);
        }

        /// <summary>
        /// Returns true if RoomConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of RoomConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoomConfig input)
        {
            if (input == null)
            {
                return false;
