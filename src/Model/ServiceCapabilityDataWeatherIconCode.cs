...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherIconCode
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_iconCode")]
    public partial class ServiceCapabilityDataWeatherIconCode : IEquatable<ServiceCapabilityDataWeatherIconCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherIconCode" /> class.
        /// </summary>
        /// <param name="value">This number is the key to the weather icon lookup..</param>
        public ServiceCapabilityDataWeatherIconCode(int value = default(int))
        {
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>This number is the key to the weather icon lookup.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherIconCode {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherIconCode);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherIconCode instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherIconCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherIconCode input)
        {
            if (input == null)
            {
                return false;
