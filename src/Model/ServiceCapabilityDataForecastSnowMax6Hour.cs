...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMax6Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMax6Hour")]
    public partial class ServiceCapabilityDataForecastSnowMax6Hour : IEquatable<ServiceCapabilityDataForecastSnowMax6Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMax6Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Maximium 6 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMax6Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Maximium 6 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Maximium 6 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMax6Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMax6Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMax6Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMax6Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMax6Hour input)
        {
            if (input == null)
            {
                return false;
