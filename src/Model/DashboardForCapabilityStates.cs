...
{
    /// <summary>
    /// DashboardForCapabilityStates
    /// </summary>
    [DataContract]
    public partial class DashboardForCapabilityStates :  IEquatable<DashboardForCapabilityStates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardForCapabilityStates" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DashboardForCapabilityStates() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardForCapabilityStates" /> class.
        /// </summary>
        ...
        public DashboardForCapabilityStates(string label = default(string), List<string> alternatives = default(List<string>), string group = default(string))
        {
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for DashboardForCapabilityStates and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DashboardForCapabilityStates {\n");
        ...
        {
            return this.Equals(input as DashboardForCapabilityStates);
        }

        /// <summary>
        /// Returns true if DashboardForCapabilityStates instances are equal
        /// </summary>
        /// <param name="input">Instance of DashboardForCapabilityStates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DashboardForCapabilityStates input)
        {
            if (input == null)
                return false;
