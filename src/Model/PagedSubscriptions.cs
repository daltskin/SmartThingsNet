...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedSubscriptions")]
    public partial class PagedSubscriptions : IEquatable<PagedSubscriptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedSubscriptions" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="links">links.</param>
        public PagedSubscriptions(List<Subscription> items = default(List<Subscription>), Links links = default(Links))
        {
            this.Items = items;
            this.Links = links;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedSubscriptions {\n");
        ...
        {
            return this.Equals(input as PagedSubscriptions);
        }

        /// <summary>
        /// Returns true if PagedSubscriptions instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedSubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedSubscriptions input)
        {
            if (input == null)
            {
                return false;
