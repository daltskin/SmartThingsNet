...
namespace SmartThingsNet.Model
{
    ...
    public partial class SliderForAutomationActionAllOf :  IEquatable<SliderForAutomationActionAllOf>, IValidatableObject
    {
        ...
        public SliderForAutomationActionAllOf(string command = default(string))
        {
            // to ensure "command" is required (not null)
            this.Command = command ?? throw new ArgumentNullException("command is a required property for SliderForAutomationActionAllOf and cannot be null");
        }
