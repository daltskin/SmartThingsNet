...
{
    /// <summary>
    /// SliderForAutomationActionAllOf
    /// </summary>
    [DataContract(Name = "sliderForAutomationAction_allOf")]
    public partial class SliderForAutomationActionAllOf : IEquatable<SliderForAutomationActionAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationActionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SliderForAutomationActionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderForAutomationActionAllOf" /> class.
        /// </summary>
        ...
        public SliderForAutomationActionAllOf(string command = default(string), string argumentType = default(string))
        {
            // to ensure "command" is required (not null)
            if (command == null) {
                throw new ArgumentNullException("command is a required property for SliderForAutomationActionAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderForAutomationActionAllOf {\n");
        ...
        {
            return this.Equals(input as SliderForAutomationActionAllOf);
        }

        /// <summary>
        /// Returns true if SliderForAutomationActionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderForAutomationActionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderForAutomationActionAllOf input)
        {
            if (input == null)
            {
                return false;
