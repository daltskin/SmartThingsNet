...
{
    /// <summary>
    /// InviteResponseItemAllOf
    /// </summary>
    [DataContract(Name = "InviteResponseItem_allOf")]
    public partial class InviteResponseItemAllOf : IEquatable<InviteResponseItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteResponseItemAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InviteResponseItemAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InviteResponseItemAllOf" /> class.
        /// </summary>
        ...
        public InviteResponseItemAllOf(int status = default(int), string info = default(string), string inviteId = default(string), string acceptUrl = default(string))
        {
            this.Status = status;
            // to ensure "info" is required (not null)
            if (info == null) {
                throw new ArgumentNullException("info is a required property for InviteResponseItemAllOf and cannot be null");
            }
            this.Info = info;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InviteResponseItemAllOf {\n");
        ...
        {
            return this.Equals(input as InviteResponseItemAllOf);
        }

        /// <summary>
        /// Returns true if InviteResponseItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InviteResponseItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InviteResponseItemAllOf input)
        {
            if (input == null)
            {
                return false;
