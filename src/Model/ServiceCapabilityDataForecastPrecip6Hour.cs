...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecip6Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precip6Hour")]
    public partial class ServiceCapabilityDataForecastPrecip6Hour : IEquatable<ServiceCapabilityDataForecastPrecip6Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecip6Hour" /> class.
        /// </summary>
        /// <param name="value">6 hours forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecip6Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// 6 hours forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>6 hours forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecip6Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecip6Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecip6Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecip6Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecip6Hour input)
        {
            if (input == null)
            {
                return false;
