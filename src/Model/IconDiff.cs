...
namespace SmartThingsNet.Model
{
    ...
    /// IconDiff
    /// </summary>
    [DataContract(Name = "IconDiff")]
    public partial class IconDiff : IEquatable<IconDiff>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IconDiff" /> class.
        /// </summary>
        /// <param name="old">old.</param>
        /// <param name="_new">_new.</param>
        public IconDiff(string old = default(string), string _new = default(string))
        {
            this.Old = old;
            this.New = _new;
        }
        ...
        {
            return this.Equals(input as IconDiff);
        }

        /// <summary>
        /// Returns true if IconDiff instances are equal
        /// </summary>
        /// <param name="input">Instance of IconDiff to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IconDiff input)
        {
            if (input == null)
            {
                return false;
