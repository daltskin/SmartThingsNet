...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherTemperature
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_temperature")]
    public partial class ServiceCapabilityDataWeatherTemperature : IEquatable<ServiceCapabilityDataWeatherTemperature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherTemperature" /> class.
        /// </summary>
        /// <param name="value">Temperature in Celcius .</param>
        /// <param name="unit">C.</param>
        public ServiceCapabilityDataWeatherTemperature(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// </summary>
        /// <value>Temperature in Celcius </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherTemperature {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherTemperature);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherTemperature instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherTemperature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherTemperature input)
        {
            if (input == null)
            {
                return false;
