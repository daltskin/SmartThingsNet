...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RuleExecutionResponse")]
    public partial class RuleExecutionResponse : IEquatable<RuleExecutionResponse>, IValidatableObject
    {
        ...
        protected RuleExecutionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RuleExecutionResponse" /> class.
        /// </summary>
        ...
        public RuleExecutionResponse(string executionId = default(string), string id = default(string), ExecutionResult result = default(ExecutionResult), List<ActionExecutionResult> actions = default(List<ActionExecutionResult>))
        {
            // to ensure "executionId" is required (not null)
            if (executionId == null) {
                throw new ArgumentNullException("executionId is a required property for RuleExecutionResponse and cannot be null");
            }
            this.ExecutionId = executionId;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for RuleExecutionResponse and cannot be null");
            }
            this.Id = id;
            this.Result = result;
        ...
        {
            return this.Equals(input as RuleExecutionResponse);
        }

        /// <summary>
        /// Returns true if RuleExecutionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RuleExecutionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RuleExecutionResponse input)
        {
            if (input == null)
            {
                return false;
