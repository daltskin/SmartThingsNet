...
{
    /// <summary>
    /// ServiceCapabilityDataExpireTime
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_expireTime")]
    public partial class ServiceCapabilityDataExpireTime : IEquatable<ServiceCapabilityDataExpireTime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataExpireTime" /> class.
        /// </summary>
        /// <param name="value">UTC time when the alert is expired.</param>
        public ServiceCapabilityDataExpireTime(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// UTC time when the alert is expired
        /// </summary>
        /// <value>UTC time when the alert is expired</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataExpireTime {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataExpireTime);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataExpireTime instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataExpireTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataExpireTime input)
        {
            if (input == null)
            {
                return false;
