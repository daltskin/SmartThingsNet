...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "visibleCondition_allOf")]
    public partial class VisibleConditionAllOf : IEquatable<VisibleConditionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public VisibleConditionAllOf(string component = default(string), string value = default(string), Operator _operator = default(Operator), string operand = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VisibleConditionAllOf {\n");
        ...
        {
            return this.Equals(input as VisibleConditionAllOf);
        }

        /// <summary>
        /// Returns true if VisibleConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of VisibleConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VisibleConditionAllOf input)
        {
            if (input == null)
            {
                return false;
