...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SceneAction")]
    public partial class SceneAction : IEquatable<SceneAction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets DeviceRequest
        /// </summary>
        [DataMember(Name = "deviceRequest", EmitDefaultValue = false)]
        public SceneDeviceRequest DeviceRequest { get; set; }

        /// <summary>
        /// Gets or Sets ModeRequest
        /// </summary>
        [DataMember(Name = "modeRequest", EmitDefaultValue = false)]
        public SceneModeRequest ModeRequest { get; set; }

        /// <summary>
        /// Gets or Sets SleepRequest
        /// </summary>
        [DataMember(Name = "sleepRequest", EmitDefaultValue = false)]
        public SceneSleepRequest SleepRequest { get; set; }

        /// <summary>
        /// Gets or Sets DeviceGroupRequest
        /// </summary>
        [DataMember(Name = "deviceGroupRequest", EmitDefaultValue = false)]
        public SceneDeviceGroupRequest DeviceGroupRequest { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SceneAction {\n");
            sb.Append("  DeviceRequest: ").Append(DeviceRequest).Append("\n");
            sb.Append("  ModeRequest: ").Append(ModeRequest).Append("\n");
            sb.Append("  SleepRequest: ").Append(SleepRequest).Append("\n");
            sb.Append("  DeviceGroupRequest: ").Append(DeviceGroupRequest).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SceneAction);
        }

        /// <summary>
        /// Returns true if SceneAction instances are equal
        /// </summary>
        /// <param name="input">Instance of SceneAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SceneAction input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.DeviceRequest == input.DeviceRequest ||
                    (this.DeviceRequest != null &&
                    this.DeviceRequest.Equals(input.DeviceRequest))
                ) && 
                (
                    this.ModeRequest == input.ModeRequest ||
                    (this.ModeRequest != null &&
                    this.ModeRequest.Equals(input.ModeRequest))
                ) && 
                (
                    this.SleepRequest == input.SleepRequest ||
                    (this.SleepRequest != null &&
                    this.SleepRequest.Equals(input.SleepRequest))
                ) && 
                (
                    this.DeviceGroupRequest == input.DeviceGroupRequest ||
                    (this.DeviceGroupRequest != null &&
                    this.DeviceGroupRequest.Equals(input.DeviceGroupRequest))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DeviceRequest.GetHashCode();
                }
                if (this.ModeRequest != null)
                {
                    hashCode = (hashCode * 59) + this.ModeRequest.GetHashCode();
                }
                if (this.SleepRequest != null)
                {
                    hashCode = (hashCode * 59) + this.SleepRequest.GetHashCode();
                }
                if (this.DeviceGroupRequest != null)
                {
                    hashCode = (hashCode * 59) + this.DeviceGroupRequest.GetHashCode();
                }
                return hashCode;
            }
        }
