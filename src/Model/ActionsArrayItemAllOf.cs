...
{
    /// <summary>
    /// ActionsArrayItemAllOf
    /// </summary>
    [DataContract(Name = "actionsArrayItem_allOf")]
    public partial class ActionsArrayItemAllOf : IEquatable<ActionsArrayItemAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public ActionsArrayItemAllOf(string component = default(string), VisibleCondition visibleCondition = default(VisibleCondition), string group = "main")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionsArrayItemAllOf {\n");
        ...
        {
            return this.Equals(input as ActionsArrayItemAllOf);
        }

        /// <summary>
        /// Returns true if ActionsArrayItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionsArrayItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionsArrayItemAllOf input)
        {
            if (input == null)
            {
                return false;
