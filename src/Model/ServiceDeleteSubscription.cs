...
{
    /// <summary>
    /// ServiceDeleteSubscription
    /// </summary>
    [DataContract(Name = "ServiceDeleteSubscription")]
    public partial class ServiceDeleteSubscription : IEquatable<ServiceDeleteSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDeleteSubscription" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ServiceDeleteSubscription() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceDeleteSubscription" /> class.
        /// </summary>
        /// <param name="locationId">location ID (required).</param>
        /// <param name="count">number of subscription deleted (required).</param>
        public ServiceDeleteSubscription(string locationId = default(string), decimal count = default(decimal))
        {
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for ServiceDeleteSubscription and cannot be null");
            }
        ...
        /// <summary>
        /// number of subscription deleted
        /// </summary>
        /// <value>number of subscription deleted</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceDeleteSubscription {\n");
        ...
        {
            return this.Equals(input as ServiceDeleteSubscription);
        }

        /// <summary>
        /// Returns true if ServiceDeleteSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceDeleteSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceDeleteSubscription input)
        {
            if (input == null)
            {
                return false;
