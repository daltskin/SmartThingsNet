...
{
    /// <summary>
    /// ServiceCapabilityDataIssueTime
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_issueTime")]
    public partial class ServiceCapabilityDataIssueTime : IEquatable<ServiceCapabilityDataIssueTime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataIssueTime" /> class.
        /// </summary>
        /// <param name="value">UTC time when the alert is issued.</param>
        public ServiceCapabilityDataIssueTime(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// UTC time when the alert is issued
        /// </summary>
        /// <value>UTC time when the alert is issued</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataIssueTime {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataIssueTime);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataIssueTime instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataIssueTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataIssueTime input)
        {
            if (input == null)
            {
                return false;
