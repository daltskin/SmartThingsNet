...
{
    /// <summary>
    /// AutomationConditionAllOf
    /// </summary>
    [DataContract(Name = "automationCondition_allOf")]
    public partial class AutomationConditionAllOf : IEquatable<AutomationConditionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public enum DisplayTypeEnum
        {
            ...
            /// <summary>
            /// Enum EnumSlider for value: enumSlider
            /// </summary>
            [EnumMember(Value = "enumSlider")]
            EnumSlider = 5
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationConditionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutomationConditionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutomationConditionAllOf" /> class.
        /// </summary>
        ...
        public AutomationConditionAllOf(string label = default(string), DisplayTypeEnum displayType = default(DisplayTypeEnum), SliderForAutomationCondition slider = default(SliderForAutomationCondition), ListForAutomationCondition list = default(ListForAutomationCondition), NumberFieldForAutomationCondition numberField = default(NumberFieldForAutomationCondition), TextFieldForAutomationCondition textField = default(TextFieldForAutomationCondition), EnumSliderForAutomationCondition enumSlider = default(EnumSliderForAutomationCondition), bool emphasis = default(bool))
        {
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for AutomationConditionAllOf and cannot be null");
            }
            this.Label = label;
        ...
        /// <summary>
        /// Gets or Sets EnumSlider
        /// </summary>
        [DataMember(Name = "enumSlider", EmitDefaultValue = false)]
        public EnumSliderForAutomationCondition EnumSlider { get; set; }
        ...
        [DataMember(Name = "emphasis", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AutomationConditionAllOf {\n");
            ...
            sb.Append("  EnumSlider: ").Append(EnumSlider).Append("\n");
        ...
        {
            return this.Equals(input as AutomationConditionAllOf);
        }

        /// <summary>
        /// Returns true if AutomationConditionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationConditionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationConditionAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EnumSlider == input.EnumSlider ||
                    (this.EnumSlider != null &&
                    this.EnumSlider.Equals(input.EnumSlider))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnumSlider != null)
                {
                    hashCode = (hashCode * 59) + this.EnumSlider.GetHashCode();
                }
