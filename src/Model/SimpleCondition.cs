...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleCondition :  IEquatable<SimpleCondition>, IValidatableObject
    {
        /// <summary>
        ...
        public SimpleCondition(string id = default(string), Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            this.Left = left ?? throw new ArgumentNullException("left is a required property for SimpleCondition and cannot be null");
            // to ensure "right" is required (not null)
            this.Right = right ?? throw new ArgumentNullException("right is a required property for SimpleCondition and cannot be null");
            this.Id = id;
        ...
        {
            return this.Equals(input as SimpleCondition);
        }

        /// <summary>
        /// Returns true if SimpleCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleCondition input)
        {
            if (input == null)
                return false;
