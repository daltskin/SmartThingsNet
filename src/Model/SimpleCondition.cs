...
namespace SmartThingsNet.Model
{
    ...
    /// SimpleCondition
    /// </summary>
    [DataContract(Name = "SimpleCondition")]
    public partial class SimpleCondition : IEquatable<SimpleCondition>, IValidatableObject
    {
        ...
        public SimpleCondition(Operand left = default(Operand), Operand right = default(Operand), ConditionAggregationMode? aggregation = default(ConditionAggregationMode?))
        {
            // to ensure "left" is required (not null)
            if (left == null) {
                throw new ArgumentNullException("left is a required property for SimpleCondition and cannot be null");
            }
            this.Left = left;
            // to ensure "right" is required (not null)
            if (right == null) {
                throw new ArgumentNullException("right is a required property for SimpleCondition and cannot be null");
            }
            this.Right = right;
