...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CapabilityLocalization")]
    public partial class CapabilityLocalization : IEquatable<CapabilityLocalization>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalization" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CapabilityLocalization() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CapabilityLocalization" /> class.
        /// </summary>
        /// <param name="tag">The tag of the locale as defined in [RFC bcp47](http://www.rfc-editor.org/rfc/bcp/bcp47.txt). (required).</param>
        /// <param name="label">A localized label for the capability.</param>
        /// <param name="description">A localized description of the capability.</param>
        /// <param name="attributes">Map of attribute name to localizations.</param>
        /// <param name="commands">Map of command name to localizations.</param>
        public CapabilityLocalization(string tag = default(string), string label = default(string), string description = default(string), Dictionary<string, CapabilityLocalizationAttributes> attributes = default(Dictionary<string, CapabilityLocalizationAttributes>), Dictionary<string, CapabilityLocalizationCommands> commands = default(Dictionary<string, CapabilityLocalizationCommands>))
        {
            // to ensure "tag" is required (not null)
            if (tag == null) {
                throw new ArgumentNullException("tag is a required property for CapabilityLocalization and cannot be null");
            }
            this.Tag = tag;
            this.Label = label;
        ...
        /// </summary>
        /// <value>A localized label for the capability</value>
        ...
        /// </summary>
        /// <value>A localized description of the capability</value>
        ...
        /// </summary>
        /// <value>Map of attribute name to localizations</value>
        [DataMember(Name = "attributes", EmitDefaultValue = false)]
        public Dictionary<string, CapabilityLocalizationAttributes> Attributes { get; set; }

        /// <summary>
        /// Map of command name to localizations
        /// </summary>
        /// <value>Map of command name to localizations</value>
        [DataMember(Name = "commands", EmitDefaultValue = false)]
        public Dictionary<string, CapabilityLocalizationCommands> Commands { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CapabilityLocalization {\n");
        ...
        {
            return this.Equals(input as CapabilityLocalization);
        }

        /// <summary>
        /// Returns true if CapabilityLocalization instances are equal
        /// </summary>
        /// <param name="input">Instance of CapabilityLocalization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CapabilityLocalization input)
        {
            if (input == null)
            {
                return false;
