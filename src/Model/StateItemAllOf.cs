...
namespace SmartThingsNet.Model
{
    ...
    /// StateItemAllOf
    /// </summary>
    [DataContract(Name = "stateItem_allOf")]
    public partial class StateItemAllOf : IEquatable<StateItemAllOf>, IValidatableObject
    {
        ...
        public StateItemAllOf(string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>))
        {
            // to ensure "label" is required (not null)
            if (label == null) {
                throw new ArgumentNullException("label is a required property for StateItemAllOf and cannot be null");
            }
            this.Label = label;
