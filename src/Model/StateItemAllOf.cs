...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StateItemAllOf :  IEquatable<StateItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateItemAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StateItemAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StateItemAllOf" /> class.
        /// </summary>
        ...
        public StateItemAllOf(string label = default(string), List<AlternativeItem> alternatives = default(List<AlternativeItem>), string group = default(string))
        {
            // to ensure "label" is required (not null)
            this.Label = label ?? throw new ArgumentNullException("label is a required property for StateItemAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StateItemAllOf {\n");
        ...
        {
            return this.Equals(input as StateItemAllOf);
        }

        /// <summary>
        /// Returns true if StateItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of StateItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateItemAllOf input)
        {
            if (input == null)
                return false;
