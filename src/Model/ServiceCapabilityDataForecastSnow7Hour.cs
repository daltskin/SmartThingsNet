...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnow7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snow7Hour")]
    public partial class ServiceCapabilityDataForecastSnow7Hour : IEquatable<ServiceCapabilityDataForecastSnow7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnow7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) 7 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnow7Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) 7 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) 7 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnow7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnow7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnow7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnow7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnow7Hour input)
        {
            if (input == null)
            {
                return false;
