...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LocationActionExecutionResult")]
    public partial class LocationActionExecutionResult : IEquatable<LocationActionExecutionResult>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationActionExecutionResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LocationActionExecutionResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationActionExecutionResult" /> class.
        /// </summary>
        /// <param name="result">result (required).</param>
        /// <param name="locationId">Location ID for location actions (required).</param>
        public LocationActionExecutionResult(ExecutionResult result = default(ExecutionResult), string locationId = default(string))
        {
            this.Result = result;
            // to ensure "locationId" is required (not null)
            if (locationId == null) {
                throw new ArgumentNullException("locationId is a required property for LocationActionExecutionResult and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Location ID for location actions</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocationActionExecutionResult {\n");
        ...
        {
            return this.Equals(input as LocationActionExecutionResult);
        }

        /// <summary>
        /// Returns true if LocationActionExecutionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationActionExecutionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationActionExecutionResult input)
        {
            if (input == null)
            {
                return false;
