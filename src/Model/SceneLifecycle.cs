...
{
    /// <summary>
    /// The scene lifecycle. The lifecycle will be one of: * CREATE - Invoked when a scene is created. * UPDATE - Invoked when a scene is updated. * DELETE - Invoked when a scene is deleted. * CREATEFORBIXBY - Invoked when a scene is created for Bixby. * UPDATEFORBIXBY - Invoked when a scene is updated for Bixby. * DELETEFORBIXBY - Invoked when a scene is deleted for Bixby. 
    /// </summary>
    /// <value>The scene lifecycle. The lifecycle will be one of: * CREATE - Invoked when a scene is created. * UPDATE - Invoked when a scene is updated. * DELETE - Invoked when a scene is deleted. * CREATEFORBIXBY - Invoked when a scene is created for Bixby. * UPDATEFORBIXBY - Invoked when a scene is updated for Bixby. * DELETEFORBIXBY - Invoked when a scene is deleted for Bixby. </value>
    ...
    public enum SceneLifecycle
    {
        ...
        /// <summary>
        /// Enum CREATEFORBIXBY for value: CREATEFORBIXBY
        /// </summary>
        [EnumMember(Value = "CREATEFORBIXBY")]
        CREATEFORBIXBY = 4,

        /// <summary>
        /// Enum UPDATEFORBIXBY for value: UPDATEFORBIXBY
        /// </summary>
        [EnumMember(Value = "UPDATEFORBIXBY")]
        UPDATEFORBIXBY = 5,

        /// <summary>
        /// Enum DELETEFORBIXBY for value: DELETEFORBIXBY
        /// </summary>
        [EnumMember(Value = "DELETEFORBIXBY")]
        DELETEFORBIXBY = 6
