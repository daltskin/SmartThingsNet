...
{
    /// <summary>
    /// Data type and value properties used to describe the attribute.
    /// </summary>
    [DataContract(Name = "AttributeProperties")]
    public partial class AttributeProperties : IEquatable<AttributeProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeProperties" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="AttributeProperties" /> class.
        /// </summary>
        /// <param name="value">Properties that describe the value of an attribute. (required).</param>
        /// <param name="unit">unit.</param>
        /// <param name="data">data.</param>
        public AttributeProperties(Dictionary<string, Object> value = default(Dictionary<string, Object>), AttributePropertiesUnit unit = default(AttributePropertiesUnit), AttributePropertiesData data = default(AttributePropertiesData))
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for AttributeProperties and cannot be null");
            }
            this.Value = value;
            this.Unit = unit;
            this.Data = data;
        ...
        /// <summary>
        /// Properties that describe the value of an attribute.
        /// </summary>
        /// <value>Properties that describe the value of an attribute.</value>
        ...
        public AttributePropertiesUnit Unit { get; set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public AttributePropertiesData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributeProperties {\n");
        ...
        {
            return this.Equals(input as AttributeProperties);
        }

        /// <summary>
        /// Returns true if AttributeProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributeProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeProperties input)
        {
            if (input == null)
            {
                return false;
