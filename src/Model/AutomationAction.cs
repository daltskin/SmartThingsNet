...
namespace SmartThingsNet.Model
{
    ...
    /// AutomationAction
    /// </summary>
    [DataContract(Name = "automationAction")]
    public partial class AutomationAction : IEquatable<AutomationAction>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AutomationAction);
        }

        /// <summary>
        /// Returns true if AutomationAction instances are equal
        /// </summary>
        /// <param name="input">Instance of AutomationAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutomationAction input)
        {
            if (input == null)
            {
                return false;
