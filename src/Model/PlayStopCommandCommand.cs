...
namespace SmartThingsNet.Model
{
    ...
    public partial class PlayStopCommandCommand :  IEquatable<PlayStopCommandCommand>, IValidatableObject
    {
        ...
        public PlayStopCommandCommand(string name = default(string), string play = default(string), string stop = default(string))
        {
            // to ensure "play" is required (not null)
            this.Play = play ?? throw new ArgumentNullException("play is a required property for PlayStopCommandCommand and cannot be null");
            // to ensure "stop" is required (not null)
            this.Stop = stop ?? throw new ArgumentNullException("stop is a required property for PlayStopCommandCommand and cannot be null");
            this.Name = name;
        }
