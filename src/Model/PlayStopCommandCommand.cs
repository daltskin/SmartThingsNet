...
{
    /// <summary>
    /// To specify separate commands with no arguments for on and off, use the \&quot;play\&quot; and \&quot;stop\&quot; fields respectively. To specify a single command, use \&quot;name\&quot; for the command and the \&quot;play\&quot; and \&quot;stop\&quot; fields for the arguments.
    /// </summary>
    [DataContract(Name = "playStopCommand_command")]
    public partial class PlayStopCommandCommand : IEquatable<PlayStopCommandCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopCommandCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayStopCommandCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayStopCommandCommand" /> class.
        /// </summary>
        ...
        public PlayStopCommandCommand(string name = default(string), string play = default(string), string stop = default(string), string argumentType = default(string))
        {
            // to ensure "play" is required (not null)
            if (play == null) {
                throw new ArgumentNullException("play is a required property for PlayStopCommandCommand and cannot be null");
            }
            this.Play = play;
            // to ensure "stop" is required (not null)
            if (stop == null) {
                throw new ArgumentNullException("stop is a required property for PlayStopCommandCommand and cannot be null");
            }
            this.Stop = stop;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayStopCommandCommand {\n");
        ...
        {
            return this.Equals(input as PlayStopCommandCommand);
        }

        /// <summary>
        /// Returns true if PlayStopCommandCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayStopCommandCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayStopCommandCommand input)
        {
            if (input == null)
            {
                return false;
