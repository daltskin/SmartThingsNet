...
{
    /// <summary>
    /// ExcludedActionItemId
    /// </summary>
    [DataContract(Name = "excludedActionItemId")]
    public partial class ExcludedActionItemId : IEquatable<ExcludedActionItemId>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedActionItemId" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExcludedActionItemId() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedActionItemId" /> class.
        /// </summary>
        ...
        public ExcludedActionItemId(int id = default(int), Object value = default(Object), List<ExcludedActionItemExclude> exclude = default(List<ExcludedActionItemExclude>))
        {
            // to ensure "exclude" is required (not null)
            if (exclude == null) {
                throw new ArgumentNullException("exclude is a required property for ExcludedActionItemId and cannot be null");
            }
        ...
        public List<ExcludedActionItemExclude> Exclude { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedActionItemId {\n");
        ...
        {
            return this.Equals(input as ExcludedActionItemId);
        }

        /// <summary>
        /// Returns true if ExcludedActionItemId instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedActionItemId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedActionItemId input)
        {
            if (input == null)
            {
                return false;
