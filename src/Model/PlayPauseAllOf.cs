...
namespace SmartThingsNet.Model
{
    ...
    /// PlayPauseAllOf
    /// </summary>
    [DataContract(Name = "playPause_allOf")]
    public partial class PlayPauseAllOf : IEquatable<PlayPauseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayPauseAllOf {\n");
        ...
        {
            return this.Equals(input as PlayPauseAllOf);
        }

        /// <summary>
        /// Returns true if PlayPauseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayPauseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayPauseAllOf input)
        {
            if (input == null)
            {
                return false;
