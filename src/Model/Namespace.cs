...
namespace SmartThingsNet.Model
{
    ...
    public partial class Namespace :  IEquatable<Namespace>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The type of owner of the namespace.</value>
        ...
        /// </summary>
        /// <param name="name">A URL safe globally unique namespace name (ascii letters and numbers only).</param>
        /// <param name="ownerType">The type of owner of the namespace..</param>
        /// <param name="ownerId">id of the owner (user, or in the future, organization).</param>
        ...
        /// </summary>
        /// <value>A URL safe globally unique namespace name (ascii letters and numbers only)</value>
        ...
        /// </summary>
        /// <value>id of the owner (user, or in the future, organization)</value>
