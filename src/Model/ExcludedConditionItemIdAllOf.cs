...
{
    /// <summary>
    /// ExcludedConditionItemIdAllOf
    /// </summary>
    [DataContract(Name = "excludedConditionItemId_allOf")]
    public partial class ExcludedConditionItemIdAllOf : IEquatable<ExcludedConditionItemIdAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExcludedConditionItemIdAllOf" /> class.
        /// </summary>
        /// <param name="id">The index of the array in the given capability to which this exclusion object will be inserted.</param>
        public ExcludedConditionItemIdAllOf(int id = default(int))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExcludedConditionItemIdAllOf {\n");
        ...
        {
            return this.Equals(input as ExcludedConditionItemIdAllOf);
        }

        /// <summary>
        /// Returns true if ExcludedConditionItemIdAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ExcludedConditionItemIdAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExcludedConditionItemIdAllOf input)
        {
            if (input == null)
            {
                return false;
