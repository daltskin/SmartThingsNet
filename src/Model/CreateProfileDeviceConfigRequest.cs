...
{
    /// <summary>
    /// CreateProfileDeviceConfigRequest
    /// </summary>
    [DataContract(Name = "CreateProfileDeviceConfigRequest")]
    public partial class CreateProfileDeviceConfigRequest : IEquatable<CreateProfileDeviceConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProfileDeviceConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateProfileDeviceConfigRequest {\n");
        ...
        {
            return this.Equals(input as CreateProfileDeviceConfigRequest);
        }

        /// <summary>
        /// Returns true if CreateProfileDeviceConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateProfileDeviceConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateProfileDeviceConfigRequest input)
        {
            if (input == null)
            {
                return false;
