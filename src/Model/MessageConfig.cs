...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageConfig")]
    public partial class MessageConfig : IEquatable<MessageConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageConfig" /> class.
        /// </summary>
        /// <param name="messageGroupKey">The key value of the message group..</param>
        public MessageConfig(string messageGroupKey = default(string))
        {
        ...
        /// </summary>
        /// <value>The key value of the message group.</value>
        [DataMember(Name = "messageGroupKey", EmitDefaultValue = false)]
        public string MessageGroupKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MessageGroupKey: ").Append(MessageGroupKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MessageConfig);
        }

        /// <summary>
        /// Returns true if MessageConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageConfig input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.MessageGroupKey == input.MessageGroupKey ||
                    (this.MessageGroupKey != null &&
                    this.MessageGroupKey.Equals(input.MessageGroupKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.MessageGroupKey != null)
                {
                    hashCode = (hashCode * 59) + this.MessageGroupKey.GetHashCode();
                }
                return hashCode;
            }
        }
