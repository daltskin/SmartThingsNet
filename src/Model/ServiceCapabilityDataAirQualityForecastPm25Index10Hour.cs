...
{
    /// <summary>
    /// ServiceCapabilityDataAirQualityForecastPm25Index10Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_airQualityForecast_pm25Index10Hour")]
    public partial class ServiceCapabilityDataAirQualityForecastPm25Index10Hour : IEquatable<ServiceCapabilityDataAirQualityForecastPm25Index10Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataAirQualityForecastPm25Index10Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea) 10 hours index forecast of particulate matter less than 2.5 microns .</param>
        public ServiceCapabilityDataAirQualityForecastPm25Index10Hour(decimal value = default(decimal))
        {
            this.Value = value;
        }

        /// <summary>
        /// (This attribute is only available in Korea) 10 hours index forecast of particulate matter less than 2.5 microns 
        /// </summary>
        /// <value>(This attribute is only available in Korea) 10 hours index forecast of particulate matter less than 2.5 microns </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataAirQualityForecastPm25Index10Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataAirQualityForecastPm25Index10Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataAirQualityForecastPm25Index10Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataAirQualityForecastPm25Index10Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataAirQualityForecastPm25Index10Hour input)
        {
            if (input == null)
            {
                return false;
