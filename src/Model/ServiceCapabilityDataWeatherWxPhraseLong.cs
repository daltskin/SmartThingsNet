...
{
    /// <summary>
    /// ServiceCapabilityDataWeatherWxPhraseLong
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_weather_wxPhraseLong")]
    public partial class ServiceCapabilityDataWeatherWxPhraseLong : IEquatable<ServiceCapabilityDataWeatherWxPhraseLong>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataWeatherWxPhraseLong" /> class.
        /// </summary>
        /// <param name="value">A text description of observed weather conditions accompanying the iconCode field.  Range - 32 character phrase .</param>
        public ServiceCapabilityDataWeatherWxPhraseLong(string value = default(string))
        {
            this.Value = value;
        }

        /// <summary>
        /// A text description of observed weather conditions accompanying the iconCode field.  Range - 32 character phrase 
        /// </summary>
        /// <value>A text description of observed weather conditions accompanying the iconCode field.  Range - 32 character phrase </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataWeatherWxPhraseLong {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataWeatherWxPhraseLong);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataWeatherWxPhraseLong instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataWeatherWxPhraseLong to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataWeatherWxPhraseLong input)
        {
            if (input == null)
            {
                return false;
