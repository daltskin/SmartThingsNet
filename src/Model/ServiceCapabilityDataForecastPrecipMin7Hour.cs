...
{
    /// <summary>
    /// ServiceCapabilityDataForecastPrecipMin7Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_precipMin7Hour")]
    public partial class ServiceCapabilityDataForecastPrecipMin7Hour : IEquatable<ServiceCapabilityDataForecastPrecipMin7Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastPrecipMin7Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) minimium 7 hour forecast liquid precipitation amount in millimeters .</param>
        /// <param name="unit">mm.</param>
        public ServiceCapabilityDataForecastPrecipMin7Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) minimium 7 hour forecast liquid precipitation amount in millimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) minimium 7 hour forecast liquid precipitation amount in millimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastPrecipMin7Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastPrecipMin7Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastPrecipMin7Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastPrecipMin7Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastPrecipMin7Hour input)
        {
            if (input == null)
            {
                return false;
