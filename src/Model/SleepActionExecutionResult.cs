...
{
    /// <summary>
    /// The result of a sleep action execution
    /// </summary>
    [DataContract(Name = "SleepActionExecutionResult")]
    public partial class SleepActionExecutionResult : IEquatable<SleepActionExecutionResult>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SleepActionExecutionResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SleepActionExecutionResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SleepActionExecutionResult" /> class.
        /// </summary>
        /// <param name="result">result (required).</param>
        public SleepActionExecutionResult(ExecutionResult result = default(ExecutionResult))
        {
            this.Result = result;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SleepActionExecutionResult {\n");
        ...
        {
            return this.Equals(input as SleepActionExecutionResult);
        }

        /// <summary>
        /// Returns true if SleepActionExecutionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SleepActionExecutionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SleepActionExecutionResult input)
        {
            if (input == null)
            {
                return false;
