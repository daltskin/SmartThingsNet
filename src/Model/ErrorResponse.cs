...
namespace SmartThingsNet.Model
{
    ...
    public partial class ErrorResponse : IEquatable<ErrorResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="requestId">A correlation id used for reference when contacting support..</param>
        /// <param name="error">error.</param>
        public ErrorResponse(string requestId = default(string), Error error = default(Error))
        {
        ...
        /// </summary>
        /// <value>A correlation id used for reference when contacting support.</value>
