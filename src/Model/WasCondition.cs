...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WasCondition")]
    public partial class WasCondition : IEquatable<WasCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WasCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WasCondition" /> class.
        /// </summary>
        ...
        public WasCondition(List<Condition> and = default(List<Condition>), List<Condition> or = default(List<Condition>), Condition not = default(Condition), EqualsCondition propertyEquals = default(EqualsCondition), GreaterThanCondition greaterThan = default(GreaterThanCondition), GreaterThanOrEqualsCondition greaterThanOrEquals = default(GreaterThanOrEqualsCondition), LessThanCondition lessThan = default(LessThanCondition), LessThanOrEqualsCondition lessThanOrEquals = default(LessThanOrEqualsCondition), BetweenCondition between = default(BetweenCondition), string id = default(string), Interval duration = default(Interval), Operand operand = default(Operand))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for WasCondition and cannot be null");
            }
            this.Id = id;
            // to ensure "duration" is required (not null)
            if (duration == null) {
                throw new ArgumentNullException("duration is a required property for WasCondition and cannot be null");
            }
        ...
        public EqualsCondition PropertyEquals { get; set; }
        ...
        /// <summary>
        /// Gets or Sets GreaterThanOrEquals
        /// </summary>
        [DataMember(Name = "greaterThanOrEquals", EmitDefaultValue = false)]
        public GreaterThanOrEqualsCondition GreaterThanOrEquals { get; set; }
        ...
        /// <summary>
        /// Gets or Sets LessThanOrEquals
        /// </summary>
        [DataMember(Name = "lessThanOrEquals", EmitDefaultValue = false)]
        public LessThanOrEqualsCondition LessThanOrEquals { get; set; }

        /// <summary>
        /// Gets or Sets Between
        /// </summary>
        [DataMember(Name = "between", EmitDefaultValue = false)]
        public BetweenCondition Between { get; set; }

        /// <summary>
        /// Unique id for the condition
        /// </summary>
        /// <value>Unique id for the condition</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GreaterThanOrEquals: ").Append(GreaterThanOrEquals).Append("\n");
            sb.Append("  LessThan: ").Append(LessThan).Append("\n");
            sb.Append("  LessThanOrEquals: ").Append(LessThanOrEquals).Append("\n");
        ...
        {
            return this.Equals(input as WasCondition);
        }

        /// <summary>
        /// Returns true if WasCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of WasCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasCondition input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PropertyEquals == input.PropertyEquals ||
                    (this.PropertyEquals != null &&
                    this.PropertyEquals.Equals(input.PropertyEquals))
                ) && 
                (
                ...
                (
                    this.GreaterThanOrEquals == input.GreaterThanOrEquals ||
                    (this.GreaterThanOrEquals != null &&
                    this.GreaterThanOrEquals.Equals(input.GreaterThanOrEquals))
                ) && 
                (
                ...
                (
                    this.LessThanOrEquals == input.LessThanOrEquals ||
                    (this.LessThanOrEquals != null &&
                    this.LessThanOrEquals.Equals(input.LessThanOrEquals))
                ) && 
                (
                    this.Between == input.Between ||
                    (this.Between != null &&
                    this.Between.Equals(input.Between))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PropertyEquals.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.GreaterThanOrEquals.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.LessThanOrEquals.GetHashCode();
                }
                if (this.Between != null)
                {
                    hashCode = (hashCode * 59) + this.Between.GetHashCode();
                }
                if (this.Id != null)
                {
