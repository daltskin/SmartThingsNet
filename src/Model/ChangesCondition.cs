...
namespace SmartThingsNet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangesCondition")]
    public partial class ChangesCondition : IEquatable<ChangesCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangesCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangesCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangesCondition" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChangesCondition {\n");
        ...
        {
            return this.Equals(input as ChangesCondition);
        }

        /// <summary>
        /// Returns true if ChangesCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangesCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangesCondition input)
        {
            if (input == null)
            {
                return false;
