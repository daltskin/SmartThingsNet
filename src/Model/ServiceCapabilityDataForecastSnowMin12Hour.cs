...
{
    /// <summary>
    /// ServiceCapabilityDataForecastSnowMin12Hour
    /// </summary>
    [DataContract(Name = "ServiceCapabilityData_forecast_snowMin12Hour")]
    public partial class ServiceCapabilityDataForecastSnowMin12Hour : IEquatable<ServiceCapabilityDataForecastSnowMin12Hour>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceCapabilityDataForecastSnowMin12Hour" /> class.
        /// </summary>
        /// <param name="value">(This attribute is only available in Korea and Japan) Minimium 12 hours forecast snowfall amount in centimeters .</param>
        /// <param name="unit">cm.</param>
        public ServiceCapabilityDataForecastSnowMin12Hour(float value = default(float), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        /// <summary>
        /// (This attribute is only available in Korea and Japan) Minimium 12 hours forecast snowfall amount in centimeters 
        /// </summary>
        /// <value>(This attribute is only available in Korea and Japan) Minimium 12 hours forecast snowfall amount in centimeters </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceCapabilityDataForecastSnowMin12Hour {\n");
        ...
        {
            return this.Equals(input as ServiceCapabilityDataForecastSnowMin12Hour);
        }

        /// <summary>
        /// Returns true if ServiceCapabilityDataForecastSnowMin12Hour instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceCapabilityDataForecastSnowMin12Hour to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCapabilityDataForecastSnowMin12Hour input)
        {
            if (input == null)
            {
                return false;
