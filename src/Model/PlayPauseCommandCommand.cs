...
namespace SmartThingsNet.Model
{
    ...
    public partial class PlayPauseCommandCommand :  IEquatable<PlayPauseCommandCommand>, IValidatableObject
    {
        ...
        public PlayPauseCommandCommand(string name = default(string), string play = default(string), string pause = default(string))
        {
            // to ensure "play" is required (not null)
            this.Play = play ?? throw new ArgumentNullException("play is a required property for PlayPauseCommandCommand and cannot be null");
            // to ensure "pause" is required (not null)
            this.Pause = pause ?? throw new ArgumentNullException("pause is a required property for PlayPauseCommandCommand and cannot be null");
            this.Name = name;
        }
