...
{
    /// <summary>
    /// To specify separate commands with no arguments for on and off, use the \&quot;play\&quot; and \&quot;pause\&quot; fields respectively. To specify a single command, use \&quot;name\&quot; for the command and the \&quot;play\&quot; and \&quot;pause\&quot; fields for the arguments.
    /// </summary>
    [DataContract(Name = "playPauseCommand_command")]
    public partial class PlayPauseCommandCommand : IEquatable<PlayPauseCommandCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayPauseCommandCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayPauseCommandCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayPauseCommandCommand" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="play">play (required).</param>
        ...
        public PlayPauseCommandCommand(string name = default(string), string play = default(string), string pause = default(string), string argumentType = default(string))
        {
            // to ensure "play" is required (not null)
            if (play == null) {
                throw new ArgumentNullException("play is a required property for PlayPauseCommandCommand and cannot be null");
            }
            this.Play = play;
            // to ensure "pause" is required (not null)
            if (pause == null) {
                throw new ArgumentNullException("pause is a required property for PlayPauseCommandCommand and cannot be null");
            }
            this.Pause = pause;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayPauseCommandCommand {\n");
        ...
        {
            return this.Equals(input as PlayPauseCommandCommand);
        }

        /// <summary>
        /// Returns true if PlayPauseCommandCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayPauseCommandCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayPauseCommandCommand input)
        {
            if (input == null)
            {
                return false;
