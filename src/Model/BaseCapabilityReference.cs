...
{
    /// <summary>
    /// BaseCapabilityReference
    /// </summary>
    [DataContract(Name = "BaseCapabilityReference")]
    public partial class BaseCapabilityReference : IEquatable<BaseCapabilityReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseCapabilityReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BaseCapabilityReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseCapabilityReference" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="version">version.</param>
        public BaseCapabilityReference(string id = default(string), int version = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for BaseCapabilityReference and cannot be null");
            }
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseCapabilityReference {\n");
        ...
        {
            return this.Equals(input as BaseCapabilityReference);
        }

        /// <summary>
        /// Returns true if BaseCapabilityReference instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseCapabilityReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCapabilityReference input)
        {
            if (input == null)
            {
                return false;
